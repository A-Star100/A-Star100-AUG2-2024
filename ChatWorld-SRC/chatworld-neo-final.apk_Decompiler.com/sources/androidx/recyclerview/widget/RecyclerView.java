            ...
            if (Build.VERSION.SDK_INT < 9) {
                ...
                if (scroller.computeScrollOffset()) {
                    ...
                    if (RecyclerView.this.mAdapter != null) {
                        ...
                        int hresult = RecyclerView.this.mScrollStepConsumed[0];
                    ...
                    if (RecyclerView.this.dispatchNestedScroll(adapterSize, vresult, overscrollX, overscrollY, (int[]) null, 1)) {
                    ...
                    if (!(adapterSize == 0 && vresult == 0)) {
                        RecyclerView.this.dispatchOnScrolled(adapterSize, vresult);
                    }
                    if (!RecyclerView.this.awakenScrollBars()) {
                        RecyclerView.this.invalidate();
                    }
                    boolean fullyConsumedAny = (dx == 0 && dy == 0) || (dx != 0 && RecyclerView.this.mLayout.canScrollHorizontally() && adapterSize == dx) || (dy != 0 && RecyclerView.this.mLayout.canScrollVertically() && vresult == dy);
