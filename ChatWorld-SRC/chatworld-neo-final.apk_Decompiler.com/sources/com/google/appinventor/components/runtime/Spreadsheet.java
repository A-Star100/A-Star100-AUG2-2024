            ...
            public void run() {
                ...
                try {
                    if (Spreadsheet.this.credentialsPath == null) {
                        Object obj2 = "";
                        try {
                            String getUrl = String.format("https://docs.google.com/spreadsheets/d/%s/export?format=csv&range=%s", new Object[]{Spreadsheet.this.spreadsheetID, URLEncoder.encode(rangeReference, Protocol.CHARSET)});
            ...
            public void run() {
                ...
                try {
                    if (Spreadsheet.this.credentialsPath == null) {
                        Object obj2 = "";
                        try {
                            String getUrl = String.format("https://docs.google.com/spreadsheets/d/%s/export?format=csv&range=%s", new Object[]{Spreadsheet.this.spreadsheetID, URLEncoder.encode(rangeRef, Protocol.CHARSET)});
                ...
                public void run() {
                    ...
                    try {
                        ...
                        if (Spreadsheet.this.credentialsPath == null) {
                            Object obj2 = obj;
                            try {
                                String getUrl = String.format("https://docs.google.com/spreadsheets/d/%s/export?format=csv&range=%s", new Object[]{Spreadsheet.this.spreadsheetID, URLEncoder.encode(cellReference, Protocol.CHARSET)});
            ...
            public void run() {
                ...
                try {
                    if (Spreadsheet.this.credentialsPath == null) {
                        ...
                        Object obj2 = "";
                        try {
                            String getUrl = String.format("https://docs.google.com/spreadsheets/d/%s/gviz/tq?tqx=out:csv&sheet=%s", new Object[]{Spreadsheet.this.spreadsheetID, URLEncoder.encode(str, Protocol.CHARSET)});
                            HttpURLConnection connection = (HttpURLConnection) new URL(getUrl).openConnection();
                            connection.setRequestMethod("GET");
                            if (connection.getResponseCode() == 400) {
