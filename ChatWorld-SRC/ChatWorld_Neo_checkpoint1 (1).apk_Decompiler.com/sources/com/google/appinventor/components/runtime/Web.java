...
public class Web extends AndroidNonvisibleComponent implements Component, ObservableDataSource<YailList, Future<YailList>> {
    ...
    public Web(ComponentContainer container) {
        ...
        this.responseTextEncoding = Protocol.CHARSET;
    ...
    public void PostText(String text) {
        requestTextImpl(text, Protocol.CHARSET, "PostText", "POST");
    }
    ...
    public void PatchText(String text) {
        requestTextImpl(text, Protocol.CHARSET, "PatchText", "PATCH");
    }
    ...
    public void PutText(String text) {
        requestTextImpl(text, Protocol.CHARSET, "PutText", "PUT");
    }
            ...
            FutureTask<Void> futureTask = new FutureTask<>(new Runnable() {
                public void run() {
                    ...
                    try {
                        ...
                        requestData = str2.getBytes(Protocol.CHARSET);
                        Web.this.performRequest(capturedProperties, requestData, (String) null, str4, str3);
    ...
    public String UriEncode(String text) {
        try {
            return URLEncoder.encode(text, Protocol.CHARSET);
        } catch (UnsupportedEncodingException e) {
    ...
    public String UriDecode(String text) {
        try {
            return URLDecoder.decode(text, Protocol.CHARSET);
        } catch (UnsupportedEncodingException e) {
            Log.e(LOG_TAG, "UTF-8 is unsupported?", e);
            return "";
        }
    ...
    public Object XMLTextDecodeAsDictionary(String XmlText) {
        try {
            ...
            is.setEncoding(Protocol.CHARSET);
            parser.parse(is, p);
            return p.getRoot();
        } catch (Exception e) {
