...
public class WebRTCNativeMgr {
    ...
    public static final CharsetDecoder utf8Decoder = Charset.forName(Protocol.CHARSET).newDecoder();
    /* access modifiers changed from: private */
    ...
    public void send(String output) {
        try {
            ...
            this.dataChannel.send(new DataChannel.Buffer(ByteBuffer.wrap(output.getBytes(Protocol.CHARSET)), false));
