...
public final class SMSModule$definition$lambda$4$$inlined$AsyncFunction$1 extends Lambda implements Function1<Object[], Boolean> {
    final /* synthetic */ SMSModule this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public SMSModule$definition$lambda$4$$inlined$AsyncFunction$1(SMSModule sMSModule) {
        super(1);
