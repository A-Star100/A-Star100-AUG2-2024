...
public final class FileSystemModule$definition$lambda$48$$inlined$AsyncFunction$40 extends Lambda implements Function1<Object[], String> {
    ...
    public final String invoke(Object[] objArr) {
        ...
        if (this.this$0.isSAFUri(parse)) {
            ...
            DocumentFile createFile = access$getNearestSAFFile.createFile(str3, str4);
            if (createFile != null) {
