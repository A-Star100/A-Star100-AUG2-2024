...
public final class DownloadOptions implements Record {
    ...
    public int hashCode() {
        int m = Video$$ExternalSyntheticBackport0.m(this.md5) * 31;
        ...
        return ((hashCode + i) * 31) + this.sessionType.hashCode();
    }
    ...
    public String toString() {
        ...
        return "DownloadOptions(md5=" + z + ", cache=" + bool + ", headers=" + map + ", sessionType=" + sessionType2 + ")";
    }
