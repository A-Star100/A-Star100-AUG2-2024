...
public final class RNHeadlessAppLoader implements HeadlessAppLoader {
    ...
    public boolean invalidateApp(String str) {
        ...
        new Handler(this.context.getMainLooper()).post(new RNHeadlessAppLoader$$ExternalSyntheticLambda0((ReactInstanceManager) obj, str));
        return true;
    }

    /* access modifiers changed from: private */
    public static final void invalidateApp$lambda$0(ReactInstanceManager reactInstanceManager, String str) {
