...
public class UIManagerModuleWrapper implements ActivityProvider, InternalModule, JavaScriptContextProvider, UIManager {
    ...
    public void onDestroy() {
        ...
        for (com.facebook.react.bridge.LifecycleEventListener removeLifecycleEventListener : this.mLifecycleListenersMap.values()) {
            this.mReactContext.removeLifecycleEventListener(removeLifecycleEventListener);
        }
