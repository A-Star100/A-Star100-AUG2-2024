...
public class FontLoaderModule extends Module {
    ...
    public ModuleDefinitionData definition() {
        ...
        try {
            ...
            AnyType[] anyTypeArr = {new AnyType(new LazyKType(Reflection.getOrCreateKotlinClass(String.class), false, FontLoaderModule$definition$lambda$2$$inlined$AsyncFunction$1.INSTANCE)), new AnyType(new LazyKType(Reflection.getOrCreateKotlinClass(String.class), false, FontLoaderModule$definition$lambda$2$$inlined$AsyncFunction$2.INSTANCE))};
            Function1 fontLoaderModule$definition$lambda$2$$inlined$AsyncFunction$3 = new FontLoaderModule$definition$lambda$2$$inlined$AsyncFunction$3(this);
            Class<Unit> cls3 = Unit.class;
            if (Intrinsics.areEqual((Object) cls3, (Object) Integer.TYPE)) {
                asyncFunction = new IntAsyncFunctionComponent("loadAsync", anyTypeArr, fontLoaderModule$definition$lambda$2$$inlined$AsyncFunction$3);
            } else if (Intrinsics.areEqual((Object) cls3, (Object) Boolean.TYPE)) {
                asyncFunction = new BoolAsyncFunctionComponent("loadAsync", anyTypeArr, fontLoaderModule$definition$lambda$2$$inlined$AsyncFunction$3);
            } else if (Intrinsics.areEqual((Object) cls3, (Object) Double.TYPE)) {
                asyncFunction = new DoubleAsyncFunctionComponent("loadAsync", anyTypeArr, fontLoaderModule$definition$lambda$2$$inlined$AsyncFunction$3);
            } else if (Intrinsics.areEqual((Object) cls3, (Object) Float.TYPE)) {
                asyncFunction = new FloatAsyncFunctionComponent("loadAsync", anyTypeArr, fontLoaderModule$definition$lambda$2$$inlined$AsyncFunction$3);
            } else if (Intrinsics.areEqual((Object) cls3, (Object) String.class)) {
                asyncFunction = new StringAsyncFunctionComponent("loadAsync", anyTypeArr, fontLoaderModule$definition$lambda$2$$inlined$AsyncFunction$3);
            } else {
                asyncFunction = new AsyncFunctionComponent("loadAsync", anyTypeArr, fontLoaderModule$definition$lambda$2$$inlined$AsyncFunction$3);
            }
