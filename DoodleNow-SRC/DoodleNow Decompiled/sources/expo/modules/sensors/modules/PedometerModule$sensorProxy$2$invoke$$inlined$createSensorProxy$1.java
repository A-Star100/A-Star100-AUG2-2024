...
public final class PedometerModule$sensorProxy$2$invoke$$inlined$createSensorProxy$1 extends Lambda implements Function0<PedometerServiceInterface> {
    final /* synthetic */ WeakReference $weakModule;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public PedometerModule$sensorProxy$2$invoke$$inlined$createSensorProxy$1(WeakReference weakReference) {
        super(0);
        this.$weakModule = weakReference;
    }

    /* JADX WARNING: type inference failed for: r1v4, types: [expo.modules.interfaces.sensors.SensorServiceInterface, expo.modules.interfaces.sensors.services.PedometerServiceInterface] */
