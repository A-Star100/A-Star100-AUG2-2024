...
public final class AccelerometerModule$sensorProxy$2$invoke$$inlined$createSensorProxy$2 extends Lambda implements Function1<SensorEvent, Unit> {
    final /* synthetic */ String $eventName;
    final /* synthetic */ WeakReference $weakModule;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AccelerometerModule$sensorProxy$2$invoke$$inlined$createSensorProxy$2(WeakReference weakReference, String str) {
        super(1);
