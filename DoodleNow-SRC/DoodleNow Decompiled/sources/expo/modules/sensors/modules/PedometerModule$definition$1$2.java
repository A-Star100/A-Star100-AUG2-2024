...
final class PedometerModule$definition$1$2 extends Lambda implements Function0<SensorProxy> {
    final /* synthetic */ PedometerModule this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PedometerModule$definition$1$2(PedometerModule pedometerModule) {
        super(0);
