...
public final class MagnetometerUncalibratedModule$sensorProxy$2$invoke$$inlined$createSensorProxy$1 extends Lambda implements Function0<MagnetometerUncalibratedServiceInterface> {
    final /* synthetic */ WeakReference $weakModule;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public MagnetometerUncalibratedModule$sensorProxy$2$invoke$$inlined$createSensorProxy$1(WeakReference weakReference) {
        super(0);
        this.$weakModule = weakReference;
    }

    /* JADX WARNING: type inference failed for: r1v4, types: [expo.modules.interfaces.sensors.SensorServiceInterface, expo.modules.interfaces.sensors.services.MagnetometerUncalibratedServiceInterface] */
