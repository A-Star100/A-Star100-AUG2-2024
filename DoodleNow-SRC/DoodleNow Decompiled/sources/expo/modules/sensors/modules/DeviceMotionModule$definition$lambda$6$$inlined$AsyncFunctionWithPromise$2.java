...
public final class DeviceMotionModule$definition$lambda$6$$inlined$AsyncFunctionWithPromise$2 extends Lambda implements Function2<Object[], Promise, Unit> {
    final /* synthetic */ DeviceMotionModule this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public DeviceMotionModule$definition$lambda$6$$inlined$AsyncFunctionWithPromise$2(DeviceMotionModule deviceMotionModule) {
        super(2);
    ...
    public final void invoke(Object[] objArr, Promise promise) {
        ...
        String str = objArr[0];
        UIManager access$getUiManager$p = this.this$0.uiManager;
        if (access$getUiManager$p == null) {
            Intrinsics.throwUninitializedPropertyAccessException("uiManager");
            access$getUiManager$p = null;
        }
        access$getUiManager$p.runOnUiQueueThread(new DeviceMotionModule$definition$1$4$1(this.this$0, promise));
    }
