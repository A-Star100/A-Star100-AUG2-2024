...
public final class SensorProxyKt$UseSensorProxy$$inlined$AsyncFunction$3 extends Lambda implements Function1<Object[], Unit> {
    final /* synthetic */ Function0 $sensorProxyGetter$inlined;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public SensorProxyKt$UseSensorProxy$$inlined$AsyncFunction$3(Function0 function0) {
        super(1);
    ...
    public final Unit invoke(Object[] objArr) {
        ...
        ((SensorProxy) this.$sensorProxyGetter$inlined.invoke()).setUpdateInterval(objArr[0].intValue());
