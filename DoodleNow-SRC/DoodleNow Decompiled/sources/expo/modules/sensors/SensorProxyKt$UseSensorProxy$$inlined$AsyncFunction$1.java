...
public final class SensorProxyKt$UseSensorProxy$$inlined$AsyncFunction$1 extends Lambda implements Function2<Object[], Promise, Unit> {
    final /* synthetic */ Function0 $sensorProxyGetter$inlined;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public SensorProxyKt$UseSensorProxy$$inlined$AsyncFunction$1(Function0 function0) {
        super(2);
    ...
    public final void invoke(Object[] objArr, Promise promise) {
        ...
        ((SensorProxy) this.$sensorProxyGetter$inlined.invoke()).setUpdateInterval(((Integer) promise).intValue());
    }
