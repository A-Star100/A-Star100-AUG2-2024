...
public final class LocationModule$definition$lambda$27$$inlined$AsyncFunction$20 extends Lambda implements Function1<Object[], Unit> {
    final /* synthetic */ LocationModule this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public LocationModule$definition$lambda$27$$inlined$AsyncFunction$20(LocationModule locationModule) {
        super(1);
    ...
    public final Unit invoke(Object[] objArr) {
        ...
        String str = objArr[0];
        GeofencingOptions geofencingOptions = objArr[1];
        String str2 = str;
        if (!this.this$0.isMissingBackgroundPermissions()) {
            this.this$0.getMTaskManager().registerTask(str2, GeofencingTaskConsumer.class, geofencingOptions.toMap$expo_location_release());
