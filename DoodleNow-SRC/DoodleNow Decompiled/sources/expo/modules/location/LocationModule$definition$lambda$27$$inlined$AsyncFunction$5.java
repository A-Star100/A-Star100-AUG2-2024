...
public final class LocationModule$definition$lambda$27$$inlined$AsyncFunction$5 extends Lambda implements Function2<Object[], Promise, Unit> {
    final /* synthetic */ LocationModule this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public LocationModule$definition$lambda$27$$inlined$AsyncFunction$5(LocationModule locationModule) {
        super(2);
    ...
    public final void invoke(Object[] objArr, Promise promise) {
        ...
        } else if (intValue == this.this$0.mHeadingId) {
            this.this$0.destroyHeadingWatch();
        } else {
            this.this$0.removeLocationUpdatesForRequest(intValue);
        }
    }
