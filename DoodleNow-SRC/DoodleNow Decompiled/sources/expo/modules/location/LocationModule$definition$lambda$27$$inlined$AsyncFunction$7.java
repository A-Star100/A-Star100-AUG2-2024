...
public final class LocationModule$definition$lambda$27$$inlined$AsyncFunction$7 extends Lambda implements Function1<Object[], Unit> {
    final /* synthetic */ LocationModule this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public LocationModule$definition$lambda$27$$inlined$AsyncFunction$7(LocationModule locationModule) {
        super(1);
    ...
    public final Unit invoke(Object[] objArr) {
        ...
        if (!this.this$0.isMissingForegroundPermissions()) {
            if (intValue == this.this$0.mHeadingId) {
