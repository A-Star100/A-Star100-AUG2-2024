...
public final class PersistentFileLog {
    ...
    public PersistentFileLog(String str, Context context) {
        ...
        this.filePath = path + "/dev.expo.modules.core.logging." + str;
    }
    ...
    public final long getFileSize() {
        ...
        L_0x0010:
            ...
            r0 = r1
            java.io.FileInputStream r0 = (java.io.FileInputStream) r0     // Catch:{ all -> 0x0028 }
            java.nio.channels.FileChannel r0 = r0.getChannel()     // Catch:{ all -> 0x0028 }
            long r4 = r0.size()     // Catch:{ all -> 0x0028 }
            r0 = 0
