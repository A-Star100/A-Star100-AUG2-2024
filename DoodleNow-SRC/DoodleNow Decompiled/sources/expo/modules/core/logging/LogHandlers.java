...
public final class LogHandlers {
    ...
    public final LogHandler createOSLogHandler(String str) {
        Intrinsics.checkNotNullParameter(str, "category");
        return new OSLogHandler(str);
    }

    public final LogHandler createPersistentFileLogHandler(Context context, String str) {
        Intrinsics.checkNotNullParameter(context, "context");
        Intrinsics.checkNotNullParameter(str, "category");
        return new PersistentFileLogHandler(str, context);
    }
}
