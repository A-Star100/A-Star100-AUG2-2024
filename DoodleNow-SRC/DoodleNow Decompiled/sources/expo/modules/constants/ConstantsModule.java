...
public final class ConstantsModule extends Module {
    public ModuleDefinitionData definition() {
        ...
        try {
            ...
            moduleDefinitionBuilder.getAsyncFunctions().put("getWebViewUserAgentAsync", new AsyncFunctionComponent("getWebViewUserAgentAsync", new AnyType[0], new ConstantsModule$definition$lambda$1$$inlined$AsyncFunction$1()));
