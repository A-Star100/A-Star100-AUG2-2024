...
public final class SharedObjectId {
    ...
    public static final /* synthetic */ SharedObjectId m1187boximpl(int i) {
        return new SharedObjectId(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m1188constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1189equalsimpl(int i, Object obj) {
        return (obj instanceof SharedObjectId) && i == ((SharedObjectId) obj).m1195unboximpl();
    }
    ...
    public static int m1191hashCodeimpl(int i) {
        return i;
    }
    ...
    public boolean equals(Object obj) {
        return m1189equalsimpl(this.value, obj);
    }
    ...
    public int hashCode() {
        return m1191hashCodeimpl(this.value);
    }
    ...
    public static final SharedObject m1193toNativeObjectimpl(int i, AppContext appContext) {
        Intrinsics.checkNotNullParameter(appContext, "appContext");
        return appContext.getSharedObjectRegistry$expo_modules_core_release().m1199toNativeObjectkyJHjyY$expo_modules_core_release(i);
    }

    /* renamed from: toJavaScriptObject-impl  reason: not valid java name */
    public static final JavaScriptObject m1192toJavaScriptObjectimpl(int i, AppContext appContext) {
        Intrinsics.checkNotNullParameter(appContext, "appContext");
        SharedObject r1 = m1193toNativeObjectimpl(i, appContext);
        if (r1 == null) {
            return null;
        }
