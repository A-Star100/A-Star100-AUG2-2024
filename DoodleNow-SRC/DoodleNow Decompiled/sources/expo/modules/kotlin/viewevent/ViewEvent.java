        ...
        if (unimoduleProxy != null) {
            ...
            if (!this.isValidated) {
                ...
                if (moduleHolder == null) {
                    ...
                    Class<?> cls = this.view.getClass();
                    Logger.warn$default(logger, "⚠️ Cannot get module holder for " + cls, (Throwable) null, 2, (Object) null);
                    return;
                }
                ...
                if (callbacksDefinition == null) {
                    Logger logger2 = CoreLoggerKt.getLogger();
                    Class<?> cls2 = moduleHolder.getModule().getClass();
                    Logger.warn$default(logger2, "⚠️ Cannot get callbacks for " + cls2, (Throwable) null, 2, (Object) null);
                    return;
                }
                ...
                int i = 0;
                while (i < length) {
                    if (Intrinsics.areEqual((Object) names[i], (Object) this.name)) {
                        this.isValidated = true;
                    } else {
                        i++;
                    }
                }
                Logger logger3 = CoreLoggerKt.getLogger();
                String str = this.name;
                Class<?> cls3 = moduleHolder.getModule().getClass();
                Logger.warn$default(logger3, "⚠️ Event " + str + " wasn't exported from " + cls3, (Throwable) null, 2, (Object) null);
                return;
            }
            ...
            if (callbackInvoker$expo_modules_core_release != null) {
                ...
                callbackInvoker$expo_modules_core_release.emit(id, str2, convertEventBody, sh);
            }
        }
    }
