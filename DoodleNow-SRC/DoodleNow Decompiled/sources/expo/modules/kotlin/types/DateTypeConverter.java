...
public final class DateTypeConverter extends DynamicAwareTypeConverters<LocalDate> {
    ...
    public LocalDate convertFromDynamic(Dynamic dynamic) {
        ...
        if (i == 1) {
            LocalDate m = LocalDate.parse(dynamic.asString(), Downloader$$ExternalSyntheticApiModelOutline0.m());
    ...
    public LocalDate convertFromAny(Object obj) {
        ...
        if (obj instanceof String) {
            LocalDate m = LocalDate.parse((CharSequence) obj, Downloader$$ExternalSyntheticApiModelOutline0.m());
            Intrinsics.checkNotNullExpressionValue(m, "parse(...)");
            return m;
    ...
    private final LocalDate convertFromLong(long j) {
        LocalDate m = Instant.ofEpochMilli(j).atZone(Downloader$$ExternalSyntheticApiModelOutline0.m()).toLocalDate();
