...
public final class EnumTypeConverter extends DynamicAwareTypeConverters<Enum<?>> {
            ...
            if (!(enumArr.length == 0)) {
                ...
                if (primaryConstructor2 != null) {
                    ...
                    if (!Enumerable.class.isAssignableFrom(JvmClassMappingKt.getJavaClass(kClass))) {
                        ...
                        Logger.error$default(logger, "Enum '" + kClass + "' should inherit from " + orCreateKotlinClass + ".", (Throwable) null, 2, (Object) null);
                        return;
                    }
                    return;
                }
    ...
    private final Enum<?> convertEnumWithParameter(Object obj, Enum<?>[] enumArr, String str) {
        ...
        if (declaredField != null) {
            ...
            String simpleName = this.enumClass.getSimpleName();
            throw new IllegalArgumentException(("Couldn't convert '" + obj + "' to " + simpleName + " where " + str + " is the enum parameter").toString());
        }
