...
public final class EitherTypeConverterKt {
    ...
    public static final List<DeferredValue> createDeferredValues(Object obj, AppContext appContext, List<? extends Pair<ExpectedType, ? extends TypeConverter<?>>> list, List<? extends KType> list2) {
        ...
        String joinToString$default = CollectionsKt.joinToString$default(list2, ", ", (CharSequence) null, (CharSequence) null, 0, (CharSequence) null, EitherTypeConverterKt$createDeferredValues$1.INSTANCE, 30, (Object) null);
        throw new TypeCastException("Cannot cast '" + obj + "' to 'Either<" + joinToString$default + ">'");
    }
}
