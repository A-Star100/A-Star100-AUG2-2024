    ...
    public Response intercept(Interceptor.Chain chain) {
        ...
        try {
            ...
            if (proceed.isRedirect()) {
                ...
                ResponseBody peekResponseBody$default = ExpoNetworkInspectOkHttpInterceptorsKt.peekResponseBody$default(proceed, 0, 2, (Object) null);
                ExpoNetworkInspectOkHttpInterceptorsKt.getDelegate().didReceiveResponse(str, request, proceed, peekResponseBody$default);
