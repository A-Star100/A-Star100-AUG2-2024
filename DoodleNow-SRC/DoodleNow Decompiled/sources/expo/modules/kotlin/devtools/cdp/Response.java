...
public final class Response implements JsonSerializable {
    ...
    public int hashCode() {
        return (((((((((this.url.hashCode() * 31) + this.status) * 31) + this.statusText.hashCode()) * 31) + this.headers.hashCode()) * 31) + this.mimeType.hashCode()) * 31) + Video$$ExternalSyntheticBackport0.m(this.encodedDataLength);
    }
    ...
    public String toString() {
        ...
        return "Response(url=" + str + ", status=" + i + ", statusText=" + str2 + ", headers=" + map + ", mimeType=" + str3 + ", encodedDataLength=" + j + ")";
    }
