...
public final class Event {
    ...
    public final Event copy(String str, JsonSerializable jsonSerializable) {
        ...
        Intrinsics.checkNotNullParameter(jsonSerializable, OutcomeEventsTable.COLUMN_NAME_PARAMS);
    ...
    public String toString() {
        ...
        JsonSerializable jsonSerializable = this.params;
        return "Event(method=" + str + ", params=" + jsonSerializable + ")";
    }
