...
public final class RequestWillBeSentParams implements JsonSerializable {
    ...
    public int hashCode() {
        int hashCode = ((((((((((((((this.requestId.hashCode() * 31) + this.loaderId.hashCode()) * 31) + this.documentURL.hashCode()) * 31) + this.request.hashCode()) * 31) + this.timestamp.hashCode()) * 31) + this.wallTime.hashCode()) * 31) + this.initiator.hashCode()) * 31) + Video$$ExternalSyntheticBackport0.m(this.redirectHasExtraInfo)) * 31;
    ...
    public String toString() {
        ...
        return "RequestWillBeSentParams(requestId=" + str + ", loaderId=" + str2 + ", documentURL=" + str3 + ", request=" + request2 + ", timestamp=" + bigDecimal + ", wallTime=" + bigDecimal2 + ", initiator=" + map + ", redirectHasExtraInfo=" + z + ", redirectResponse=" + response + ", referrerPolicy=" + str4 + ", type=" + resourceType + ")";
    }
