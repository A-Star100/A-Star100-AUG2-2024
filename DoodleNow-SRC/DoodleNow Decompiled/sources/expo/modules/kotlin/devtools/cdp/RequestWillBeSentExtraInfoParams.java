...
public final class RequestWillBeSentExtraInfoParams implements JsonSerializable {
    ...
    public String toString() {
        ...
        ConnectTiming connectTiming2 = this.connectTiming;
        return "RequestWillBeSentExtraInfoParams(requestId=" + str + ", associatedCookies=" + map + ", headers=" + map2 + ", connectTiming=" + connectTiming2 + ")";
    }
