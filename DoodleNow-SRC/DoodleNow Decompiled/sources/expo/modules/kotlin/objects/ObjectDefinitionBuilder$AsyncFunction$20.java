...
public final class ObjectDefinitionBuilder$AsyncFunction$20 extends Lambda implements Function1<Object[], R> {
    final /* synthetic */ Function5<P0, P1, P2, P3, P4, R> $body;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ObjectDefinitionBuilder$AsyncFunction$20(Function5<? super P0, ? super P1, ? super P2, ? super P3, ? super P4, ? extends R> function5) {
        super(1);
        this.$body = function5;
    }
