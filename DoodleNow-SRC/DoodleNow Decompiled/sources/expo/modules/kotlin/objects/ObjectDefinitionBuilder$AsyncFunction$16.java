...
public final class ObjectDefinitionBuilder$AsyncFunction$16 extends Lambda implements Function1<Object[], R> {
    final /* synthetic */ Function4<P0, P1, P2, P3, R> $body;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ObjectDefinitionBuilder$AsyncFunction$16(Function4<? super P0, ? super P1, ? super P2, ? super P3, ? extends R> function4) {
        super(1);
        this.$body = function4;
    }
