...
final class PropertyComponentBuilderWithThis$set$1$1 extends Lambda implements Function1<Object[], Unit> {
    final /* synthetic */ Function2<ThisType, T, Unit> $body;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public PropertyComponentBuilderWithThis$set$1$1(Function2<? super ThisType, ? super T, Unit> function2) {
        super(1);
        this.$body = function2;
    }
