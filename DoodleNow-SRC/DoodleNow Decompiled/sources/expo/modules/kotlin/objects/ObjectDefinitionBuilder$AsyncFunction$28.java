...
public final class ObjectDefinitionBuilder$AsyncFunction$28 extends Lambda implements Function1<Object[], R> {
    final /* synthetic */ Function7<P0, P1, P2, P3, P4, P5, P6, R> $body;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ObjectDefinitionBuilder$AsyncFunction$28(Function7<? super P0, ? super P1, ? super P2, ? super P3, ? super P4, ? super P5, ? super P6, ? extends R> function7) {
        super(1);
        this.$body = function7;
    }
