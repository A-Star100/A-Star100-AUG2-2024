...
public final class FloatAsyncFunctionComponent extends AsyncFunctionComponent<Float> {
    ...
    public FloatAsyncFunctionComponent(String str, AnyType[] anyTypeArr, Function1<? super Object[], Float> function1) {
    ...
    public void callUserImplementation$expo_modules_core_release(Object[] objArr, Promise promise, AppContext appContext) {
        ...
        promise.resolve(((Number) getBody().invoke(convertArgs(objArr, appContext))).floatValue());
    }
}
