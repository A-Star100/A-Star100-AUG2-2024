...
public final class BoolAsyncFunctionComponent extends AsyncFunctionComponent<Boolean> {
    ...
    public BoolAsyncFunctionComponent(String str, AnyType[] anyTypeArr, Function1<? super Object[], Boolean> function1) {
    ...
    public void callUserImplementation$expo_modules_core_release(Object[] objArr, Promise promise, AppContext appContext) {
        ...
        promise.resolve(((Boolean) getBody().invoke(convertArgs(objArr, appContext))).booleanValue());
    }
}
