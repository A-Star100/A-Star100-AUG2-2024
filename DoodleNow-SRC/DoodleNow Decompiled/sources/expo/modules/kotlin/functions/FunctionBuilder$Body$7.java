...
public final class FunctionBuilder$Body$7 extends Lambda implements Function1<Object[], Object> {
    final /* synthetic */ Function2<P0, P1, R> $body;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public FunctionBuilder$Body$7(Function2<? super P0, ? super P1, ? extends R> function2) {
        super(1);
        this.$body = function2;
    }
