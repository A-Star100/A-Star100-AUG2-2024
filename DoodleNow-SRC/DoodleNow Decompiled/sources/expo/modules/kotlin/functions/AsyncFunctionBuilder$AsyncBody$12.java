...
public final class AsyncFunctionBuilder$AsyncBody$12 extends Lambda implements Function1<Object[], R> {
    final /* synthetic */ Function3<P0, P1, P2, R> $body;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AsyncFunctionBuilder$AsyncBody$12(Function3<? super P0, ? super P1, ? super P2, ? extends R> function3) {
        super(1);
        this.$body = function3;
    }
