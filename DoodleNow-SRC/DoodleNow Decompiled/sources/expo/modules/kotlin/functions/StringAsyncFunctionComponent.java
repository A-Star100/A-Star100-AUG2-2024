...
public final class StringAsyncFunctionComponent extends AsyncFunctionComponent<String> {
    ...
    public StringAsyncFunctionComponent(String str, AnyType[] anyTypeArr, Function1<? super Object[], String> function1) {
    ...
    public void callUserImplementation$expo_modules_core_release(Object[] objArr, Promise promise, AppContext appContext) {
        ...
        promise.resolve((String) getBody().invoke(convertArgs(objArr, appContext)));
    }
}
