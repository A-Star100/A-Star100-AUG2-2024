...
public final class DoubleAsyncFunctionComponent extends AsyncFunctionComponent<Double> {
    ...
    public DoubleAsyncFunctionComponent(String str, AnyType[] anyTypeArr, Function1<? super Object[], Double> function1) {
    ...
    public void callUserImplementation$expo_modules_core_release(Object[] objArr, Promise promise, AppContext appContext) {
        ...
        promise.resolve(((Number) getBody().invoke(convertArgs(objArr, appContext))).doubleValue());
    }
}
