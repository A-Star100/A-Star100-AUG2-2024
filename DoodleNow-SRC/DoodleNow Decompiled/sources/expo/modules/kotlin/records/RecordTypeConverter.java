...
public final class RecordTypeConverter<T extends Record> extends DynamicAwareTypeConverters<T> {
    ...
    private static final class PropertyDescriptor {
        ...
        public int hashCode() {
            return (((((this.typeConverter.hashCode() * 31) + this.fieldAnnotation.hashCode()) * 31) + Video$$ExternalSyntheticBackport0.m(this.isRequired)) * 31) + this.validators.hashCode();
        }
        ...
        public String toString() {
            ...
            return "PropertyDescriptor(typeConverter=" + typeConverter2 + ", fieldAnnotation=" + field + ", isRequired=" + z + ", validators=" + list + ")";
        }
