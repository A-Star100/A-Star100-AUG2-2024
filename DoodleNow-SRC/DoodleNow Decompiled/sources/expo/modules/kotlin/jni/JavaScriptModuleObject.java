...
public final class JavaScriptModuleObject implements Destructible {
    ...
    public final native void emitEvent(JSIContext jSIContext, String str, ReadableNativeMap readableNativeMap);
    ...
    public final native void registerClass(String str, JavaScriptModuleObject javaScriptModuleObject, boolean z, Class<?> cls, ExpectedType[] expectedTypeArr, JNIFunctionBody jNIFunctionBody);
