            ...
            if (hashCode != -1837081951) {
                if (hashCode == -591152331 && action.equals(ActivityResultContracts.StartIntentSenderForResult.ACTION_INTENT_SENDER_REQUEST)) {
                    if (Build.VERSION.SDK_INT >= 33) {
                        parcelable = (Parcelable) createIntent.getParcelableExtra(ActivityResultContracts.StartIntentSenderForResult.EXTRA_INTENT_SENDER_REQUEST, IntentSenderRequest.class);
                    } else {
                        parcelable = createIntent.getParcelableExtra(ActivityResultContracts.StartIntentSenderForResult.EXTRA_INTENT_SENDER_REQUEST);
                    }
    ...
    public static final void register$lambda$4(AppContextActivityResultRegistry appContextActivityResultRegistry, String str, LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
        ...
        if (i == 1) {
            ...
            if (callbacksAndContract != null) {
                ...
                if (Build.VERSION.SDK_INT >= 33) {
                    parcelable = (Parcelable) Downloader$$ExternalSyntheticApiModelOutline0.m(bundle, str, ActivityResult.class);
                } else {
