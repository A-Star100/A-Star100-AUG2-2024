...
public final class ActivityResultsManager$registerForActivityResult$$inlined$withActivityAvailable$1 implements OnActivityAvailableListener {
    ...
    public void onActivityAvailable(AppCompatActivity appCompatActivity) {
        ...
        try {
            ...
            AppContextActivityResultRegistry access$getRegistry$p = this.this$0.registry;
            int andIncrement = this.this$0.nextLocalRequestCode.getAndIncrement();
            obj = Result.m1230constructorimpl(access$getRegistry$p.register("AppContext_rq#" + andIncrement, appCompatActivity, this.$contract$inlined, this.$fallbackCallback$inlined));
        } catch (Throwable th) {
