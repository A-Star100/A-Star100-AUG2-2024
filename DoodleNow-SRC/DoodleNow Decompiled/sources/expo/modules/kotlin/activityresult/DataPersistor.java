...
public final class DataPersistor {
    ...
    public final Map<String, Serializable> retrieveStringToSerializableMap(String str) {
        ...
        for (Object next : iterable) {
            ...
            if (Build.VERSION.SDK_INT >= 33) {
                serializable = Downloader$$ExternalSyntheticApiModelOutline0.m(bundle, str2, Serializable.class);
            } else {
    ...
    public final Serializable retrieveSerializable(String str) {
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            return Downloader$$ExternalSyntheticApiModelOutline0.m(retrievedData, str, Serializable.class);
        }
        return retrievedData.getSerializable(str);
    }
