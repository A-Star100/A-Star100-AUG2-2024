...
public class AVManager implements LifecycleEventListener, AudioManager.OnAudioFocusChangeListener, MediaRecorder.OnInfoListener, AVManagerInterface, InternalModule {
    ...
    public void onCreate(ModuleRegistry moduleRegistry) {
        ...
        if (moduleRegistry != null) {
            ...
            uIManager.runOnClientCodeQueueThread(new AVManager$$ExternalSyntheticLambda9(this));
        }
    }
    ...
    public void setAudioIsEnabled(Boolean bool) {
        ...
        if (!bool.booleanValue()) {
            getUIManager().runOnUiQueueThread(new AVManager$$ExternalSyntheticLambda10(this));
        }
    }
    ...
    public void setAudioMode(ReadableArguments readableArguments) {
        ...
        if (!z) {
            this.mIsDuckingAudio = false;
            getUIManager().runOnUiQueueThread(new AVManager$$ExternalSyntheticLambda5(this));
        }
    ...
    public void loadForSound(ReadableArguments readableArguments, ReadableArguments readableArguments2, Promise promise) {
        getUIManager().runOnUiQueueThread(new AVManager$$ExternalSyntheticLambda4(this, readableArguments, readableArguments2, promise));
    }
    ...
    public void unloadForSound(Integer num, Promise promise) {
        getUIManager().runOnUiQueueThread(new AVManager$$ExternalSyntheticLambda7(this, num, promise));
    }
    ...
    public void setStatusForSound(Integer num, ReadableArguments readableArguments, Promise promise) {
        getUIManager().runOnUiQueueThread(new AVManager$$ExternalSyntheticLambda8(this, num, promise, readableArguments));
    }
    ...
    public void replaySound(Integer num, ReadableArguments readableArguments, Promise promise) {
        getUIManager().runOnUiQueueThread(new AVManager$$ExternalSyntheticLambda6(this, num, promise, readableArguments));
    }
    ...
    public void getStatusForSound(Integer num, Promise promise) {
        getUIManager().runOnUiQueueThread(new AVManager$$ExternalSyntheticLambda3(this, num, promise));
    }
    ...
    public void getCurrentInput(Promise promise) {
        ...
        try {
            Downloader$$ExternalSyntheticApiModelOutline0.m(this.mAudioRecorder);
        } catch (Exception unused) {
        }
        AudioDeviceInfo m$1 = Downloader$$ExternalSyntheticApiModelOutline0.m$1(this.mAudioRecorder);
        if (m$1 == null) {
            ...
            while (true) {
                ...
                if (audioDeviceInfo.getType() == 15) {
                    boolean unused2 = this.mAudioRecorder.setPreferredDevice(audioDeviceInfo);
                    m$1 = audioDeviceInfo;
                    break;
                }
                i++;
        ...
        if (m$1 != null) {
            promise.resolve(getMapFromDeviceInfo(m$1));
        } else {
    ...
    public void pauseAudioRecording(Promise promise) {
        ...
        try {
            Downloader$$ExternalSyntheticApiModelOutline0.m$1(this.mAudioRecorder);
