...
public final class ViewUtils {
    ...
    public static final void tryRunWithVideoView$lambda$0(ModuleRegistry moduleRegistry, int i, VideoViewCallback videoViewCallback, Promise promise) {
        Intrinsics.checkNotNullParameter(moduleRegistry, "$moduleRegistry");
        Intrinsics.checkNotNullParameter(videoViewCallback, "$callback");
    ...
    /* access modifiers changed from: private */
    public static final void tryRunWithVideoView$lambda$1(ModuleRegistry moduleRegistry, int i, VideoViewCallback videoViewCallback, expo.modules.kotlin.Promise promise) {
        Intrinsics.checkNotNullParameter(moduleRegistry, "$moduleRegistry");
        Intrinsics.checkNotNullParameter(videoViewCallback, "$callback");
        Intrinsics.checkNotNullParameter(promise, "$promise");
        INSTANCE.tryRunWithVideoViewOnUiThread(moduleRegistry, i, videoViewCallback, promise);
