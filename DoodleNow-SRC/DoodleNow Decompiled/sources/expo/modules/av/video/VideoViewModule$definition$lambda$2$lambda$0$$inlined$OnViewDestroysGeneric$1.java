...
public final class VideoViewModule$definition$lambda$2$lambda$0$$inlined$OnViewDestroysGeneric$1 extends Lambda implements Function1<View, Unit> {
    final /* synthetic */ Function1 $body;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public VideoViewModule$definition$lambda$2$lambda$0$$inlined$OnViewDestroysGeneric$1(Function1 function1) {
        super(1);
        this.$body = function1;
    }
