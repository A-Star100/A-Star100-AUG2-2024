...
public final class VideoViewWrapper extends FrameLayout {
    ...
    public VideoViewWrapper(Context context, AppContext appContext) {
        ...
        View view = this;
        this.onStatusUpdate$delegate = new ViewEventDelegate(view, (Function1) null);
        this.onLoadStart$delegate = new ViewEventDelegate(view, (Function1) null);
        this.onLoad$delegate = new ViewEventDelegate(view, (Function1) null);
        this.onError$delegate = new ViewEventDelegate(view, (Function1) null);
        this.onReadyForDisplay$delegate = new ViewEventDelegate(view, (Function1) null);
        this.onFullscreenUpdate$delegate = new ViewEventDelegate(view, (Function1) null);
    }

    /* access modifiers changed from: private */
    public static final void mLayoutRunnable$lambda$0(VideoViewWrapper videoViewWrapper) {
