...
public final class ImageLibraryContract implements AppContextActivityResultContract<ImageLibraryContractOptions, ImagePickerContractResult> {
    ...
    public Intent createIntent(Context context, ImageLibraryContractOptions imageLibraryContractOptions) {
        ...
        if (imageLibraryContractOptions.getOptions().getLegacy()) {
            return createLegacyIntent(imageLibraryContractOptions.getOptions());
        }
        ...
        if (intent != null) {
            ...
            if (!(intent2 == null || (allDataUris = ImagePickerUtilsKt.getAllDataUris(intent2)) == null)) {
                if (imageLibraryContractOptions.getOptions().getAllowsMultipleSelection()) {
                    ...
                    if (imageLibraryContractOptions.getOptions().getSelectionLimit() > 0) {
                        list = CollectionsKt.take(list, imageLibraryContractOptions.getOptions().getSelectionLimit());
                    }
                    imagePickerContractResult = new ImagePickerContractResult.Success(list);
    ...
    private final Intent createLegacyIntent(ImagePickerOptions imagePickerOptions) {
        String[] strArr;
        ...
        int i = WhenMappings.$EnumSwitchMapping$0[imagePickerOptions.getMediaTypes().ordinal()];
        if (i == 1) {
