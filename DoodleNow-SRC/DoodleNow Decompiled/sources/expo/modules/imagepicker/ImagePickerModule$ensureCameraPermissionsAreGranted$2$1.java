    ...
    public final void onResult(Map<String, PermissionsResponse> map) {
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            ...
            if (permissionsStatus == PermissionsStatus.GRANTED) {
                ...
                this.$continuation.resumeWith(Result.m1230constructorimpl(Unit.INSTANCE));
                return;
            }
            Result.Companion companion2 = Result.Companion;
            this.$continuation.resumeWith(Result.m1230constructorimpl(ResultKt.createFailure(new UserRejectedPermissionsException())));
            return;
        }
