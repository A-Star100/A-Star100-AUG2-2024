...
public final class ImagePickerModule$definition$lambda$7$$inlined$AsyncFunctionWithPromise$4 extends Lambda implements Function2<Object[], Promise, Unit> {
    final /* synthetic */ ImagePickerModule this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ImagePickerModule$definition$lambda$7$$inlined$AsyncFunctionWithPromise$4(ImagePickerModule imagePickerModule) {
        super(2);
    ...
    public final void invoke(Object[] objArr, Promise promise) {
        ...
        if (permissions != null) {
            ...
            permissions.getPermissions(this.this$0.createPermissionsDecorator(promise), (String[]) Arrays.copyOf(access$getMediaLibraryPermissions, access$getMediaLibraryPermissions.length));
            return;
        }
