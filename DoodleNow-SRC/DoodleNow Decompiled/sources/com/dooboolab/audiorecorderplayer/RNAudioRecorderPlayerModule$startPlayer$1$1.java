...
@Metadata(d1 = {"\u0000\u0011\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\b\u0010\u0002\u001a\u00020\u0003H\u0016¨\u0006\u0004"}, d2 = {"com/dooboolab/audiorecorderplayer/RNAudioRecorderPlayerModule$startPlayer$1$1", "Ljava/util/TimerTask;", "run", "", "react-native-audio-recorder-player_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
...
public final class RNAudioRecorderPlayerModule$startPlayer$1$1 extends TimerTask {
    ...
    RNAudioRecorderPlayerModule$startPlayer$1$1(MediaPlayer mediaPlayer, RNAudioRecorderPlayerModule rNAudioRecorderPlayerModule) {
        this.$mp = mediaPlayer;
    ...
    public void run() {
        try {
            ...
            createMap.putInt("duration", this.$mp.getDuration());
            ...
            String access$getTag$cp = RNAudioRecorderPlayerModule.tag;
            String message = e.getMessage();
            Log.e(access$getTag$cp, "Mediaplayer error: " + message);
        }
    }
}
