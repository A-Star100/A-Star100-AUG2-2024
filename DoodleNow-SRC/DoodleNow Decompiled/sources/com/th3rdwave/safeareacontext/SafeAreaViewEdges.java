...
public final class SafeAreaViewEdges {
    ...
    public String toString() {
        ...
        SafeAreaViewEdgeModes safeAreaViewEdgeModes4 = this.left;
        return "SafeAreaViewEdges(top=" + safeAreaViewEdgeModes + ", right=" + safeAreaViewEdgeModes2 + ", bottom=" + safeAreaViewEdgeModes3 + ", left=" + safeAreaViewEdgeModes4 + ")";
    }
