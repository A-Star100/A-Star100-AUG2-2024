...
public final class SafeAreaUtilsKt {
    private static final EdgeInsets getRootWindowInsetsCompatR(View view) {
        ...
        if (rootWindowInsets == null || (m = rootWindowInsets.getInsets(Downloader$$ExternalSyntheticApiModelOutline0.m$1() | Downloader$$ExternalSyntheticApiModelOutline0.m$2() | WindowInsets.Type.navigationBars())) == null) {
            return null;
        }
