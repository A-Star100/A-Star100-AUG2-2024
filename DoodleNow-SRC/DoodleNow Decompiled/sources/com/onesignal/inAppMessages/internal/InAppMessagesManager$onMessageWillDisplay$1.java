...
final class InAppMessagesManager$onMessageWillDisplay$1 extends Lambda implements Function1<IInAppMessageLifecycleListener, Unit> {
    final /* synthetic */ InAppMessage $message;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    InAppMessagesManager$onMessageWillDisplay$1(InAppMessage inAppMessage) {
        super(1);
