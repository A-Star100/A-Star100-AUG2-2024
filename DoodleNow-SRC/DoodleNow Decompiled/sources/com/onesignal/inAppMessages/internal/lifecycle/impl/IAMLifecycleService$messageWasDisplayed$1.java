...
final class IAMLifecycleService$messageWasDisplayed$1 extends Lambda implements Function1<IInAppLifecycleEventHandler, Unit> {
    final /* synthetic */ InAppMessage $message;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    IAMLifecycleService$messageWasDisplayed$1(InAppMessage inAppMessage) {
        super(1);
