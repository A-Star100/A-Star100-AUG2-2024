...
final class IAMLifecycleService$messagePageChanged$1 extends Lambda implements Function1<IInAppLifecycleEventHandler, Unit> {
    final /* synthetic */ InAppMessage $message;
    final /* synthetic */ InAppMessagePage $page;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    IAMLifecycleService$messagePageChanged$1(InAppMessage inAppMessage, InAppMessagePage inAppMessagePage) {
        super(1);
