...
final class IAMLifecycleService$messageActionOccurredOnMessage$1 extends Lambda implements Function1<IInAppLifecycleEventHandler, Unit> {
    final /* synthetic */ InAppMessageClickResult $action;
    final /* synthetic */ InAppMessage $message;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    IAMLifecycleService$messageActionOccurredOnMessage$1(InAppMessage inAppMessage, InAppMessageClickResult inAppMessageClickResult) {
        super(1);
