...
final class TriggerController$onModelAdded$1 extends Lambda implements Function1<ITriggerHandler, Unit> {
    final /* synthetic */ TriggerModel $model;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    TriggerController$onModelAdded$1(TriggerModel triggerModel) {
        super(1);
