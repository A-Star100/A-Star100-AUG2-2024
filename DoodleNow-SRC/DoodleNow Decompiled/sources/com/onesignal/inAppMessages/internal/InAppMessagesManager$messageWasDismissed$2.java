...
final class InAppMessagesManager$messageWasDismissed$2 extends Lambda implements Function1<IInAppMessageLifecycleListener, Unit> {
    final /* synthetic */ InAppMessage $message;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    InAppMessagesManager$messageWasDismissed$2(InAppMessage inAppMessage) {
        super(1);
