...
final class DeviceRegistrationListener$retrievePushTokenAndUpdateSubscription$1 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = this.this$0._pushTokenManager.retrievePushToken(this);
        ...
        this.this$0._subscriptionManager.addOrUpdatePushSubscriptionToken(pushTokenResponse.getToken(), this.this$0._notificationsManager.getPermission() ? pushTokenResponse.getStatus() : SubscriptionStatus.NO_PERMISSION);
