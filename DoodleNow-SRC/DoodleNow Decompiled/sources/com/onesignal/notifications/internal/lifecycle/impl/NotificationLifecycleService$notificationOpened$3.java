...
final class NotificationLifecycleService$notificationOpened$3 extends Lambda implements Function1<INotificationClickListener, Unit> {
    final /* synthetic */ NotificationClickEvent $openResult;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    NotificationLifecycleService$notificationOpened$3(NotificationClickEvent notificationClickEvent) {
        super(1);
