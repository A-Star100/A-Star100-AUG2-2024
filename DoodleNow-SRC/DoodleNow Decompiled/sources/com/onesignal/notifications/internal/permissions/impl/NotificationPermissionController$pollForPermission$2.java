...
final class NotificationPermissionController$pollForPermission$2 extends Lambda implements Function1<INotificationPermissionChangedHandler, Unit> {
    final /* synthetic */ boolean $enabled;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    NotificationPermissionController$pollForPermission$2(boolean z) {
        super(1);
        this.$enabled = z;
    }
