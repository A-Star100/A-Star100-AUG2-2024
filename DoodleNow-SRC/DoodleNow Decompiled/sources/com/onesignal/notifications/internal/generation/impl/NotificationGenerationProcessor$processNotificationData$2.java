...
final class NotificationGenerationProcessor$processNotificationData$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new AnonymousClass1(notificationGenerationProcessor, notificationReceivedEvent, booleanRef, notification, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                notificationGenerationProcessor._lifecycleService.externalRemoteNotificationReceived(notificationReceivedEvent);
                if (notificationReceivedEvent.getDiscard()) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            final NotificationReceivedEvent notificationReceivedEvent = this.$notificationReceivedEvent;
