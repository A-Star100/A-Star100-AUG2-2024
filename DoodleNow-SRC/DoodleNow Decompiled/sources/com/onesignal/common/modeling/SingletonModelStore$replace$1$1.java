...
final class SingletonModelStore$replace$1$1 extends Lambda implements Function1<ISingletonModelStoreChangeHandler<TModel>, Unit> {
    final /* synthetic */ TModel $existingModel;
    final /* synthetic */ String $tag;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SingletonModelStore$replace$1$1(TModel tmodel, String str) {
        super(1);
