...
final class ModelStore$removeItem$2 extends Lambda implements Function1<IModelStoreChangeHandler<TModel>, Unit> {
    final /* synthetic */ TModel $model;
    final /* synthetic */ String $tag;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ModelStore$removeItem$2(TModel tmodel, String str) {
        super(1);
        this.$model = tmodel;
        this.$tag = str;
    }
