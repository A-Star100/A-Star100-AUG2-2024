...
final class ModelStore$onChanged$1 extends Lambda implements Function1<IModelStoreChangeHandler<TModel>, Unit> {
    final /* synthetic */ ModelChangedArgs $args;
    final /* synthetic */ String $tag;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ModelStore$onChanged$1(ModelChangedArgs modelChangedArgs, String str) {
        super(1);
