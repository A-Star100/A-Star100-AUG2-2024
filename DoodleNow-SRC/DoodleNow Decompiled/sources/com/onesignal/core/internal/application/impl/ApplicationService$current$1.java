...
final class ApplicationService$current$1 extends Lambda implements Function1<IActivityLifecycleHandler, Unit> {
    final /* synthetic */ Activity $value;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ApplicationService$current$1(Activity activity) {
        super(1);
        this.$value = activity;
    }
