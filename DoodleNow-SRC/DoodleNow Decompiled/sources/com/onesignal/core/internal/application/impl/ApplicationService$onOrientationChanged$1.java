...
final class ApplicationService$onOrientationChanged$1 extends Lambda implements Function1<IActivityLifecycleHandler, Unit> {
    final /* synthetic */ Activity $activity;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ApplicationService$onOrientationChanged$1(Activity activity) {
        super(1);
