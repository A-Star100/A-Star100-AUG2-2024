...
public interface IOneSignal {
    ...
    public static final class DefaultImpls {
        ...
        public static void login(IOneSignal iOneSignal, String str) {
            ...
            iOneSignal.login(str, (String) null);
        }
    }
}
