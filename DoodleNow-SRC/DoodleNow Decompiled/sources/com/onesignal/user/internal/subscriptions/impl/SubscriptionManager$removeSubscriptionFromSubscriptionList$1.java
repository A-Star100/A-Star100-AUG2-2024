...
final class SubscriptionManager$removeSubscriptionFromSubscriptionList$1 extends Lambda implements Function1<ISubscriptionChangedHandler, Unit> {
    final /* synthetic */ ISubscription $subscription;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SubscriptionManager$removeSubscriptionFromSubscriptionList$1(ISubscription iSubscription) {
        super(1);
