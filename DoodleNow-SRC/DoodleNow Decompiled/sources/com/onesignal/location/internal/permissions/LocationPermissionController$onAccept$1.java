...
final class LocationPermissionController$onAccept$1 extends Lambda implements Function1<ILocationPermissionChangedHandler, Unit> {
    public static final LocationPermissionController$onAccept$1 INSTANCE = new LocationPermissionController$onAccept$1();

    LocationPermissionController$onAccept$1() {
        super(1);
    }
