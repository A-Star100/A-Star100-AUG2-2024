...
final class LocationPermissionController$showFallbackAlertDialog$1$onAccept$1$onFocus$1 extends Lambda implements Function1<ILocationPermissionChangedHandler, Unit> {
    final /* synthetic */ boolean $hasPermission;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    LocationPermissionController$showFallbackAlertDialog$1$onAccept$1$onFocus$1(boolean z) {
        super(1);
