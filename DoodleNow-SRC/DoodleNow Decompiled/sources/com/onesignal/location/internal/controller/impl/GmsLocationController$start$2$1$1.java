...
final class GmsLocationController$start$2$1$1 extends Lambda implements Function1<ILocationUpdatedHandler, Unit> {
    final /* synthetic */ GmsLocationController this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    GmsLocationController$start$2$1$1(GmsLocationController gmsLocationController) {
        super(1);
