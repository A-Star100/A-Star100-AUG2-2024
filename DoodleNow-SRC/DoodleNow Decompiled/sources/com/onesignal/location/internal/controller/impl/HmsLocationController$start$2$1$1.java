...
final class HmsLocationController$start$2$1$1 extends Lambda implements Function1<ILocationUpdatedHandler, Unit> {
    final /* synthetic */ HmsLocationController this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    HmsLocationController$start$2$1$1(HmsLocationController hmsLocationController) {
        super(1);
    ...
    public final void invoke(ILocationUpdatedHandler iLocationUpdatedHandler) {
        ...
        Intrinsics.checkNotNull(access$getLastLocation$p);
        iLocationUpdatedHandler.onLocationChanged(access$getLastLocation$p);
    }
}
