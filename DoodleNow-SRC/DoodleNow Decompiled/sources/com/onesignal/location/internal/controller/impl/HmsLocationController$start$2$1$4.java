...
final class HmsLocationController$start$2$1$4 extends Lambda implements Function1<ILocationUpdatedHandler, Unit> {
    final /* synthetic */ HmsLocationController this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    HmsLocationController$start$2$1$4(HmsLocationController hmsLocationController) {
        super(1);
