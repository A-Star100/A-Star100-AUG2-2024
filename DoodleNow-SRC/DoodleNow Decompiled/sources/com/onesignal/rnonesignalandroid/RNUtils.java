    ...
    public static WritableMap convertHashMapToWritableMap(HashMap<String, Object> hashMap) throws JSONException {
        ...
        for (Map.Entry next : hashMap.entrySet()) {
            ...
            if (value instanceof String) {
                ...
                createMap.putDouble(str, ((Float) value).doubleValue());
            } else if (value instanceof Long) {
                createMap.putDouble(str, ((Long) value).doubleValue());
            } else if (value instanceof HashMap) {
                createMap.putMap(str, convertHashMapToWritableMap((HashMap) value));
            } else {
