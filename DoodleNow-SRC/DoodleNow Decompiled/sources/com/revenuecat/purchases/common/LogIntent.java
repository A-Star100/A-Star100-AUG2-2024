...
public enum LogIntent {
    ...
    GOOGLE_ERROR(CollectionsKt.listOf(Emojis.ROBOT, Emojis.DOUBLE_EXCLAMATION)),
    GOOGLE_WARNING(CollectionsKt.listOf(Emojis.ROBOT, Emojis.DOUBLE_EXCLAMATION)),
    INFO(CollectionsKt.listOf(Emojis.INFO)),
    PURCHASE(CollectionsKt.listOf(Emojis.MONEY_BAG)),
    RC_ERROR(CollectionsKt.listOf(Emojis.SAD_CAT_EYES, Emojis.DOUBLE_EXCLAMATION)),
    RC_PURCHASE_SUCCESS(CollectionsKt.listOf(Emojis.HEART_CAT_EYES, Emojis.MONEY_BAG)),
    ...
    AMAZON_WARNING(CollectionsKt.listOf(Emojis.BOX, Emojis.DOUBLE_EXCLAMATION)),
    AMAZON_ERROR(CollectionsKt.listOf(Emojis.BOX, Emojis.DOUBLE_EXCLAMATION));
