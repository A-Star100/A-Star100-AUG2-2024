...
public final class DateExtensionsKt {
    private static final long CACHE_REFRESH_PERIOD_IN_BACKGROUND = DurationKt.toDuration(25, DurationUnit.HOURS);
    private static final long CACHE_REFRESH_PERIOD_IN_FOREGROUND = DurationKt.toDuration(5, DurationUnit.MINUTES);
    ...
    public static final boolean isCacheStale(Date date, boolean z, DateProvider dateProvider) {
        ...
        return m1095isCacheStale8Mi8wO0(date, z ? CACHE_REFRESH_PERIOD_IN_BACKGROUND : CACHE_REFRESH_PERIOD_IN_FOREGROUND, dateProvider);
    }

    /* renamed from: isCacheStale-8Mi8wO0$default  reason: not valid java name */
    public static /* synthetic */ boolean m1096isCacheStale8Mi8wO0$default(Date date, long j, DateProvider dateProvider, int i, Object obj) {
        if ((i & 2) != 0) {
            dateProvider = new DefaultDateProvider();
        }
        return m1095isCacheStale8Mi8wO0(date, j, dateProvider);
    }

    /* renamed from: isCacheStale-8Mi8wO0  reason: not valid java name */
    public static final boolean m1095isCacheStale8Mi8wO0(Date date, long j, DateProvider dateProvider) {
        Intrinsics.checkNotNullParameter(dateProvider, "dateProvider");
        if (date == null) {
            return true;
        }
        Duration.Companion companion = Duration.Companion;
        return Duration.m2562compareToLRDsOJo(DurationKt.toDuration(dateProvider.getNow().getTime() - date.getTime(), DurationUnit.MILLISECONDS), j) >= 0;
    }
}
