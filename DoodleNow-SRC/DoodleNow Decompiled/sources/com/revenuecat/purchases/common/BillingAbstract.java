...
public abstract class BillingAbstract {
    ...
    public abstract void consumeAndSave(boolean z, StoreTransaction storeTransaction, PostReceiptInitiationSource postReceiptInitiationSource);

    /* access modifiers changed from: protected */
    public abstract void endConnection();

    public abstract void findPurchaseInPurchaseHistory(String str, ProductType productType, String str2, Function1<? super StoreTransaction, Unit> function1, Function1<? super PurchasesError, Unit> function12);
    ...
    public abstract void getStorefront(Function1<? super String, Unit> function1, Function1<? super PurchasesError, Unit> function12);
    ...
    public abstract void queryAllPurchases(String str, Function1<? super List<StoreTransaction>, Unit> function1, Function1<? super PurchasesError, Unit> function12);

    public abstract void queryProductDetailsAsync(ProductType productType, Set<String> set, Function1<? super List<? extends StoreProduct>, Unit> function1, Function1<? super PurchasesError, Unit> function12);

    public abstract void queryPurchases(String str, Function1<? super Map<String, StoreTransaction>, Unit> function1, Function1<? super PurchasesError, Unit> function12);
    ...
    public abstract void showInAppMessagesIfNeeded(Activity activity, List<? extends InAppMessageType> list, Function0<Unit> function0);
    ...
    public BillingAbstract(PurchasesStateProvider purchasesStateProvider2) {
        Intrinsics.checkNotNullParameter(purchasesStateProvider2, "purchasesStateProvider");
