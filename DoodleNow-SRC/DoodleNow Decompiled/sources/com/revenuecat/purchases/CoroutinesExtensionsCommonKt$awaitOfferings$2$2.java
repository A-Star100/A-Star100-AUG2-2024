...
final class CoroutinesExtensionsCommonKt$awaitOfferings$2$2 extends Lambda implements Function1<PurchasesError, Unit> {
    final /* synthetic */ Continuation<Offerings> $continuation;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    CoroutinesExtensionsCommonKt$awaitOfferings$2$2(Continuation<? super Offerings> continuation) {
        super(1);
    ...
    public final void invoke(PurchasesError purchasesError) {
        ...
        Continuation<Offerings> continuation = this.$continuation;
