...
public class RNPurchasesModule extends ReactContextBaseJavaModule implements UpdatedCustomerInfoListener {
    ...
    public void setupPurchases(String str, String str2, boolean z, String str3, String str4, boolean z2, boolean z3, String str5) {
        ...
        String str6 = str;
        String str7 = str2;
        CommonKt.configure(this.reactContext, str6, str7, Boolean.valueOf(z), platformInfo, store, new DangerousSettings(), Boolean.valueOf(z3), str5);
    ...
    public void purchaseProduct(String str, ReadableMap readableMap, String str2, String str3, ReadableMap readableMap2, String str4, Promise promise) {
        ...
        CommonKt.purchaseProduct(getCurrentActivity(), str, str2, (String) null, upgradeInfo.getOldProductIdentifier(), upgradeInfo.getProrationMode(), valueOf, str4, getOnResult(promise));
    }
    ...
    public void setLogHandler() {
        CommonKt.setLogHandler(new RNPurchasesModule$$ExternalSyntheticLambda0(this));
    }
