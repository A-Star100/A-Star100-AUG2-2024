...
final class CoroutinesExtensionsCommonKt$awaitGetProducts$2$2 extends Lambda implements Function1<PurchasesError, Unit> {
    final /* synthetic */ Continuation<List<? extends StoreProduct>> $continuation;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    CoroutinesExtensionsCommonKt$awaitGetProducts$2$2(Continuation<? super List<? extends StoreProduct>> continuation) {
        super(1);
