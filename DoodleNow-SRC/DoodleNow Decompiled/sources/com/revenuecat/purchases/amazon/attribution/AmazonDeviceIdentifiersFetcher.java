    ...
    public void getDeviceIdentifiers(Application application, Function1<? super Map<String, String>, Unit> function1) {
        ...
        try {
            ...
            if (Settings.Secure.getInt(contentResolver, "limit_ad_tracking") == 0) {
                ...
                function1.invoke(MapExtensionsKt.filterNotNullValues(MapsKt.mapOf(TuplesKt.to(SubscriberAttributeKey.DeviceIdentifiers.AmazonAdID.INSTANCE.getBackendKey(), str), TuplesKt.to(SubscriberAttributeKey.DeviceIdentifiers.IP.INSTANCE.getBackendKey(), b.ac))));
            }
