...
public final class StoreProductConversionsKt {
    ...
    public static final StoreProduct toStoreProduct(Product product, String str) {
        ...
        Intrinsics.checkNotNullExpressionValue(price, b.x);
        ...
        if (freeTrialPeriod != null) {
            period = createPeriod(freeTrialPeriod);
        }
        JSONObject json = product.toJSON();
        Intrinsics.checkNotNullExpressionValue(json, "this.toJSON()");
        return new AmazonStoreProduct(sku, revenueCatProductType, title, title2, description, createPeriod, createPrice, (SubscriptionOptions) null, (SubscriptionOption) null, smallIconUrl, period, json, (PresentedOfferingContext) null);
    }
    ...
    public static final Price createPrice(String str, String str2) {
        ...
        Intrinsics.checkNotNullExpressionValue(parsePriceUsingRegex, "priceNumeric");
        BigDecimal multiply = parsePriceUsingRegex.multiply(new BigDecimal(1000000));
    ...
    public static final BigDecimal parsePriceUsingRegex(String str) {
        ...
        Intrinsics.checkNotNullExpressionValue(group, "dirtyPrice");
        String obj = StringsKt.trim((CharSequence) StringsKt.replace$default(StringsKt.replace$default(StringsKt.replace$default(group, MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR, "", false, 4, (Object) null), " ", "", false, 4, (Object) null), " ", "", false, 4, (Object) null)).toString();
        ...
        if (split$default.size() != 1) {
            if (((String) CollectionsKt.last(split$default)).length() == 3) {
                ...
                str2 = CollectionsKt.joinToString$default(CollectionsKt.dropLast(split$default, 1), "", (CharSequence) null, (CharSequence) null, 0, (CharSequence) null, (Function1) null, 62, (Object) null) + '.' + ((String) CollectionsKt.last(split$default));
            }
            obj = str2;
        }
