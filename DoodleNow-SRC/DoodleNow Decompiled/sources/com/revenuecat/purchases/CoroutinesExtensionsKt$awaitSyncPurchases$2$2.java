...
final class CoroutinesExtensionsKt$awaitSyncPurchases$2$2 extends Lambda implements Function1<PurchasesError, Unit> {
    final /* synthetic */ Continuation<CustomerInfo> $continuation;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    CoroutinesExtensionsKt$awaitSyncPurchases$2$2(Continuation<? super CustomerInfo> continuation) {
        super(1);
