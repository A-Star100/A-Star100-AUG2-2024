...
final class CoroutinesExtensionsCommonKt$awaitRestore$2$1 extends Lambda implements Function1<PurchasesError, Unit> {
    final /* synthetic */ Continuation<CustomerInfo> $continuation;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    CoroutinesExtensionsCommonKt$awaitRestore$2$1(Continuation<? super CustomerInfo> continuation) {
        super(1);
