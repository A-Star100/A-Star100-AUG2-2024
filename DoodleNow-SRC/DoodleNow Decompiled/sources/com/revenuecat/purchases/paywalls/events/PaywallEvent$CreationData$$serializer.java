...
public final class PaywallEvent$CreationData$$serializer implements GeneratedSerializer<PaywallEvent.CreationData> {
    ...
    public PaywallEvent.CreationData deserialize(Decoder decoder) {
        ...
        if (beginStructure.decodeSequentially()) {
            obj2 = beginStructure.decodeSerializableElement(descriptor2, 0, UUIDSerializer.INSTANCE, null);
            obj = beginStructure.decodeSerializableElement(descriptor2, 1, DateSerializer.INSTANCE, null);
            i = 3;
        } else {
            boolean z = true;
            int i2 = 0;
            ...
            while (z) {
                ...
                if (decodeElementIndex == -1) {
                    ...
                    obj2 = beginStructure.decodeSerializableElement(descriptor2, 0, UUIDSerializer.INSTANCE, obj2);
                    i2 |= 1;
        ...
        return new PaywallEvent.CreationData(i, (UUID) obj2, (Date) obj, (SerializationConstructorMarker) null);
    }

    public void serialize(Encoder encoder, PaywallEvent.CreationData creationData) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(creationData, "value");
        SerialDescriptor descriptor2 = getDescriptor();
