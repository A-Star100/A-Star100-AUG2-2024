...
public final class PaywallPostReceiptData$$serializer implements GeneratedSerializer<PaywallPostReceiptData> {
    ...
    public PaywallPostReceiptData deserialize(Decoder decoder) {
        ...
        return new PaywallPostReceiptData(i2, str4, i, str3, z, str2, str, (SerializationConstructorMarker) null);
    }

    public void serialize(Encoder encoder, PaywallPostReceiptData paywallPostReceiptData) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(paywallPostReceiptData, "value");
        SerialDescriptor descriptor2 = getDescriptor();
