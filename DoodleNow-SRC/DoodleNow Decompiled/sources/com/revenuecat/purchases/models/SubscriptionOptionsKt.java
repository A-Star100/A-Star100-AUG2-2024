...
public final class SubscriptionOptionsKt {
    ...
    public static final Map<Period.Unit, Integer> DAYS_IN_UNIT = MapsKt.mapOf(TuplesKt.to(Period.Unit.DAY, 1), TuplesKt.to(Period.Unit.WEEK, 7), TuplesKt.to(Period.Unit.MONTH, 30), TuplesKt.to(Period.Unit.YEAR, Integer.valueOf(DAYS_IN_YEAR)));
