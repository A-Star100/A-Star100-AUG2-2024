...
public class LoggerUtil {
    ...
    public static String bytesToHex(byte[] bArr) {
        ...
        for (int i6 = 0; i6 < i; i6++) {
            int i7 = i6 * 2;
            int i8 = i7 + 1 + i7;
            cArr[i8 + 2] = AbstractJsonLexerKt.COMMA;
            cArr[i8 + 3] = ' ';
        }
    ...
    public static void logConnectionUpdateCallback(String str, BluetoothGatt bluetoothGatt, int i, int i2, int i3, int i4) {
        if (RxBleLog.isAtLeast(4)) {
            RxBleLog.i(commonMacMessage(bluetoothGatt) + commonCallbackMessage() + commonStatusMessage() + ", interval=%d (%.2f ms), latency=%d, timeout=%d (%.0f ms)", str, Integer.valueOf(i), Integer.valueOf(i2), Float.valueOf(((float) i2) * 1.25f), Integer.valueOf(i3), Integer.valueOf(i4), Float.valueOf(((float) i4) * 10.0f));
        }
    }
    ...
    public static class AttributeLogWrapper {
        ...
        public AttributeLogWrapper(UUID uuid2, byte[] bArr, boolean z) {
            this.uuid = uuid2;
            this.value = bArr;
            this.valueMatters = z;
        }
