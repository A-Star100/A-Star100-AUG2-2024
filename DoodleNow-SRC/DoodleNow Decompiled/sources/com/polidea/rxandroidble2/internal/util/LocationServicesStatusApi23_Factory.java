...
public final class LocationServicesStatusApi23_Factory implements Factory<LocationServicesStatusApi23> {
    ...
    public static LocationServicesStatusApi23 newInstance(CheckerLocationProvider checkerLocationProvider2, CheckerScanPermission checkerScanPermission, int i, int i2, boolean z) {
        return new LocationServicesStatusApi23(checkerLocationProvider2, checkerScanPermission, i, i2, z);
    }
}
