...
public class BackgroundScannerImpl implements BackgroundScanner {
    ...
    public List<ScanResult> onScanResultReceived(Intent intent) {
        ...
        if (intExtra2 == 0) {
            for (android.bluetooth.le.ScanResult convertScanResultToRxAndroidBLEModel : extractScanResults) {
                arrayList.add(convertScanResultToRxAndroidBLEModel(intExtra, convertScanResultToRxAndroidBLEModel));
            }
            return arrayList;
        }
