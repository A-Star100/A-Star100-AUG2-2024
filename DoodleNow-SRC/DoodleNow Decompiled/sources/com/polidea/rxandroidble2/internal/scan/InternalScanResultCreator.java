...
public class InternalScanResultCreator {
    ...
    @Inject
    public InternalScanResultCreator(ScanRecordParser scanRecordParser2, IsConnectableChecker isConnectableChecker2) {
        this.scanRecordParser = scanRecordParser2;
        this.isConnectableChecker = isConnectableChecker2;
    }
