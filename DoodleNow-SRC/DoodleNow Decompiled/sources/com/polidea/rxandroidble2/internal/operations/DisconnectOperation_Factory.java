...
public final class DisconnectOperation_Factory implements Factory<DisconnectOperation> {
    ...
    public static DisconnectOperation newInstance(RxBleGattCallback rxBleGattCallback, BluetoothGattProvider bluetoothGattProvider2, String str, BluetoothManager bluetoothManager, Scheduler scheduler, TimeoutConfiguration timeoutConfiguration, ConnectionStateChangeListener connectionStateChangeListener) {
