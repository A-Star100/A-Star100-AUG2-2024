...
public class ScanFilter implements Parcelable, ScanFilterInterface {
    ...
    public boolean matches(ScanResultInterface scanResultInterface) {
        ...
        if (scanRecord != null) {
            ...
            return false;
        } else if (this.mServiceUuid == null && this.mManufacturerData == null && this.mServiceData == null) {
            return true;
        } else {
            return false;
        }
    ...
    public String toString() {
        ...
        if (parcelUuid == null) {
            ...
            str = LoggerUtil.getUuidToLog(parcelUuid.getUuid());
        }
        sb.append(str);
        sb.append(", mUuidMask=");
        ParcelUuid parcelUuid2 = this.mServiceUuidMask;
        if (parcelUuid2 == null) {
            ...
            str2 = LoggerUtil.getUuidToLog(parcelUuid2.getUuid());
        }
        sb.append(str2);
        ...
        if (parcelUuid3 == null) {
            ...
            str3 = LoggerUtil.getUuidToLog(parcelUuid3.getUuid());
        }
        sb.append(str3);
        ...
        if (parcelUuid4 == null) {
            ...
            str4 = LoggerUtil.getUuidToLog(parcelUuid4.getUuid());
        }
        sb.append(str4);
        sb.append(", mServiceDataUuid=");
        ParcelUuid parcelUuid5 = this.mServiceDataUuid;
        if (parcelUuid5 != null) {
            str5 = LoggerUtil.getUuidToLog(parcelUuid5.getUuid());
        }
        sb.append(str5);
