        ...
        if (type != null) {
            ...
            if (constructType.isArrayType()) {
                ...
                if (rawClass == Object.class) {
                    ...
                    createSchemaNode.set("items", findValueSerializer instanceof SchemaAware ? ((SchemaAware) findValueSerializer).getSchema(serializerProvider, (Type) null) : JsonSchema.getDefaultSchemaNode());
                }
            }
        }
