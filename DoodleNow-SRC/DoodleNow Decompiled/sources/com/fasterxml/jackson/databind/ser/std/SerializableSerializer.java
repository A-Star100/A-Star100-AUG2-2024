...
public class SerializableSerializer extends StdSerializer<JsonSerializable> {
    ...
    public com.fasterxml.jackson.databind.JsonNode getSchema(com.fasterxml.jackson.databind.SerializerProvider r7, java.lang.reflect.Type r8) throws com.fasterxml.jackson.databind.JsonMappingException {
        ...
        L_0x0045:
            ...
            com.fasterxml.jackson.databind.JsonNode r1 = r4.readTree((java.lang.String) r1)     // Catch:{ IOException -> 0x005b }
            r0.set(r3, r1)     // Catch:{ IOException -> 0x005b }
            goto L_0x0062
        L_0x005b:
        ...
        L_0x0062:
            ...
            com.fasterxml.jackson.databind.JsonNode r8 = r3.readTree((java.lang.String) r8)     // Catch:{ IOException -> 0x0072 }
