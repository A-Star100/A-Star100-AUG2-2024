...
public class ObjectMapper extends ObjectCodec implements Versioned, Serializable {
    ...
    public java.lang.Object _readMapAndClose(com.fasterxml.jackson.core.JsonParser r9, com.fasterxml.jackson.databind.JavaType r10) throws java.io.IOException {
        /*
            r8 = this;
            com.fasterxml.jackson.core.JsonToken r0 = r8._initForReading(r9)     // Catch:{ all -> 0x004f }
            com.fasterxml.jackson.core.JsonToken r1 = com.fasterxml.jackson.core.JsonToken.VALUE_NULL     // Catch:{ all -> 0x004f }
            if (r0 != r1) goto L_0x0019
            com.fasterxml.jackson.databind.DeserializationConfig r0 = r8.getDeserializationConfig()     // Catch:{ all -> 0x004f }
            com.fasterxml.jackson.databind.deser.DefaultDeserializationContext r0 = r8.createDeserializationContext(r9, r0)     // Catch:{ all -> 0x004f }
            com.fasterxml.jackson.databind.JsonDeserializer r10 = r8._findRootDeserializer(r0, r10)     // Catch:{ all -> 0x004f }
            java.lang.Object r10 = r10.getNullValue(r0)     // Catch:{ all -> 0x004f }
            goto L_0x0046
        L_0x0019:
            com.fasterxml.jackson.core.JsonToken r1 = com.fasterxml.jackson.core.JsonToken.END_ARRAY     // Catch:{ all -> 0x004f }
            if (r0 == r1) goto L_0x0045
            com.fasterxml.jackson.core.JsonToken r1 = com.fasterxml.jackson.core.JsonToken.END_OBJECT     // Catch:{ all -> 0x004f }
            if (r0 != r1) goto L_0x0022
            goto L_0x0045
        L_0x0022:
            com.fasterxml.jackson.databind.DeserializationConfig r5 = r8.getDeserializationConfig()     // Catch:{ all -> 0x004f }
            com.fasterxml.jackson.databind.deser.DefaultDeserializationContext r0 = r8.createDeserializationContext(r9, r5)     // Catch:{ all -> 0x004f }
            com.fasterxml.jackson.databind.JsonDeserializer r7 = r8._findRootDeserializer(r0, r10)     // Catch:{ all -> 0x004f }
            boolean r1 = r5.useRootWrapping()     // Catch:{ all -> 0x004f }
            if (r1 == 0) goto L_0x003d
            r2 = r8
            r3 = r9
            r4 = r0
            r6 = r10
            java.lang.Object r10 = r2._unwrapAndDeserialize(r3, r4, r5, r6, r7)     // Catch:{ all -> 0x004f }
            goto L_0x0041
        L_0x003d:
            java.lang.Object r10 = r7.deserialize(r9, r0)     // Catch:{ all -> 0x004f }
        L_0x0041:
            r0.checkUnresolvedObjectId()     // Catch:{ all -> 0x004f }
            goto L_0x0046
        L_0x0045:
            r10 = 0
        L_0x0046:
            r9.clearCurrentToken()     // Catch:{ all -> 0x004f }
