    ...
    private AnnotatedMethodMap _resolveMemberMethods() {
        ...
        for (JavaType next : this._superTypes) {
            ...
            if (mixInResolver == null) {
                ...
                cls = mixInResolver.findMixInClassFor(next.getRawClass());
            }
            Class<?> cls2 = cls;
            _addMemberMethods(next.getRawClass(), new TypeResolutionContext.Basic(this._typeFactory, next.getBindings()), annotatedMethodMap, cls2, annotatedMethodMap2);
        }
