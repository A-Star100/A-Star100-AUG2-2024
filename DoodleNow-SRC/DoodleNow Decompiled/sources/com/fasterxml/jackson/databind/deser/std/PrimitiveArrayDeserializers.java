...
public abstract class PrimitiveArrayDeserializers<T> extends StdDeserializer<T> implements ContextualDeserializer {
    ...
    static final class ByteDeser extends PrimitiveArrayDeserializers<byte[]> {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:33:0x0072 A[Catch:{ Exception -> 0x008a }] */
        ...
        public byte[] deserialize(com.fasterxml.jackson.core.JsonParser r7, com.fasterxml.jackson.databind.DeserializationContext r8) throws java.io.IOException {
            ...
            L_0x0033:
                ...
                r3 = r2
            L_0x0043:
                com.fasterxml.jackson.core.JsonToken r4 = r7.nextToken()     // Catch:{ Exception -> 0x008a }
                com.fasterxml.jackson.core.JsonToken r5 = com.fasterxml.jackson.core.JsonToken.END_ARRAY     // Catch:{ Exception -> 0x008a }
                if (r4 == r5) goto L_0x0083
                com.fasterxml.jackson.core.JsonToken r5 = com.fasterxml.jackson.core.JsonToken.VALUE_NUMBER_INT     // Catch:{ Exception -> 0x008a }
                if (r4 == r5) goto L_0x006b
                com.fasterxml.jackson.core.JsonToken r5 = com.fasterxml.jackson.core.JsonToken.VALUE_NUMBER_FLOAT     // Catch:{ Exception -> 0x008a }
                if (r4 != r5) goto L_0x0054
                goto L_0x006b
            L_0x0054:
                com.fasterxml.jackson.core.JsonToken r5 = com.fasterxml.jackson.core.JsonToken.VALUE_NULL     // Catch:{ Exception -> 0x008a }
                if (r4 != r5) goto L_0x005a
                r4 = r2
                goto L_0x006f
            L_0x005a:
                java.lang.Class r4 = r6._valueClass     // Catch:{ Exception -> 0x008a }
                java.lang.Class r4 = r4.getComponentType()     // Catch:{ Exception -> 0x008a }
                java.lang.Object r4 = r8.handleUnexpectedToken(r4, r7)     // Catch:{ Exception -> 0x008a }
                java.lang.Number r4 = (java.lang.Number) r4     // Catch:{ Exception -> 0x008a }
                byte r4 = r4.byteValue()     // Catch:{ Exception -> 0x008a }
                goto L_0x006f
            L_0x006b:
                byte r4 = r7.getByteValue()     // Catch:{ Exception -> 0x008a }
            L_0x006f:
                int r5 = r1.length     // Catch:{ Exception -> 0x008a }
                if (r3 < r5) goto L_0x007a
                java.lang.Object r5 = r0.appendCompletedChunk(r1, r3)     // Catch:{ Exception -> 0x008a }
                byte[] r5 = (byte[]) r5     // Catch:{ Exception -> 0x008a }
                r3 = r2
                r1 = r5
            L_0x007a:
                int r5 = r3 + 1
