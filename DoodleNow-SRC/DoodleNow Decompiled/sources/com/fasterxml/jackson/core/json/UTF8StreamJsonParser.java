...
public class UTF8StreamJsonParser extends ParserBase {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:48:0x0049 A[SYNTHETIC] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
...
*/
    ...
    private final void _matchToken2(String str, int i) throws IOException {
        ...
        if ((this._inputPtr < this._inputEnd || _loadMore()) && (b = this._inputBuffer[this._inputPtr] & 255) >= 48 && b != 93 && b != 125) {
            _checkMatchEnd(str, i, b);
        }
    }
