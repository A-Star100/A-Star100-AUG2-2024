...
public class ReactSlider extends AppCompatSeekBar {
    ...
    private double mMaxValue = AudioStats.AUDIO_AMPLITUDE_NONE;
    private double mMinValue = AudioStats.AUDIO_AMPLITUDE_NONE;
    private double mRealLowerLimit = -9.223372036854776E18d;
    private double mRealUpperLimit = 9.223372036854776E18d;
    private double mStep = AudioStats.AUDIO_AMPLITUDE_NONE;
    private double mStepCalculated = AudioStats.AUDIO_AMPLITUDE_NONE;
    private int mUpperLimit;
    private double mValue = AudioStats.AUDIO_AMPLITUDE_NONE;
