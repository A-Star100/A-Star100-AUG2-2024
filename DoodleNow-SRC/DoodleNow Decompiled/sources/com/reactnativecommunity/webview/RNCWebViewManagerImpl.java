...
public final class RNCWebViewManagerImpl {
    ...
    public final void setApplicationNameForUserAgent(RNCWebViewWrapper rNCWebViewWrapper, String str) {
        ...
        if (str != null) {
            ...
            this.mUserAgentWithApplicationName = defaultUserAgent + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + str;
        } else {
    ...
    public final void setSource(RNCWebViewWrapper rNCWebViewWrapper, ReadableMap readableMap, boolean z) {
        ...
        if (readableMap != null) {
            String str = "";
            if (readableMap.hasKey(InAppMessageContent.HTML)) {
                String string = readableMap.getString(InAppMessageContent.HTML);
