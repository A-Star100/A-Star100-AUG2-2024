...
public final class BitmapUtil {
    ...
    public /* synthetic */ class WhenMappings {
        ...
        static {
            ...
            L_0x0036:
                android.graphics.Bitmap$Config r1 = com.facebook.react.views.text.ReactTextView$$ExternalSyntheticApiModelOutline0.m()     // Catch:{ NoSuchFieldError -> 0x0041 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0041 }
                r2 = 6
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0041 }
            L_0x0041:
                android.graphics.Bitmap$Config r1 = com.android.billingclient.api.zzg$$ExternalSyntheticApiModelOutline0.m()     // Catch:{ NoSuchFieldError -> 0x004c }
        ...
        if (inputStream != null) {
            ...
            try {
                ...
                if (Build.VERSION.SDK_INT >= 26) {
                    colorSpace = zzg$$ExternalSyntheticApiModelOutline0.m(options);
                }
