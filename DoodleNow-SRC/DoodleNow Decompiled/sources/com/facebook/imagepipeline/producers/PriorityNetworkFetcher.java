...
public class PriorityNetworkFetcher<FETCH_STATE extends FetchState> implements NetworkFetcher<PriorityFetchState<FETCH_STATE>> {
        ...
        try {
            AnonymousClass2 r0 = new NetworkFetcher.Callback() {
                ...
                public void onFailure(Throwable th) {
                    ...
                    } else if ((PriorityNetworkFetcher.this.maxNumberOfRequeue == -1 || priorityFetchState.requeueCount < PriorityNetworkFetcher.this.maxNumberOfRequeue) && (!PriorityNetworkFetcher.this.nonRecoverableExceptionPreventsRequeue || !(th instanceof NonrecoverableException))) {
    ...
    public static boolean shouldRetry(Throwable th, int i, int i2, int i3, boolean z, boolean z2, boolean z3, Priority priority) {
        ...
        if ((!z6 || !message.contains("Canceled")) && ((!z6 || !message.contains("unexpected end of stream on null")) && ((!(th instanceof SocketException) || !message.contains("Socket closed")) && (!z5 || !(th instanceof InterruptedIOException) || !message.contains(ClientComponent.NamedSchedulers.TIMEOUT))))) {
            return false;
        }
        return true;
    }
