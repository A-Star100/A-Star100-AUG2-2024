...
public final class DecodeProducer implements Producer<CloseableReference<CloseableImage>> {
    ...
    private abstract class ProgressiveDecoder extends DelegatingConsumer<EncodedImage, CloseableReference<CloseableImage>> {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:11:0x002d, code lost:
            r2 = r2.getName();
         */
        /* JADX WARNING: Removed duplicated region for block: B:33:0x00bf A[Catch:{ all -> 0x015d }] */
        ...
        private final void doDecode(com.facebook.imagepipeline.image.EncodedImage r20, int r21, int r22) {
            ...
            L_0x0095:
                r14 = r3
            L_0x0096:
                com.facebook.imagepipeline.producers.JobScheduler r2 = r11.jobScheduler     // Catch:{ all -> 0x015d }
                long r3 = r2.getQueuedTime()     // Catch:{ all -> 0x015d }
                com.facebook.imagepipeline.producers.ProducerContext r2 = r11.producerContext     // Catch:{ all -> 0x015d }
                com.facebook.imagepipeline.request.ImageRequest r2 = r2.getImageRequest()     // Catch:{ all -> 0x015d }
                android.net.Uri r2 = r2.getSourceUri()     // Catch:{ all -> 0x015d }
                java.lang.String r2 = r2.toString()     // Catch:{ all -> 0x015d }
                java.lang.String r5 = "producerContext.imageRequest.sourceUri.toString()"
                kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, r5)     // Catch:{ all -> 0x015d }
                if (r9 != 0) goto L_0x00b9
                if (r15 == 0) goto L_0x00b4
                goto L_0x00b9
            L_0x00b4:
                int r5 = r19.getIntermediateImageEndOffset(r20)     // Catch:{ all -> 0x015d }
                goto L_0x00bd
            L_0x00b9:
                int r5 = r20.getSize()     // Catch:{ all -> 0x015d }
            L_0x00bd:
                if (r9 != 0) goto L_0x00c7
                if (r15 == 0) goto L_0x00c2
                goto L_0x00c7
            L_0x00c2:
                com.facebook.imagepipeline.image.QualityInfo r9 = r19.getQualityInfo()     // Catch:{ all -> 0x015d }
                goto L_0x00c9
            L_0x00c7:
                com.facebook.imagepipeline.image.QualityInfo r9 = com.facebook.imagepipeline.image.ImmutableQualityInfo.FULL_QUALITY     // Catch:{ all -> 0x015d }
            L_0x00c9:
                com.facebook.imagepipeline.producers.ProducerListener2 r15 = r11.producerListener     // Catch:{ all -> 0x015d }
                r18 = r2
                com.facebook.imagepipeline.producers.ProducerContext r2 = r11.producerContext     // Catch:{ all -> 0x015d }
                r15.onProducerStart(r2, r13)     // Catch:{ all -> 0x015d }
                kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r9, r1)     // Catch:{ DecodeException -> 0x0108 }
                com.facebook.imagepipeline.image.CloseableImage r15 = r11.internalDecode(r12, r5, r9)     // Catch:{ DecodeException -> 0x0108 }
                int r1 = r20.getSampleSize()     // Catch:{ Exception -> 0x00fe }
                r2 = 1
            ...
            L_0x00e2:
                ...
                r5 = r9
                r9 = r14
                java.util.Map r1 = r1.getExtraMap(r2, r3, r5, r6, r7, r8, r9, r10)     // Catch:{ all -> 0x015d }
                com.facebook.imagepipeline.producers.ProducerListener2 r2 = r11.producerListener     // Catch:{ all -> 0x015d }
                com.facebook.imagepipeline.producers.ProducerContext r3 = r11.producerContext     // Catch:{ all -> 0x015d }
                r2.onProducerFinishWithSuccess(r3, r13, r1)     // Catch:{ all -> 0x015d }
                r1 = r22
                r11.setImageExtras(r12, r15, r1)     // Catch:{ all -> 0x015d }
                r11.handleResult(r15, r0)     // Catch:{ all -> 0x015d }
            ...
            L_0x0108:
                r0 = move-exception
                com.facebook.imagepipeline.image.EncodedImage r5 = r0.getEncodedImage()     // Catch:{ Exception -> 0x0103 }
                java.lang.String r15 = r11.TAG     // Catch:{ Exception -> 0x0103 }
                java.lang.String r2 = "%s, {uri: %s, firstEncodedBytes: %s, length: %d}"
                r12 = 4
                java.lang.Object[] r12 = new java.lang.Object[r12]     // Catch:{ Exception -> 0x0103 }
                java.lang.String r17 = r0.getMessage()     // Catch:{ Exception -> 0x0103 }
                r16 = 0
                r12[r16] = r17     // Catch:{ Exception -> 0x0103 }
                r16 = 1
                r12[r16] = r18     // Catch:{ Exception -> 0x0103 }
                r16 = r13
                r13 = 10
                java.lang.String r13 = r5.getFirstBytesAsHexString(r13)     // Catch:{ Exception -> 0x013b }
                r17 = 2
                r12[r17] = r13     // Catch:{ Exception -> 0x013b }
                int r5 = r5.getSize()     // Catch:{ Exception -> 0x013b }
                java.lang.Integer r5 = java.lang.Integer.valueOf(r5)     // Catch:{ Exception -> 0x013b }
                r13 = 3
                r12[r13] = r5     // Catch:{ Exception -> 0x013b }
                com.facebook.common.logging.FLog.w((java.lang.String) r15, (java.lang.String) r2, (java.lang.Object[]) r12)     // Catch:{ Exception -> 0x013b }
                throw r0     // Catch:{ Exception -> 0x013b }
            L_0x013b:
                r0 = move-exception
                goto L_0x0106
            L_0x013d:
                kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r9, r1)     // Catch:{ all -> 0x015d }
                r1 = r19
                r5 = r9
                r9 = r14
                java.util.Map r1 = r1.getExtraMap(r2, r3, r5, r6, r7, r8, r9, r10)     // Catch:{ all -> 0x015d }
                ...
                com.facebook.imagepipeline.producers.ProducerContext r3 = r11.producerContext     // Catch:{ all -> 0x015d }
                r4 = r0
                java.lang.Throwable r4 = (java.lang.Throwable) r4     // Catch:{ all -> 0x015d }
                r5 = r16
                r2.onProducerFinishWithFailure(r3, r5, r4, r1)     // Catch:{ all -> 0x015d }
                java.lang.Throwable r0 = (java.lang.Throwable) r0     // Catch:{ all -> 0x015d }
                r11.handleError(r0)     // Catch:{ all -> 0x015d }
                com.facebook.imagepipeline.image.EncodedImage.closeSafely(r20)
                return
            L_0x015d:
                r0 = move-exception
