...
public class ImagePipeline {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:30:0x006a, code lost:
        if (r8.mSuppressBitmapPrefetchingSupplier.get().booleanValue() != false) goto L_0x006c;
     */
    ...
    public com.facebook.datasource.DataSource<java.lang.Void> prefetchToBitmapCache(com.facebook.imagepipeline.request.ImageRequest r9, @javax.annotation.Nullable java.lang.Object r10, @javax.annotation.Nullable com.facebook.imagepipeline.listener.RequestListener r11) {
        /*
            r8 = this;
            boolean r0 = com.facebook.imagepipeline.systrace.FrescoSystrace.isTracing()     // Catch:{ all -> 0x009f }
            if (r0 == 0) goto L_0x000b
            java.lang.String r0 = "ImagePipeline#prefetchToBitmapCache"
            com.facebook.imagepipeline.systrace.FrescoSystrace.beginSection(r0)     // Catch:{ all -> 0x009f }
        L_0x000b:
            com.facebook.common.internal.Supplier<java.lang.Boolean> r0 = r8.mIsPrefetchEnabledSupplier     // Catch:{ all -> 0x009f }
            ...
            java.util.concurrent.CancellationException r9 = PREFETCH_EXCEPTION     // Catch:{ all -> 0x009f }
            com.facebook.datasource.DataSource r9 = com.facebook.datasource.DataSources.immediateFailedDataSource(r9)     // Catch:{ all -> 0x009f }
        ...
        L_0x0028:
            return r9
        L_0x0029:
            com.facebook.imagepipeline.core.ImagePipelineConfigInterface r0 = r8.mConfig     // Catch:{ Exception -> 0x0090 }
            com.facebook.imagepipeline.core.ImagePipelineExperiments r0 = r0.getExperiments()     // Catch:{ Exception -> 0x0090 }
            if (r0 == 0) goto L_0x0051
            com.facebook.imagepipeline.core.ImagePipelineConfigInterface r0 = r8.mConfig     // Catch:{ Exception -> 0x0090 }
            com.facebook.imagepipeline.core.ImagePipelineExperiments r0 = r0.getExperiments()     // Catch:{ Exception -> 0x0090 }
            boolean r0 = r0.getPrefetchShortcutEnabled()     // Catch:{ Exception -> 0x0090 }
            if (r0 == 0) goto L_0x0051
            boolean r0 = r8.isInBitmapMemoryCache((com.facebook.imagepipeline.request.ImageRequest) r9)     // Catch:{ Exception -> 0x0090 }
            if (r0 == 0) goto L_0x0051
            com.facebook.datasource.DataSource r9 = com.facebook.datasource.DataSources.immediateSuccessfulDataSource()     // Catch:{ Exception -> 0x0090 }
            boolean r10 = com.facebook.imagepipeline.systrace.FrescoSystrace.isTracing()
        ...
        L_0x0050:
            return r9
        L_0x0051:
            java.lang.Boolean r0 = r9.shouldDecodePrefetches()     // Catch:{ Exception -> 0x0090 }
            if (r0 == 0) goto L_0x005e
            boolean r0 = r0.booleanValue()     // Catch:{ Exception -> 0x0090 }
            if (r0 != 0) goto L_0x0073
            goto L_0x006c
        L_0x005e:
            com.facebook.common.internal.Supplier<java.lang.Boolean> r0 = r8.mSuppressBitmapPrefetchingSupplier     // Catch:{ Exception -> 0x0090 }
            java.lang.Object r0 = r0.get()     // Catch:{ Exception -> 0x0090 }
            java.lang.Boolean r0 = (java.lang.Boolean) r0     // Catch:{ Exception -> 0x0090 }
            boolean r0 = r0.booleanValue()     // Catch:{ Exception -> 0x0090 }
            if (r0 == 0) goto L_0x0073
        L_0x006c:
            com.facebook.imagepipeline.core.ProducerSequenceFactory r0 = r8.mProducerSequenceFactory     // Catch:{ Exception -> 0x0090 }
            com.facebook.imagepipeline.producers.Producer r0 = r0.getEncodedImagePrefetchProducerSequence(r9)     // Catch:{ Exception -> 0x0090 }
            goto L_0x0079
        L_0x0073:
            com.facebook.imagepipeline.core.ProducerSequenceFactory r0 = r8.mProducerSequenceFactory     // Catch:{ Exception -> 0x0090 }
            com.facebook.imagepipeline.producers.Producer r0 = r0.getDecodedImagePrefetchProducerSequence(r9)     // Catch:{ Exception -> 0x0090 }
        L_0x0079:
            r2 = r0
            com.facebook.imagepipeline.request.ImageRequest$RequestLevel r4 = com.facebook.imagepipeline.request.ImageRequest.RequestLevel.FULL_FETCH     // Catch:{ Exception -> 0x0090 }
            com.facebook.imagepipeline.common.Priority r6 = com.facebook.imagepipeline.common.Priority.MEDIUM     // Catch:{ Exception -> 0x0090 }
            r1 = r8
            r3 = r9
            r5 = r10
            r7 = r11
            com.facebook.datasource.DataSource r9 = r1.submitPrefetchRequest(r2, r3, r4, r5, r6, r7)     // Catch:{ Exception -> 0x0090 }
            boolean r10 = com.facebook.imagepipeline.systrace.FrescoSystrace.isTracing()
