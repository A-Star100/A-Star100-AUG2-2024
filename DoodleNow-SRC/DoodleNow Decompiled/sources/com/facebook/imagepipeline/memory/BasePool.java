...
public abstract class BasePool<V> implements Pool<V> {
    ...
    public synchronized void trimToSize(int r8) {
        /*
            r7 = this;
            monitor-enter(r7)
            com.facebook.imagepipeline.memory.BasePool$Counter r0 = r7.mUsed     // Catch:{ all -> 0x0094 }
            int r0 = r0.mNumBytes     // Catch:{ all -> 0x0094 }
            com.facebook.imagepipeline.memory.BasePool$Counter r1 = r7.mFree     // Catch:{ all -> 0x0094 }
            int r1 = r1.mNumBytes     // Catch:{ all -> 0x0094 }
            int r0 = r0 + r1
            int r0 = r0 - r8
            com.facebook.imagepipeline.memory.BasePool$Counter r1 = r7.mFree     // Catch:{ all -> 0x0094 }
            int r1 = r1.mNumBytes     // Catch:{ all -> 0x0094 }
            int r0 = java.lang.Math.min(r0, r1)     // Catch:{ all -> 0x0094 }
            if (r0 > 0) goto L_0x0017
            monitor-exit(r7)
            return
        L_0x0017:
            r1 = 2
            boolean r2 = com.facebook.common.logging.FLog.isLoggable(r1)     // Catch:{ all -> 0x0094 }
            if (r2 == 0) goto L_0x003a
            java.lang.Class<?> r2 = r7.TAG     // Catch:{ all -> 0x0094 }
            java.lang.String r3 = "trimToSize: TargetSize = %d; Initial Size = %d; Bytes to free = %d"
            java.lang.Integer r4 = java.lang.Integer.valueOf(r8)     // Catch:{ all -> 0x0094 }
            com.facebook.imagepipeline.memory.BasePool$Counter r5 = r7.mUsed     // Catch:{ all -> 0x0094 }
            int r5 = r5.mNumBytes     // Catch:{ all -> 0x0094 }
            com.facebook.imagepipeline.memory.BasePool$Counter r6 = r7.mFree     // Catch:{ all -> 0x0094 }
            int r6 = r6.mNumBytes     // Catch:{ all -> 0x0094 }
            int r5 = r5 + r6
            java.lang.Integer r5 = java.lang.Integer.valueOf(r5)     // Catch:{ all -> 0x0094 }
            java.lang.Integer r6 = java.lang.Integer.valueOf(r0)     // Catch:{ all -> 0x0094 }
            com.facebook.common.logging.FLog.v((java.lang.Class<?>) r2, (java.lang.String) r3, (java.lang.Object) r4, (java.lang.Object) r5, (java.lang.Object) r6)     // Catch:{ all -> 0x0094 }
        L_0x003a:
            r7.logStats()     // Catch:{ all -> 0x0094 }
            r2 = 0
        L_0x003e:
            android.util.SparseArray<com.facebook.imagepipeline.memory.Bucket<V>> r3 = r7.mBuckets     // Catch:{ all -> 0x0094 }
        ...
        L_0x0049:
            android.util.SparseArray<com.facebook.imagepipeline.memory.Bucket<V>> r3 = r7.mBuckets     // Catch:{ all -> 0x0094 }
            java.lang.Object r3 = r3.valueAt(r2)     // Catch:{ all -> 0x0094 }
            com.facebook.imagepipeline.memory.Bucket r3 = (com.facebook.imagepipeline.memory.Bucket) r3     // Catch:{ all -> 0x0094 }
            java.lang.Object r3 = com.facebook.common.internal.Preconditions.checkNotNull(r3)     // Catch:{ all -> 0x0094 }
            com.facebook.imagepipeline.memory.Bucket r3 = (com.facebook.imagepipeline.memory.Bucket) r3     // Catch:{ all -> 0x0094 }
        L_0x0057:
            if (r0 <= 0) goto L_0x006e
            java.lang.Object r4 = r3.pop()     // Catch:{ all -> 0x0094 }
            if (r4 != 0) goto L_0x0060
            goto L_0x006e
        L_0x0060:
            r7.free(r4)     // Catch:{ all -> 0x0094 }
            int r4 = r3.mItemSize     // Catch:{ all -> 0x0094 }
            int r0 = r0 - r4
            com.facebook.imagepipeline.memory.BasePool$Counter r4 = r7.mFree     // Catch:{ all -> 0x0094 }
            int r5 = r3.mItemSize     // Catch:{ all -> 0x0094 }
            r4.decrement(r5)     // Catch:{ all -> 0x0094 }
            goto L_0x0057
        L_0x006e:
            int r2 = r2 + 1
            goto L_0x003e
        L_0x0071:
            r7.logStats()     // Catch:{ all -> 0x0094 }
            boolean r0 = com.facebook.common.logging.FLog.isLoggable(r1)     // Catch:{ all -> 0x0094 }
            if (r0 == 0) goto L_0x0092
            java.lang.Class<?> r0 = r7.TAG     // Catch:{ all -> 0x0094 }
            java.lang.String r1 = "trimToSize: TargetSize = %d; Final Size = %d"
            java.lang.Integer r8 = java.lang.Integer.valueOf(r8)     // Catch:{ all -> 0x0094 }
            com.facebook.imagepipeline.memory.BasePool$Counter r2 = r7.mUsed     // Catch:{ all -> 0x0094 }
            int r2 = r2.mNumBytes     // Catch:{ all -> 0x0094 }
            com.facebook.imagepipeline.memory.BasePool$Counter r3 = r7.mFree     // Catch:{ all -> 0x0094 }
            int r3 = r3.mNumBytes     // Catch:{ all -> 0x0094 }
            int r2 = r2 + r3
            java.lang.Integer r2 = java.lang.Integer.valueOf(r2)     // Catch:{ all -> 0x0094 }
            com.facebook.common.logging.FLog.v((java.lang.Class<?>) r0, (java.lang.String) r1, (java.lang.Object) r8, (java.lang.Object) r2)     // Catch:{ all -> 0x0094 }
        L_0x0092:
            monitor-exit(r7)
            return
        L_0x0094:
    ...
    public synchronized Map<String, Integer> getStats() {
        ...
        for (int i = 0; i < this.mBuckets.size(); i++) {
            ...
            hashMap.put("buckets_used_" + getSizeInBytes(keyAt), Integer.valueOf(((Bucket) Preconditions.checkNotNull(this.mBuckets.valueAt(i))).getInUseCount()));
        }
