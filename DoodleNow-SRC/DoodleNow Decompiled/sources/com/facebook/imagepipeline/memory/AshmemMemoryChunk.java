...
public class AshmemMemoryChunk implements MemoryChunk, Closeable {
    ...
    public AshmemMemoryChunk(int i) {
        ...
        try {
            SharedMemory m = SharedMemory.create(TAG, i);
            this.mSharedMemory = m;
            this.mByteBuffer = ReactTextView$$ExternalSyntheticApiModelOutline0.m(m);
    ...
    public synchronized void close() {
        if (!isClosed()) {
            ...
            if (sharedMemory != null) {
                ReactTextView$$ExternalSyntheticApiModelOutline0.m(sharedMemory);
            }
    ...
    public int getSize() {
        ...
        return ReactTextView$$ExternalSyntheticApiModelOutline0.m(this.mSharedMemory);
    }
