...
public abstract class AbstractProducerToDataSourceAdapter<T> extends AbstractDataSource<T> implements HasImageRequest {
    ...
    protected AbstractProducerToDataSourceAdapter(com.facebook.imagepipeline.producers.Producer<T> r4, com.facebook.imagepipeline.producers.SettableProducerContext r5, com.facebook.imagepipeline.listener.RequestListener2 r6) {
        ...
        L_0x0038:
            ...
            r0 = r5
            com.facebook.imagepipeline.producers.ProducerContext r0 = (com.facebook.imagepipeline.producers.ProducerContext) r0     // Catch:{ all -> 0x006f }
            r6.onRequestStart(r0)     // Catch:{ all -> 0x006f }
        ...
        L_0x0058:
            ...
            com.facebook.imagepipeline.producers.Consumer r6 = r3.createConsumer()     // Catch:{ all -> 0x006a }
            com.facebook.imagepipeline.producers.ProducerContext r5 = (com.facebook.imagepipeline.producers.ProducerContext) r5     // Catch:{ all -> 0x006a }
            r4.produceResults(r6, r5)     // Catch:{ all -> 0x006a }
        ...
        L_0x0074:
            ...
            java.util.Map r0 = r5.getExtras()     // Catch:{ all -> 0x00d0 }
            r3.setExtras(r0)     // Catch:{ all -> 0x00d0 }
            com.facebook.imagepipeline.systrace.FrescoSystrace r0 = com.facebook.imagepipeline.systrace.FrescoSystrace.INSTANCE     // Catch:{ all -> 0x00d0 }
            boolean r0 = com.facebook.imagepipeline.systrace.FrescoSystrace.isTracing()     // Catch:{ all -> 0x00d0 }
            if (r0 != 0) goto L_0x008f
            r0 = r5
            com.facebook.imagepipeline.producers.ProducerContext r0 = (com.facebook.imagepipeline.producers.ProducerContext) r0     // Catch:{ all -> 0x00d0 }
            r6.onRequestStart(r0)     // Catch:{ all -> 0x00d0 }
            goto L_0x009d
        L_0x008f:
            com.facebook.imagepipeline.systrace.FrescoSystrace.beginSection(r2)     // Catch:{ all -> 0x00d0 }
            r0 = r5
            com.facebook.imagepipeline.producers.ProducerContext r0 = (com.facebook.imagepipeline.producers.ProducerContext) r0     // Catch:{ all -> 0x00cb }
            r6.onRequestStart(r0)     // Catch:{ all -> 0x00cb }
            kotlin.Unit r6 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x00cb }
            com.facebook.imagepipeline.systrace.FrescoSystrace.endSection()     // Catch:{ all -> 0x00d0 }
        L_0x009d:
            com.facebook.imagepipeline.systrace.FrescoSystrace r6 = com.facebook.imagepipeline.systrace.FrescoSystrace.INSTANCE     // Catch:{ all -> 0x00d0 }
            boolean r6 = com.facebook.imagepipeline.systrace.FrescoSystrace.isTracing()     // Catch:{ all -> 0x00d0 }
            if (r6 != 0) goto L_0x00af
            com.facebook.imagepipeline.producers.Consumer r6 = r3.createConsumer()     // Catch:{ all -> 0x00d0 }
            com.facebook.imagepipeline.producers.ProducerContext r5 = (com.facebook.imagepipeline.producers.ProducerContext) r5     // Catch:{ all -> 0x00d0 }
            r4.produceResults(r6, r5)     // Catch:{ all -> 0x00d0 }
            goto L_0x00c0
        L_0x00af:
            com.facebook.imagepipeline.systrace.FrescoSystrace.beginSection(r1)     // Catch:{ all -> 0x00d0 }
            com.facebook.imagepipeline.producers.Consumer r6 = r3.createConsumer()     // Catch:{ all -> 0x00c6 }
            com.facebook.imagepipeline.producers.ProducerContext r5 = (com.facebook.imagepipeline.producers.ProducerContext) r5     // Catch:{ all -> 0x00c6 }
            r4.produceResults(r6, r5)     // Catch:{ all -> 0x00c6 }
            kotlin.Unit r4 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x00c6 }
            com.facebook.imagepipeline.systrace.FrescoSystrace.endSection()     // Catch:{ all -> 0x00d0 }
        L_0x00c0:
            kotlin.Unit r4 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x00d0 }
            com.facebook.imagepipeline.systrace.FrescoSystrace.endSection()
        L_0x00c5:
            return
        L_0x00c6:
