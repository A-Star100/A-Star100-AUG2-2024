...
public final class RenderScriptBlurFilter {
    ...
    public static final void blurBitmap(android.graphics.Bitmap r3, android.graphics.Bitmap r4, android.content.Context r5, int r6) {
        ...
        L_0x0018:
            ...
            r0 = 0
            android.renderscript.RenderScript r5 = android.renderscript.RenderScript.create(r5)     // Catch:{ all -> 0x0079 }
            java.lang.String r1 = "Required value was null."
            if (r5 == 0) goto L_0x006f
            android.renderscript.Element r0 = android.renderscript.Element.U8_4(r5)     // Catch:{ all -> 0x006c }
            android.renderscript.ScriptIntrinsicBlur r0 = android.renderscript.ScriptIntrinsicBlur.create(r5, r0)     // Catch:{ all -> 0x006c }
            android.renderscript.Allocation r4 = android.renderscript.Allocation.createFromBitmap(r5, r4)     // Catch:{ all -> 0x006c }
            if (r4 == 0) goto L_0x0062
            android.renderscript.Allocation r2 = android.renderscript.Allocation.createFromBitmap(r5, r3)     // Catch:{ all -> 0x006c }
            if (r2 == 0) goto L_0x0058
            float r6 = (float) r6     // Catch:{ all -> 0x006c }
            r0.setRadius(r6)     // Catch:{ all -> 0x006c }
            r0.setInput(r4)     // Catch:{ all -> 0x006c }
            r0.forEach(r2)     // Catch:{ all -> 0x006c }
            r2.copyTo(r3)     // Catch:{ all -> 0x006c }
            r0.destroy()     // Catch:{ all -> 0x006c }
            r4.destroy()     // Catch:{ all -> 0x006c }
            r2.destroy()     // Catch:{ all -> 0x006c }
        ...
        L_0x0058:
            ...
            java.lang.String r4 = r1.toString()     // Catch:{ all -> 0x006c }
        ...
        L_0x006c:
            ...
            goto L_0x007a
        L_0x006f:
            java.lang.IllegalStateException r3 = new java.lang.IllegalStateException     // Catch:{ all -> 0x0079 }
