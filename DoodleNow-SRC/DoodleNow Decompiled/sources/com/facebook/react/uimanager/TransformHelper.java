                ...
                if ("matrix".equals(nextKey)) {
                    ...
                    if (equals) {
                        ...
                        if (ViewProps.TRANSLATE_X.equals(nextKey)) {
                            MatrixMathHelper.applyTranslate2D(dArr3, map.getDouble(nextKey), AudioStats.AUDIO_AMPLITUDE_NONE);
                        } else if (ViewProps.TRANSLATE_Y.equals(nextKey)) {
                            MatrixMathHelper.applyTranslate2D(dArr3, AudioStats.AUDIO_AMPLITUDE_NONE, map.getDouble(nextKey));
