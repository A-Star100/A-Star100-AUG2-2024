    ...
    public static boolean isLayoutOnly(ReadableMap readableMap, String str) {
        ...
        switch (c) {
            ...
            case 1:
                ...
                return readableMap4.isNull(BORDER_RIGHT_WIDTH) || readableMap4.getDouble(BORDER_RIGHT_WIDTH) == AudioStats.AUDIO_AMPLITUDE_NONE;
            case 2:
            ...
            case 3:
                ...
                return readableMap6.isNull(BORDER_TOP_WIDTH) || readableMap6.getDouble(BORDER_TOP_WIDTH) == AudioStats.AUDIO_AMPLITUDE_NONE;
            case 4:
            ...
            case 5:
                ...
                return readableMap8.isNull(BORDER_BOTTOM_WIDTH) || readableMap8.getDouble(BORDER_BOTTOM_WIDTH) == AudioStats.AUDIO_AMPLITUDE_NONE;
            case 6:
            ...
            case 8:
                ...
                return readableMap11.isNull(BORDER_LEFT_WIDTH) || readableMap11.getDouble(BORDER_LEFT_WIDTH) == AudioStats.AUDIO_AMPLITUDE_NONE;
            case 9:
            ...
            case 12:
                ...
                return readableMap15.isNull(str3) || readableMap15.getDouble(str3) == AudioStats.AUDIO_AMPLITUDE_NONE;
            case 13:
            ...
            case 14:
                ...
                if (!readableMap17.hasKey(str4) || readableMap17.isNull(str4) || readableMap17.getDouble(str4) == AudioStats.AUDIO_AMPLITUDE_NONE) {
                    return true;
                }
                return false;
            default:
