...
public class NativeViewHierarchyManager {
            ...
            for (int i = 0; viewGroupManager.getChildAt(viewGroup, i) != null; i += 16) {
                ...
                while (true) {
                    ...
                    if (viewGroupManager.getChildAt(viewGroup, i3) == null || i2 >= 16) {
                        ...
                        sb.append(viewGroupManager.getChildAt(viewGroup, i3).getId() + f.a);
                        i2++;
                    }
                }
                sb.append("\n");
    ...
    public synchronized void manageChildren(int r18, int[] r19, com.facebook.react.uimanager.ViewAtIndex[] r20, int[] r21) {
        /*
            ...
            monitor-enter(r17)
            com.facebook.react.bridge.UiThreadUtil.assertOnUiThread()     // Catch:{ all -> 0x01ff }
            java.util.Set r12 = r17.getPendingDeletionsForTag(r18)     // Catch:{ all -> 0x01ff }
            android.util.SparseArray<android.view.View> r2 = r8.mTagsToViews     // Catch:{ all -> 0x01ff }
            java.lang.Object r2 = r2.get(r0)     // Catch:{ all -> 0x01ff }
            r13 = r2
            android.view.ViewGroup r13 = (android.view.ViewGroup) r13     // Catch:{ all -> 0x01ff }
            com.facebook.react.uimanager.ViewManager r2 = r17.resolveViewManager(r18)     // Catch:{ all -> 0x01ff }
            r14 = r2
            com.facebook.react.uimanager.ViewGroupManager r14 = (com.facebook.react.uimanager.ViewGroupManager) r14     // Catch:{ all -> 0x01ff }
            if (r13 == 0) goto L_0x01de
            int r1 = r14.getChildCount(r13)     // Catch:{ all -> 0x01ff }
            if (r9 == 0) goto L_0x00f0
            int r2 = r9.length     // Catch:{ all -> 0x01ff }
            int r2 = r2 + -1
        L_0x002f:
            if (r2 < 0) goto L_0x00f0
            r3 = r9[r2]     // Catch:{ all -> 0x01ff }
            if (r3 < 0) goto L_0x00c5
            android.view.View r4 = r14.getChildAt(r13, (int) r3)     // Catch:{ all -> 0x01ff }
            if (r4 != 0) goto L_0x0076
            android.util.SparseBooleanArray r1 = r8.mRootTags     // Catch:{ all -> 0x01ff }
            boolean r1 = r1.get(r0)     // Catch:{ all -> 0x01ff }
            ...
            return
        L_0x004b:
            com.facebook.react.uimanager.IllegalViewOperationException r1 = new com.facebook.react.uimanager.IllegalViewOperationException     // Catch:{ all -> 0x01ff }
            ...
            java.lang.String r0 = "\n detail: "
            r2.append(r0)     // Catch:{ all -> 0x01ff }
            java.lang.String r0 = constructManageChildrenErrorMessage(r13, r14, r9, r10, r11)     // Catch:{ all -> 0x01ff }
            r2.append(r0)     // Catch:{ all -> 0x01ff }
            java.lang.String r0 = r2.toString()     // Catch:{ all -> 0x01ff }
            r1.<init>(r0)     // Catch:{ all -> 0x01ff }
            throw r1     // Catch:{ all -> 0x01ff }
        L_0x0076:
            if (r3 >= r1) goto L_0x009a
            android.view.View r1 = r14.getChildAt(r13, (int) r3)     // Catch:{ all -> 0x01ff }
            boolean r4 = r8.mLayoutAnimationEnabled     // Catch:{ all -> 0x01ff }
            if (r4 == 0) goto L_0x0093
            com.facebook.react.uimanager.layoutanimation.LayoutAnimationController r4 = r8.mLayoutAnimator     // Catch:{ all -> 0x01ff }
            boolean r4 = r4.shouldAnimateLayout(r1)     // Catch:{ all -> 0x01ff }
            if (r4 == 0) goto L_0x0093
            int r1 = r1.getId()     // Catch:{ all -> 0x01ff }
            boolean r1 = r8.arrayContains(r11, r1)     // Catch:{ all -> 0x01ff }
            if (r1 == 0) goto L_0x0093
            goto L_0x0096
        L_0x0093:
            r14.removeViewAt(r13, (int) r3)     // Catch:{ all -> 0x01ff }
        L_0x0096:
            int r2 = r2 + -1
            r1 = r3
            goto L_0x002f
        ...
        L_0x00f0:
            ...
            r7 = 0
        L_0x00f3:
            int r1 = r11.length     // Catch:{ all -> 0x01ff }
            if (r7 >= r1) goto L_0x0161
            r1 = r11[r7]     // Catch:{ all -> 0x01ff }
            android.util.SparseArray<android.view.View> r2 = r8.mTagsToViews     // Catch:{ all -> 0x01ff }
            java.lang.Object r2 = r2.get(r1)     // Catch:{ all -> 0x01ff }
            r6 = r2
            android.view.View r6 = (android.view.View) r6     // Catch:{ all -> 0x01ff }
            if (r6 == 0) goto L_0x013c
            boolean r2 = r8.mLayoutAnimationEnabled     // Catch:{ all -> 0x01ff }
            if (r2 == 0) goto L_0x012f
            com.facebook.react.uimanager.layoutanimation.LayoutAnimationController r2 = r8.mLayoutAnimator     // Catch:{ all -> 0x01ff }
            boolean r2 = r2.shouldAnimateLayout(r6)     // Catch:{ all -> 0x01ff }
            if (r2 == 0) goto L_0x012f
            java.lang.Integer r1 = java.lang.Integer.valueOf(r1)     // Catch:{ all -> 0x01ff }
            r12.add(r1)     // Catch:{ all -> 0x01ff }
            com.facebook.react.uimanager.layoutanimation.LayoutAnimationController r5 = r8.mLayoutAnimator     // Catch:{ all -> 0x01ff }
            com.facebook.react.uimanager.NativeViewHierarchyManager$1 r4 = new com.facebook.react.uimanager.NativeViewHierarchyManager$1     // Catch:{ all -> 0x01ff }
            r1 = r4
            r2 = r17
            r3 = r14
            r15 = r4
            ...
            r16 = r7
            r7 = r18
            r1.<init>(r3, r4, r5, r6, r7)     // Catch:{ all -> 0x01ff }
            r0.deleteView(r9, r15)     // Catch:{ all -> 0x01ff }
            goto L_0x0135
        L_0x012f:
            r9 = r6
            r16 = r7
            r8.dropView(r9)     // Catch:{ all -> 0x01ff }
        L_0x0135:
            int r7 = r16 + 1
            r0 = r18
            r9 = r19
            goto L_0x00f3
        L_0x013c:
            com.facebook.react.uimanager.IllegalViewOperationException r0 = new com.facebook.react.uimanager.IllegalViewOperationException     // Catch:{ all -> 0x01ff }
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ all -> 0x01ff }
            r2.<init>()     // Catch:{ all -> 0x01ff }
            ...
            r2.append(r1)     // Catch:{ all -> 0x01ff }
            r3 = r19
            java.lang.String r1 = constructManageChildrenErrorMessage(r13, r14, r3, r10, r11)     // Catch:{ all -> 0x01ff }
            r2.append(r1)     // Catch:{ all -> 0x01ff }
            java.lang.String r1 = r2.toString()     // Catch:{ all -> 0x01ff }
        ...
        L_0x0161:
            ...
            r0 = 0
        L_0x0165:
            int r1 = r10.length     // Catch:{ all -> 0x01ff }
            if (r0 >= r1) goto L_0x01cd
            r1 = r10[r0]     // Catch:{ all -> 0x01ff }
            android.util.SparseArray<android.view.View> r2 = r8.mTagsToViews     // Catch:{ all -> 0x01ff }
            int r4 = r1.mTag     // Catch:{ all -> 0x01ff }
            java.lang.Object r2 = r2.get(r4)     // Catch:{ all -> 0x01ff }
            android.view.View r2 = (android.view.View) r2     // Catch:{ all -> 0x01ff }
            if (r2 == 0) goto L_0x01a8
            int r4 = r1.mIndex     // Catch:{ all -> 0x01ff }
            boolean r5 = r12.isEmpty()     // Catch:{ all -> 0x01ff }
            if (r5 != 0) goto L_0x01a2
            r4 = 0
            r5 = 0
        L_0x0180:
            int r6 = r13.getChildCount()     // Catch:{ all -> 0x01ff }
            if (r4 >= r6) goto L_0x01a2
            int r6 = r1.mIndex     // Catch:{ all -> 0x01ff }
            if (r5 != r6) goto L_0x018b
            goto L_0x01a2
        L_0x018b:
            android.view.View r6 = r13.getChildAt(r4)     // Catch:{ all -> 0x01ff }
            int r6 = r6.getId()     // Catch:{ all -> 0x01ff }
            java.lang.Integer r6 = java.lang.Integer.valueOf(r6)     // Catch:{ all -> 0x01ff }
            boolean r6 = r12.contains(r6)     // Catch:{ all -> 0x01ff }
        ...
        L_0x019f:
            ...
            goto L_0x0180
        L_0x01a2:
            r14.addView(r13, (android.view.View) r2, (int) r4)     // Catch:{ all -> 0x01ff }
            int r0 = r0 + 1
            goto L_0x0165
        L_0x01a8:
            com.facebook.react.uimanager.IllegalViewOperationException r0 = new com.facebook.react.uimanager.IllegalViewOperationException     // Catch:{ all -> 0x01ff }
            ...
            r2.append(r4)     // Catch:{ all -> 0x01ff }
            int r1 = r1.mTag     // Catch:{ all -> 0x01ff }
            r2.append(r1)     // Catch:{ all -> 0x01ff }
            java.lang.String r1 = "\n detail: "
            r2.append(r1)     // Catch:{ all -> 0x01ff }
            java.lang.String r1 = constructManageChildrenErrorMessage(r13, r14, r3, r10, r11)     // Catch:{ all -> 0x01ff }
            ...
            throw r0     // Catch:{ all -> 0x01ff }
        L_0x01cd:
            boolean r0 = r12.isEmpty()     // Catch:{ all -> 0x01ff }
            if (r0 == 0) goto L_0x01dc
            java.util.HashMap<java.lang.Integer, java.util.Set<java.lang.Integer>> r0 = r8.mPendingDeletionsForTag     // Catch:{ all -> 0x01ff }
            java.lang.Integer r1 = java.lang.Integer.valueOf(r18)     // Catch:{ all -> 0x01ff }
            r0.remove(r1)     // Catch:{ all -> 0x01ff }
        L_0x01dc:
            monitor-exit(r17)
            return
        L_0x01de:
            ...
            com.facebook.react.uimanager.IllegalViewOperationException r0 = new com.facebook.react.uimanager.IllegalViewOperationException     // Catch:{ all -> 0x01ff }
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ all -> 0x01ff }
            r2.<init>(r1)     // Catch:{ all -> 0x01ff }
            r1 = r18
            r2.append(r1)     // Catch:{ all -> 0x01ff }
            java.lang.String r1 = " which doesn't exist\n detail: "
            r2.append(r1)     // Catch:{ all -> 0x01ff }
            java.lang.String r1 = constructManageChildrenErrorMessage(r13, r14, r3, r10, r11)     // Catch:{ all -> 0x01ff }
            r2.append(r1)     // Catch:{ all -> 0x01ff }
            java.lang.String r1 = r2.toString()     // Catch:{ all -> 0x01ff }
