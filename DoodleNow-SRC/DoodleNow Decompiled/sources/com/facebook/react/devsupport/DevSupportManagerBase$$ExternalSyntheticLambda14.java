...
public final /* synthetic */ class DevSupportManagerBase$$ExternalSyntheticLambda14 implements Runnable {
    ...
    public /* synthetic */ DevSupportManagerBase$$ExternalSyntheticLambda14(DevSupportManagerBase devSupportManagerBase, Exception exc) {
        this.f$0 = devSupportManagerBase;
        this.f$1 = exc;
    }

    public final void run() {
        this.f$0.lambda$reportBundleLoadingFailure$12(this.f$1);
    }
}
