...
public abstract class DevSupportManagerBase implements DevSupportManager {
    ...
    public DevSupportManagerBase(Context context, ReactInstanceDevHelper reactInstanceDevHelper, String str, boolean z, RedBoxHandler redBoxHandler, DevBundleDownloadListener devBundleDownloadListener, int i, Map<String, RequestHandler> map, SurfaceDelegateFactory surfaceDelegateFactory, DevLoadingViewManager devLoadingViewManager) {
        ...
        this.mShakeDetector = new ShakeDetector(new DevSupportManagerBase$$ExternalSyntheticLambda19(this), i);
    ...
    public void updateJSError(String str, ReadableArray readableArray, int i) {
        UiThreadUtil.runOnUiThread(new DevSupportManagerBase$$ExternalSyntheticLambda11(this, i, str, readableArray));
    }
    ...
    private void showNewError(String str, StackFrame[] stackFrameArr, int i, ErrorType errorType) {
        UiThreadUtil.runOnUiThread(new DevSupportManagerBase$$ExternalSyntheticLambda16(this, str, stackFrameArr, i, errorType));
    }
    ...
    public void showDevOptionsDialog() {
        ...
        if (this.mDevOptionsDialog == null && this.mIsDevSupportEnabled && !ActivityManager.isUserAMonkey()) {
            ...
            if (this.mDevSettings.isDeviceDebugEnabled() && !this.mDevSettings.isRemoteJSDebugEnabled()) {
                ...
                linkedHashMap.put(string, new DevSupportManagerBase$$ExternalSyntheticLambda20(this));
            }
            linkedHashMap.put(this.mApplicationContext.getString(R.string.catalyst_change_bundle_location), new DevSupportManagerBase$$ExternalSyntheticLambda21(this));
            ...
            linkedHashMap.put(str, new DevSupportManagerBase$$ExternalSyntheticLambda1(this));
            ...
            linkedHashMap.put(this.mApplicationContext.getString(R.string.catalyst_settings), new DevSupportManagerBase$$ExternalSyntheticLambda3(this));
            ...
            }, new DevSupportManagerBase$$ExternalSyntheticLambda4(this, devOptionHandlerArr)).setOnCancelListener(new DevSupportManagerBase$$ExternalSyntheticLambda5(this)).create();
    ...
    private void showDevLoadingViewForUrl(String str) {
        if (this.mApplicationContext != null) {
            try {
                ...
                devLoadingViewManager.showMessage(context.getString(i, new Object[]{url.getHost() + Constants.SUBS_ID_BASE_PLAN_ID_SEPARATOR + port}));
    ...
    public void fetchSplitBundleAndCreateBundleLoader(String str, CallbackWithBundleLoader callbackWithBundleLoader) {
        ...
        UiThreadUtil.runOnUiThread(new DevSupportManagerBase$$ExternalSyntheticLambda8(this, devServerSplitBundleURL, new File(file, str.replaceAll("/", "_") + ".jsbundle"), callbackWithBundleLoader));
    }
    ...
    public /* synthetic */ void lambda$fetchSplitBundleAndCreateBundleLoader$9(final String str, final File file, final CallbackWithBundleLoader callbackWithBundleLoader) {
        ...
        this.mDevServerHelper.downloadBundleFromURL(new DevBundleDownloadListener() {
            ...
            public void onSuccess() {
                UiThreadUtil.runOnUiThread(new DevSupportManagerBase$6$$ExternalSyntheticLambda1(this));
            ...
            public void onFailure(Exception exc) {
                UiThreadUtil.runOnUiThread(new DevSupportManagerBase$6$$ExternalSyntheticLambda0(DevSupportManagerBase.this));
    ...
    public void isPackagerRunning(PackagerStatusCallback packagerStatusCallback) {
        DevSupportManagerBase$$ExternalSyntheticLambda15 devSupportManagerBase$$ExternalSyntheticLambda15 = new DevSupportManagerBase$$ExternalSyntheticLambda15(this, packagerStatusCallback);
        ...
        if (packagerLocationCustomizer != null) {
            packagerLocationCustomizer.run(devSupportManagerBase$$ExternalSyntheticLambda15);
        } else {
            devSupportManagerBase$$ExternalSyntheticLambda15.run();
        }
    }
    ...
    public void reloadJSFromServer(String str) {
        reloadJSFromServer(str, new DevSupportManagerBase$$ExternalSyntheticLambda6(this));
    }
    ...
    public /* synthetic */ void lambda$reloadJSFromServer$11() {
        ...
        UiThreadUtil.runOnUiThread(new DevSupportManagerBase$$ExternalSyntheticLambda9(reactInstanceDevHelper));
    }
    ...
    public void reportBundleLoadingFailure(Exception exc) {
        UiThreadUtil.runOnUiThread(new DevSupportManagerBase$$ExternalSyntheticLambda14(this, exc));
    }
    ...
    public void setRemoteJSDebugEnabled(boolean z) {
        if (this.mIsDevSupportEnabled) {
            UiThreadUtil.runOnUiThread(new DevSupportManagerBase$$ExternalSyntheticLambda7(this, z));
        }
    }
        ...
        if (this.mIsDevSupportEnabled) {
            ...
            this.mDevServerHelper.openPackagerConnection(getClass().getSimpleName(), new DevServerHelper.PackagerCommandListener() {
                ...
                public void onPackagerReloadCommand() {
                    ...
                    UiThreadUtil.runOnUiThread(new DevSupportManagerBase$9$$ExternalSyntheticLambda2(this));
                }
                ...
                public void onPackagerDevMenuCommand() {
                    UiThreadUtil.runOnUiThread(new DevSupportManagerBase$9$$ExternalSyntheticLambda0(this));
                }
                ...
                public void onCaptureHeapCommand(Responder responder) {
                    UiThreadUtil.runOnUiThread(new DevSupportManagerBase$9$$ExternalSyntheticLambda1(this, responder));
                }
