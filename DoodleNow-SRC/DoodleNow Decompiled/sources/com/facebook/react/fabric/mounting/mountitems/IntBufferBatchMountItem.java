                ...
                for (int i13 = 0; i13 < i; i13++) {
                    if (i10 == 2) {
                        ...
                        if (i10 == 4) {
                            ...
                            int i17 = i6 + 2;
                            i6 += 3;
                            surfaceManager.addViewAt(iArr3[i6 + 1], i16, iArr3[i17]);
                        } else if (i10 == 16) {
                            int[] iArr4 = this.mIntBuffer;
                            int i18 = i6 + 2;
                            i6 += 3;
                            surfaceManager.removeViewAt(iArr4[i6], iArr4[i6 + 1], iArr4[i18]);
                        } else if (i10 == 2048) {
                            int[] iArr5 = this.mIntBuffer;
                            int i19 = i6 + 2;
                            i6 += 3;
                            surfaceManager.removeDeleteTreeAt(iArr5[i6], iArr5[i6 + 1], iArr5[i19]);
                        } else {
                            if (i10 == 32) {
                                i2 = i6 + 1;
                                i3 = i12 + 1;
                ...
                while (true) {
                    if (i9 < i) {
                        if (i8 == 2) {
                            ...
                            int i10 = i4 + 1;
                            i4 += 2;
                            sb.append(String.format("CREATE [%d] - layoutable:%d - %s\n", new Object[]{Integer.valueOf(this.mIntBuffer[i4]), Integer.valueOf(this.mIntBuffer[i10]), fabricComponentName}));
                        } else {
                            if (i8 == 4) {
                                i2 = i4 + 1;
                                ...
                                int i11 = i4 + 2;
                                i4 += 3;
                                sb.append(String.format("INSERT [%d]->[%d] @%d\n", new Object[]{Integer.valueOf(this.mIntBuffer[i4]), Integer.valueOf(this.mIntBuffer[i4 + 1]), Integer.valueOf(this.mIntBuffer[i11])}));
                            } else if (i8 == 16) {
                                int i12 = i4 + 2;
                                i4 += 3;
                                sb.append(String.format("REMOVE [%d]->[%d] @%d\n", new Object[]{Integer.valueOf(this.mIntBuffer[i4]), Integer.valueOf(this.mIntBuffer[i4 + 1]), Integer.valueOf(this.mIntBuffer[i12])}));
                            } else if (i8 == 2048) {
                                int i13 = i4 + 2;
                                i4 += 3;
                                sb.append(String.format("REMOVE+DELETE TREE [%d]->[%d] @%d\n", new Object[]{Integer.valueOf(this.mIntBuffer[i4]), Integer.valueOf(this.mIntBuffer[i4 + 1]), Integer.valueOf(this.mIntBuffer[i13])}));
                            } else {
                                if (i8 == 32) {
                                    i3 = i5 + 1;
                                    ...
                                    i3 = i5 + 1;
                                    StateWrapper stateWrapper = (StateWrapper) this.mObjBuffer[i5];
                                    i2 = i4 + 1;
                                    ...
                                    int i14 = i4 + 6;
                                    i4 += 7;
                                    sb.append(String.format("UPDATE LAYOUT [%d]->[%d]: x:%d y:%d w:%d h:%d displayType:%d\n", new Object[]{Integer.valueOf(iArr2[i4 + 1]), Integer.valueOf(iArr2[i4]), Integer.valueOf(this.mIntBuffer[i4 + 2]), Integer.valueOf(this.mIntBuffer[i4 + 3]), Integer.valueOf(this.mIntBuffer[i4 + 4]), Integer.valueOf(this.mIntBuffer[i4 + 5]), Integer.valueOf(this.mIntBuffer[i14])}));
                                } else if (i8 == 512) {
                                    int i15 = i4 + 4;
                                    i4 += 5;
                                    sb.append(String.format("UPDATE PADDING [%d]: top:%d right:%d bottom:%d left:%d\n", new Object[]{Integer.valueOf(this.mIntBuffer[i4]), Integer.valueOf(this.mIntBuffer[i4 + 1]), Integer.valueOf(this.mIntBuffer[i4 + 2]), Integer.valueOf(this.mIntBuffer[i4 + 3]), Integer.valueOf(this.mIntBuffer[i15])}));
                                } else if (i8 == 1024) {
                                    int i16 = i4 + 4;
                                    i4 += 5;
                                    sb.append(String.format("UPDATE OVERFLOWINSET [%d]: left:%d top:%d right:%d bottom:%d\n", new Object[]{Integer.valueOf(this.mIntBuffer[i4]), Integer.valueOf(this.mIntBuffer[i4 + 1]), Integer.valueOf(this.mIntBuffer[i4 + 2]), Integer.valueOf(this.mIntBuffer[i4 + 3]), Integer.valueOf(this.mIntBuffer[i16])}));
                                } else if (i8 == 256) {
                                    i5++;
                                    i2 = i4 + 1;
