    ...
    public List<NativeModule> createNativeModules(ReactApplicationContext reactApplicationContext) {
        ...
        for (ReactPackage next : this.mChildReactPackages) {
            if (next instanceof BaseReactPackage) {
                ...
                for (String next2 : baseReactPackage.getReactModuleInfoProvider().getReactModuleInfos().keySet()) {
                    hashMap.put(next2, baseReactPackage.getModule(next2, reactApplicationContext));
                }
            } else {
