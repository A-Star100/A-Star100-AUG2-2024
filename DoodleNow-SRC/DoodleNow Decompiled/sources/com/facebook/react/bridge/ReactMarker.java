...
public class ReactMarker {
    ...
    public interface FabricMarkerListener {
        ...
        public final /* synthetic */ class CC {
            public static void $default$logFabricMarker(FabricMarkerListener _this, ReactMarkerConstants reactMarkerConstants, String str, int i, long j, int i2) {
                _this.logFabricMarker(reactMarkerConstants, str, i, j);
            }
        }
    }
