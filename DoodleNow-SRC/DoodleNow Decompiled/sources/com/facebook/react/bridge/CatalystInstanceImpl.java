...
public class CatalystInstanceImpl implements CatalystInstance {
    ...
    public void decrementPendingJSCalls() {
        ...
        if (z && !this.mBridgeIdleListeners.isEmpty()) {
            this.mNativeModulesQueueThread.runOnQueue(new CatalystInstanceImpl$$ExternalSyntheticLambda2(this));
        }
    }
    ...
    public void onNativeException(Exception exc) {
        ...
        this.mReactQueueConfiguration.getUIQueueThread().runOnQueue(new CatalystInstanceImpl$$ExternalSyntheticLambda4(this));
    }
