        ...
        if (directionAwareBorderInsets.top > 0.0f || directionAwareBorderInsets.bottom > 0.0f || directionAwareBorderInsets.left > 0.0f || directionAwareBorderInsets.right > 0.0f) {
            ...
            if (directionAwareBorderInsets.top != fullBorderWidth || directionAwareBorderInsets.bottom != fullBorderWidth || directionAwareBorderInsets.left != fullBorderWidth || directionAwareBorderInsets.right != fullBorderWidth || borderColor != borderColor8 || i3 != borderColor8 || borderColor3 != borderColor8 || borderColor7 != borderColor8) {
                ...
                if (directionAwareBorderInsets.left > 0.0f) {
                    ...
                    f4 = f6;
                    f = f5;
                    drawQuadrilateral(canvas, i2, f5, f7 - 0.8f, this.mInnerTopLeftCorner.x, this.mInnerTopLeftCorner.y - 0.8f, this.mInnerBottomLeftCorner.x, this.mInnerBottomLeftCorner.y + 0.8f, f5, f8 + 0.8f);
                } else {
                    f2 = f8;
                    f3 = f7;
                    f4 = f6;
                ...
                if (directionAwareBorderInsets.top > 0.0f) {
                    drawQuadrilateral(canvas, i3, f - 0.8f, f3, this.mInnerTopLeftCorner.x - 0.8f, this.mInnerTopLeftCorner.y, this.mInnerTopRightCorner.x + 0.8f, this.mInnerTopRightCorner.y, f4 + 0.8f, f3);
                }
                if (directionAwareBorderInsets.right > 0.0f) {
                    drawQuadrilateral(canvas, i, f4, f3 - 0.8f, this.mInnerTopRightCorner.x, this.mInnerTopRightCorner.y - 0.8f, this.mInnerBottomRightCorner.x, this.mInnerBottomRightCorner.y + 0.8f, f4, f2 + 0.8f);
                }
                if (directionAwareBorderInsets.bottom > 0.0f) {
                    drawQuadrilateral(canvas, borderColor7, f - 0.8f, f2, this.mInnerBottomLeftCorner.x - 0.8f, this.mInnerBottomLeftCorner.y, this.mInnerBottomRightCorner.x + 0.8f, this.mInnerBottomRightCorner.y, f4 + 0.8f, f2);
                }
