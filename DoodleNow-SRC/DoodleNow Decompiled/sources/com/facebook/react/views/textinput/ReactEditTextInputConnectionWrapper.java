...
class ReactEditTextInputConnectionWrapper extends InputConnectionWrapper {
    ...
    public boolean setComposingText(CharSequence charSequence, int i) {
        ...
        dispatchKeyEventOrEnqueue((selectionStart2 < selectionStart || selectionStart2 <= 0 || (!z2 && z)) ? BACKSPACE_KEY_VALUE : String.valueOf(this.mEditText.getText().charAt(selectionStart2 - 1)));
