...
public class ReactTextInputManager extends BaseViewManager<ReactEditText, LayoutShadowNode> {
    ...
    public void setSelectionHandleColor(ReactEditText reactEditText, Integer num) {
        if (Build.VERSION.SDK_INT >= 29) {
            Drawable mutate = ReactTextView$$ExternalSyntheticApiModelOutline0.m(reactEditText).mutate();
            ...
            if (num != null) {
                ReactTextView$$ExternalSyntheticApiModelOutline0.m();
                BlendModeColorFilter m = ReactTextView$$ExternalSyntheticApiModelOutline0.m(num.intValue(), ReactTextView$$ExternalSyntheticApiModelOutline0.m());
            ...
            while (true) {
                ...
                if (i < strArr.length) {
                    try {
                        ...
                        if (i2 != 0) {
                            Drawable mutate4 = ContextCompat.getDrawable(reactEditText.getContext(), i2).mutate();
                            if (num != null) {
    ...
    public void setCursorColor(ReactEditText reactEditText, Integer num) {
        if (Build.VERSION.SDK_INT >= 29) {
            Drawable m$3 = reactEditText.getTextCursorDrawable();
            if (m$3 != null) {
                if (num != null) {
                    ReactTextView$$ExternalSyntheticApiModelOutline0.m();
                    m$3.setColorFilter(ReactTextView$$ExternalSyntheticApiModelOutline0.m(num.intValue(), ReactTextView$$ExternalSyntheticApiModelOutline0.m()));
                } else {
                    m$3.clearColorFilter();
                }
                reactEditText.setTextCursorDrawable(m$3);
            }
        } else if (Build.VERSION.SDK_INT != 28) {
            try {
    ...
    public void addEventEmitters(ThemedReactContext themedReactContext, ReactEditText reactEditText) {
        ...
        reactEditText.setOnFocusChangeListener(new ReactTextInputManager$$ExternalSyntheticLambda15(themedReactContext, reactEditText));
        reactEditText.setOnEditorActionListener(new ReactTextInputManager$$ExternalSyntheticLambda16(reactEditText, themedReactContext));
    }
    ...
    public Object updateState(ReactEditText reactEditText, ReactStylesDiffMap reactStylesDiffMap, StateWrapper stateWrapper) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            i = ReactTextView$$ExternalSyntheticApiModelOutline0.m(reactEditText);
        }
