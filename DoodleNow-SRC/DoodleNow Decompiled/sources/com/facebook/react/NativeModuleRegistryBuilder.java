...
public class NativeModuleRegistryBuilder {
    ...
    public void processPackage(ReactPackage reactPackage) {
        ...
        if (reactPackage instanceof LazyReactPackage) {
            ...
            iterable = ((BaseReactPackage) reactPackage).getNativeModuleIterator(this.mReactApplicationContext);
        } else {
            iterable = ReactPackageHelper.getNativeModuleIterator(reactPackage, this.mReactApplicationContext);
        }
