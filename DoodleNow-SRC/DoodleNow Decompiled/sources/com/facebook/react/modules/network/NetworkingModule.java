...
public final class NetworkingModule extends NativeNetworkingAndroidSpec {
    ...
    public void sendRequest(String str, String str2, double d, ReadableArray readableArray, ReadableMap readableMap, String str3, boolean z, double d2, boolean z2) {
        ...
        try {
            ...
            Throwable th2 = th;
            StringBuilder sb = new StringBuilder("Failed to send url request: ");
            String str4 = str2;
            sb.append(str2);
    ...
    public void sendRequestInternal(java.lang.String r7, java.lang.String r8, int r9, com.facebook.react.bridge.ReadableArray r10, com.facebook.react.bridge.ReadableMap r11, java.lang.String r12, boolean r13, int r14, boolean r15) {
        /*
            ...
            android.net.Uri r0 = android.net.Uri.parse(r8)     // Catch:{ IOException -> 0x01ac }
            java.util.List<com.facebook.react.modules.network.NetworkingModule$UriHandler> r1 = r6.mUriHandlers     // Catch:{ IOException -> 0x01ac }
            java.util.Iterator r1 = r1.iterator()     // Catch:{ IOException -> 0x01ac }
        L_0x000e:
            boolean r2 = r1.hasNext()     // Catch:{ IOException -> 0x01ac }
            if (r2 == 0) goto L_0x002b
            java.lang.Object r2 = r1.next()     // Catch:{ IOException -> 0x01ac }
            com.facebook.react.modules.network.NetworkingModule$UriHandler r2 = (com.facebook.react.modules.network.NetworkingModule.UriHandler) r2     // Catch:{ IOException -> 0x01ac }
            boolean r4 = r2.supports(r0, r12)     // Catch:{ IOException -> 0x01ac }
            if (r4 == 0) goto L_0x000e
            com.facebook.react.bridge.WritableMap r7 = r2.fetch(r0)     // Catch:{ IOException -> 0x01ac }
            com.facebook.react.modules.network.ResponseUtil.onDataReceived((com.facebook.react.bridge.ReactApplicationContext) r3, (int) r9, (com.facebook.react.bridge.WritableMap) r7)     // Catch:{ IOException -> 0x01ac }
            com.facebook.react.modules.network.ResponseUtil.onRequestSuccess(r3, r9)     // Catch:{ IOException -> 0x01ac }
            return
        L_0x002b:
            r0 = 0
            okhttp3.Request$Builder r1 = new okhttp3.Request$Builder     // Catch:{ Exception -> 0x01a3 }
            r1.<init>()     // Catch:{ Exception -> 0x01a3 }
            okhttp3.Request$Builder r8 = r1.url((java.lang.String) r8)     // Catch:{ Exception -> 0x01a3 }
