...
public abstract class BaseReactPackage implements ReactPackage {
    ...
    public Iterable<ModuleHolder> getNativeModuleIterator(ReactApplicationContext reactApplicationContext) {
        return new BaseReactPackage$$ExternalSyntheticLambda0(this, getReactModuleInfoProvider().getReactModuleInfos().entrySet().iterator(), reactApplicationContext);
    }
        ...
        return new Iterator<ModuleHolder>() {
            ...
            private void findNext() {
                ...
                L_0x0024:
                    ...
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.BaseReactPackage.AnonymousClass1.findNext():void");
            }
