...
class CoreReactPackage extends TurboReactPackage {
    ...
    public ReactModuleInfoProvider getReactModuleInfoProvider() {
        ...
        try {
            return (ReactModuleInfoProvider) Class.forName(cls.getName() + "$$ReactModuleInfoProvider").newInstance();
            ...
            for (int i = 0; i < 7; i++) {
                Class cls2 = clsArr[i];
                ReactModule reactModule = (ReactModule) cls2.getAnnotation(ReactModule.class);
                if (reactModule != null) {
                    hashMap.put(reactModule.name(), new ReactModuleInfo(reactModule.name(), cls2.getName(), reactModule.canOverrideExistingModule(), reactModule.needsEagerInit(), reactModule.isCxxModule(), ReactModuleInfo.classIsTurboModule(cls2)));
                }
            }
