...
class BridgelessAtomicRef<T> {
    ...
    public T getOrCreate(com.facebook.react.runtime.BridgelessAtomicRef.Provider<T> r5) {
        /*
            ...
            monitor-enter(r4)
            com.facebook.react.runtime.BridgelessAtomicRef$State r1 = r4.state     // Catch:{ all -> 0x00b1 }
            com.facebook.react.runtime.BridgelessAtomicRef$State r2 = com.facebook.react.runtime.BridgelessAtomicRef.State.Success     // Catch:{ all -> 0x00b1 }
            if (r1 != r2) goto L_0x000f
            java.lang.Object r5 = r4.get()     // Catch:{ all -> 0x00b1 }
            monitor-exit(r4)     // Catch:{ all -> 0x00b1 }
            return r5
        L_0x000f:
            com.facebook.react.runtime.BridgelessAtomicRef$State r1 = r4.state     // Catch:{ all -> 0x00b1 }
            com.facebook.react.runtime.BridgelessAtomicRef$State r2 = com.facebook.react.runtime.BridgelessAtomicRef.State.Failure     // Catch:{ all -> 0x00b1 }
            if (r1 == r2) goto L_0x009d
            com.facebook.react.runtime.BridgelessAtomicRef$State r0 = r4.state     // Catch:{ all -> 0x00b1 }
            com.facebook.react.runtime.BridgelessAtomicRef$State r1 = com.facebook.react.runtime.BridgelessAtomicRef.State.Creating     // Catch:{ all -> 0x00b1 }
            r2 = 1
            r3 = 0
            if (r0 == r1) goto L_0x0023
            com.facebook.react.runtime.BridgelessAtomicRef$State r0 = com.facebook.react.runtime.BridgelessAtomicRef.State.Creating     // Catch:{ all -> 0x00b1 }
            r4.state = r0     // Catch:{ all -> 0x00b1 }
            r0 = r2
            goto L_0x0024
        L_0x0023:
            r0 = r3
        ...
        L_0x005f:
            monitor-enter(r4)
        L_0x0060:
            com.facebook.react.runtime.BridgelessAtomicRef$State r5 = r4.state     // Catch:{ all -> 0x009a }
            com.facebook.react.runtime.BridgelessAtomicRef$State r0 = com.facebook.react.runtime.BridgelessAtomicRef.State.Creating     // Catch:{ all -> 0x009a }
        ...
        L_0x006c:
            ...
            java.lang.Thread r5 = java.lang.Thread.currentThread()     // Catch:{ all -> 0x009a }
            r5.interrupt()     // Catch:{ all -> 0x009a }
        L_0x0075:
            com.facebook.react.runtime.BridgelessAtomicRef$State r5 = r4.state     // Catch:{ all -> 0x009a }
            com.facebook.react.runtime.BridgelessAtomicRef$State r0 = com.facebook.react.runtime.BridgelessAtomicRef.State.Failure     // Catch:{ all -> 0x009a }
            if (r5 == r0) goto L_0x0081
            java.lang.Object r5 = r4.get()     // Catch:{ all -> 0x009a }
            monitor-exit(r4)     // Catch:{ all -> 0x009a }
            return r5
        L_0x0081:
            java.lang.RuntimeException r5 = new java.lang.RuntimeException     // Catch:{ all -> 0x009a }
            ...
            r0.append(r1)     // Catch:{ all -> 0x009a }
            java.lang.String r1 = r4.failureMessage     // Catch:{ all -> 0x009a }
            r0.append(r1)     // Catch:{ all -> 0x009a }
        ...
        L_0x009a:
            ...
            throw r5
        L_0x009d:
            java.lang.RuntimeException r5 = new java.lang.RuntimeException     // Catch:{ all -> 0x00b1 }
            java.lang.StringBuilder r1 = new java.lang.StringBuilder     // Catch:{ all -> 0x00b1 }
            r1.<init>(r0)     // Catch:{ all -> 0x00b1 }
            java.lang.String r0 = r4.failureMessage     // Catch:{ all -> 0x00b1 }
            r1.append(r0)     // Catch:{ all -> 0x00b1 }
            java.lang.String r0 = r1.toString()     // Catch:{ all -> 0x00b1 }
            r5.<init>(r0)     // Catch:{ all -> 0x00b1 }
