...
public final /* synthetic */ class ReactHostImpl$$ExternalSyntheticLambda1 implements Continuation {
    ...
    public /* synthetic */ ReactHostImpl$$ExternalSyntheticLambda1(ReactHostImpl reactHostImpl, ReactHostImpl.ReactInstanceTaskUnwrapper reactInstanceTaskUnwrapper) {
        this.f$0 = reactHostImpl;
        this.f$1 = reactInstanceTaskUnwrapper;
    }

    public final Object then(Task task) {
        return this.f$0.lambda$getOrCreateReloadTask$37(this.f$1, task);
    }
}
