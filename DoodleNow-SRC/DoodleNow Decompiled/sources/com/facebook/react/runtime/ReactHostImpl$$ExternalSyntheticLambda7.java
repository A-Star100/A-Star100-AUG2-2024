...
public final /* synthetic */ class ReactHostImpl$$ExternalSyntheticLambda7 implements Continuation {
    ...
    public /* synthetic */ ReactHostImpl$$ExternalSyntheticLambda7(ReactHostImpl reactHostImpl, ReactHostImpl.ReactInstanceTaskUnwrapper reactInstanceTaskUnwrapper) {
        this.f$0 = reactHostImpl;
        this.f$1 = reactInstanceTaskUnwrapper;
    }

    public final Object then(Task task) {
        return this.f$0.lambda$getOrCreateDestroyTask$41(this.f$1, task);
    }
}
