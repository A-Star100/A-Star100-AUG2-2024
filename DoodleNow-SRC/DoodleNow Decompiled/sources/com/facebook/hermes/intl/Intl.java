...
public class Intl {
    ...
    public static String toLocaleLowerCase(List<String> list, String str) throws JSRangeErrorException {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            return UCharacter.toLowerCase(Intl$$ExternalSyntheticApiModelOutline0.m((Object) LocaleMatcher.bestFitMatch((String[]) list.toArray(strArr)).matchedLocale.getLocale()), str);
        }
    ...
    public static String toLocaleUpperCase(List<String> list, String str) throws JSRangeErrorException {
        String[] strArr = new String[list.size()];
        if (Build.VERSION.SDK_INT >= 24) {
            return UCharacter.toUpperCase(Intl$$ExternalSyntheticApiModelOutline0.m((Object) LocaleMatcher.bestFitMatch((String[]) list.toArray(strArr)).matchedLocale.getLocale()), str);
        }
