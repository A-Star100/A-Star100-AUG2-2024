...
public class PlatformDateTimeFormatterICU implements IPlatformDateTimeFormatter {
    ...
    public String fieldToString(AttributedCharacterIterator.Attribute attribute, String str) {
        ...
        } else if (attribute == Intl$$ExternalSyntheticApiModelOutline0.m$1()) {
            return "month";
        } else {
            if (attribute == Intl$$ExternalSyntheticApiModelOutline0.m$4()) {
                return "day";
            }
            if (attribute == Intl$$ExternalSyntheticApiModelOutline0.m$8() || attribute == Intl$$ExternalSyntheticApiModelOutline0.m$9() || attribute == Intl$$ExternalSyntheticApiModelOutline0.m$10() || attribute == DateFormat.Field.HOUR_OF_DAY1) {
                return "hour";
            }
            if (attribute == DateFormat.Field.MINUTE) {
                return "minute";
            }
            if (attribute == Intl$$ExternalSyntheticApiModelOutline0.m$3()) {
                return "second";
            }
    ...
    public String getDefaultCalendarName(ILocaleObject<?> iLocaleObject) throws JSRangeErrorException {
        return UnicodeExtensionKeys.resolveCalendarAlias(Intl$$ExternalSyntheticApiModelOutline0.m(DateFormat.getDateInstance(3, Intl$$ExternalSyntheticApiModelOutline0.m((Object) iLocaleObject.getLocale())).getCalendar()));
    }
    ...
    public IPlatformDateTimeFormatter.HourCycle getDefaultHourCycle(ILocaleObject<?> iLocaleObject) throws JSRangeErrorException {
        try {
            String patternWithoutLiterals = PatternUtils.getPatternWithoutLiterals(Intl$$ExternalSyntheticApiModelOutline0.m((Object) DateFormat.getTimeInstance(0, Intl$$ExternalSyntheticApiModelOutline0.m((Object) iLocaleObject.getLocale()))).toPattern());
    ...
    public String getDefaultTimeZone(ILocaleObject<?> iLocaleObject) throws JSRangeErrorException {
        return Intl$$ExternalSyntheticApiModelOutline0.m(Intl$$ExternalSyntheticApiModelOutline0.m(Intl$$ExternalSyntheticApiModelOutline0.m((Object) iLocaleObject.getLocale()))).getID();
    }
    ...
    private static String getPatternForStyle(ILocaleObject<?> iLocaleObject, IPlatformDateTimeFormatter.DateStyle dateStyle, IPlatformDateTimeFormatter.TimeStyle timeStyle) throws JSRangeErrorException {
        if (dateStyle == IPlatformDateTimeFormatter.DateStyle.UNDEFINED) {
            return Intl$$ExternalSyntheticApiModelOutline0.m((Object) DateFormat.getTimeInstance(toICUTimeStyle(timeStyle), Intl$$ExternalSyntheticApiModelOutline0.m((Object) iLocaleObject.getLocale()))).toLocalizedPattern();
        }
        if (timeStyle == IPlatformDateTimeFormatter.TimeStyle.UNDEFINED) {
            return Intl$$ExternalSyntheticApiModelOutline0.m((Object) DateFormat.getDateInstance(toICUDateStyle(dateStyle), Intl$$ExternalSyntheticApiModelOutline0.m((Object) iLocaleObject.getLocale()))).toLocalizedPattern();
        }
        return Intl$$ExternalSyntheticApiModelOutline0.m((Object) DateFormat.getDateTimeInstance(toICUDateStyle(dateStyle), toICUTimeStyle(timeStyle), Intl$$ExternalSyntheticApiModelOutline0.m((Object) iLocaleObject.getLocale()))).toLocalizedPattern();
    }
    ...
    public void configure(ILocaleObject<?> iLocaleObject, String str, String str2, IPlatformDateTimeFormatter.FormatMatcher formatMatcher, IPlatformDateTimeFormatter.WeekDay weekDay, IPlatformDateTimeFormatter.Era era, IPlatformDateTimeFormatter.Year year, IPlatformDateTimeFormatter.Month month, IPlatformDateTimeFormatter.Day day, IPlatformDateTimeFormatter.Hour hour, IPlatformDateTimeFormatter.Minute minute, IPlatformDateTimeFormatter.Second second, IPlatformDateTimeFormatter.TimeZoneName timeZoneName, IPlatformDateTimeFormatter.HourCycle hourCycle, Object obj, IPlatformDateTimeFormatter.DateStyle dateStyle, IPlatformDateTimeFormatter.TimeStyle timeStyle, Object obj2) throws JSRangeErrorException {
        ...
        if (!str.isEmpty()) {
            ...
            calendar = Intl$$ExternalSyntheticApiModelOutline0.m(Intl$$ExternalSyntheticApiModelOutline0.m((Object) cloneObject.getLocale()));
        } else {
            calendar = null;
        }
        if (!str2.isEmpty()) {
            try {
                if (Intl$$ExternalSyntheticApiModelOutline0.m(JSObjects.getJavaString(str2)) != null) {
        ...
        if (calendar != null) {
            this.mDateFormat = DateFormat.getPatternInstance(calendar, skeleton, Intl$$ExternalSyntheticApiModelOutline0.m((Object) iLocaleObject.getLocale()));
        } else {
            this.mDateFormat = DateFormat.getPatternInstance(skeleton, Intl$$ExternalSyntheticApiModelOutline0.m((Object) iLocaleObject.getLocale()));
        }
        if (!JSObjects.isUndefined(obj) && !JSObjects.isNull(obj)) {
            this.mDateFormat.setTimeZone(Intl$$ExternalSyntheticApiModelOutline0.m(JSObjects.getJavaString(obj)));
        }
    }
