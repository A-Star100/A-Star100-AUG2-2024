...
public class PlatformCollatorICU implements IPlatformCollator {
    ...
    public IPlatformCollator configure(ILocaleObject<?> iLocaleObject) throws JSRangeErrorException {
        RuleBasedCollator m = Intl$$ExternalSyntheticApiModelOutline0.m((Object) Intl$$ExternalSyntheticApiModelOutline0.m(((LocaleObjectICU) iLocaleObject).getLocale()));
        this.mCollator = m;
    ...
    public IPlatformCollator.Sensitivity getSensitivity() {
        ...
        int m = Intl$$ExternalSyntheticApiModelOutline0.m(ruleBasedCollator);
        if (m == 0) {
            if (Intl$$ExternalSyntheticApiModelOutline0.m(this.mCollator)) {
    ...
    public IPlatformCollator setCaseFirstAttribute(IPlatformCollator.CaseFirst caseFirst) {
        ...
        if (i == 1) {
            ...
            Intl$$ExternalSyntheticApiModelOutline0.m(this.mCollator);
        } else {
