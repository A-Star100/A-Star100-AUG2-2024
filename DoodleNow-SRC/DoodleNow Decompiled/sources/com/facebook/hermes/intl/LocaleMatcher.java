...
public class LocaleMatcher {
    ...
    public static ULocale bestFitBestAvailableLocale(ILocaleObject<?> iLocaleObject) throws JSRangeErrorException {
        ULocale[] m = Intl$$ExternalSyntheticApiModelOutline0.m();
        ULocale[] uLocaleArr = {Intl$$ExternalSyntheticApiModelOutline0.m((Object) iLocaleObject.getLocaleWithoutExtensions())};
        boolean[] zArr = new boolean[1];
        ULocale m2 = ULocale.acceptLanguage(uLocaleArr, m, zArr);
        if (zArr[0] || m2 == null) {
            return null;
        }
        return m2;
