...
public final class CameraViewModule extends ReactContextBaseJavaModule {
    ...
    public final String getLocationPermissionStatus() {
        PermissionStatus permission = getPermission(LocationConstants.ANDROID_FINE_LOCATION_PERMISSION_STRING);
        if (permission == PermissionStatus.GRANTED) {
            return permission.getUnionValue();
        }
        return getPermission(LocationConstants.ANDROID_COARSE_LOCATION_PERMISSION_STRING).getUnionValue();
    }
    ...
    public final void requestLocationPermission(Promise promise) {
        Intrinsics.checkNotNullParameter(promise, BaseJavaModule.METHOD_TYPE_PROMISE);
        requestPermission(LocationConstants.ANDROID_FINE_LOCATION_PERMISSION_STRING, promise);
    }
