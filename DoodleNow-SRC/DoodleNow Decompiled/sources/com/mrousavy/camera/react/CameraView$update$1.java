...
@DebugMetadata(c = "com.mrousavy.camera.react.CameraView$update$1", f = "CameraView.kt", i = {}, l = {153}, m = "invokeSuspend", n = {}, s = {})
                ...
                public final void invoke(CameraConfiguration cameraConfiguration) {
                    ...
                    if (cameraView.currentConfigureCall == j) {
                        ...
                        if (cameraView.getPhoto()) {
                            cameraConfiguration.setPhoto(CameraConfiguration.Output.Enabled.Companion.create(new CameraConfiguration.Photo(cameraView.getPhotoHdr(), cameraView.getPhotoQualityBalance())));
                        } else {
                        ...
                        if (cameraView.getVideo() || cameraView.getEnableFrameProcessor()) {
                            cameraConfiguration.setVideo(CameraConfiguration.Output.Enabled.Companion.create(new CameraConfiguration.Video(cameraView.getVideoHdr())));
                        } else {
                            cameraConfiguration.setVideo(CameraConfiguration.Output.Disabled.Companion.create());
                        }
                        if (cameraView.getEnableFrameProcessor()) {
                            cameraConfiguration.setFrameProcessor(CameraConfiguration.Output.Enabled.Companion.create(new CameraConfiguration.FrameProcessor(cameraView.getPixelFormat())));
                        } else {
                        ...
                        cameraConfiguration.setFps(cameraView.getFps());
