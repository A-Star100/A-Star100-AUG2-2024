...
final class CameraViewModule$takeSnapshot$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (UiThreadUtil.isOnUiThread()) {
            try {
                promise.resolve(CameraView_TakeSnapshotKt.takeSnapshot(cameraView, SnapshotOptions.Companion.fromJSValue(readableMap)));
            } catch (Throwable th) {
                promise.reject(th);
            }
        } else {
            UiThreadUtil.runOnUiThread(new CameraViewModule$takeSnapshot$1$invokeSuspend$$inlined$runOnUiThread$1(readableMap, cameraView, promise));
        }
