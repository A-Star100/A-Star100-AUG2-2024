...
public final class CameraView_EventsKt {
    ...
    public static final void invokeOnError(CameraView cameraView, Throwable th) {
        ...
        WritableMap createMap = Arguments.createMap();
        createMap.putString("code", cameraError.getCode());
        createMap.putString(OneSignalDbContract.NotificationTable.COLUMN_NAME_MESSAGE, cameraError.getMessage());
    ...
    private static final WritableMap errorToMap(Throwable th) {
        WritableMap createMap = Arguments.createMap();
        createMap.putString(OneSignalDbContract.NotificationTable.COLUMN_NAME_MESSAGE, th.getMessage());
