...
public final class CameraDeviceFormat {
    ...
    public int hashCode() {
        return (((((((((((((((((((((((((this.videoWidth * 31) + this.videoHeight) * 31) + this.photoWidth) * 31) + this.photoHeight) * 31) + Double.doubleToLongBits(this.minFps)) * 31) + Double.doubleToLongBits(this.maxFps)) * 31) + Double.doubleToLongBits(this.minISO)) * 31) + Double.doubleToLongBits(this.maxISO)) * 31) + Double.doubleToLongBits(this.fieldOfView)) * 31) + this.videoStabilizationModes.hashCode()) * 31) + this.autoFocusSystem.hashCode()) * 31) + Video$$ExternalSyntheticBackport0.m(this.supportsVideoHdr)) * 31) + Video$$ExternalSyntheticBackport0.m(this.supportsPhotoHdr)) * 31) + Video$$ExternalSyntheticBackport0.m(this.supportsDepthCapture);
    }
    ...
    public String toString() {
        ...
        return "CameraDeviceFormat(videoWidth=" + i + ", videoHeight=" + i2 + ", photoWidth=" + i3 + ", photoHeight=" + i4 + ", minFps=" + d + ", maxFps=" + d2 + ", minISO=" + d3 + ", maxISO=" + d4 + ", fieldOfView=" + d5 + ", videoStabilizationModes=" + list + ", autoFocusSystem=" + autoFocusSystem2 + ", supportsVideoHdr=" + z + ", supportsPhotoHdr=" + z2 + ", supportsDepthCapture=" + this.supportsDepthCapture + ")";
    }
