...
public final class OrientationManager {
    ...
    public /* synthetic */ class WhenMappings {
        ...
        static {
            ...
            L_0x0019:
                com.mrousavy.camera.core.types.OutputOrientation r1 = com.mrousavy.camera.core.types.OutputOrientation.PORTRAIT     // Catch:{ NoSuchFieldError -> 0x0022 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0022 }
                r2 = 3
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0022 }
            L_0x0022:
                com.mrousavy.camera.core.types.OutputOrientation r1 = com.mrousavy.camera.core.types.OutputOrientation.LANDSCAPE_LEFT     // Catch:{ NoSuchFieldError -> 0x002b }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x002b }
                r2 = 4
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x002b }
            L_0x002b:
                com.mrousavy.camera.core.types.OutputOrientation r1 = com.mrousavy.camera.core.types.OutputOrientation.PORTRAIT_UPSIDE_DOWN     // Catch:{ NoSuchFieldError -> 0x0034 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0034 }
                r2 = 5
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0034 }
            L_0x0034:
                com.mrousavy.camera.core.types.OutputOrientation r1 = com.mrousavy.camera.core.types.OutputOrientation.LANDSCAPE_RIGHT     // Catch:{ NoSuchFieldError -> 0x003d }
    ...
    public final Orientation getOutputOrientation() {
        switch (WhenMappings.$EnumSwitchMapping$0[this.targetOutputOrientation.ordinal()]) {
            case 1:
    ...
    public final void setTargetOutputOrientation(OutputOrientation outputOrientation) {
        ...
        OutputOrientation outputOrientation2 = this.targetOutputOrientation;
        Log.i(TAG, "Target Orientation changed " + outputOrientation2 + " -> " + outputOrientation + "!");
        this.targetOutputOrientation = outputOrientation;
        this.displayManager.unregisterDisplayListener(this.displayListener);
        this.orientationListener.disable();
        switch (WhenMappings.$EnumSwitchMapping$0[outputOrientation.ordinal()]) {
            case 1:
            case 2:
            ...
            case 5:
            case 6:
                Log.i(TAG, "Setting output orientation to " + outputOrientation + ". (locked)");
                return;
            default:
                return;
        }
