...
public final class PixelFormatNotSupportedError extends CameraError {
    ...
    public PixelFormatNotSupportedError(String str) {
        super("device", "pixel-format-not-supported", "The pixelFormat " + str + " is not supported on the given Camera Device!", (Throwable) null, 8, (DefaultConstructorMarker) null);
