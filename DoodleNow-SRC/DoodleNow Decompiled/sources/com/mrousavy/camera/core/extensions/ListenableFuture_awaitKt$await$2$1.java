...
final class ListenableFuture_awaitKt$await$2$1 implements Runnable {
    ...
    public final void run() {
        ...
        try {
            ...
            continuation.resumeWith(Result.m1230constructorimpl(this.$this_await.get()));
        } catch (ExecutionException e) {
            Throwable cause = e.getCause();
            if (cause != null) {
                Continuation<V> continuation2 = this.$continuation;
                Result.Companion companion2 = Result.Companion;
                continuation2.resumeWith(Result.m1230constructorimpl(ResultKt.createFailure(cause)));
                return;
            }
            throw e;
        }
