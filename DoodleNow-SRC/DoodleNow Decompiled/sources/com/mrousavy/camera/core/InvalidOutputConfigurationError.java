...
public final class InvalidOutputConfigurationError extends CameraError {
    public InvalidOutputConfigurationError(Throwable th) {
        super(OutcomeEventsTable.COLUMN_NAME_SESSION, "invalid-output-configuration", "Failed to configure the Camera Session because the output/stream configurations are invalid!", th);
    }
}
