...
public final class CameraNotReadyError extends CameraError {
    public CameraNotReadyError() {
        super(OutcomeEventsTable.COLUMN_NAME_SESSION, "camera-not-ready", "The Camera is not ready yet! Wait for the onInitialized() callback!", (Throwable) null, 8, (DefaultConstructorMarker) null);
    }
}
