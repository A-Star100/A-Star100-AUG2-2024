...
public final class MetadataProvider implements LocationListener {
    ...
    private final boolean getHasLocationPermission() {
        return ContextCompat.checkSelfPermission(this.context, LocationConstants.ANDROID_FINE_LOCATION_PERMISSION_STRING) == 0 || ContextCompat.checkSelfPermission(this.context, LocationConstants.ANDROID_COARSE_LOCATION_PERMISSION_STRING) == 0;
    }
    ...
    public final void enableLocationUpdates(boolean z) {
        if (!z) {
            ...
            this.locationManager.requestLocationUpdates("gps", 5000, 5.0f, this);
