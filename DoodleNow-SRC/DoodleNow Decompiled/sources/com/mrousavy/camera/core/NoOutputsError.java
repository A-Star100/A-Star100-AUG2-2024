...
public final class NoOutputsError extends CameraError {
    public NoOutputsError() {
        super(OutcomeEventsTable.COLUMN_NAME_SESSION, "no-outputs", "Cannot create a CameraCaptureSession without any outputs! (PREVIEW, PHOTO, VIDEO, ...)", (Throwable) null, 8, (DefaultConstructorMarker) null);
    }
}
