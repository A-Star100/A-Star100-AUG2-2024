...
public final class CameraSession_VideoKt {
    public static final void startRecording(CameraSession cameraSession, boolean z, RecordVideoOptions recordVideoOptions, Function1<? super Video, Unit> function1, Function1<? super CameraError, Unit> function12) {
        ...
        if (cameraSession.getCamera$react_native_vision_camera_release() == null) {
            ...
            if (videoOutput$react_native_vision_camera_release != null) {
                File createTempFile = FileUtils.Companion.createTempFile(cameraSession.getContext$react_native_vision_camera_release(), recordVideoOptions.getFileType().toExtension());
                ...
                if (location != null) {
                    ...
                    Log.i(CameraSession.TAG, "Setting Video Location to " + latitude + ", " + longitude + "...");
                ...
                if (z) {
                    ...
                    Intrinsics.checkNotNullExpressionValue(prepareRecording, "withAudioEnabled(...)");
                }
                PendingRecording asPersistentRecording = prepareRecording.asPersistentRecording();
                Intrinsics.checkNotNullExpressionValue(asPersistentRecording, "asPersistentRecording(...)");
                Size attachedSurfaceResolution = videoOutput$react_native_vision_camera_release.getAttachedSurfaceResolution();
                if (attachedSurfaceResolution == null) {
                    attachedSurfaceResolution = new Size(0, 0);
                }
                cameraSession.setRecordingCanceled$react_native_vision_camera_release(false);
                cameraSession.setRecording$react_native_vision_camera_release(asPersistentRecording.start(CameraQueues.Companion.getCameraExecutor(), new CameraSession_VideoKt$$ExternalSyntheticLambda0(cameraSession, function12, createTempFile, attachedSurfaceResolution, function1)));
                return;
            }
    ...
    public static final void startRecording$lambda$2(CameraSession cameraSession, Function1 function1, File file, Size size, Function1 function12, VideoRecordEvent videoRecordEvent) {
        ...
        if (videoRecordEvent instanceof VideoRecordEvent.Start) {
            ...
            Log.i(CameraSession.TAG, "Status update! Recorded " + numBytesRecorded + " bytes.");
            ...
            if (cameraSession.isRecordingCanceled$react_native_vision_camera_release()) {
                ...
                if (path != null) {
                    function12.invoke(new Video(path, recordedDurationNanos, size));
                    return;
                }
