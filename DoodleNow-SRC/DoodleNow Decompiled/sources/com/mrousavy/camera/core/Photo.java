...
public final class Photo {
    ...
    public int hashCode() {
        return (((((((this.path.hashCode() * 31) + this.width) * 31) + this.height) * 31) + this.orientation.hashCode()) * 31) + Video$$ExternalSyntheticBackport0.m(this.isMirrored);
    }
    ...
    public String toString() {
        ...
        return "Photo(path=" + str + ", width=" + i + ", height=" + i2 + ", orientation=" + orientation2 + ", isMirrored=" + z + ")";
    }
