...
public final class CameraDeviceDetails {
    ...
    private final ReadableArray getFormats() {
        ...
        for (DynamicRange supportedQualities : supportedDynamicRanges) {
            List<Quality> supportedQualities2 = this.videoCapabilities.getSupportedQualities(supportedQualities);
            Intrinsics.checkNotNullExpressionValue(supportedQualities2, "getSupportedQualities(...)");
            Iterable<Quality> iterable = supportedQualities2;
            ...
            List<Size> list = (List) arrayList2;
            List<Size> supportedResolutions = this.cameraInfoInternal.getSupportedResolutions(256);
            Intrinsics.checkNotNullExpressionValue(supportedResolutions, "getSupportedResolutions(...)");
            Set<Range<Integer>> supportedFrameRateRanges = this.cameraInfo.getSupportedFrameRateRanges();
            Intrinsics.checkNotNullExpressionValue(supportedFrameRateRanges, "getSupportedFrameRateRanges(...)");
            Iterable iterable2 = supportedFrameRateRanges;
            Iterator it = iterable2.iterator();
            if (it.hasNext()) {
                Comparable comparable = (Integer) ((Range) it.next()).getLower();
                while (it.hasNext()) {
                    Comparable comparable2 = (Integer) ((Range) it.next()).getLower();
                ...
                if (it2.hasNext()) {
                    Comparable comparable3 = (Integer) ((Range) it2.next()).getUpper();
                    while (it2.hasNext()) {
                        Comparable comparable4 = (Integer) ((Range) it2.next()).getUpper();
    ...
    private final boolean getSupports10BitHDR() {
        /*
            r4 = this;
            androidx.camera.video.VideoCapabilities r0 = r4.videoCapabilities
            java.util.Set r0 = r0.getSupportedDynamicRanges()
            java.lang.String r1 = "getSupportedDynamicRanges(...)"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r0, r1)
        ...
        L_0x0020:
            ...
            boolean r3 = r1.is10BitHdr()
            if (r3 != 0) goto L_0x003a
            androidx.camera.core.DynamicRange r3 = androidx.camera.core.DynamicRange.HDR_UNSPECIFIED_10_BIT
        ...
        L_0x003b:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mrousavy.camera.core.CameraDeviceDetails.getSupports10BitHDR():boolean");
    }
        ...
        for (Map.Entry<String, CameraCharacteristics> value : cameraCharacteristicsMap.entrySet()) {
            ...
            if (sizeF == null) {
                ...
                if (fArr == null) {
                    ...
                    } else if (60.0d <= maxFieldOfView2 && maxFieldOfView2 <= 94.0d) {
                        deviceType = DeviceType.WIDE_ANGLE;
    ...
    private final double getMaxFieldOfView(float[] fArr, SizeF sizeF) {
        ...
        return minOrNull != null ? getFieldOfView(minOrNull.floatValue(), sizeF) : AudioStats.AUDIO_AMPLITUDE_NONE;
    }
