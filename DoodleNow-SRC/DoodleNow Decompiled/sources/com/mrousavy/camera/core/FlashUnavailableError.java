...
public final class FlashUnavailableError extends CameraError {
    public FlashUnavailableError() {
        super("device", "flash-unavailable", "The Camera Device does not have a flash unit! Make sure you select a device where `device.hasFlash`/`device.hasTorch` is true.", (Throwable) null, 8, (DefaultConstructorMarker) null);
    }
}
