...
public final class InvalidTypeScriptUnionError extends CameraError {
    ...
    public InvalidTypeScriptUnionError(String str, String str2) {
        super(MediationConfiguration.CUSTOM_EVENT_SERVER_PARAMETER_FIELD, "invalid-parameter", "The given value for " + str + " could not be parsed! (Received: " + str2 + ")", (Throwable) null, 8, (DefaultConstructorMarker) null);
