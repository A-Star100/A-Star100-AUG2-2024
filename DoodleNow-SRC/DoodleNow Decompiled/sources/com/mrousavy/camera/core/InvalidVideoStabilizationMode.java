...
public final class InvalidVideoStabilizationMode extends CameraError {
    ...
    public InvalidVideoStabilizationMode(VideoStabilizationMode videoStabilizationMode) {
        super("format", "invalid-video-stabilization-mode", "The given format does not support the videoStabilizationMode \"" + videoStabilizationMode.getUnionValue() + "\"! Select a format that contains " + videoStabilizationMode.getUnionValue() + " in `format.supportedVideoStabilizationModes`.", (Throwable) null, 8, (DefaultConstructorMarker) null);
