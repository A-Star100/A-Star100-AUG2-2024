...
/* compiled from: CertVerifier */
public class a {
    private static final c a = new c("CertVerifier");
    ...
    private final Set<TrustAnchor> e = new HashSet();
    ...
    static boolean a(X509Certificate x509Certificate) {
        try {
            ...
            if (a(f, digest) || a(g, digest)) {
                return true;
            }
            return false;
        } catch (NoSuchAlgorithmException e2) {
            a.b("Signature algorithm unrecognized", e2);
            return false;
        } catch (CertificateEncodingException e3) {
            a.b("Cant get fingerprint", e3);
            return false;
        }
    }
    ...
    public boolean a(CertPath certPath) {
        try {
            ...
            c cVar2 = a;
            cVar2.b("Failed to verify cert path: " + e2, e2);
            return false;
        }
    }
}
