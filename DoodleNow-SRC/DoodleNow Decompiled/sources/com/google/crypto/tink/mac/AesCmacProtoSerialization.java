...
final class AesCmacProtoSerialization {
    ...
    private static final KeySerializer<AesCmacKey, ProtoKeySerialization> KEY_SERIALIZER = KeySerializer.create(new AesCmacProtoSerialization$$ExternalSyntheticLambda2(), AesCmacKey.class, ProtoKeySerialization.class);
    private static final ParametersParser<ProtoParametersSerialization> PARAMETERS_PARSER;
    private static final ParametersSerializer<AesCmacParameters, ProtoParametersSerialization> PARAMETERS_SERIALIZER = ParametersSerializer.create(new AesCmacProtoSerialization$$ExternalSyntheticLambda0(), AesCmacParameters.class, ProtoParametersSerialization.class);
    ...
    static {
        ...
        PARAMETERS_PARSER = ParametersParser.create(new AesCmacProtoSerialization$$ExternalSyntheticLambda1(), bytesFromPrintableAscii, ProtoParametersSerialization.class);
        KEY_PARSER = KeyParser.create(new AesCmacProtoSerialization$$ExternalSyntheticLambda3(), bytesFromPrintableAscii, ProtoKeySerialization.class);
    }
