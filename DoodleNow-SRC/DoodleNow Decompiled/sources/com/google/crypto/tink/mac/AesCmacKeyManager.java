...
public final class AesCmacKeyManager extends KeyTypeManager<AesCmacKey> {
    private static final PrimitiveConstructor<AesCmacKey, ChunkedMac> CHUNKED_MAC_PRIMITIVE_CONSTRUCTOR = PrimitiveConstructor.create(new AesCmacKeyManager$$ExternalSyntheticLambda0(), AesCmacKey.class, ChunkedMac.class);
