...
final class HmacProtoSerialization {
    ...
    private static final KeySerializer<HmacKey, ProtoKeySerialization> KEY_SERIALIZER = KeySerializer.create(new HmacProtoSerialization$$ExternalSyntheticLambda2(), HmacKey.class, ProtoKeySerialization.class);
    private static final ParametersParser<ProtoParametersSerialization> PARAMETERS_PARSER;
    private static final ParametersSerializer<HmacParameters, ProtoParametersSerialization> PARAMETERS_SERIALIZER = ParametersSerializer.create(new HmacProtoSerialization$$ExternalSyntheticLambda0(), HmacParameters.class, ProtoParametersSerialization.class);
    ...
    static {
        ...
        PARAMETERS_PARSER = ParametersParser.create(new HmacProtoSerialization$$ExternalSyntheticLambda1(), bytesFromPrintableAscii, ProtoParametersSerialization.class);
        KEY_PARSER = KeyParser.create(new HmacProtoSerialization$$ExternalSyntheticLambda3(), bytesFromPrintableAscii, ProtoKeySerialization.class);
    }
