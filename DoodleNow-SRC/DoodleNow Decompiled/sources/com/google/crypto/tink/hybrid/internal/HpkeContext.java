...
final class HpkeContext {
    ...
    static HpkeContext createContext(byte[] bArr, byte[] bArr2, HpkeKem hpkeKem, HpkeKdf hpkeKdf, HpkeAead hpkeAead, byte[] bArr3) throws GeneralSecurityException {
        ...
        return new HpkeContext(bArr, hpkeKdf3.labeledExpand(labeledExtract, bArr6, SubscriberAttributeKt.JSON_NAME_KEY, bArr7, hpkeAead.getKeyLength()), hpkeKdf3.labeledExpand(labeledExtract, bArr6, "base_nonce", bArr7, hpkeAead.getNonceLength()), maxSequenceNumber(hpkeAead.getNonceLength()), hpkeAead);
    }
