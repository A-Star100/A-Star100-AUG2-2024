...
final class XChaCha20Poly1305ProtoSerialization {
    ...
    private static final KeySerializer<XChaCha20Poly1305Key, ProtoKeySerialization> KEY_SERIALIZER = KeySerializer.create(new XChaCha20Poly1305ProtoSerialization$$ExternalSyntheticLambda2(), XChaCha20Poly1305Key.class, ProtoKeySerialization.class);
    private static final ParametersParser<ProtoParametersSerialization> PARAMETERS_PARSER;
    private static final ParametersSerializer<XChaCha20Poly1305Parameters, ProtoParametersSerialization> PARAMETERS_SERIALIZER = ParametersSerializer.create(new XChaCha20Poly1305ProtoSerialization$$ExternalSyntheticLambda0(), XChaCha20Poly1305Parameters.class, ProtoParametersSerialization.class);
    ...
    static {
        ...
        PARAMETERS_PARSER = ParametersParser.create(new XChaCha20Poly1305ProtoSerialization$$ExternalSyntheticLambda1(), bytesFromPrintableAscii, ProtoParametersSerialization.class);
        KEY_PARSER = KeyParser.create(new XChaCha20Poly1305ProtoSerialization$$ExternalSyntheticLambda3(), bytesFromPrintableAscii, ProtoKeySerialization.class);
    }
