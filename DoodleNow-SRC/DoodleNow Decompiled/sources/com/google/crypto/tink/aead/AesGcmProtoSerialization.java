...
final class AesGcmProtoSerialization {
    ...
    private static final KeySerializer<AesGcmKey, ProtoKeySerialization> KEY_SERIALIZER = KeySerializer.create(new AesGcmProtoSerialization$$ExternalSyntheticLambda2(), AesGcmKey.class, ProtoKeySerialization.class);
    private static final ParametersParser<ProtoParametersSerialization> PARAMETERS_PARSER;
    private static final ParametersSerializer<AesGcmParameters, ProtoParametersSerialization> PARAMETERS_SERIALIZER = ParametersSerializer.create(new AesGcmProtoSerialization$$ExternalSyntheticLambda0(), AesGcmParameters.class, ProtoParametersSerialization.class);
    ...
    static {
        ...
        PARAMETERS_PARSER = ParametersParser.create(new AesGcmProtoSerialization$$ExternalSyntheticLambda1(), bytesFromPrintableAscii, ProtoParametersSerialization.class);
        KEY_PARSER = KeyParser.create(new AesGcmProtoSerialization$$ExternalSyntheticLambda3(), bytesFromPrintableAscii, ProtoKeySerialization.class);
    }
