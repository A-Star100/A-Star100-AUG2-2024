...
public final class LegacyProtoKey extends Key {
    ...
    private static class LegacyProtoParametersNotForCreation extends Parameters {
        ...
        /* synthetic */ LegacyProtoParametersNotForCreation(String str, OutputPrefixType outputPrefixType2, AnonymousClass1 r3) {
        ...
        private static String outputPrefixToString(OutputPrefixType outputPrefixType2) {
            int i = AnonymousClass1.$SwitchMap$com$google$crypto$tink$proto$OutputPrefixType[outputPrefixType2.ordinal()];
            if (i == 1) {
                return "TINK";
            }
            if (i == 2) {
