...
final class HkdfPrfProtoSerialization {
    ...
    private static final KeySerializer<HkdfPrfKey, ProtoKeySerialization> KEY_SERIALIZER = KeySerializer.create(new HkdfPrfProtoSerialization$$ExternalSyntheticLambda2(), HkdfPrfKey.class, ProtoKeySerialization.class);
    private static final ParametersParser<ProtoParametersSerialization> PARAMETERS_PARSER;
    private static final ParametersSerializer<HkdfPrfParameters, ProtoParametersSerialization> PARAMETERS_SERIALIZER = ParametersSerializer.create(new HkdfPrfProtoSerialization$$ExternalSyntheticLambda0(), HkdfPrfParameters.class, ProtoParametersSerialization.class);
    ...
    static {
        ...
        PARAMETERS_PARSER = ParametersParser.create(new HkdfPrfProtoSerialization$$ExternalSyntheticLambda1(), bytesFromPrintableAscii, ProtoParametersSerialization.class);
        KEY_PARSER = KeyParser.create(new HkdfPrfProtoSerialization$$ExternalSyntheticLambda3(), bytesFromPrintableAscii, ProtoKeySerialization.class);
    }
