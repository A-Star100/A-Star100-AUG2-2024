...
final class EcdsaProtoSerialization {
    ...
    private static final ParametersSerializer<EcdsaParameters, ProtoParametersSerialization> PARAMETERS_SERIALIZER = ParametersSerializer.create(new EcdsaProtoSerialization$$ExternalSyntheticLambda0(), EcdsaParameters.class, ProtoParametersSerialization.class);
    private static final KeyParser<ProtoKeySerialization> PRIVATE_KEY_PARSER;
    private static final KeySerializer<EcdsaPrivateKey, ProtoKeySerialization> PRIVATE_KEY_SERIALIZER = KeySerializer.create(new EcdsaProtoSerialization$$ExternalSyntheticLambda4(), EcdsaPrivateKey.class, ProtoKeySerialization.class);
    ...
    private static final KeySerializer<EcdsaPublicKey, ProtoKeySerialization> PUBLIC_KEY_SERIALIZER = KeySerializer.create(new EcdsaProtoSerialization$$ExternalSyntheticLambda2(), EcdsaPublicKey.class, ProtoKeySerialization.class);
    ...
    static {
        ...
        PARAMETERS_PARSER = ParametersParser.create(new EcdsaProtoSerialization$$ExternalSyntheticLambda1(), bytesFromPrintableAscii, ProtoParametersSerialization.class);
        PUBLIC_KEY_PARSER = KeyParser.create(new EcdsaProtoSerialization$$ExternalSyntheticLambda3(), bytesFromPrintableAscii2, ProtoKeySerialization.class);
        PRIVATE_KEY_PARSER = KeyParser.create(new EcdsaProtoSerialization$$ExternalSyntheticLambda5(), bytesFromPrintableAscii, ProtoKeySerialization.class);
    }
