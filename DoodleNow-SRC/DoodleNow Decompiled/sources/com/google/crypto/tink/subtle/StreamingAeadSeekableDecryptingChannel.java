...
class StreamingAeadSeekableDecryptingChannel implements SeekableByteChannel {
    ...
    public StreamingAeadSeekableDecryptingChannel(NonceBasedStreamingAead nonceBasedStreamingAead, SeekableByteChannel seekableByteChannel, byte[] bArr) throws IOException, GeneralSecurityException {
        ...
        long m$1 = seekableByteChannel.size();
        this.ciphertextChannelSize = m$1;
        this.aad = Arrays.copyOf(bArr, bArr.length);
        this.isopen = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(seekableByteChannel);
        int i = (int) (m$1 / ((long) ciphertextSegmentSize2));
        int i2 = (int) (m$1 % ((long) ciphertextSegmentSize2));
    ...
    public synchronized String toString() {
        ...
        try {
            str = "position:" + PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(this.ciphertextChannel);
    ...
    private boolean tryLoadSegment(int i) throws IOException {
        ...
        if (i != this.currentSegmentNr) {
            ...
            SeekableByteChannel unused = this.ciphertextChannel.position(j);
    ...
    public synchronized void close() throws IOException {
        PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(this.ciphertextChannel);
        this.isopen = false;
    }
