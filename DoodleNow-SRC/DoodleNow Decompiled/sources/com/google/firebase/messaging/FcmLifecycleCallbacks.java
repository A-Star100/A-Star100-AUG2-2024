...
class FcmLifecycleCallbacks implements Application.ActivityLifecycleCallbacks {
    ...
    public void onActivityCreated(Activity activity, Bundle bundle) {
        ...
        if (intent != null && this.seenIntents.add(intent)) {
            if (Build.VERSION.SDK_INT <= 25) {
                ...
                m964lambda$onActivityCreated$0$comgooglefirebasemessagingFcmLifecycleCallbacks(intent);
            }
        }
    }
    ...
    public void m964lambda$onActivityCreated$0$comgooglefirebasemessagingFcmLifecycleCallbacks(Intent intent) {
        Bundle bundle = null;
        try {
