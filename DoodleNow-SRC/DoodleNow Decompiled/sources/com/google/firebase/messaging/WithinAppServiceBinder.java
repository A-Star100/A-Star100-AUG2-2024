...
class WithinAppServiceBinder extends Binder {
    ...
    public void send(WithinAppServiceConnection.BindRequest bindRequest) {
        if (Binder.getCallingUid() == Process.myUid()) {
            ...
            this.intentHandler.handle(bindRequest.intent).addOnCompleteListener((Executor) new AdIdManager$Api33Ext4Impl$$ExternalSyntheticLambda6(), new WithinAppServiceBinder$$ExternalSyntheticLambda0(bindRequest));
            return;
        }
