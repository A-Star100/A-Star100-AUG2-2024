...
class TopicsSubscriber {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:24:0x0075 A[Catch:{ IOException -> 0x0099 }] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public boolean performTopicOperation(com.google.firebase.messaging.TopicOperation r10) throws java.io.IOException {
        /*
            ...
            r4 = 0
            java.lang.String r5 = r10.getOperation()     // Catch:{ IOException -> 0x0099 }
            int r6 = r5.hashCode()     // Catch:{ IOException -> 0x0099 }
            r7 = 83
            r8 = 1
        ...
        L_0x001b:
            ...
            boolean r5 = r5.equals(r6)     // Catch:{ IOException -> 0x0099 }
        ...
        L_0x0030:
            ...
            boolean r1 = isDebugLogEnabled()     // Catch:{ IOException -> 0x0099 }
            if (r1 == 0) goto L_0x0098
            java.lang.StringBuilder r1 = new java.lang.StringBuilder     // Catch:{ IOException -> 0x0099 }
            r1.<init>(r3)     // Catch:{ IOException -> 0x0099 }
            r1.append(r10)     // Catch:{ IOException -> 0x0099 }
            java.lang.String r10 = "."
            r1.append(r10)     // Catch:{ IOException -> 0x0099 }
            java.lang.String r10 = r1.toString()     // Catch:{ IOException -> 0x0099 }
            android.util.Log.d(r0, r10)     // Catch:{ IOException -> 0x0099 }
            goto L_0x0098
        L_0x0051:
            java.lang.String r2 = r10.getTopic()     // Catch:{ IOException -> 0x0099 }
            r9.blockingUnsubscribeFromTopic(r2)     // Catch:{ IOException -> 0x0099 }
            boolean r2 = isDebugLogEnabled()     // Catch:{ IOException -> 0x0099 }
            if (r2 == 0) goto L_0x0098
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ IOException -> 0x0099 }
            r2.<init>(r1)     // Catch:{ IOException -> 0x0099 }
            java.lang.String r10 = r10.getTopic()     // Catch:{ IOException -> 0x0099 }
            r2.append(r10)     // Catch:{ IOException -> 0x0099 }
            r2.append(r6)     // Catch:{ IOException -> 0x0099 }
            java.lang.String r10 = r2.toString()     // Catch:{ IOException -> 0x0099 }
            android.util.Log.d(r0, r10)     // Catch:{ IOException -> 0x0099 }
            goto L_0x0098
        L_0x0075:
            java.lang.String r1 = r10.getTopic()     // Catch:{ IOException -> 0x0099 }
            r9.blockingSubscribeToTopic(r1)     // Catch:{ IOException -> 0x0099 }
            boolean r1 = isDebugLogEnabled()     // Catch:{ IOException -> 0x0099 }
            if (r1 == 0) goto L_0x0098
            java.lang.StringBuilder r1 = new java.lang.StringBuilder     // Catch:{ IOException -> 0x0099 }
            ...
            java.lang.String r10 = r10.getTopic()     // Catch:{ IOException -> 0x0099 }
            r1.append(r10)     // Catch:{ IOException -> 0x0099 }
            r1.append(r6)     // Catch:{ IOException -> 0x0099 }
            java.lang.String r10 = r1.toString()     // Catch:{ IOException -> 0x0099 }
            android.util.Log.d(r0, r10)     // Catch:{ IOException -> 0x0099 }
        L_0x0098:
            return r8
