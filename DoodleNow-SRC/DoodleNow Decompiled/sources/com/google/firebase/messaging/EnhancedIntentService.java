...
public abstract class EnhancedIntentService extends Service {
    ...
    public /* synthetic */ void m963lambda$processIntent$0$comgooglefirebasemessagingEnhancedIntentService(Intent intent, TaskCompletionSource taskCompletionSource) {
        try {
            handleIntent(intent);
        } finally {
    ...
    public final int onStartCommand(Intent intent, int i, int i2) {
        ...
        processIntent.addOnCompleteListener((Executor) new AdIdManager$Api33Ext4Impl$$ExternalSyntheticLambda6(), (OnCompleteListener<Void>) new EnhancedIntentService$$ExternalSyntheticLambda1(this, intent));
        return 3;
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$onStartCommand$1$com-google-firebase-messaging-EnhancedIntentService  reason: not valid java name */
    public /* synthetic */ void m962lambda$onStartCommand$1$comgooglefirebasemessagingEnhancedIntentService(Intent intent, Task task) {
        finishTask(intent);
    }
