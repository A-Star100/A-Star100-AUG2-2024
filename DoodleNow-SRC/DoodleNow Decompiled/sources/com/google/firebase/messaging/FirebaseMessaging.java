...
public class FirebaseMessaging {
    ...
    public /* synthetic */ void m971lambda$new$1$comgooglefirebasemessagingFirebaseMessaging() {
    ...
    public /* synthetic */ void m972lambda$new$2$comgooglefirebasemessagingFirebaseMessaging(TopicsSubscriber topicsSubscriber) {
        if (isAutoInitEnabled()) {
    ...
    public /* synthetic */ void m973lambda$new$3$comgooglefirebasemessagingFirebaseMessaging() {
    ...
    public /* synthetic */ void m969lambda$getToken$4$comgooglefirebasemessagingFirebaseMessaging(TaskCompletionSource taskCompletionSource) {
        try {
    ...
    public /* synthetic */ void m967lambda$deleteToken$5$comgooglefirebasemessagingFirebaseMessaging(TaskCompletionSource taskCompletionSource) {
        try {
    ...
    public /* synthetic */ void m968lambda$deleteToken$6$comgooglefirebasemessagingFirebaseMessaging(TaskCompletionSource taskCompletionSource) {
        try {
    ...
    public /* synthetic */ Task m965lambda$blockingGetToken$10$comgooglefirebasemessagingFirebaseMessaging(String str, Store.Token token) {
    ...
    public /* synthetic */ Task m966lambda$blockingGetToken$9$comgooglefirebasemessagingFirebaseMessaging(String str, Store.Token token, String str2) throws Exception {
        getStore(this.context).saveToken(getSubtype(), str, str2, this.metadata.getAppVersionCode());
        if (token == null || !str2.equals(token.token)) {
            m970lambda$new$0$comgooglefirebasemessagingFirebaseMessaging(str2);
        }
    ...
    public void m970lambda$new$0$comgooglefirebasemessagingFirebaseMessaging(String str) {
        if (FirebaseApp.DEFAULT_APP_NAME.equals(this.firebaseApp.getName())) {
    ...
    private class AutoInit {
        ...
        public /* synthetic */ void m974lambda$initialize$0$comgooglefirebasemessagingFirebaseMessaging$AutoInit(Event event) {
            if (isEnabled()) {
