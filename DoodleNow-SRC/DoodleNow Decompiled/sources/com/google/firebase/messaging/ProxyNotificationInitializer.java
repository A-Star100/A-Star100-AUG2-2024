...
final class ProxyNotificationInitializer {
    ...
    static /* synthetic */ void lambda$setEnableProxyNotification$0(Context context, boolean z, TaskCompletionSource taskCompletionSource) {
        try {
            ...
            } else if ("com.google.android.gms".equals(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(notificationManager))) {
    ...
    static boolean isProxyNotificationEnabled(Context context) {
        if (!PlatformVersion.isAtLeastQ()) {
            ...
            return false;
        } else if (!"com.google.android.gms".equals(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((NotificationManager) context.getSystemService(NotificationManager.class)))) {
            return false;
        } else {
            if (!Log.isLoggable(Constants.TAG, 3)) {
                return true;
