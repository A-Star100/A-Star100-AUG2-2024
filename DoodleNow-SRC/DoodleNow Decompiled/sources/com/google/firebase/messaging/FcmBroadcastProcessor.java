...
public class FcmBroadcastProcessor {
    ...
    static /* synthetic */ Task lambda$startMessagingService$2(Context context2, Intent intent, boolean z, Task task) throws Exception {
        return (!PlatformVersion.isAtLeastO() || ((Integer) task.getResult()).intValue() != 402) ? task : bindToMessagingService(context2, intent, z).continueWith(new AdIdManager$Api33Ext4Impl$$ExternalSyntheticLambda6(), new FcmBroadcastProcessor$$ExternalSyntheticLambda2());
    }
    ...
    private static Task<Integer> bindToMessagingService(Context context2, Intent intent, boolean z) {
        ...
        if (!z) {
            return serviceConnection.sendIntent(intent).continueWith(new AdIdManager$Api33Ext4Impl$$ExternalSyntheticLambda6(), new FcmBroadcastProcessor$$ExternalSyntheticLambda3());
        }
