...
public final /* synthetic */ class DelegatingScheduledExecutorService$$ExternalSyntheticLambda9 implements DelegatingScheduledFuture.Resolver {
    ...
    public final ScheduledFuture addCompleter(DelegatingScheduledFuture.Completer completer) {
        return this.f$0.m953lambda$scheduleAtFixedRate$8$comgooglefirebaseconcurrentDelegatingScheduledExecutorService(this.f$1, this.f$2, this.f$3, this.f$4, completer);
    }
}
