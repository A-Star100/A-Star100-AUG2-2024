...
public class DefaultClusterRenderer<T extends ClusterItem> implements ClusterRenderer<T> {
    ...
    public void onAdd() {
        ...
        this.mClusterManager.getMarkerCollection().setOnInfoWindowLongClickListener(new DefaultClusterRenderer$$ExternalSyntheticLambda0(this));
        this.mClusterManager.getClusterMarkerCollection().setOnMarkerClickListener(new DefaultClusterRenderer$$ExternalSyntheticLambda1(this));
        this.mClusterManager.getClusterMarkerCollection().setOnInfoWindowClickListener(new DefaultClusterRenderer$$ExternalSyntheticLambda2(this));
        this.mClusterManager.getClusterMarkerCollection().setOnInfoWindowLongClickListener(new DefaultClusterRenderer$$ExternalSyntheticLambda3(this));
    }
    ...
    public /* synthetic */ void m984lambda$onAdd$0$comgooglemapsandroidclusteringviewDefaultClusterRenderer(Marker marker) {
    ...
    public /* synthetic */ boolean m985lambda$onAdd$1$comgooglemapsandroidclusteringviewDefaultClusterRenderer(Marker marker) {
    ...
    public /* synthetic */ void m986lambda$onAdd$2$comgooglemapsandroidclusteringviewDefaultClusterRenderer(Marker marker) {
    ...
    public /* synthetic */ void m987lambda$onAdd$3$comgooglemapsandroidclusteringviewDefaultClusterRenderer(Marker marker) {
    ...
    private class ViewModifier extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            if (!this.mViewModificationInProgress && this.mNextClusters != null) {
                ...
                renderTask.setCallback(new DefaultClusterRenderer$ViewModifier$$ExternalSyntheticLambda0(this));
        ...
        public /* synthetic */ void m988lambda$handleMessage$0$comgooglemapsandroidclusteringviewDefaultClusterRenderer$ViewModifier() {
            sendEmptyMessage(1);
        }
    ...
    private class RenderTask implements Runnable {
        ...
        public void run() {
            ...
            float access$800 = f - DefaultClusterRenderer.this.mZoom;
            Set<MarkerWithPosition> access$1200 = DefaultClusterRenderer.this.mMarkers;
            try {
            ...
            for (Cluster cluster2 : this.clusters) {
                ...
                if (!z || !contains || !DefaultClusterRenderer.this.mAnimate) {
                    ...
                    Point access$1400 = DefaultClusterRenderer.this.findClosestCluster(arrayList, this.mSphericalMercatorProjection.toPoint(cluster2.getPosition()));
                    if (access$1400 != null) {
            ...
            for (MarkerWithPosition markerWithPosition : access$1200) {
                ...
                if (z || access$800 <= -3.0f || !contains2 || !DefaultClusterRenderer.this.mAnimate) {
                    markerModifier.remove(contains2, markerWithPosition.marker);
                } else {
                    Point access$14002 = DefaultClusterRenderer.this.findClosestCluster(arrayList2, this.mSphericalMercatorProjection.toPoint(markerWithPosition.position));
