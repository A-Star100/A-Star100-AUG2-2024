...
public class NonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> extends AbstractAlgorithm<T> {
    ...
    private final PointQuadTree<QuadItem<T>> mQuadTree = new PointQuadTree(AudioStats.AUDIO_AMPLITUDE_NONE, 1.0d, AudioStats.AUDIO_AMPLITUDE_NONE, 1.0d);
            ...
            while (it.hasNext()) {
                ...
                if (!hashSet.contains(next)) {
                    ...
                    if (search.size() == 1) {
                        hashSet2.add(next);
                        hashSet.add(next);
                        hashMap.put(next, Double.valueOf(AudioStats.AUDIO_AMPLITUDE_NONE));
                    } else {
