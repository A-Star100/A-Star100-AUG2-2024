...
public final class CacheStats {
    ...
    public double missRate() {
        long requestCount = requestCount();
        return requestCount == 0 ? AudioStats.AUDIO_AMPLITUDE_NONE : ((double) this.missCount) / ((double) requestCount);
    }
    ...
    public double loadExceptionRate() {
        ...
        return saturatedAdd == 0 ? AudioStats.AUDIO_AMPLITUDE_NONE : ((double) this.loadExceptionCount) / ((double) saturatedAdd);
    }

    public double averageLoadPenalty() {
        long saturatedAdd = LongMath.saturatedAdd(this.loadSuccessCount, this.loadExceptionCount);
        return saturatedAdd == 0 ? AudioStats.AUDIO_AMPLITUDE_NONE : ((double) this.totalLoadTime) / ((double) saturatedAdd);
    }
