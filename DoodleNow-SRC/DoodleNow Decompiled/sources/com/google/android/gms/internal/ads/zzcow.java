    ...
    public final void zza(Map map) {
        if (this.zza != null) {
            if (((String) map.get("clear")) != null) {
                String str = (String) zzba.zzc().zza(zzbdz.zzaN);
                ...
                if (cookie != null) {
                    ...
                    while (i < zzf.size()) {
                        ...
                        it.getClass();
                        if (it.hasNext()) {
                            cookieManager.setCookie(str, String.valueOf((String) it.next()).concat(String.valueOf((String) zzba.zzc().zza(zzbdz.zzax))));
                            i++;
                        } else {
            ...
            if (!TextUtils.isEmpty(str2)) {
                this.zza.setCookie((String) zzba.zzc().zza(zzbdz.zzaN), str2);
            }
        }
    }
}
