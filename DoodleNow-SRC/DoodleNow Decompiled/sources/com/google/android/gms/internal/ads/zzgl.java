...
public final class zzgl {
    ...
    public static zzgi zzc(byte[] bArr, int i, int i2) {
        ...
        int i10;
        int i11;
        zzgm zzgm = new zzgm(bArr, i, i2);
        int i12 = 4;
        zzgm.zze(4);
        int zza2 = zzgm.zza(3);
        zzgm.zzd();
        int zza3 = zzgm.zza(2);
        boolean zzf = zzgm.zzf();
        int zza4 = zzgm.zza(5);
        int i13 = 0;
        ...
        int zzc11 = zzgm.zzc();
        int zzc12 = zzgm.zzc();
        for (int i24 = true != zzgm.zzf() ? zza2 : 0; i24 <= zza2; i24++) {
            zzgm.zzc();
            zzgm.zzc();
            zzgm.zzc();
        }
        ...
        while (i28 < zzc13) {
            if (i28 == 0 || !zzgm.zzf()) {
                ...
                int i32 = 0;
                while (i32 < zzc14) {
                    iArr5[i32] = (i32 > 0 ? iArr5[i32 - 1] : 0) - (zzgm.zzc() + 1);
                    zzgm.zzd();
                    i32++;
                }
                ...
                int i33 = 0;
                while (i33 < zzc15) {
                    iArr6[i33] = (i33 > 0 ? iArr6[i33 - 1] : 0) + zzgm.zzc() + 1;
                    zzgm.zzd();
                    i33++;
                }
                i31 = zzc15;
                ...
                int i34 = i30 + i31;
                boolean zzf2 = zzgm.zzf();
                int zzc16 = zzgm.zzc() + 1;
        ...
        if (zzgm.zzf()) {
            if (zzgm.zzf()) {
                int zza6 = zzgm.zza(8);
                if (zza6 == 255) {
                    int zza7 = zzgm.zza(16);
                    int zza8 = zzgm.zza(16);
                    if (!(zza7 == 0 || zza8 == 0)) {
                    ...
                    zzfe.zzf("NalUnitUtil", "Unexpected aspect_ratio_idc value: " + zza6);
                }
            }
            if (zzgm.zzf()) {
                zzgm.zzd();
        ...
        return new zzgi(zza3, zzf, zza4, i50, i51, zzc10, zzc11, iArr9, zza5, zzc2, i23, i5, f, i4, i29, i3);
    }

    public static zzgj zzd(byte[] bArr, int i, int i2) {
        zzgm zzgm = new zzgm(bArr, 4, i2);
        int zzc2 = zzgm.zzc();
        int zzc3 = zzgm.zzc();
        zzgm.zzd();
        return new zzgj(zzc2, zzc3, zzgm.zzf());
    }
    ...
    public static com.google.android.gms.internal.ads.zzgk zze(byte[] r26, int r27, int r28) {
        /*
            com.google.android.gms.internal.ads.zzgm r0 = new com.google.android.gms.internal.ads.zzgm
            r1 = r26
            r2 = r27
            r3 = r28
            r0.<init>(r1, r2, r3)
        ...
        L_0x017b:
            ...
            com.google.android.gms.internal.ads.zzfe.zzf(r4, r3)
        L_0x018e:
        ...
        L_0x01df:
            com.google.android.gms.internal.ads.zzgk r23 = new com.google.android.gms.internal.ads.zzgk
            r3 = r23
            r4 = r2
            r5 = r15
            r15 = r20
