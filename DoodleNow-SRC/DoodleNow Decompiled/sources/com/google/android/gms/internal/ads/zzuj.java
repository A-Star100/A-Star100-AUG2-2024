...
public final class zzuj implements zzvz {
    ...
    public zzuj(zzadm zzadm) {
        this.zza = zzadm;
    }

    public final long zzb() {
        zzadg zzadg = this.zzc;
        if (zzadg != null) {
            return zzadg.zzf();
        }
        return -1;
    ...
    public final void zzc() {
        ...
        if (zzadf != null && (zzadf instanceof zzais)) {
            ((zzais) zzadf).zza();
        }
    }
    ...
    public final int zza(zzaec zzaec) throws IOException {
        zzadf zzadf = this.zzb;
        zzadf.getClass();
        zzadg zzadg = this.zzc;
        zzadg.getClass();
        return zzadf.zzb(zzadg, zzaec);
    }
}
