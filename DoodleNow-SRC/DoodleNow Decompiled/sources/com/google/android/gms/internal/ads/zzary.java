...
public abstract class zzary implements zzarz {
    ...
    public final zzasc zzb(zzhih zzhih, zzasd zzasd) throws IOException {
        int zza2;
        long j;
        long zzb2 = zzhih.zzb();
        ((ByteBuffer) this.zza.get()).rewind().limit(8);
        do {
            zza2 = zzhih.zza((ByteBuffer) this.zza.get());
            if (zza2 == 8) {
                ...
                if (zze >= 8 || zze <= 1) {
                    ...
                    try {
                        ...
                        if (zze == 1) {
                            ...
                            zzhih.zza((ByteBuffer) this.zza.get());
                            ((ByteBuffer) this.zza.get()).position(8);
                            j = zzasb.zzf((ByteBuffer) this.zza.get()) - 16;
                        } else {
                            j = zze == 0 ? zzhih.zzc() - zzhih.zzb() : zze - 8;
                        }
                        if ("uuid".equals(str)) {
                        ...
                        long j2 = j;
                        zzasc zza3 = zza(str, bArr, zzasd instanceof zzasc ? ((zzasc) zzasd).zza() : "");
                        zza3.zzc(zzasd);
                        ((ByteBuffer) this.zza.get()).rewind();
                        zza3.zzb(zzhih, (ByteBuffer) this.zza.get(), j2, this);
                        return zza3;
