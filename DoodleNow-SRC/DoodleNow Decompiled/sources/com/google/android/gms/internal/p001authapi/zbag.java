...
public final class zbag extends GoogleApi implements CredentialSavingClient {
    ...
    static {
        ...
        zbad zbad = new zbad();
        zbb = zbad;
        zbc = new Api("Auth.Api.Identity.CredentialSaving.API", zbad, clientKey);
    }

    public zbag(Activity activity, zbh zbh) {
    ...
    public final Task<SaveAccountLinkingTokenResult> saveAccountLinkingToken(SaveAccountLinkingTokenRequest saveAccountLinkingTokenRequest) {
        ...
        return doRead(TaskApiCall.builder().setFeatures(zbas.zbg).run(new zbab(this, build)).setAutoResolveMissingFeatures(false).setMethodKey(1535).build());
    }
    ...
    public final Task<SavePasswordResult> savePassword(SavePasswordRequest savePasswordRequest) {
        ...
        return doRead(TaskApiCall.builder().setFeatures(zbas.zbe).run(new zbac(this, build)).setAutoResolveMissingFeatures(false).setMethodKey(1536).build());
    }

    public zbag(Context context, zbh zbh) {
