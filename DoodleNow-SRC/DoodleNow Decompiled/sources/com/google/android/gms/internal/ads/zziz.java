...
public final class zziz extends zzce {
    ...
    private zziz(int i, Throwable th, int i2) {
        this(i, th, (String) null, i2, (String) null, -1, (zzam) null, 4, false);
    }

    public static zziz zzb(Throwable th, String str, int i, zzam zzam, int i2, boolean z, int i3) {
        return new zziz(1, th, (String) null, i3, str, i, zzam, zzam == null ? 4 : i2, z);
    }
    ...
    public final zziz zza(zzvh zzvh) {
        String message = getMessage();
        int i = zzfx.zza;
        return new zziz(message, getCause(), this.zzb, this.zze, this.zzf, this.zzg, this.zzh, this.zzi, zzvh, this.zzc, this.zzk);
    }
    ...
    private zziz(String str, Throwable th, int i, int i2, String str2, int i3, zzam zzam, int i4, zzvh zzvh, long j, boolean z) {
        super(str, th, i, j);
        boolean z2;
        int i5;
        boolean z3 = z;
