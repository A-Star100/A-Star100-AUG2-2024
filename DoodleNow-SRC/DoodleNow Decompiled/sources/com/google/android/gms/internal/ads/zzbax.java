...
public final class zzbax extends Thread {
    ...
    public zzbax() {
        ...
        this.zzj = ((Integer) zzba.zzc().zza(zzbdz.zzS)).intValue();
        this.zzk = ((Integer) zzba.zzc().zza(zzbdz.zzT)).intValue();
        this.zzl = ((Integer) zzba.zzc().zza(zzbdz.zzU)).intValue();
        this.zze = ((Long) zzbfl.zzf.zze()).intValue();
        this.zzm = (String) zzba.zzc().zza(zzbdz.zzW);
        this.zzn = ((Boolean) zzba.zzc().zza(zzbdz.zzX)).booleanValue();
        this.zzo = ((Boolean) zzba.zzc().zza(zzbdz.zzY)).booleanValue();
        this.zzp = ((Boolean) zzba.zzc().zza(zzbdz.zzZ)).booleanValue();
    ...
    public final void run() {
        /*
            r6 = this;
        L_0x0000:
            com.google.android.gms.internal.ads.zzbas r0 = com.google.android.gms.ads.internal.zzu.zzb()     // Catch:{ all -> 0x00a8 }
        ...
        L_0x002a:
            ...
            if (r0 == 0) goto L_0x00b2
            com.google.android.gms.internal.ads.zzbas r0 = com.google.android.gms.ads.internal.zzu.zzb()     // Catch:{ InterruptedException -> 0x00d3, Exception -> 0x00c3 }
        ...
        L_0x008e:
            r0 = move-exception
            com.google.android.gms.internal.ads.zzcbh r2 = com.google.android.gms.ads.internal.zzu.zzo()     // Catch:{ InterruptedException -> 0x00d3, Exception -> 0x00c3 }
        ...
        L_0x009d:
            ...
            com.google.android.gms.internal.ads.zzbat r0 = new com.google.android.gms.internal.ads.zzbat     // Catch:{ InterruptedException -> 0x00d3, Exception -> 0x00c3 }
        ...
        L_0x00a8:
            r0 = move-exception
            com.google.android.gms.internal.ads.zzcbh r1 = com.google.android.gms.ads.internal.zzu.zzo()     // Catch:{ InterruptedException -> 0x00d3, Exception -> 0x00c3 }
    ...
    public final zzbaw zzb(View view, zzban zzban) {
        if (view != null) {
            boolean globalVisibleRect = view.getGlobalVisibleRect(new Rect());
            if ((view instanceof TextView) && !(view instanceof EditText)) {
                CharSequence text = ((TextView) view).getText();
                if (!TextUtils.isEmpty(text)) {
                    zzban.zzk(text.toString(), globalVisibleRect, view.getX(), view.getY(), (float) view.getWidth(), (float) view.getHeight());
                ...
                if (PlatformVersion.isAtLeastKitKat()) {
                    zzban.zzh();
                    webView.post(new zzbav(this, zzban, webView, globalVisibleRect));
                ...
                for (int i3 = 0; i3 < viewGroup.getChildCount(); i3++) {
                    zzbaw zzb2 = zzb(viewGroup.getChildAt(i3), zzban);
                    i += zzb2.zza;
                    i2 += zzb2.zzb;
                }
    ...
    public final void zzc(android.view.View r11) {
        /*
            r10 = this;
            com.google.android.gms.internal.ads.zzban r9 = new com.google.android.gms.internal.ads.zzban     // Catch:{ Exception -> 0x007e }
            ...
            com.google.android.gms.internal.ads.zzbas r0 = com.google.android.gms.ads.internal.zzu.zzb()     // Catch:{ Exception -> 0x007e }
            ...
            com.google.android.gms.internal.ads.zzbdq r2 = com.google.android.gms.internal.ads.zzbdz.zzV     // Catch:{ Exception -> 0x007e }
            com.google.android.gms.internal.ads.zzbdx r3 = com.google.android.gms.ads.internal.client.zzba.zzc()     // Catch:{ Exception -> 0x007e }
        ...
        L_0x0052:
            com.google.android.gms.internal.ads.zzbaw r11 = r10.zzb(r11, r9)     // Catch:{ Exception -> 0x007e }
        ...
        L_0x006e:
            com.google.android.gms.internal.ads.zzbao r11 = r10.zzd     // Catch:{ Exception -> 0x007e }
    ...
    /* access modifiers changed from: package-private */
    public final void zzd(zzban zzban, WebView webView, String str, boolean z) {
        zzban.zzg();
        try {
            if (!TextUtils.isEmpty(str)) {
                String optString = new JSONObject(str).optString("text");
                if (this.zzn || TextUtils.isEmpty(webView.getTitle())) {
                    zzban.zzl(optString, z, webView.getX(), webView.getY(), (float) webView.getWidth(), (float) webView.getHeight());
                } else {
