...
public final class zzdjv implements zzdlg {
    ...
    public final zzczi zzg;
    /* access modifiers changed from: private */
    public final zzcyo zzh;
    /* access modifiers changed from: private */
    public final zzdgl zzi;
    ...
    public zzdjv(Context context, zzdlj zzdlj, JSONObject jSONObject, zzdpx zzdpx, zzdky zzdky, zzawo zzawo, zzczi zzczi, zzcyo zzcyo, zzdgl zzdgl, zzffn zzffn, VersionInfoParcel versionInfoParcel, zzfgi zzfgi, zzcqh zzcqh, zzdmc zzdmc, Clock clock, zzdgh zzdgh, zzfmt zzfmt, zzflh zzflh, zzefo zzefo, zzdrn zzdrn) {
        this.zza = context;
        this.zzb = zzdlj;
        this.zzc = jSONObject;
        this.zzd = zzdpx;
    ...
    private final boolean zzH(JSONObject jSONObject, JSONObject jSONObject2, JSONObject jSONObject3, JSONObject jSONObject4, String str, JSONObject jSONObject5, boolean z) {
        try {
            ...
            if (((Boolean) zzba.zzc().zza(zzbdz.zziy)).booleanValue()) {
                this.zzd.zzl("/clickRecorded", new zzdjs(this, (zzdjr) null));
            } else {
                this.zzd.zzl("/logScionEvent", new zzdjq(this, (zzdjp) null));
            }
            this.zzd.zzl("/nativeImpression", new zzdju(this, (zzdjt) null));
    ...
    public final void zzk(View view, View view2, Map map, Map map2, boolean z, ImageView.ScaleType scaleType) {
        ...
        zzn(true == ((Boolean) zzba.zzc().zza(zzbdz.zzdz)).booleanValue() ? view3 : view4, zzg2, zzd2, zzf2, zze2, zzE, zzbz.zzc(zzE, context, this.zzz, this.zzy), (JSONObject) null, z, false);
    }
    ...
    public final void zzn(View view, JSONObject jSONObject, JSONObject jSONObject2, JSONObject jSONObject3, JSONObject jSONObject4, String str, JSONObject jSONObject5, JSONObject jSONObject6, boolean z, boolean z2) {
        ...
        try {
            ...
            zzbgt zzbgt = this.zzl.zzi;
            jSONObject8.put("custom_mute_requested", zzbgt != null && zzbgt.zzg);
            ...
            if (((Boolean) zzba.zzc().zza(zzbdz.zzeB)).booleanValue()) {
                jSONObject8.put("open_chrome_custom_tab", true);
            }
            if (((Boolean) zzba.zzc().zza(zzbdz.zziC)).booleanValue() && PlatformVersion.isAtLeastR()) {
                jSONObject8.put("try_fallback_for_deep_link", true);
            }
            if (((Boolean) zzba.zzc().zza(zzbdz.zziD)).booleanValue() && PlatformVersion.isAtLeastR()) {
    ...
    public final void zzu(View view) {
        ...
        zzdmc zzdmc = this.zzn;
        if (view != null) {
            view.setOnClickListener(zzdmc);
            view.setClickable(true);
            zzdmc.zzc = new WeakReference(view);
        }
    }
        ...
        try {
            if (!this.zzw) {
                if (zzcw == null) {
                    ...
                    if (zzdky.zzk() != null) {
                        this.zzw = true;
                        this.zzq.zzc(zzdky.zzk().zzf(), this.zzs);
                        zzg();
                        return;
                    }
                }
