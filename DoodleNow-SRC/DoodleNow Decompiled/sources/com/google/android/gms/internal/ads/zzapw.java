...
public final class zzapw {
                                            ...
                                            while (slice.hasRemaining()) {
                                                ...
                                                if (slice.remaining() >= 8) {
                                                    ...
                                                    if (i3 > slice.remaining()) {
                                                        ...
                                                        long j7 = j2;
                                                        X509Certificate[][] zzl = zzl(randomAccessFile.getChannel(), new zzaps(zze(slice, i3 - 4), longValue2, zza, j2, byteBuffer2, (zzapr) null));
    ...
    private static void zzh(Map map, FileChannel fileChannel, long j, long j2, long j3, ByteBuffer byteBuffer) throws SecurityException {
        if (!map.isEmpty()) {
            zzapq zzapq = new zzapq(fileChannel, 0, j);
            zzapq zzapq2 = new zzapq(fileChannel, j2, j3 - j2);
            ByteBuffer duplicate = byteBuffer.duplicate();
            duplicate.order(ByteOrder.LITTLE_ENDIAN);
            long j4 = j;
            zzapx.zzd(duplicate, j);
            zzapo zzapo = new zzapo(duplicate);
            int size = map.size();
            ...
            try {
                byte[][] zzk = zzk(iArr, new zzapp[]{zzapq, zzapq2, zzapo});
                while (i < size) {
                    int i3 = iArr[i];
                    Map map2 = map;
                    ...
                    if (arrayList.equals(arrayList2)) {
                        ...
                        if (bArr3 == null || MessageDigest.isEqual(bArr3, bArr)) {
                            ...
                            while (zzf6.hasRemaining()) {
                                ...
                                byte[] zzi2 = zzi(zzf6);
                                try {
                                    arrayList3.add(new zzapu((X509Certificate) certificateFactory.generateCertificate(new ByteArrayInputStream(zzi2)), zzi2));
    ...
    private static byte[][] zzk(int[] iArr, zzapp[] zzappArr) throws DigestException {
        long j;
        int i;
        int length;
        int[] iArr2 = iArr;
        ...
        while (true) {
            ...
            j3 += (zzappArr[i3].zza() + 1048575) / 1048576;
            i3++;
        }
        if (j3 < 2097151) {
            ...
            for (i = 3; i7 < i; i = 3) {
                ...
                while (zza > j2) {
                    ...
                    long j5 = j4;
                    try {
                        zzapp.zzb(messageDigestArr, j5, min);
                        byte[] bArr4 = bArr3;
                        int i10 = 0;
    ...
    private static X509Certificate[][] zzl(FileChannel fileChannel, zzaps zzaps) throws SecurityException {
        HashMap hashMap = new HashMap();
        ArrayList arrayList = new ArrayList();
        try {
            CertificateFactory instance = CertificateFactory.getInstance("X.509");
            try {
                ByteBuffer zzf = zzf(zzaps.zza);
                int i = 0;
                ...
                if (i <= 0) {
                    ...
                    zzh(hashMap, fileChannel, zzaps.zzb, zzaps.zzc, zzaps.zzd, zzaps.zze);
