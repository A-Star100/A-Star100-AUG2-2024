...
public final class zzacy implements zzadm {
    ...
    private static final zzacx zzc = new zzacx(zzacu.zza);
    private static final zzacx zzd = new zzacx(zzacv.zza);
    private zzfzn zze;
    ...
    public final synchronized com.google.android.gms.internal.ads.zzadf[] zza(android.net.Uri r25, java.util.Map r26) {
        ...
        L_0x0045:
            ...
            goto L_0x01de
        L_0x0048:
            java.lang.String r3 = com.google.android.gms.internal.ads.zzcb.zze(r3)     // Catch:{ all -> 0x03bf }
        ...
        L_0x03a5:
            ...
            com.google.android.gms.internal.ads.zzadf[] r2 = new com.google.android.gms.internal.ads.zzadf[r2]     // Catch:{ all -> 0x03bf }
            r4 = 0
        L_0x03ac:
            int r3 = r0.size()     // Catch:{ all -> 0x03bf }
            if (r4 >= r3) goto L_0x03bd
            java.lang.Object r3 = r0.get(r4)     // Catch:{ all -> 0x03bf }
            com.google.android.gms.internal.ads.zzadf r3 = (com.google.android.gms.internal.ads.zzadf) r3     // Catch:{ all -> 0x03bf }
    ...
    private final void zzb(int i, List list) {
        switch (i) {
            ...
            case 11:
                ...
                list.add(new zzaow(1, 1, this.zzf, new zzfv(0), new zzanl(0, this.zze), TsExtractor.DEFAULT_TIMESTAMP_SEARCH_BYTES));
                return;
            case 12:
                list.add(new zzapi());
                return;
