...
public final class zzamm implements zzalh {
    ...
    public zzamm(List list) {
        ...
        if (size == 1 && (((byte[]) list.get(0)).length == 48 || ((byte[]) list.get(0)).length == 53)) {
            ...
            this.zze = true == "Serif".equals(zzfx.zzB(bArr, 43, bArr.length + -43)) ? C.SERIF_NAME : str;
    ...
    private static void zzc(android.text.SpannableStringBuilder r4, int r5, int r6, int r7, int r8, int r9) {
        ...
        L_0x0047:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzamm.zzc(android.text.SpannableStringBuilder, int, int, int, int, int):void");
    }
    ...
    public final void zza(byte[] bArr, int i, int i2, zzalg zzalg, zzep zzep) {
        ...
        if (zzq == 0) {
            ...
            int zzd2 = zzfo.zzd();
            Charset zzB = zzfo.zzB();
            int zzd3 = zzfo.zzd() - zzd2;
            if (zzB == null) {
                zzB = zzfwd.zzc;
            }
            str = zzfo.zzA(zzq - zzd3, zzB);
        }
        if (str.isEmpty()) {
            zzep2.zza(new zzakz(zzfzn.zzm(), C.TIME_UNSET, C.TIME_UNSET));
            return;
        }
        ...
        while (true) {
            ...
            if (zzfo2.zzb() >= 8) {
                ...
                if (zzg3 == 1937013100) {
                    zzek.zzd(this.zza.zzb() >= i7 ? z : z2);
                    int zzq2 = this.zza.zzq();
                    int i8 = z2;
                    while (i8 < zzq2) {
                        zzfo zzfo3 = this.zza;
                        zzek.zzd(zzfo3.zzb() >= 12 ? z : z2);
                        int zzq3 = zzfo3.zzq();
                        int zzq4 = zzfo3.zzq();
                        zzfo3.zzL(i7);
                        int zzm = zzfo3.zzm();
                        ...
                        if (zzq3 >= i5) {
                            zzfe.zzf("Tx3gParser", "Ignoring styl with start (" + zzq3 + ") >= end (" + i5 + ").");
                        } else {
                ...
                zzea.zze(f, 0);
                zzea.zzf(0);
                zzep2.zza(new zzakz(zzfzn.zzn(zzea.zzp()), C.TIME_UNSET, C.TIME_UNSET));
                return;
            }
        }
    }
