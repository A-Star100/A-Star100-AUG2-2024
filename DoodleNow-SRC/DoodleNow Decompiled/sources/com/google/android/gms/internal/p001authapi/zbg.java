...
public final class zbg extends GmsClient {
    ...
    public zbg(Context context, Looper looper, zbc zbc, ClientSettings clientSettings, ConnectionCallbacks connectionCallbacks, OnConnectionFailedListener onConnectionFailedListener) {
