...
public final class zzbbh {
    ...
    public static void zzc(String[] strArr, int i, int i2, PriorityQueue priorityQueue) {
        ...
        while (true) {
            ...
            if (i3 < length2 - 5) {
                ...
                zze = ((((((zze + 1073807359) - ((zza(16785407, 5) * ((((long) zzbbd.zza(strArr2[i3 - 1])) + 2147483647L) % 1073807359)) % 1073807359)) % 1073807359) * 16785407) % 1073807359) + ((((long) zzbbd.zza(strArr2[i3 + 5])) + 2147483647L) % 1073807359)) % 1073807359;
    ...
    static void zzd(int i, long j, String str, int i2, PriorityQueue priorityQueue) {
        zzbbg zzbbg = new zzbbg(j, str, i2);
        if ((priorityQueue.size() != i || (((zzbbg) priorityQueue.peek()).zzc <= zzbbg.zzc && ((zzbbg) priorityQueue.peek()).zza <= zzbbg.zza)) && !priorityQueue.contains(zzbbg)) {
            priorityQueue.add(zzbbg);
    ...
    private static long zze(String[] strArr, int i, int i2) {
        long zza = (((long) zzbbd.zza(strArr[0])) + 2147483647L) % 1073807359;
        for (int i3 = 1; i3 < i2; i3++) {
            zza = (((zza * 16785407) % 1073807359) + ((((long) zzbbd.zza(strArr[i3])) + 2147483647L) % 1073807359)) % 1073807359;
        }
        return zza;
    }
}
