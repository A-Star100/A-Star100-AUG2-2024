...
public final class zzcbb {
    ...
    public zzcbb(String str, long j) {
        ...
        if (!TextUtils.isEmpty(str)) {
            try {
                ...
                if (((Boolean) zzba.zzc().zza(zzbdz.zzlr)).booleanValue() && zzj()) {
                    return;
                }
                        ...
                        if (!TextUtils.isEmpty(optString)) {
                            if (!TextUtils.isEmpty(optString2)) {
                                if ("interstitial".equalsIgnoreCase(optString)) {
                                    ...
                                    this.zzc.put(optString2, new zzbqi(optJSONObject2));
                                }
                            }
                        }
                    }
                ...
                if (((Boolean) zzba.zzc().zza(zzbdz.zzgs)).booleanValue() && (optJSONObject = this.zzg.optJSONObject("common_settings")) != null) {
    ...
    public final boolean zzj() {
        if (!TextUtils.isEmpty(this.zze) && this.zzg != null) {
            long longValue = ((Long) zzba.zzc().zza(zzbdz.zzlu)).longValue();
            if (((Boolean) zzba.zzc().zza(zzbdz.zzlt)).booleanValue() && !TextUtils.isEmpty(this.zze)) {
                longValue = this.zzg.optLong("cache_ttl_sec", ((Long) zzba.zzc().zza(zzbdz.zzlu)).longValue());
            }
