...
public final class zzdma implements GestureDetector.OnGestureListener {
    ...
    public final synchronized boolean onFling(android.view.MotionEvent r6, android.view.MotionEvent r7, float r8, float r9) {
        /*
            r5 = this;
            monitor-enter(r5)
            com.google.android.gms.internal.ads.zzdkt r0 = r5.zza     // Catch:{ all -> 0x0079 }
            r1 = 0
        ...
        L_0x0061:
            r6 = r1
        L_0x0062:
            com.google.android.gms.internal.ads.zzdkt r7 = r5.zza     // Catch:{ all -> 0x0079 }
            int r7 = r7.zza()     // Catch:{ all -> 0x0079 }
            if (r2 != r7) goto L_0x0077
            com.google.android.gms.internal.ads.zzdkt r7 = r5.zza     // Catch:{ all -> 0x0079 }
            com.google.android.gms.internal.ads.zzdlu r8 = r5.zzb     // Catch:{ all -> 0x0079 }
            android.widget.FrameLayout r8 = r8.zzr()     // Catch:{ all -> 0x0079 }
            r7.zzD(r8, r6)     // Catch:{ all -> 0x0079 }
            monitor-exit(r5)
            return r1
        L_0x0077:
            monitor-exit(r5)
