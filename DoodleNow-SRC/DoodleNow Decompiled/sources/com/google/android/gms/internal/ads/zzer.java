...
public final class zzer implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public zzer(Handler handler, zzeq zzeq) {
        this.zzb = handler;
    }
    ...
    public final void zzb(int i) throws zzes {
        ...
        zzet.zza(eglChooseConfig && iArr2[0] > 0 && eGLConfigArr[0] != null, String.format(Locale.US, "eglChooseConfig failed: success=%b, numConfigs[0]=%d, configs[0]=%s", new Object[]{Boolean.valueOf(eglChooseConfig), Integer.valueOf(iArr2[0]), eGLConfigArr[0]}));
        ...
        if (i == 1) {
            ...
            zzet.zza(eGLSurface != null, "eglCreatePbufferSurface failed");
        }
        zzet.zza(EGL14.eglMakeCurrent(eGLDisplay, eGLSurface, eGLSurface, eglCreateContext), "eglMakeCurrent failed");
        this.zzf = eGLSurface;
