...
public final class zzec {
    ...
    @Deprecated
    public static final zzn zzb = zzdy.zza;
    ...
    public final boolean equals(java.lang.Object r5) {
        ...
        L_0x0004:
            ...
            goto L_0x008e
        L_0x0013:
            com.google.android.gms.internal.ads.zzec r5 = (com.google.android.gms.internal.ads.zzec) r5
        ...
        L_0x008e:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzec.equals(java.lang.Object):boolean");
    }
    ...
    public final Bundle zza() {
        ...
        if (charSequence != null) {
            ...
            if (charSequence2 instanceof Spanned) {
                ArrayList zza2 = zzef.zza((Spanned) charSequence2);
                if (!zza2.isEmpty()) {
    ...
    /* synthetic */ zzec(CharSequence charSequence, Layout.Alignment alignment, Layout.Alignment alignment2, Bitmap bitmap, float f, int i, int i2, float f2, int i3, int i4, float f3, float f4, float f5, boolean z, int i5, int i6, float f6, zzeb zzeb) {
        CharSequence charSequence2 = charSequence;
        Bitmap bitmap2 = bitmap;
        if (charSequence2 == null) {
            bitmap.getClass();
        } else {
            zzek.zzd(bitmap2 == null);
        }
        if (charSequence2 instanceof Spanned) {
