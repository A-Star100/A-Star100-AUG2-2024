...
public class zzdup {
    ...
    protected zzdup(Executor executor, zzr zzr, CsiUrlBuilder csiUrlBuilder, Context context) {
        this.zzd = executor;
        this.zze = zzr;
        this.zzf = ((Boolean) zzba.zzc().zza(zzbdz.zzbX)).booleanValue();
        this.zzg = csiUrlBuilder;
        this.zzh = ((Boolean) zzba.zzc().zza(zzbdz.zzca)).booleanValue();
        this.zzi = ((Boolean) zzba.zzc().zza(zzbdz.zzhe)).booleanValue();
        this.zzc = context;
    }
        ...
        if (!map.isEmpty()) {
            if (map == null || map.isEmpty()) {
                ...
                if (!this.zzj.getAndSet(true)) {
                    String str = (String) zzba.zzc().zza(zzbdz.zzki);
                    this.zzk.set(zzad.zza(this.zzc, str, new zzduo(this, str)));
                }
