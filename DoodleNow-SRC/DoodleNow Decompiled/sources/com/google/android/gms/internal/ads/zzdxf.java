...
public final class zzdxf implements zzdyg, zzdwq {
    ...
    zzdxf(zzdxq zzdxq, zzdyh zzdyh, zzdwr zzdwr, Context context, VersionInfoParcel versionInfoParcel, zzdxa zzdxa, zzdyc zzdyc, zzdxm zzdxm, zzdxm zzdxm2, @Nullable String str) {
        this.zza = zzdxq;
        this.zzb = zzdyh;
        this.zzc = zzdwr;
    ...
    private final synchronized JSONObject zzt() throws JSONException {
        ...
        for (Map.Entry entry : this.zzl.entrySet()) {
            ...
            for (zzdwt zzdwt : (List) entry.getValue()) {
                if (zzdwt.zzg()) {
                    jSONArray.put(zzdwt.zzd());
                }
            }
    ...
    private final void zzu() {
        ...
        this.zzc.zzd(this);
        this.zzf.zzf(this);
        if (!TextUtils.isEmpty((CharSequence) zzba.zzc().zza(zzbdz.zzjr))) {
            this.zzg.zzb(PreferenceManager.getDefaultSharedPreferences(this.zzj), Arrays.asList(((String) zzba.zzc().zza(zzbdz.zzjr)).split(f.a)));
        }
        if (!TextUtils.isEmpty((CharSequence) zzba.zzc().zza(zzbdz.zzjs))) {
            this.zzh.zzb(this.zzj.getSharedPreferences("admob", 0), Arrays.asList(((String) zzba.zzc().zza(zzbdz.zzjs)).split(f.a)));
        }
        zzA(zzu.zzo().zzi().zzm());
        this.zzx = zzu.zzo().zzi().zzn();
    }
    ...
    private final synchronized void zzw(com.google.android.gms.internal.ads.zzdxb r2, boolean r3) {
        /*
            r1 = this;
            monitor-enter(r1)
            com.google.android.gms.internal.ads.zzdxb r0 = r1.zzr     // Catch:{ all -> 0x0023 }
        ...
        L_0x0023:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzdxf.zzw(com.google.android.gms.internal.ads.zzdxb, boolean):void");
    }
    ...
    private final synchronized void zzx(boolean r2, boolean r3) {
        ...
        L_0x0006:
            ...
            com.google.android.gms.internal.ads.zzbdq r2 = com.google.android.gms.internal.ads.zzbdz.zzjd     // Catch:{ all -> 0x003c }
            com.google.android.gms.internal.ads.zzbdx r0 = com.google.android.gms.ads.internal.client.zzba.zzc()     // Catch:{ all -> 0x003c }
    ...
    public final synchronized ListenableFuture zzb(String str) {
        ...
        if (this.zzm.containsKey(str)) {
            zzcbw.zzc((zzdwt) this.zzm.get(str));
        } else {
            if (!this.zzn.containsKey(str)) {
                this.zzn.put(str, new ArrayList());
            }
            ((List) this.zzn.get(str)).add(zzcbw);
        }
        return zzcbw;
    }
    ...
    public final synchronized java.lang.String zzd() {
        /*
            ...
            com.google.android.gms.internal.ads.zzdxb r2 = r7.zzr     // Catch:{ JSONException -> 0x0033 }
            r0.put(r1, r2)     // Catch:{ JSONException -> 0x0033 }
        ...
        L_0x0039:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzdxf.zzd():java.lang.String");
    }
    ...
    public final synchronized JSONObject zze() {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(this.zzk)) {
                String str = this.zzk;
                jSONObject.put(b.I, "afma-sdk-a-v" + str);
            }
            ...
            if (((Boolean) zzba.zzc().zza(zzbdz.zzje)).booleanValue() && (jSONObject2 = this.zzp) != null) {
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final synchronized void zzf(java.lang.String r4, com.google.android.gms.internal.ads.zzdwt r5) {
        /*
            r3 = this;
            monitor-enter(r3)
            com.google.android.gms.internal.ads.zzbdq r0 = com.google.android.gms.internal.ads.zzbdz.zziO     // Catch:{ all -> 0x009f }
            com.google.android.gms.internal.ads.zzbdx r1 = com.google.android.gms.ads.internal.client.zzba.zzc()     // Catch:{ all -> 0x009f }
        ...
        L_0x001b:
            ...
            com.google.android.gms.internal.ads.zzbdq r1 = com.google.android.gms.internal.ads.zzbdz.zziQ     // Catch:{ all -> 0x009f }
            com.google.android.gms.internal.ads.zzbdx r2 = com.google.android.gms.ads.internal.client.zzba.zzc()     // Catch:{ all -> 0x009f }
        ...
        L_0x0048:
            ...
            com.google.android.gms.internal.ads.zzbdq r4 = com.google.android.gms.internal.ads.zzbdz.zzjm     // Catch:{ all -> 0x009f }
            com.google.android.gms.internal.ads.zzbdx r0 = com.google.android.gms.ads.internal.client.zzba.zzc()     // Catch:{ all -> 0x009f }
        ...
        L_0x0088:
            ...
            com.google.android.gms.internal.ads.zzcbw r1 = (com.google.android.gms.internal.ads.zzcbw) r1     // Catch:{ all -> 0x009f }
        ...
        L_0x009f:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzdxf.zzf(java.lang.String, com.google.android.gms.internal.ads.zzdwt):void");
    }

    public final void zzg() {
        if (((Boolean) zzba.zzc().zza(zzbdz.zziO)).booleanValue()) {
            if (!((Boolean) zzba.zzc().zza(zzbdz.zzjd)).booleanValue() || !zzu.zzo().zzi().zzN()) {
                String zzm2 = zzu.zzo().zzi().zzm();
    ...
    public final synchronized void zzh(zzda zzda, zzdxe zzdxe) {
        if (!zzq()) {
            try {
                zzda.zze(zzfhk.zzd(18, (String) null, (zze) null));
            ...
            if (!((Boolean) zzba.zzc().zza(zzbdz.zziO)).booleanValue()) {
                try {
                    zzda.zze(zzfhk.zzd(1, (String) null, (zze) null));
                } catch (RemoteException unused2) {
                    zzm.zzj("Ad inspector had an internal error.");
                }
            } else {
                this.zzv = zzdxe;
                this.zza.zzj(zzda, new zzbls(this), new zzbll(this.zzf), new zzbkz(this));
            }
        }
    }
    ...
    public final void zzm(zzdxb zzdxb) {
        zzw(zzdxb, true);
    }
    ...
    public final synchronized boolean zzq() {
        /*
            r2 = this;
            monitor-enter(r2)
            com.google.android.gms.internal.ads.zzbdq r0 = com.google.android.gms.internal.ads.zzbdz.zzjd     // Catch:{ all -> 0x002c }
            com.google.android.gms.internal.ads.zzbdx r1 = com.google.android.gms.ads.internal.client.zzba.zzc()     // Catch:{ all -> 0x002c }
        ...
        L_0x002c:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzdxf.zzq():boolean");
    }
    ...
    public final boolean zzs() {
        return this.zzw < ((Long) zzba.zzc().zza(zzbdz.zzjj)).longValue();
    }
}
