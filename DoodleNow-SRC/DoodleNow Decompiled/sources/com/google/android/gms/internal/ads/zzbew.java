...
public final class zzbew {
    ...
    public final void zzb(Activity activity) {
        String zza2;
        if (this.zzb == null && (zza2 = zzhjn.zza(activity)) != null) {
            zzhjo zzhjo = new zzhjo(this);
            this.zzc = zzhjo;
            CustomTabsClient.bindCustomTabsService(activity, zza2, zzhjo);
        }
    }
    ...
    public final void zze(zzbev zzbev) {
        this.zzd = zzbev;
    }
