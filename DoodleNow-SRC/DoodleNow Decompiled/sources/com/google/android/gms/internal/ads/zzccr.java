...
public final class zzccr extends zzcct implements TextureView.SurfaceTextureListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnVideoSizeChangedListener {
    ...
    public zzccr(Context context, zzcdn zzcdn, boolean z, boolean z2, zzcdm zzcdm, zzcdo zzcdo) {
        super(context);
        ...
        if (this.zzj != null && surfaceTexture != null) {
            ...
            try {
                ...
                if (this.zzo) {
                    ...
                    this.zzn = zzcdl;
                    zzcdl.zzd(surfaceTexture, getWidth(), getHeight());
                    this.zzn.start();
    ...
    private final boolean zzH() {
        ...
        L_0x000f:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzccr.zzH():boolean");
    }

    static /* bridge */ /* synthetic */ void zzl(zzccr zzccr, MediaPlayer mediaPlayer) {
        MediaFormat format;
        if (((Boolean) zzba.zzc().zza(zzbdz.zzbQ)).booleanValue() && zzccr.zzd != null && mediaPlayer != null) {
            try {
                ...
                if (trackInfo != null) {
                    ...
                    if (!hashMap.isEmpty()) {
                        zzccr.zzd.zzd("onMetadataEvent", hashMap);
                    }
                }
    ...
    public final boolean onError(MediaPlayer mediaPlayer, int i, int i2) {
        ...
        zzm.zzj("AdMediaPlayerView MediaPlayer error: " + str + Constants.SUBS_ID_BASE_PLAN_ID_SEPARATOR + str2);
        zzF(-1);
        this.zzh = -1;
        zzt.zza.post(new zzccl(this, str, str2));
        return true;
    }
    ...
    public final void onPrepared(android.media.MediaPlayer r8) {
        /*
            ...
            r0 = 2
            r7.zzF(r0)
            com.google.android.gms.internal.ads.zzcdo r0 = r7.zze
            r0.zzb()
            com.google.android.gms.internal.ads.zzftg r0 = com.google.android.gms.ads.internal.util.zzt.zza
            com.google.android.gms.internal.ads.zzccj r1 = new com.google.android.gms.internal.ads.zzccj
            r1.<init>(r7, r8)
            r0.post(r1)
        ...
        L_0x00a8:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzccr.onPrepared(android.media.MediaPlayer):void");
    }
    ...
    public final void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int i, int i2) {
        ...
        zzt.zza.post(new zzccn(this, i, i2));
    }
