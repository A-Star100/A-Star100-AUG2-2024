...
public final class zzdyh extends zzftn {
    ...
    public final void zza(SensorEvent sensorEvent) {
        if (((Boolean) zzba.zzc().zza(zzbdz.zziS)).booleanValue()) {
            float f = sensorEvent.values[0];
            float f2 = f / 9.80665f;
            float f3 = sensorEvent.values[1] / 9.80665f;
            float f4 = sensorEvent.values[2] / 9.80665f;
            if (((float) Math.sqrt((double) ((f2 * f2) + (f3 * f3) + (f4 * f4)))) >= ((Float) zzba.zzc().zza(zzbdz.zziT)).floatValue()) {
                long currentTimeMillis = zzu.zzB().currentTimeMillis();
                if (this.zze + ((long) ((Integer) zzba.zzc().zza(zzbdz.zziU)).intValue()) <= currentTimeMillis) {
                    if (this.zze + ((long) ((Integer) zzba.zzc().zza(zzbdz.zziV)).intValue()) < currentTimeMillis) {
                        this.zzf = 0;
                    }
                    ...
                    int i = this.zzf + 1;
                    this.zzf = i;
                    zzdyg zzdyg = this.zzg;
                    if (zzdyg != null) {
                        if (i == ((Integer) zzba.zzc().zza(zzbdz.zziW)).intValue()) {
                            zzdxf zzdxf = (zzdxf) zzdyg;
                            zzdxf.zzh(new zzdxc(zzdxf), zzdxe.GESTURE);
                        }
                    }
                }
            }
    ...
    public final void zzc() {
        /*
            r6 = this;
            monitor-enter(r6)
            com.google.android.gms.internal.ads.zzbdq r0 = com.google.android.gms.internal.ads.zzbdz.zziS     // Catch:{ all -> 0x006a }
            com.google.android.gms.internal.ads.zzbdx r1 = com.google.android.gms.ads.internal.client.zzba.zzc()     // Catch:{ all -> 0x006a }
        ...
        L_0x0035:
            ...
            com.google.android.gms.internal.ads.zzbdq r0 = com.google.android.gms.internal.ads.zzbdz.zziU     // Catch:{ all -> 0x006a }
            com.google.android.gms.internal.ads.zzbdx r4 = com.google.android.gms.ads.internal.client.zzba.zzc()     // Catch:{ all -> 0x006a }
        ...
        L_0x006a:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzdyh.zzc():void");
    }

    public final void zzd(zzdyg zzdyg) {
        this.zzg = zzdyg;
    }
}
