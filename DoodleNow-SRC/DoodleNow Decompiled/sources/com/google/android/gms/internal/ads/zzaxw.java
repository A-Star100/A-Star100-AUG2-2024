...
public final class zzaxw implements View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener, Application.ActivityLifecycleCallbacks {
    ...
    public zzaxw(Context context, zzaxi zzaxi) {
    ...
    private final void zzh(View view) {
        ...
        if (this.zzf == null) {
            ...
            zzaxv zzaxv = new zzaxv(this);
            this.zzf = zzaxv;
            this.zzb.registerReceiver(zzaxv, intentFilter);
        }
    ...
    private final void zzi(android.view.View r4) {
        ...
        L_0x0036:
            ...
            com.google.android.gms.internal.ads.zzaxe r0 = r3.zzj     // Catch:{ Exception -> 0x003f }
            r4.unregisterActivityLifecycleCallbacks(r0)     // Catch:{ Exception -> 0x003f }
        L_0x003f:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzaxw.zzi(android.view.View):void");
    }
