...
public final class zzeby extends zzece {
    ...
    public final synchronized void onConnected(android.os.Bundle r4) {
        /*
            ...
            com.google.android.gms.internal.ads.zzbwi r1 = r3.zzh     // Catch:{ RemoteException -> 0x002b, all -> 0x001a }
        ...
        L_0x0039:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzeby.onConnected(android.os.Bundle):void");
    }

    public final synchronized ListenableFuture zza(zzbwi zzbwi, long j) {
        if (this.zzb) {
        ...
        zzo.addListener(new zzebx(this), zzcbr.zzf);
        return zzo;
    }
}
