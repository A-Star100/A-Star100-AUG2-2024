...
public final class zzefo extends zzbuh {
    ...
    public zzefo(Context context, zzefd zzefd, zzr zzr, zzduh zzduh) {
        this.zzb = context;
        this.zzc = zzduh;
        this.zzd = zzr;
        this.zze = zzefd;
    ...
    public static void zzc(Context context, zzduh zzduh, zzefd zzefd, String str, String str2, Map map) {
        String str3;
        String str4 = true != zzu.zzo().zzz(context) ? "offline" : CustomTabsCallback.ONLINE_EXTRAS_KEY;
        if (zzduh != null) {
        ...
        zzefd.zzd(new zzeff(zzu.zzB().currentTimeMillis(), str, str3, 2));
    }
    ...
    private final String zzr() {
        zzeev zzeev = (zzeev) this.zza.get(this.zzf);
        return zzeev == null ? "" : zzeev.zzb();
    }
    ...
    private final void zzu() {
        /*
            ...
            com.google.android.gms.internal.ads.zzeev r5 = (com.google.android.gms.internal.ads.zzeev) r5     // Catch:{ RemoteException -> 0x0040 }
    ...
    private final void zzv(Activity activity, zzm zzm) {
        ...
        if (NotificationManagerCompat.from(activity).areNotificationsEnabled()) {
            ...
            zzK.setTitle(zzs(R.string.notifications_permission_title, "Allow app to send you notifications?")).setPositiveButton(zzs(R.string.notifications_permission_confirm, "Allow"), new zzefh(this, activity, zzm)).setNegativeButton(zzs(R.string.notifications_permission_decline, "Don't allow"), new zzefi(this, zzm)).setOnCancelListener(new zzefj(this, zzm));
            zzK.create().show();
    ...
    private final void zzw(Activity activity, zzm zzm) {
        ...
        zzu.zzp();
        AlertDialog.Builder onCancelListener = zzt.zzK(activity).setOnCancelListener(new zzefg(zzm));
        ...
        timer.schedule(new zzefn(this, alertDialog, timer, zzm), C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS);
    }
    ...
    public final void zze(Intent intent) {
        ...
        if (stringExtra.equals("offline_notification_clicked") || stringExtra.equals("offline_notification_dismissed")) {
            ...
            boolean zzz = zzu.zzo().zzz(this.zzb);
            HashMap hashMap = new HashMap();
            char c = 2;
    ...
    public final void zzf(String[] strArr, int[] iArr, IObjectWrapper iObjectWrapper) {
        ...
        while (i < strArr.length) {
            if (!strArr[i].equals("android.permission.POST_NOTIFICATIONS")) {
                ...
                zzefq zzefq = (zzefq) ObjectWrapper.unwrap(iObjectWrapper);
                Activity zza2 = zzefq.zza();
                zzm zzb2 = zzefq.zzb();
                HashMap hashMap = new HashMap();
                if (iArr[i] == 0) {
                    hashMap.put("dialog_action", "confirm");
    ...
    public final void zzg(IObjectWrapper iObjectWrapper) {
        ...
        this.zzf = zzefq.zzc();
        this.zzg = zzefq.zzd();
        if (!((Boolean) zzba.zzc().zza(zzbdz.zziu)).booleanValue()) {
            zzt(this.zzf, "dialog_impression", zzfzq.zzd());
            zzu.zzp();
            AlertDialog.Builder zzK = zzt.zzK(zza2);
            zzK.setTitle(zzs(R.string.offline_opt_in_title, "Open ad when you're back online.")).setMessage(zzs(R.string.offline_opt_in_message, "We'll send you a notification with a link to the advertiser site.")).setPositiveButton(zzs(R.string.offline_opt_in_confirm, "OK"), new zzefk(this, zza2, zzb2)).setNegativeButton(zzs(R.string.offline_opt_in_decline, "No thanks"), new zzefl(this, zzb2)).setOnCancelListener(new zzefm(this, zzb2));
            zzK.create().show();
            return;
        }
        zzv(zza2, zzb2);
    ...
    public final void zzh() {
        this.zze.zze(new zzeew(this.zzd));
    }
    ...
    public final void zzp(String str, zzdky zzdky) {
        String str2;
        String str3 = "";
        if (!TextUtils.isEmpty(zzdky.zzx())) {
            str2 = zzdky.zzx();
        } else {
            str2 = zzdky.zzB() != null ? zzdky.zzB() : str3;
        }
        zzbhe zzm = zzdky.zzm();
        if (zzm != null) {
            try {
        ...
        this.zza.put(str, new zzeer(str2, str3, drawable));
    }
}
