...
public final class zzfo {
    private static final char[] zza = {CharUtils.CR, 10};
    ...
    private final int zzO(Charset charset) {
        ...
        if (charset.equals(zzfwd.zzc) || charset.equals(zzfwd.zza)) {
            ...
            int i3 = this.zze;
            if (i2 - i3 > 0) {
                b = (byte) zzgci.zza((long) (this.zzd[i3] & 255));
                return (zzgci.zza((long) b) << 16) + i;
            }
        }
    ...
    public final void zzF(zzfn zzfn, int i) {
        zzG(zzfn.zza, 0, i);
        zzfn.zzk(0);
    }
    ...
    public final int zzg() {
        ...
        int i2 = i + 3;
        this.zze = i + 4;
        return (bArr[i2] & 255) | ((bArr[i] & 255) << Ascii.CAN) | ((bArr[i + 1] & 255) << Ascii.DLE) | ((bArr[i + 2] & 255) << 8);
    }
    ...
    public final int zzh() {
        ...
        int i2 = i + 2;
        this.zze = i + 3;
        return (bArr[i2] & 255) | (((bArr[i] & 255) << Ascii.CAN) >> 8) | ((bArr[i + 1] & 255) << 8);
    }
    ...
    public final int zzi() {
        ...
        return ((bArr[i2] & 255) << Ascii.CAN) | i3 | (bArr[i] & 255) | ((bArr[i + 2] & 255) << Ascii.DLE);
    }
    ...
    public final int zzo() {
        ...
        int i2 = i + 2;
        this.zze = i + 3;
        return (bArr[i2] & 255) | ((bArr[i] & 255) << Ascii.DLE) | ((bArr[i + 1] & 255) << 8);
    }
    ...
    public final long zzr() {
        ...
        this.zze = i + 8;
        long j6 = (j & 255) << 8;
        long j7 = (((long) bArr[i + 6]) & 255) << 48;
        return ((((long) bArr[i + 7]) & 255) << 56) | j7 | j6 | (((long) bArr[i]) & 255) | ((j2 & 255) << 16) | ((j3 & 255) << 24) | ((j4 & 255) << 32) | ((j5 & 255) << 40);
    }
    ...
    public final long zzs() {
        ...
        long j2 = (long) bArr[i + 2];
        this.zze = i + 4;
        return ((((long) bArr[i + 3]) & 255) << 24) | (((long) bArr[i]) & 255) | ((j & 255) << 8) | ((j2 & 255) << 16);
    }
    ...
    public final long zzt() {
        ...
        long j5 = (long) bArr[i + 5];
        this.zze = i + 8;
        return (((long) bArr[i + 7]) & 255) | ((((long) bArr[i]) & 255) << 56) | ((j & 255) << 48) | ((j2 & 255) << 40) | ((j3 & 255) << 32) | ((j4 & 255) << 24) | ((j5 & 255) << 16) | ((((long) bArr[i + 6]) & 255) << 8);
    }
    ...
    public final long zzu() {
        ...
        this.zze = i + 4;
        long j2 = j & 255;
        return (((long) bArr[i + 3]) & 255) | ((((long) bArr[i]) & 255) << 24) | (j2 << 16) | ((((long) bArr[i + 2]) & 255) << 8);
    }
