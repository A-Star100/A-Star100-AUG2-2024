...
public final class zzcn {
    ...
    @Deprecated
    public static final zzn zze = zzcm.zza;
    ...
    public zzcn(Object obj, int i, zzbp zzbp, Object obj2, int i2, long j, long j2, int i3, int i4) {
        this.zzf = obj;
        this.zzg = i;
        this.zzh = zzbp;
        this.zzi = obj2;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null && getClass() == obj.getClass()) {
            zzcn zzcn = (zzcn) obj;
            return this.zzg == zzcn.zzg && this.zzj == zzcn.zzj && this.zzk == zzcn.zzk && this.zzl == zzcn.zzl && this.zzm == zzcn.zzm && this.zzn == zzcn.zzn && zzfwl.zza(this.zzh, zzcn.zzh) && zzfwl.zza(this.zzf, zzcn.zzf) && zzfwl.zza(this.zzi, zzcn.zzi);
        }
    }
