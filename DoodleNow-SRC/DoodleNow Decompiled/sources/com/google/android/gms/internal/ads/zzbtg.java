...
public final class zzbtg implements MediationInterstitialAdapter {
    ...
    public final void showInterstitial() {
        ...
        zzt.zza.post(new zzbtf(this, new AdOverlayInfoParcel(new zzc(build.intent, (zzy) null), (zza) null, new zzbte(this), (zzaa) null, new VersionInfoParcel(0, 0, false), (zzcgm) null, (zzdgn) null)));
        zzu.zzo().zzq();
    }
}
