...
public final class zzfdg implements zzhiv {
    ...
    public zzfdg(zzhjm zzhjm, zzhjm zzhjm2, zzhjm zzhjm3) {
        this.zza = zzhjm;
        this.zzb = zzhjm2;
        this.zzc = zzhjm3;
    }
    ...
    public final zzfde zzb() {
        ...
        if (((Integer) zzba.zzc().zza(zzbdz.zzgK)).intValue() > 0) {
            if (!((Boolean) zzba.zzc().zza(zzbdz.zzgt)).booleanValue() || z) {
                zzfij zza2 = zzfik.zza(zzfia.AppOpen, context, zzfhs, new zzfci(new zzfcf()));
