...
final class zzcgc extends zzgp implements zzht {
    ...
    private final zzhs zzf = new zzhs();
    private zzhb zzg;
    ...
    zzcgc(String str, zzhy zzhy, int i, int i2, long j, long j2) {
        super(true);
        zzek.zzc(str);
        this.zze = str;
        this.zzc = i;
    ...
    public final long zzb(zzhb zzhb) throws zzhp {
        long j;
        this.zzg = zzhb;
        this.zzn = 0;
        long j2 = zzhb.zze;
        ...
        throw new zzcga(headerField, zzhb);
    }
    ...
    public final HttpURLConnection zzk(long j, long j2, int i) throws zzhp {
        ...
        try {
            ...
            try {
                ...
                zzhb zzhb = this.zzg;
                throw new zzhp("Unable to connect to ".concat(valueOf), e2, zzhb, 2000, i);
            }
        } catch (IOException e3) {
            IOException iOException = e3;
            String valueOf2 = String.valueOf(uri);
            throw new zzhp("Unable to connect to ".concat(valueOf2), iOException, this.zzg, 2000, i);
        }
    }
}
