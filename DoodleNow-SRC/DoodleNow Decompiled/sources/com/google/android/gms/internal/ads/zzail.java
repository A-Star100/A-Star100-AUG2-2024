...
final class zzail {
    ...
    private final long zzb(zzadg zzadg) throws IOException {
        int i;
        zzact zzact = (zzact) zzadg;
        int i2 = 0;
        zzact.zzm(this.zza.zzM(), 0, 1, false);
        ...
        int i5 = b & (~i3);
        zzact.zzm(this.zza.zzM(), 1, i4, false);
        while (i2 < i4) {
            i2++;
    ...
    public final boolean zza(zzadg zzadg) throws IOException {
        long zzb2;
        int i;
        long zzd = zzadg.zzd();
        ...
        if (zzb3 != Long.MIN_VALUE) {
            ...
            if (i2 == 0 || j3 < zzd) {
                while (true) {
                    ...
                    if (i5 < 0) {
                        if (zzb(zzadg) == Long.MIN_VALUE || zzb2 < 0) {
                            return false;
                        }
                        if (i != 0) {
                            int zzb4 = (int) (zzb2 = zzb(zzadg));
                            zzact.zzl(zzb4, false);
                            this.zzb += zzb4;
                        }
                    } else if (i5 == 0) {
                        return true;
