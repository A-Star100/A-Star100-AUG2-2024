...
public final class zbaa extends GoogleApi implements AuthorizationClient {
    ...
    static {
        ...
        zby zby = new zby();
        zbb = zby;
        zbc = new Api("Auth.Api.Identity.Authorization.API", zby, clientKey);
    }
    ...
    public final Task<AuthorizationResult> authorize(AuthorizationRequest authorizationRequest) {
        ...
        return doRead(TaskApiCall.builder().setFeatures(zbas.zbc).run(new zbx(this, build)).setAutoResolveMissingFeatures(false).setMethodKey(1534).build());
    }
