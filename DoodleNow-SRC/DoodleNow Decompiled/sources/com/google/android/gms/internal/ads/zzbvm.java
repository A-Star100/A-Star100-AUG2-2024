...
public final class zzbvm {
    ...
    public zzbvm(zzbvl zzbvl) {
        View zza2 = zzbvl.zza;
        this.zza = zza2;
        Map zzd = zzbvl.zzb;
        this.zzb = zzd;
        zzcap zza3 = zzbvg.zza(zzbvl.zza.getContext());
        this.zzc = zza3;
        if (zza3 != null && !zzd.isEmpty()) {
            try {
                zza3.zzg(new zzbvn(ObjectWrapper.wrap(zza2).asBinder(), ObjectWrapper.wrap(zzd).asBinder()));
    ...
    public final void zzb(List list) {
        ...
        zzcap zzcap = this.zzc;
        if (zzcap != null) {
            try {
                zzcap.zzi(list, ObjectWrapper.wrap(this.zza), new zzbvj(this, list));
            } catch (RemoteException e) {
    ...
    public final void zzc(MotionEvent motionEvent) {
        ...
        if (zzcap != null) {
            try {
                zzcap.zzk(ObjectWrapper.wrap(motionEvent));
            } catch (RemoteException unused) {
                zzm.zzg("Failed to call remote method.");
            }
        } else {
    ...
    public final void zzd(Uri uri, UpdateClickUrlCallback updateClickUrlCallback) {
        ...
        try {
            this.zzc.zzl(new ArrayList(Arrays.asList(new Uri[]{uri})), ObjectWrapper.wrap(this.zza), new zzbvi(this, updateClickUrlCallback));
        } catch (RemoteException e) {
