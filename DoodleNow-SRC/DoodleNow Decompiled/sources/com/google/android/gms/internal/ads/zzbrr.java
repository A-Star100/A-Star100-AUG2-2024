...
public final class zzbrr implements MediationBannerListener, MediationInterstitialListener, MediationNativeListener {
    ...
    public final void zzd(MediationNativeAdapter mediationNativeAdapter, zzbhz zzbhz) {
        Preconditions.checkMainThread("#008 Must be called on the main UI thread.");
        zzm.zze("Adapter called onAdLoaded with template id ".concat(String.valueOf(zzbhz.zzb())));
        this.zzc = zzbhz;
        try {
            this.zza.zzo();
        } catch (RemoteException e) {
    ...
    public final void zze(MediationNativeAdapter mediationNativeAdapter, zzbhz zzbhz, String str) {
        try {
            this.zza.zzr(zzbhz.zza(), str);
        } catch (RemoteException e) {
            zzm.zzl("#007 Could not call remote method.", e);
        }
    }
