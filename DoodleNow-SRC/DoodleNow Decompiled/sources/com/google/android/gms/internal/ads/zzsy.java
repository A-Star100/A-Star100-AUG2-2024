...
final class zzsy implements zztg {
    ...
    /*  JADX ERROR: IndexOutOfBoundsException in pass: RegionMakerVisitor
        ...
        */
    static /* bridge */ /* synthetic */ void zza(com.google.android.gms.internal.ads.zzsy r9, android.os.Message r10) {
        /*
            int r0 = r10.what
            r1 = 0
    ...
    private static zzsx zzi() {
        ...
        synchronized (arrayDeque) {
            ...
            zzsx zzsx2 = (zzsx) arrayDeque.removeFirst();
            return zzsx2;
        }
    }
    ...
    public final void zze(int i, int i2, zzie zzie, long j, int i3) {
        ...
        cryptoInfo.numSubSamples = zzie.zzf;
        cryptoInfo.numBytesOfClearData = zzk(zzie.zzd, cryptoInfo.numBytesOfClearData);
        cryptoInfo.numBytesOfEncryptedData = zzk(zzie.zze, cryptoInfo.numBytesOfEncryptedData);
        byte[] zzj = zzj(zzie.zzb, cryptoInfo.key);
        zzj.getClass();
        cryptoInfo.key = zzj;
        byte[] zzj2 = zzj(zzie.zza, cryptoInfo.iv);
        zzj2.getClass();
        cryptoInfo.iv = zzj2;
        cryptoInfo.mode = zzie.zzc;
        if (zzfx.zza >= 24) {
            FrameworkMediaDrm$$ExternalSyntheticApiModelOutline0.m();
            cryptoInfo.setPattern(FrameworkMediaDrm$$ExternalSyntheticApiModelOutline0.m(zzie.zzg, zzie.zzh));
        }
