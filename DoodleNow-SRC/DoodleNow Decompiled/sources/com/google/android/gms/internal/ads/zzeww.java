...
public final class zzeww implements zzewq {
    ...
    public final /* bridge */ /* synthetic */ void zzj(Object obj) {
        ...
        if (!((Boolean) zzba.zzc().zza(zzbdz.zzkH)).booleanValue()) {
        ...
        if (((Boolean) zzba.zzc().zza(zzbdz.zzkS)).booleanValue()) {
            zzfgw.zzg(bundle, "gotmt_l", true, ((Boolean) zzba.zzc().zza(zzbdz.zzkP)).booleanValue());
            zzfgw.zzg(bundle, "gotmt_i", true, ((Boolean) zzba.zzc().zza(zzbdz.zzkO)).booleanValue());
        }
    }
}
