...
final class zzapf implements zzapg {
    ...
    public zzapf(zzadi zzadi, zzaem zzaem, zzapj zzapj) throws zzcc {
        this.zzc = zzadi;
        this.zzd = zzaem;
        this.zze = zzapj;
        int max = Math.max(1, zzapj.zzc / 10);
        this.zzi = max;
        zzfo zzfo = new zzfo(zzapj.zzf);
        zzfo.zzk();
        int zzk2 = zzfo.zzk();
        this.zzf = zzk2;
        int i = zzapj.zzb;
        int i2 = (((zzapj.zzd - (i * 4)) * 8) / (zzapj.zze * i)) + 1;
        if (zzk2 == i2) {
            int i3 = zzfx.zza;
            int i4 = ((max + zzk2) - 1) / zzk2;
            this.zzg = new byte[(zzapj.zzd * i4)];
            this.zzh = new zzfo(i4 * (zzk2 + zzk2) * i);
            int i5 = ((zzapj.zzc * zzapj.zzd) * 8) / zzk2;
            zzak zzak = new zzak();
        ...
        throw zzcc.zza("Expected frames per block: " + i2 + "; got: " + zzk2, (Throwable) null);
    }
    ...
    private final void zzf(int i) {
        long zzt = this.zzl + zzfx.zzt(this.zzn, 1000000, (long) this.zze.zzc, RoundingMode.FLOOR);
        int zze2 = zze(i);
        this.zzd.zzs(zzt, 1, zze2, this.zzm - zze2, (zzael) null);
        this.zzn += (long) i;
        this.zzm -= zze2;
    }

    public final void zza(int i, long j) {
        this.zzc.zzO(new zzapm(this.zze, this.zzf, (long) i, j));
    ...
    public final boolean zzc(com.google.android.gms.internal.ads.zzadg r21, long r22) throws java.io.IOException {
        /*
            ...
            int r3 = r0.zzf
            int r4 = r4 + r3
            com.google.android.gms.internal.ads.zzapj r5 = r0.zze
            r6 = -1
            int r4 = r4 + r6
            int r4 = r4 / r3
            int r3 = r5.zzd
        ...
        L_0x0044:
            int r1 = r0.zzk
            com.google.android.gms.internal.ads.zzapj r2 = r0.zze
            int r2 = r2.zzd
            int r1 = r1 / r2
            if (r1 <= 0) goto L_0x014a
            byte[] r2 = r0.zzg
            com.google.android.gms.internal.ads.zzfo r4 = r0.zzh
            r6 = 0
        L_0x0052:
            if (r6 >= r1) goto L_0x0117
            r8 = 0
        L_0x0055:
            com.google.android.gms.internal.ads.zzapj r9 = r0.zze
            int r10 = r9.zzb
        ...
        L_0x0117:
            ...
            r4.zzJ(r2)
            int r2 = r0.zzk
            com.google.android.gms.internal.ads.zzapj r4 = r0.zze
            int r4 = r4.zzd
            int r1 = r1 * r4
            int r2 = r2 - r1
            r0.zzk = r2
            com.google.android.gms.internal.ads.zzfo r1 = r0.zzh
            com.google.android.gms.internal.ads.zzaem r2 = r0.zzd
            int r4 = r1.zze()
            com.google.android.gms.internal.ads.zzaek.zzb(r2, r1, r4)
            int r1 = r0.zzm
            int r1 = r1 + r4
            r0.zzm = r1
            int r1 = r0.zzd(r1)
