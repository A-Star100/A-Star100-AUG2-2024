...
public final class zzzr implements zzzn, zzhy {
    ...
    /* synthetic */ zzzr(Context context, Map map, int i, zzel zzel, boolean z, zzzq zzzq) {
            ...
            if (zzg == null) {
                ...
                if (!(context == null || (telephonyManager = (TelephonyManager) context.getSystemService(HintConstants.AUTOFILL_HINT_PHONE)) == null)) {
                    ...
                    if (!TextUtils.isEmpty(networkCountryIso)) {
                        str = zzfvx.zzb(networkCountryIso);
                        int[] zzm2 = zzm(str);
                        HashMap hashMap = new HashMap(8);
                        hashMap.put(0, 1000000L);
                        zzfzn zzfzn = zza;
                        hashMap.put(2, (Long) zzfzn.get(zzm2[0]));
                        ...
                        hashMap.put(7, (Long) zzfzn.get(zzm2[0]));
                        zzg = new zzzr(applicationContext, hashMap, 2000, zzel.zza, true, (zzzq) null);
                    }
                }
                str = zzfvx.zzb(Locale.getDefault().getCountry());
                int[] zzm22 = zzm(str);
                HashMap hashMap2 = new HashMap(8);
                hashMap2.put(0, 1000000L);
                zzfzn zzfzn2 = zza;
                hashMap2.put(2, (Long) zzfzn2.get(zzm22[0]));
                ...
                hashMap2.put(7, (Long) zzfzn2.get(zzm22[0]));
                zzg = new zzzr(applicationContext, hashMap2, 2000, zzel.zza, true, (zzzq) null);
            }
            zzzr = zzg;
        }
        return zzzr;
    ...
    public final synchronized void zzk(int r9) {
        ...
        L_0x0026:
            ...
            com.google.android.gms.internal.ads.zzaag r9 = r8.zzk     // Catch:{ all -> 0x0042 }
        ...
        L_0x0042:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzzr.zzk(int):void");
    }

    private static boolean zzl(zzhb zzhb, boolean z) {
        return z && !zzhb.zzb(8);
    }
    ...
    public final synchronized void zza(zzgv zzgv, zzhb zzhb, boolean z, int i) {
        if (zzl(zzhb, z)) {
            this.zzn += (long) i;
        }
    }

    public final synchronized void zzb(zzgv zzgv, zzhb zzhb, boolean z) {
        if (zzl(zzhb, z)) {
            zzek.zzf(this.zzl > 0);
    ...
    public final synchronized void zzd(zzgv zzgv, zzhb zzhb, boolean z) {
        if (zzl(zzhb, z)) {
            if (this.zzl == 0) {
    ...
    public final void zzf(zzzm zzzm) {
        this.zzi.zzc(zzzm);
    }

    public final void zze(Handler handler, zzzm zzzm) {
        zzzm.getClass();
        this.zzi.zza(handler, zzzm);
    }
}
