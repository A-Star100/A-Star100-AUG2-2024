...
final class zzafq extends zzafs {
    ...
    private static Double zzg(zzfo zzfo) {
        return Double.valueOf(Double.longBitsToDouble(zzfo.zzt()));
    }

    private static String zzi(zzfo zzfo) {
        int zzq = zzfo.zzq();
        int zzd2 = zzfo.zzd();
        zzfo.zzL(zzq);
        return new String(zzfo.zzM(), zzd2, zzq);
    }

    private static HashMap zzj(zzfo zzfo) {
        int zzp = zzfo.zzp();
        HashMap hashMap = new HashMap(zzp);
        for (int i = 0; i < zzp; i++) {
            String zzi = zzi(zzfo);
            Object zzh = zzh(zzfo, zzfo.zzm());
            if (zzh != null) {
                hashMap.put(zzi, zzh);
            }
        }
    ...
    public final boolean zza(zzfo zzfo) {
        return true;
    }

    /* access modifiers changed from: protected */
    public final boolean zzb(zzfo zzfo, long j) {
        if (zzfo.zzm() == 2 && "onMetaData".equals(zzi(zzfo)) && zzfo.zzb() != 0 && zzfo.zzm() == 8) {
            HashMap zzj = zzj(zzfo);
    ...
    private static java.lang.Object zzh(com.google.android.gms.internal.ads.zzfo r4, int r5) {
        /*
        ...
        L_0x007a:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzafq.zzh(com.google.android.gms.internal.ads.zzfo, int):java.lang.Object");
    }
}
