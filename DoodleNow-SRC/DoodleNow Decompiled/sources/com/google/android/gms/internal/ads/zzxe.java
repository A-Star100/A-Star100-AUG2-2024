...
final class zzxe {
    ...
    public final java.lang.Object zza(int r4) {
        ...
        L_0x0038:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzxe.zza(int):java.lang.Object");
    }
    ...
    public final void zzc(int i, Object obj) {
        ...
        if (this.zzb.size() > 0) {
            ...
            if (keyAt == i) {
                ...
                zzep.zza(sparseArray2.valueAt(sparseArray2.size() - 1));
            }
        }
