...
public abstract class zzii extends zzcx {
    ...
    public zzii(boolean z, zzxb zzxb) {
        this.zzd = zzxb;
        this.zzc = zzxb.zzc();
    }
    ...
    public final zzcu zzd(int i, zzcu zzcu, boolean z) {
        int zzq = zzq(i);
        int zzt = zzt(zzq);
        zzu(zzq).zzd(i - zzs(zzq), zzcu, z);
        zzcu.zzd += zzt;
        if (z) {
            Object zzv = zzv(zzq);
            Object obj = zzcu.zzc;
            obj.getClass();
            zzcu.zzc = Pair.create(zzv, obj);
        }
        return zzcu;
    }
    ...
    public final zzcw zze(int i, zzcw zzcw, long j) {
        ...
        int zzt = zzt(zzr);
        int zzs = zzs(zzr);
        zzu(zzr).zze(i - zzt, zzcw, j);
        Object zzv = zzv(zzr);
        if (!zzcw.zza.equals(zzcw.zzc)) {
            zzv = Pair.create(zzv, zzcw.zzc);
        }
        zzcw.zzc = zzv;
        zzcw.zzp += zzs;
        zzcw.zzq += zzs;
    ...
    public final zzcu zzn(Object obj, zzcu zzcu) {
        Pair pair = (Pair) obj;
        Object obj2 = pair.first;
        Object obj3 = pair.second;
        int zzp = zzp(obj2);
        int zzt = zzt(zzp);
        zzu(zzp).zzn(obj3, zzcu);
        zzcu.zzd += zzt;
        zzcu.zzc = obj;
        return zzcu;
    }
