...
class zzhct extends AbstractMap {
    ...
    /* synthetic */ zzhct(int i, zzhcs zzhcs) {
        this.zza = i;
    }
    ...
    private final int zzk(Comparable comparable) {
        ...
        int i2 = 0;
        if (i >= 0) {
            int compareTo = comparable.compareTo(((zzhcn) this.zzb.get(i)).zza());
            if (compareTo > 0) {
                return -(size + 1);
            }
            if (compareTo == 0) {
        ...
        while (i2 <= i) {
            int i3 = (i2 + i) / 2;
            int compareTo2 = comparable.compareTo(((zzhcn) this.zzb.get(i3)).zza());
            if (compareTo2 < 0) {
                i = i3 - 1;
    ...
    public final Set entrySet() {
        if (this.zze == null) {
            this.zze = new zzhcr(this, (zzhcq) null);
        }
        return this.zze;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        int zzb2 = zzb();
        if (zzb2 != zzhct.zzb()) {
            return entrySet().equals(zzhct.entrySet());
        }
        for (int i = 0; i < zzb2; i++) {
            if (!zzg(i).equals(zzhct.zzg(i))) {
                return false;
            }
        }
        if (zzb2 != size) {
            return this.zzc.equals(zzhct.zzc);
        }
        return true;
    }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i2 = this.zza;
        if (size == i2) {
            zzhcn zzhcn = (zzhcn) this.zzb.remove(i2 - 1);
            zzm().put(zzhcn.zza(), zzhcn.getValue());
        }
