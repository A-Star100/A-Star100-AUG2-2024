...
public final class zzado {
    public static int zza(zzfo zzfo, int i) {
        switch (i) {
            case 1:
                return 192;
            case 2:
    ...
    public static long zzb(zzadg zzadg, zzads zzads) throws IOException {
        zzadg.zzj();
        zzact zzact = (zzact) zzadg;
        zzact.zzl(1, false);
        byte[] bArr = new byte[1];
        zzact.zzm(bArr, 0, 1, false);
        byte b = bArr[0] & 1;
        boolean z = 1 == b;
        zzact.zzl(2, false);
        int i = 1 != b ? 6 : 7;
        zzfo zzfo = new zzfo(i);
        zzfo.zzJ(zzadj.zza(zzadg, zzfo.zzM(), 0, i));
        zzadg.zzj();
        zzadn zzadn = new zzadn();
        if (zzd(zzfo, zzads, z, zzadn)) {
            return zzadn.zza;
        }
    ...
    private static boolean zzd(zzfo zzfo, zzads zzads, boolean z, zzadn zzadn) {
        try {
            long zzw = zzfo.zzw();
            if (!z) {
                zzw *= (long) zzads.zzb;
