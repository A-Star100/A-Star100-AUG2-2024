...
public final class zzti {
    ...
    private final void zzj(String str) {
        ...
        zzfe.zzb(com.google.android.exoplayer2.mediacodec.MediaCodecInfo.TAG, "NoSupport [" + str + "] [" + this.zza + ", " + this.zzb + "] [" + str2 + "]");
    }
    ...
    private final boolean zzl(com.google.android.gms.internal.ads.zzam r12, boolean r13) {
        /*
            r11 = this;
            android.util.Pair r0 = com.google.android.gms.internal.ads.zzuc.zza(r12)
            r1 = 1
    ...
    private final boolean zzm(zzam zzam) {
        return this.zzb.equals(zzam.zzm) || this.zzb.equals(zzuc.zzc(zzam));
    }
    ...
    public final zzis zzb(zzam zzam, zzam zzam2) {
        int i = true != zzfx.zzG(zzam.zzm, zzam2.zzm) ? 8 : 0;
        if (this.zzh) {
            ...
            if (!zzfx.zzG(zzam.zzy, zzam2.zzy)) {
                i |= 2048;
            }
            String str = this.zza;
            if (zzfx.zzd.startsWith("SM-T230") && "OMX.MARVELL.VIDEO.HW.CODA7542DECODER".equals(str) && !zzam.zzd(zzam2)) {
                i |= 2;
            }
            if (i == 0) {
                return new zzis(this.zza, zzam, zzam2, true != zzam.zzd(zzam2) ? 2 : 3, 0);
            }
        } else {
            ...
            if (i == 0) {
                return new zzis(this.zza, zzam, zzam2, 1, 0);
            }
        }
        return new zzis(this.zza, zzam, zzam2, 0, i);
    }
    ...
    public final boolean zze(zzam zzam) throws zztw {
        int i;
        ...
        if (!this.zzh) {
            ...
            if (i4 != -1) {
                ...
                if (codecCapabilities2 == null) {
                    ...
                    if (audioCapabilities2 == null) {
                        ...
                        if (maxInputChannelCount <= 1 && ((zzfx.zza < 26 || maxInputChannelCount <= 0) && !MimeTypes.AUDIO_MPEG.equals(str2) && !MimeTypes.AUDIO_AMR_NB.equals(str2) && !MimeTypes.AUDIO_AMR_WB.equals(str2) && !MimeTypes.AUDIO_AAC.equals(str2) && !MimeTypes.AUDIO_VORBIS.equals(str2) && !MimeTypes.AUDIO_OPUS.equals(str2) && !MimeTypes.AUDIO_RAW.equals(str2) && !MimeTypes.AUDIO_FLAC.equals(str2) && !MimeTypes.AUDIO_ALAW.equals(str2) && !MimeTypes.AUDIO_MLAW.equals(str2) && !MimeTypes.AUDIO_MSGSM.equals(str2))) {
                            if (MimeTypes.AUDIO_AC3.equals(str2)) {
                                i = 6;
                            } else {
                                i = MimeTypes.AUDIO_E_AC3.equals(str2) ? 16 : 30;
                            }
                            zzfe.zzf(com.google.android.exoplayer2.mediacodec.MediaCodecInfo.TAG, "AssumedMaxChannelAdjustment: " + str + ", [" + maxInputChannelCount + " to " + i + "]");
            ...
            return true;
        } else if (zzam.zzr <= 0 || zzam.zzs <= 0) {
            return true;
        } else {
            int i5 = zzfx.zza;
            return zzg(zzam.zzr, zzam.zzs, (double) zzam.zzt);
        }
    }
    ...
    public final boolean zzg(int i, int i2, double d) {
        ...
        if (!zzk(videoCapabilities, i, i2, d)) {
            ...
            zzfe.zzb(com.google.android.exoplayer2.mediacodec.MediaCodecInfo.TAG, "AssumedSupport [" + ("sizeAndRate.rotated, " + i + "x" + i2 + "@" + d) + "] [" + this.zza + ", " + this.zzb + "] [" + zzfx.zze + "]");
        }
        return true;
    }
