...
final class zzta extends MediaCodec.Callback {
    ...
    public static /* synthetic */ void zzd(zzta zzta) {
        synchronized (zzta.zza) {
            if (!zzta.zzm) {
                long j = zzta.zzl - 1;
                zzta.zzl = j;
                int i = (j > 0 ? 1 : (j == 0 ? 0 : -1));
                if (i <= 0) {
                    if (i < 0) {
                        ...
                        synchronized (zzta.zza) {
                            zzta.zzn = illegalStateException;
                        }
                        return;
                    }
                    zzta.zzi();
    ...
    public final int zzb(android.media.MediaCodec.BufferInfo r10) {
        ...
        L_0x0019:
            ...
            com.google.android.gms.internal.ads.zzek.zzb(r2)     // Catch:{ all -> 0x004b }
