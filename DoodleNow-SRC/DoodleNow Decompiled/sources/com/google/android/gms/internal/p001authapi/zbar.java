...
public final class zbar extends GmsClient {
    ...
    public zbar(Context context, Looper looper, zbu zbu, ClientSettings clientSettings, ConnectionCallbacks connectionCallbacks, OnConnectionFailedListener onConnectionFailedListener) {
