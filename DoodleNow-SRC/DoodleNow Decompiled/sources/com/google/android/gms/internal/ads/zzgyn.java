...
final class zzgyn extends zzgyt {
    ...
    /* synthetic */ zzgyn(Iterable iterable, int i, boolean z, zzgym zzgym) {
        super((zzgys) null);
        this.zzh = i;
        this.zze = iterable;
    ...
    private final void zzM(byte[] bArr, int i, int i2) throws IOException {
        if (i2 <= zzK()) {
            ...
            while (i3 > 0) {
                ...
                long j = (long) min;
                zzhdh.zzo(this.zzm, bArr, (long) (i2 - i3), j);
                i3 -= min;
                this.zzm += j;
            }
        } else if (i2 > 0) {
    ...
    public final int zzi() throws IOException {
        ...
        if (j - j2 >= 4) {
            this.zzm = 4 + j2;
            return (zzhdh.zza(j2) & 255) | ((zzhdh.zza(1 + j2) & 255) << 8) | ((zzhdh.zza(2 + j2) & 255) << Ascii.DLE) | ((zzhdh.zza(j2 + 3) & 255) << Ascii.CAN);
        }
    ...
    public final int zzj() throws IOException {
        ...
        if (this.zzo != j) {
            long j2 = j + 1;
            byte zza = zzhdh.zza(j);
            if (zza >= 0) {
                this.zzm++;
                return zza;
            } else if (this.zzo - this.zzm >= 10) {
                long j3 = 2 + j;
                byte zza2 = (zzhdh.zza(j2) << 7) ^ zza;
                if (zza2 < 0) {
                    b = zza2 ^ Byte.MIN_VALUE;
                } else {
                    long j4 = 3 + j;
                    byte zza3 = (zzhdh.zza(j3) << Ascii.SO) ^ zza2;
                    if (zza3 >= 0) {
                        b2 = zza3 ^ 16256;
                    } else {
                        long j5 = 4 + j;
                        byte zza4 = zza3 ^ (zzhdh.zza(j4) << Ascii.NAK);
                        if (zza4 < 0) {
                            b = -2080896 ^ zza4;
                        } else {
                            j4 = 5 + j;
                            byte zza5 = zzhdh.zza(j5);
    ...
    public final long zzq() throws IOException {
        ...
        if (j - j2 >= 8) {
            this.zzm = 8 + j2;
            byte zza = zzhdh.zza(j2 + 4);
            long j3 = j2;
            byte zza2 = zzhdh.zza(j3 + 5);
            long zza3 = ((long) zzhdh.zza(j2)) & 255;
            byte zza4 = zzhdh.zza(j3 + 6);
            long zza5 = (((long) zzhdh.zza(1 + j2)) & 255) << 8;
            byte zza6 = zzhdh.zza(j3 + 7);
            return ((((long) zza) & 255) << 32) | zza3 | zza5 | ((((long) zzhdh.zza(j2 + 2)) & 255) << 16) | ((((long) zzhdh.zza(3 + j2)) & 255) << 24) | ((((long) zza2) & 255) << 40) | ((((long) zza4) & 255) << 48) | ((((long) zza6) & 255) << 56);
        }
        ...
        if (this.zzo != j4) {
            ...
            if (zza >= 0) {
                ...
                if (zza2 < 0) {
                    ...
                    long j7 = 3 + j4;
                    byte zza3 = (zzhdh.zza(j6) << Ascii.SO) ^ zza2;
                    if (zza3 >= 0) {
                        j = (long) (zza3 ^ 16256);
                    } else {
                        long j8 = 4 + j4;
                        ...
                        if (zza4 < 0) {
                            ...
                            j7 = 5 + j4;
                            long zza5 = (((long) zzhdh.zza(j8)) << 28) ^ ((long) zza4);
                            if (zza5 >= 0) {
                                j = 266354560 ^ zza5;
                            } else {
                                long j9 = 6 + j4;
                                long zza6 = zza5 ^ (((long) zzhdh.zza(j7)) << 35);
                                if (zza6 < 0) {
                                    j3 = -34093383808L;
                                } else {
                                    long j10 = 7 + j4;
                                    long zza7 = zza6 ^ (((long) zzhdh.zza(j9)) << 42);
                                    if (zza7 >= 0) {
                                        j2 = 4363953127296L ^ zza7;
                                    } else {
                                        j9 = 8 + j4;
                                        zza6 = zza7 ^ (((long) zzhdh.zza(j10)) << 49);
                                        if (zza6 < 0) {
                                            j3 = -558586000294016L;
                                        } else {
                                            j10 = 9 + j4;
                                            long zza8 = (zza6 ^ (((long) zzhdh.zza(j9)) << 56)) ^ 71499008037633920L;
                                            if (zza8 < 0) {
                                                long j11 = j4 + 10;
                                                if (((long) zzhdh.zza(j10)) >= 0) {
                                                    long j12 = j11;
                                                    j = zza8;
                                                    j6 = j12;
                                                }
    ...
    public final String zzy() throws IOException {
        ...
        if (zzj2 > 0) {
            ...
            long j3 = (long) zzj2;
            if (j3 <= j - j2) {
                String zzg2 = zzhdm.zzg(this.zzg, (int) (j2 - this.zzn), zzj2);
                this.zzm += j3;
                return zzg2;
            }
        }
