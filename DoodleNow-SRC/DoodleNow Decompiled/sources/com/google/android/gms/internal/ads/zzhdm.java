...
final class zzhdm {
    private static final zzhdj zza = new zzhdk();
    ...
    static int zzd(java.lang.String r8, byte[] r9, int r10, int r11) {
        ...
        L_0x00bd:
            r1 = r4
        L_0x00be:
            com.google.android.gms.internal.ads.zzhdl r8 = new com.google.android.gms.internal.ads.zzhdl
            int r1 = r1 + -1
            r8.<init>(r1, r0)
            throw r8
        L_0x00c6:
    ...
    static String zzg(ByteBuffer byteBuffer, int i, int i2) throws zzhak {
        ...
        if (byteBuffer.hasArray()) {
            return zzhdj.zzb(byteBuffer.array(), byteBuffer.arrayOffset() + i, i2);
