...
interface zzhby {
    ...
    @Deprecated
    void zzE(List list, zzhcg zzhcg, zzgzf zzgzf) throws IOException;

    void zzF(List list) throws IOException;

    void zzG(List list) throws IOException;

    void zzH(List list, zzhcg zzhcg, zzgzf zzgzf) throws IOException;
    ...
    @Deprecated
    Object zzr(Class cls, zzgzf zzgzf) throws IOException;

    Object zzs(Class cls, zzgzf zzgzf) throws IOException;

    String zzt() throws IOException;

    String zzu() throws IOException;

    void zzv(Object obj, zzhcg zzhcg, zzgzf zzgzf) throws IOException;

    void zzw(Object obj, zzhcg zzhcg, zzgzf zzgzf) throws IOException;
