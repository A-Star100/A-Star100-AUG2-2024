...
public final class zzewh implements zzewq {
    ...
    public final /* bridge */ /* synthetic */ void zzj(Object obj) {
        ...
        bundle.putString("extra_caps", (String) zzba.zzc().zza(zzbdz.zzdE));
        bundle.putInt("target_api", this.zze);
        bundle.putInt("dv", this.zzf);
        bundle.putInt("lv", this.zzg);
        if (((Boolean) zzba.zzc().zza(zzbdz.zzfX)).booleanValue() && !TextUtils.isEmpty(this.zzh)) {
            bundle.putString("ev", this.zzh);
        }
        Bundle zza2 = zzfgw.zza(bundle, "sdk_env");
        zza2.putBoolean("mf", ((Boolean) zzbft.zzc.zze()).booleanValue());
        ...
        Bundle zza3 = zzfgw.zza(zza2, "build_meta");
        zza3.putString("cl", "619949182");
