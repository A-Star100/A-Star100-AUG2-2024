...
final class zzarj {
    ...
    zzarj(java.lang.String r14, com.google.android.gms.internal.ads.zzapz r15) {
        /*
            r13 = this;
    ...
    static zzarj zza(zzark zzark) throws IOException {
        if (zzarm.zze(zzark) == 538247942) {
            String zzh2 = zzarm.zzh(zzark);
            String zzh3 = zzarm.zzh(zzark);
            long zzf2 = zzarm.zzf(zzark);
            long zzf3 = zzarm.zzf(zzark);
            long zzf4 = zzarm.zzf(zzark);
            long zzf5 = zzarm.zzf(zzark);
            int zze2 = zzarm.zze(zzark);
            if (zze2 >= 0) {
                List emptyList = zze2 == 0 ? Collections.emptyList() : new ArrayList();
                for (int i = 0; i < zze2; i++) {
                    emptyList.add(new zzaqi(zzarm.zzh(zzark).intern(), zzarm.zzh(zzark).intern()));
                }
                return new zzarj(zzh2, zzh3, zzf2, zzf3, zzf4, zzf5, emptyList);
            }
