                ...
                try {
                    ...
                    if (signatureArr == null || (r0 = signatureArr.length) == 0) {
                        ...
                        for (Signature byteArray : signatureArr) {
                            String zza2 = zzfvt.zza(byteArray.toByteArray());
                            arrayList.add(zza2);
                        ...
                        zzfvg.zzd(String.format("Play Store package certs are not valid. Found these sha256 certs: [%s].", objArr), new Object[0]);
                    }
