...
public final class NativeAdView extends FrameLayout {
    ...
    private final void zzf(String str, View view) {
        ...
        if (zzbhi != null) {
            try {
                zzbhi.zzdv(str, ObjectWrapper.wrap(view));
    ...
    public final void onVisibilityChanged(View view, int i) {
        ...
        if (zzbhi != null) {
            try {
                zzbhi.zze(ObjectWrapper.wrap(view), i);
            } catch (RemoteException e) {
    ...
    public final void setClickConfirmingView(View view) {
        ...
        if (zzbhi != null) {
            try {
                zzbhi.zzdw(ObjectWrapper.wrap(view));
            } catch (RemoteException e) {
    ...
    public final View zza(String str) {
        ...
        if (zzbhi != null) {
            try {
                IObjectWrapper zzb2 = zzbhi.zzb(str);
                if (zzb2 != null) {
        ...
        if (zzbhi != null) {
            try {
                if (mediaContent instanceof zzep) {
                    zzbhi.zzdx(((zzep) mediaContent).zzc());
                } else if (mediaContent == null) {
                    zzbhi.zzdx((zzbhb) null);
                } else {
    ...
    public final /* synthetic */ void zzc(ImageView.ScaleType scaleType) {
        zzbhi zzbhi = this.zzb;
        if (zzbhi != null && scaleType != null) {
            try {
                zzbhi.zzdy(ObjectWrapper.wrap(scaleType));
            } catch (RemoteException e) {
