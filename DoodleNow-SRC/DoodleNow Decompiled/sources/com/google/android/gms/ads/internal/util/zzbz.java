...
public final class zzbz {
    ...
    public static WindowManager.LayoutParams zzb() {
        ...
        layoutParams.flags = ((Integer) zzba.zzc().zza(zzbdz.zzhY)).intValue();
        layoutParams.type = 2;
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (((String) entry.getKey()).equals("3010")) {
                                if (((Boolean) zzba.zzc().zza(zzbdz.zzhS)).booleanValue()) {
                                    jSONObject4.put("mediaview_graphics_matrix", view2.getMatrix().toShortString());
                                }
                                if (((Boolean) zzba.zzc().zza(zzbdz.zzhT)).booleanValue()) {
                                ...
                                if (((Boolean) zzba.zzc().zza(zzbdz.zzhU)).booleanValue()) {
                                ...
                                if (((Boolean) zzba.zzc().zza(zzbdz.zzhV)).booleanValue() && scaleType != null) {
    ...
    public static JSONObject zzf(View view) {
        ...
        if (view != null) {
            try {
                boolean z = false;
                if (((Boolean) zzba.zzc().zza(zzbdz.zzhR)).booleanValue()) {
                    zzu.zzp();
    ...
    /* JADX WARNING: Removed duplicated region for block: B:29:0x0146  */
    /* JADX WARNING: Removed duplicated region for block: B:34:0x0156  */
    /* JADX WARNING: Removed duplicated region for block: B:40:0x0165  */
    /* JADX WARNING: Removed duplicated region for block: B:45:0x0171 A[Catch:{ JSONException -> 0x0176 }] */
    ...
    public static org.json.JSONObject zzg(android.content.Context r16, android.view.View r17) {
        ...
        L_0x0103:
            com.google.android.gms.internal.ads.zzbdq r0 = com.google.android.gms.internal.ads.zzbdz.zzgo
            ...
            java.lang.Class r2 = r0.getClass()     // Catch:{ NoSuchMethodException -> 0x013b, SecurityException -> 0x0135, IllegalAccessException -> 0x0133, InvocationTargetException -> 0x0131 }
            java.lang.String r3 = "getTemplateTypeName"
            java.lang.Class[] r4 = new java.lang.Class[r11]     // Catch:{ NoSuchMethodException -> 0x013b, SecurityException -> 0x0135, IllegalAccessException -> 0x0133, InvocationTargetException -> 0x0131 }
            java.lang.reflect.Method r2 = r2.getMethod(r3, r4)     // Catch:{ NoSuchMethodException -> 0x013b, SecurityException -> 0x0135, IllegalAccessException -> 0x0133, InvocationTargetException -> 0x0131 }
            java.lang.Object[] r3 = new java.lang.Object[r11]     // Catch:{ NoSuchMethodException -> 0x013b, SecurityException -> 0x0135, IllegalAccessException -> 0x0133, InvocationTargetException -> 0x0131 }
            java.lang.Object r0 = r2.invoke(r0, r3)     // Catch:{ NoSuchMethodException -> 0x013b, SecurityException -> 0x0135, IllegalAccessException -> 0x0133, InvocationTargetException -> 0x0131 }
            java.lang.String r0 = (java.lang.String) r0     // Catch:{ NoSuchMethodException -> 0x013b, SecurityException -> 0x0135, IllegalAccessException -> 0x0133, InvocationTargetException -> 0x0131 }
            goto L_0x013d
        L_0x0131:
            r0 = move-exception
            goto L_0x0136
        ...
        L_0x0176:
            ...
            com.google.android.gms.ads.internal.util.client.zzm.zzh(r2, r0)
        L_0x017c:
            com.google.android.gms.internal.ads.zzbdq r0 = com.google.android.gms.internal.ads.zzbdz.zzhT
            com.google.android.gms.internal.ads.zzbdx r2 = com.google.android.gms.ads.internal.client.zzba.zzc()
            java.lang.Object r0 = r2.zza(r0)
            java.lang.Boolean r0 = (java.lang.Boolean) r0
            boolean r0 = r0.booleanValue()
    ...
    public static boolean zzh(Context context, zzffn zzffn) {
        if (!zzffn.zzO) {
            return false;
        }
        if (((Boolean) zzba.zzc().zza(zzbdz.zzhW)).booleanValue()) {
            return ((Boolean) zzba.zzc().zza(zzbdz.zzhZ)).booleanValue();
        }
        String str = (String) zzba.zzc().zza(zzbdz.zzhX);
        if (!str.isEmpty() && context != null) {
            String packageName = context.getPackageName();
            for (String equals : zzfxe.zzc(zzfwc.zzc(';')).zzd(str)) {
    ...
    public static boolean zzi(int i) {
        if (!((Boolean) zzba.zzc().zza(zzbdz.zzdq)).booleanValue()) {
            return true;
        }
        return ((Boolean) zzba.zzc().zza(zzbdz.zzdr)).booleanValue() || i <= 15299999;
    }
