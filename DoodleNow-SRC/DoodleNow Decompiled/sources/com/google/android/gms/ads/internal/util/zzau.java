...
public final class zzau {
    ...
    /* access modifiers changed from: package-private */
    public final /* synthetic */ void zzc(zzgep zzgep) {
        if (!zzu.zzs().zzj(this.zza, this.zzd, this.zze)) {
            zzu.zzs().zzd(this.zza, this.zzd, this.zze);
            return;
        }
        zzgep.execute(new zzan(this));
    }

    /* access modifiers changed from: package-private */
    public final /* synthetic */ void zzd(zzgep zzgep) {
        if (!zzu.zzs().zzj(this.zza, this.zzd, this.zze)) {
            zzu.zzs().zzd(this.zza, this.zzd, this.zze);
            return;
        }
        zzgep.execute(new zzam(this));
    }
    ...
    public final /* synthetic */ void zzj(int i, int i2, int i3, int i4, int i5, DialogInterface dialogInterface, int i6) {
        if (i6 == i) {
            ...
            zzK.setNegativeButton("Close", zzak.zza);
            zzK.create().show();
        } else if (i6 == i2) {
            zzm.zze("Debug mode [Creative Preview] selected.");
            zzcbr.zza.execute(new zzai(this));
        } else if (i6 == i3) {
            zzm.zze("Debug mode [Troubleshooting] selected.");
            zzcbr.zza.execute(new zzag(this));
        } else if (i6 == i4) {
            zzdxf zzdxf = this.zzb;
            zzgep zzgep = zzcbr.zze;
            zzgep zzgep2 = zzcbr.zza;
            if (zzdxf.zzq()) {
                zzgep.execute(new zzat(this));
            } else {
                zzgep2.execute(new zzaf(this, zzgep));
            }
        } else if (i6 == i5) {
            zzdxf zzdxf2 = this.zzb;
            zzgep zzgep3 = zzcbr.zze;
            zzgep zzgep4 = zzcbr.zza;
            if (zzdxf2.zzq()) {
                zzgep3.execute(new zzae(this));
            } else {
                zzgep4.execute(new zzal(this, zzgep3));
            }
        }
    }
        ...
        if (i != -1) {
            if (i == 0) {
                if (actionMasked == 5) {
                    ...
                    this.zzk.postDelayed(this.zzl, ((Long) zzba.zzc().zza(zzbdz.zzeD)).longValue());
                }
            } else if (i == 5) {
                if (pointerCount == 2) {
                    if (actionMasked == 2) {
    ...
    public final void zzr() {
        try {
            ...
            boolean booleanValue = ((Boolean) zzba.zzc().zza(zzbdz.zzjd)).booleanValue();
