...
public class zzw extends zzv {
    ...
    public final zzbdg.zzq zzg(Context context, TelephonyManager telephonyManager) {
        ...
        if (zzt.zzA(context, "android.permission.ACCESS_NETWORK_STATE")) {
            return telephonyManager.isDataEnabled() ? zzbdg.zzq.ENUM_TRUE : zzbdg.zzq.ENUM_FALSE;
        }
    ...
    public final void zzh(Context context, String str, String str2) {
        ...
        NotificationChannel m = ComponentDialog$$ExternalSyntheticApiModelOutline0.m("offline_notification_channel", (CharSequence) "AdMob Offline Notifications", ((Integer) zzba.zzc().zza(zzbdz.zziw)).intValue());
