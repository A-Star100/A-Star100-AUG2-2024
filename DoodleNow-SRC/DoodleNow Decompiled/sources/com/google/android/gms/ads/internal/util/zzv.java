...
public class zzv extends zzu {
    ...
    public final boolean zzd(Activity activity, Configuration configuration) {
        if (!((Boolean) zzba.zzc().zza(zzbdz.zzeL)).booleanValue()) {
            return false;
        }
        if (((Boolean) zzba.zzc().zza(zzbdz.zzeN)).booleanValue()) {
        ...
        int round = ((int) Math.round(((double) activity.getResources().getDisplayMetrics().density) + 0.5d)) * ((Integer) zzba.zzc().zza(zzbdz.zzeJ)).intValue();
