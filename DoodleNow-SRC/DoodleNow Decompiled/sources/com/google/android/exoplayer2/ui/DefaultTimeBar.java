...
public class DefaultTimeBar extends View implements TimeBar {
    ...
    public /* synthetic */ void m832lambda$new$0$comgoogleandroidexoplayer2uiDefaultTimeBar() {
        stopScrubbing(false);
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$new$1$com-google-android-exoplayer2-ui-DefaultTimeBar  reason: not valid java name */
    public /* synthetic */ void m833lambda$new$1$comgoogleandroidexoplayer2uiDefaultTimeBar(ValueAnimator valueAnimator) {
    ...
    private void drawPlayhead(Canvas canvas) {
        if (this.duration > 0) {
            ...
            Drawable drawable = this.scrubberDrawable;
            if (drawable == null) {
                canvas.drawCircle((float) constrainValue, (float) centerY, (float) ((int) ((((float) ((this.scrubbing || isFocused()) ? this.scrubberDraggedSize : isEnabled() ? this.scrubberEnabledSize : this.scrubberDisabledSize)) * this.scrubberScale) / 2.0f)), this.scrubberPaint);
                return;
            }
