...
public class StyledPlayerControlView extends FrameLayout {
    ...
    private final class SettingViewHolder extends RecyclerView.ViewHolder {
        ...
        public /* synthetic */ void m837lambda$new$0$comgoogleandroidexoplayer2uiStyledPlayerControlView$SettingViewHolder(View view) {
    ...
    private final class PlaybackSpeedAdapter extends RecyclerView.Adapter<SubSettingViewHolder> {
        ...
        public /* synthetic */ void m836lambda$onBindViewHolder$0$comgoogleandroidexoplayer2uiStyledPlayerControlView$PlaybackSpeedAdapter(int i, View view) {
            if (i != this.selectedIndex) {
    ...
    private final class TextTrackSelectionAdapter extends TrackSelectionAdapter {
        ...
        public /* synthetic */ void m838lambda$onBindViewHolderAtZeroPosition$0$comgoogleandroidexoplayer2uiStyledPlayerControlView$TextTrackSelectionAdapter(View view) {
    ...
    private final class AudioTrackSelectionAdapter extends TrackSelectionAdapter {
        ...
        public /* synthetic */ void m835lambda$onBindViewHolderAtZeroPosition$0$comgoogleandroidexoplayer2uiStyledPlayerControlView$AudioTrackSelectionAdapter(View view) {
            if (StyledPlayerControlView.this.player != null) {
    ...
    private abstract class TrackSelectionAdapter extends RecyclerView.Adapter<SubSettingViewHolder> {
        ...
        public /* synthetic */ void m839lambda$onBindViewHolder$0$comgoogleandroidexoplayer2uiStyledPlayerControlView$TrackSelectionAdapter(Player player, TrackGroup trackGroup, TrackInformation trackInformation, View view) {
