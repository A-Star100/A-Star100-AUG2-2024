...
final class StyledPlayerControlViewLayoutManager {
    ...
    public /* synthetic */ void m841lambda$new$0$comgoogleandroidexoplayer2uiStyledPlayerControlViewLayoutManager(ValueAnimator valueAnimator) {
    ...
    public /* synthetic */ void m842lambda$new$1$comgoogleandroidexoplayer2uiStyledPlayerControlViewLayoutManager(ValueAnimator valueAnimator) {
        float floatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        View view = this.controlsBackground;
        if (view != null) {
            view.setAlpha(floatValue);
    ...
    public /* synthetic */ void m843lambda$new$2$comgoogleandroidexoplayer2uiStyledPlayerControlViewLayoutManager(ValueAnimator valueAnimator) {
    ...
    public /* synthetic */ void m844lambda$new$3$comgoogleandroidexoplayer2uiStyledPlayerControlViewLayoutManager(ValueAnimator valueAnimator) {
        animateOverflow(((Float) valueAnimator.getAnimatedValue()).floatValue());
    }
