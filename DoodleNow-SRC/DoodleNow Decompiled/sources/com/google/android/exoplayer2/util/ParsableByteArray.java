...
public final class ParsableByteArray {
    ...
    public int readUnsignedInt24() {
        ...
        this.position = i + 3;
        return (bArr[i + 2] & 255) | ((bArr[i + 1] & 255) << 8) | i2;
    }
    ...
    public int readInt24() {
        ...
        this.position = i + 3;
        return (bArr[i + 2] & 255) | i2 | (((bArr[i] & 255) << Ascii.CAN) >> 8);
    }
    ...
    public int readLittleEndianInt24() {
        ...
        int i2 = (bArr[i + 1] & 255) << 8;
        this.position = i + 3;
        return ((bArr[i + 2] & 255) << Ascii.DLE) | i2 | (bArr[i] & 255);
    }
    ...
    public int readLittleEndianInt() {
        ...
        this.position = i + 4;
        return ((bArr[i + 3] & 255) << Ascii.CAN) | b | ((bArr[i + 2] & 255) << Ascii.DLE);
    }
    ...
    public int readUnsignedFixedPoint1616() {
        byte[] bArr = this.data;
        int i = this.position;
        byte b = (bArr[i + 1] & 255) | ((bArr[i] & 255) << 8);
        this.position = i + 4;
        return b;
    }
