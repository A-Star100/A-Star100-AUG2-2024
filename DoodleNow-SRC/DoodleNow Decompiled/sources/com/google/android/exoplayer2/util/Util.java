...
public final class Util {
    ...
    private static boolean isMediaStoreExternalContentUri(Uri uri) {
        if (!UriUtil.LOCAL_CONTENT_SCHEME.equals(uri.getScheme()) || !"media".equals(uri.getAuthority())) {
            return false;
        }
    ...
    public static ExecutorService newSingleThreadExecutor(String str) {
        return Executors.newSingleThreadExecutor(new Util$$ExternalSyntheticLambda4(str));
    }
    ...
    private static String[] getSystemLocalesV24(Configuration configuration) {
        return split(ComponentDialog$$ExternalSyntheticApiModelOutline0.m(ComponentDialog$$ExternalSyntheticApiModelOutline0.m(configuration)), f.a);
    }
