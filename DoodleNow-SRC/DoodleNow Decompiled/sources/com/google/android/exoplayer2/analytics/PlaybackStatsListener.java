...
public final class PlaybackStatsListener implements AnalyticsListener, PlaybackSessionManager.Listener {
    ...
    public void onEvents(Player player, AnalyticsListener.Events events) {
        ...
        if (events.size() != 0) {
            ...
            for (String next : this.playbackStatsTrackers.keySet()) {
                ...
                playbackStatsTracker.onEvents(player, eventTime, booleanValue, j, hasEvent, i, hasEvent3, hasEvent4, playbackException, z ? this.nonFatalException : null, hasEvent6 ? this.bandwidthTimeMs : 0, hasEvent6 ? this.bandwidthBytes : 0, hasEvent7 ? this.videoFormat : null, hasEvent7 ? this.audioFormat : null, hasEvent8 ? this.videoSize : null);
            }
    ...
    private static final class PlaybackStatsTracker {
        ...
        public PlaybackStats build(boolean z) {
            ...
            long j20 = j16;
            long j21 = j14;
            return new PlaybackStats(1, jArr3, list7, arrayList, j3, z2 ? 1 : 0, z3 ? 1 : 0, z4 ? 1 : 0, i3, j2, i4, i5, i9, i7, i8, j4, z5 ? 1 : 0, list5, list6, j5, j6, j7, j8, j9, j10, i12, i13, i11, j12, i14, j21, j15, j20, j17, j19, i15 > 0 ? 1 : 0, i15, this.nonFatalErrorCount, this.fatalErrorHistory, this.nonFatalErrorHistory);
        }
