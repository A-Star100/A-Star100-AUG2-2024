...
public final class MediaMetricsListener implements AnalyticsListener, PlaybackSessionManager.Listener {
    ...
    public static MediaMetricsListener create(Context context2) {
        MediaMetricsManager m = ReactTextView$$ExternalSyntheticApiModelOutline0.m(context2.getSystemService("media_metrics"));
        if (m == null) {
            return null;
        }
    ...
    private void maybeReportPlaybackError(long j) {
        ...
        if (playbackException != null) {
            ...
            this.playbackSession.reportPlaybackErrorEvent(FrameworkMediaDrm$$ExternalSyntheticApiModelOutline0.m().setTimeSinceCreatedMillis(j - this.startTimeMs).setErrorCode(errorInfo.errorCode).setSubErrorCode(errorInfo.subErrorCode).setException(playbackException).build());
