    ...
    private static final class Api29 {
        ...
        public static int[] getDirectPlaybackSupportedEncodings() {
            ...
            while (it.hasNext()) {
                ...
                if (FrameworkMediaDrm$$ExternalSyntheticApiModelOutline0.m(new AudioFormat.Builder().setChannelMask(12).setEncoding(intValue).setSampleRate(48000).build(), DEFAULT_AUDIO_ATTRIBUTES)) {
