...
public final class DefaultAudioSink implements AudioSink {
    ...
    public void configure(Format format, int i, int[] iArr) throws AudioSink.ConfigurationException {
        ...
        if (MimeTypes.AUDIO_RAW.equals(format2.sampleMimeType)) {
            ...
            int i12 = 0;
            while (i12 < length) {
                AudioProcessor audioProcessor = audioProcessorArr2[i12];
                try {
            ...
            if (useOffloadedPlayback(format2, this.audioAttributes)) {
                ...
                i6 = -1;
                i4 = -1;
                i2 = Util.getAudioTrackChannelConfig(format2.channelCount);
            } else {
                ...
                if (encodingAndChannelConfigForPassthrough != null) {
                    ...
                    audioProcessorArr = audioProcessorArr3;
                    i3 = i15;
                    i2 = ((Integer) encodingAndChannelConfigForPassthrough.second).intValue();
                    i6 = -1;
                    i4 = -1;
                    i5 = intValue;
                } else {
        ...
        if (i != 0) {
            ...
            i8 = i5;
            i9 = this.audioTrackBufferSizeProvider.getBufferSizeInBytes(getAudioTrackMinBufferSize(i3, i2, i5), i5, i7, i4, i3, this.enableAudioTrackPlaybackParams ? 8.0d : 1.0d);
        }
        if (i8 == 0) {
            throw new AudioSink.ConfigurationException("Invalid output encoding (mode=" + i7 + ") for: " + format2, format2);
        } else if (i2 != 0) {
            this.offloadDisabledUntilNextConfiguration = false;
            Configuration configuration2 = new Configuration(format, i6, i7, i4, i3, i2, i8, i9, audioProcessorArr);
            ...
            throw new AudioSink.ConfigurationException("Invalid output channel config (mode=" + i7 + ") for: " + format2, format2);
        }
    }
