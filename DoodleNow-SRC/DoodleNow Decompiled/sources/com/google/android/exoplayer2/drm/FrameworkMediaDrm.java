...
public final class FrameworkMediaDrm implements ExoMediaDrm {
    ...
    public static final ExoMediaDrm.Provider DEFAULT_PROVIDER = new FrameworkMediaDrm$$ExternalSyntheticLambda3();
    ...
    public void setOnEventListener(ExoMediaDrm.OnEventListener onEventListener) {
        this.mediaDrm.setOnEventListener(onEventListener == null ? null : new FrameworkMediaDrm$$ExternalSyntheticLambda2(this, onEventListener));
    }
    ...
    public /* synthetic */ void m789lambda$setOnEventListener$1$comgoogleandroidexoplayer2drmFrameworkMediaDrm(ExoMediaDrm.OnEventListener onEventListener, MediaDrm mediaDrm2, byte[] bArr, int i, int i2, byte[] bArr2) {
    ...
    public void setOnKeyStatusChangeListener(ExoMediaDrm.OnKeyStatusChangeListener onKeyStatusChangeListener) {
        ...
        if (Util.SDK_INT >= 23) {
            ...
            if (onKeyStatusChangeListener == null) {
                ...
                frameworkMediaDrm$$ExternalSyntheticLambda4 = new FrameworkMediaDrm$$ExternalSyntheticLambda4(this, onKeyStatusChangeListener);
            }
            mediaDrm2.setOnKeyStatusChangeListener(frameworkMediaDrm$$ExternalSyntheticLambda4, (Handler) null);
            return;
        }
    ...
    public /* synthetic */ void m791lambda$setOnKeyStatusChangeListener$2$comgoogleandroidexoplayer2drmFrameworkMediaDrm(ExoMediaDrm.OnKeyStatusChangeListener onKeyStatusChangeListener, MediaDrm mediaDrm2, byte[] bArr, List list, boolean z) {
    ...
    public /* synthetic */ void m790lambda$setOnExpirationUpdateListener$3$comgoogleandroidexoplayer2drmFrameworkMediaDrm(ExoMediaDrm.OnExpirationUpdateListener onExpirationUpdateListener, MediaDrm mediaDrm2, byte[] bArr, long j) {
    ...
    private static class Api31 {
        ...
        public static void setLogSessionIdOnMediaDrmSession(MediaDrm mediaDrm, byte[] bArr, PlayerId playerId) {
            ...
            if (!logSessionId.equals(ReactTextView$$ExternalSyntheticApiModelOutline0.m())) {
