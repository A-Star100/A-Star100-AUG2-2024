...
public class DefaultTrackSelector extends MappingTrackSelector {
    ...
    public /* synthetic */ List m830lambda$selectAudioTrack$3$comgoogleandroidexoplayer2trackselectionDefaultTrackSelector(Parameters parameters2, boolean z, int i, TrackGroup trackGroup, int[] iArr) {
    ...
    private static final class TextTrackInfo extends TrackInfo<TextTrackInfo> implements Comparable<TextTrackInfo> {
        ...
        public int compareTo(TextTrackInfo textTrackInfo) {
            Ordering ordering;
            ComparisonChain compareFalseFirst = ComparisonChain.start().compareFalseFirst(this.isWithinRendererCapabilities, textTrackInfo.isWithinRendererCapabilities).compare(Integer.valueOf(this.preferredLanguageIndex), Integer.valueOf(textTrackInfo.preferredLanguageIndex), Ordering.natural().reverse()).compare(this.preferredLanguageScore, textTrackInfo.preferredLanguageScore).compare(this.preferredRoleFlagsScore, textTrackInfo.preferredRoleFlagsScore).compareFalseFirst(this.isDefault, textTrackInfo.isDefault);
            Boolean valueOf = Boolean.valueOf(this.isForced);
            Boolean valueOf2 = Boolean.valueOf(textTrackInfo.isForced);
            if (this.preferredLanguageScore == 0) {
                ordering = Ordering.natural();
            } else {
                ordering = Ordering.natural().reverse();
            }
            ComparisonChain compare = compareFalseFirst.compare(valueOf, valueOf2, ordering).compare(this.selectedAudioLanguageScore, textTrackInfo.selectedAudioLanguageScore);
    ...
    private static class SpatializerWrapperV32 {
        ...
        private SpatializerWrapperV32(Spatializer spatializer2) {
            ...
            this.spatializationSupported = FrameworkMediaDrm$$ExternalSyntheticApiModelOutline0.m(spatializer2) != 0;
        }
        ...
        public boolean isEnabled() {
            return FrameworkMediaDrm$$ExternalSyntheticApiModelOutline0.m(this.spatializer);
        }
