...
final class ExoPlayerImpl extends BasePlayer implements ExoPlayer, ExoPlayer.AudioComponent, ExoPlayer.VideoComponent, ExoPlayer.TextComponent, ExoPlayer.DeviceComponent {
    ...
    public ExoPlayerImpl(com.google.android.exoplayer2.ExoPlayer.Builder r37, com.google.android.exoplayer2.Player r38) {
        /*
            ...
            r1 = r36
            r0 = r37
            java.lang.String r2 = " [ExoPlayerLib/2.18.1] ["
            ...
            java.lang.StringBuilder r6 = new java.lang.StringBuilder     // Catch:{ all -> 0x02e1 }
            r6.<init>(r3)     // Catch:{ all -> 0x02e1 }
            int r3 = java.lang.System.identityHashCode(r36)     // Catch:{ all -> 0x02e1 }
            java.lang.String r3 = java.lang.Integer.toHexString(r3)     // Catch:{ all -> 0x02e1 }
            r6.append(r3)     // Catch:{ all -> 0x02e1 }
            r6.append(r2)     // Catch:{ all -> 0x02e1 }
            java.lang.String r2 = com.google.android.exoplayer2.util.Util.DEVICE_DEBUG_INFO     // Catch:{ all -> 0x02e1 }
            r6.append(r2)     // Catch:{ all -> 0x02e1 }
            java.lang.String r2 = "]"
            r6.append(r2)     // Catch:{ all -> 0x02e1 }
            java.lang.String r2 = r6.toString()     // Catch:{ all -> 0x02e1 }
            com.google.android.exoplayer2.util.Log.i(r5, r2)     // Catch:{ all -> 0x02e1 }
            android.content.Context r2 = r0.context     // Catch:{ all -> 0x02e1 }
            android.content.Context r2 = r2.getApplicationContext()     // Catch:{ all -> 0x02e1 }
            r1.applicationContext = r2     // Catch:{ all -> 0x02e1 }
            com.google.common.base.Function<com.google.android.exoplayer2.util.Clock, com.google.android.exoplayer2.analytics.AnalyticsCollector> r3 = r0.analyticsCollectorFunction     // Catch:{ all -> 0x02e1 }
            com.google.android.exoplayer2.util.Clock r5 = r0.clock     // Catch:{ all -> 0x02e1 }
            java.lang.Object r3 = r3.apply(r5)     // Catch:{ all -> 0x02e1 }
            com.google.android.exoplayer2.analytics.AnalyticsCollector r3 = (com.google.android.exoplayer2.analytics.AnalyticsCollector) r3     // Catch:{ all -> 0x02e1 }
            r1.analyticsCollector = r3     // Catch:{ all -> 0x02e1 }
            com.google.android.exoplayer2.util.PriorityTaskManager r5 = r0.priorityTaskManager     // Catch:{ all -> 0x02e1 }
            r1.priorityTaskManager = r5     // Catch:{ all -> 0x02e1 }
            com.google.android.exoplayer2.audio.AudioAttributes r5 = r0.audioAttributes     // Catch:{ all -> 0x02e1 }
            r1.audioAttributes = r5     // Catch:{ all -> 0x02e1 }
            int r5 = r0.videoScalingMode     // Catch:{ all -> 0x02e1 }
            r1.videoScalingMode = r5     // Catch:{ all -> 0x02e1 }
            int r5 = r0.videoChangeFrameRateStrategy     // Catch:{ all -> 0x02e1 }
            r1.videoChangeFrameRateStrategy = r5     // Catch:{ all -> 0x02e1 }
            boolean r5 = r0.skipSilenceEnabled     // Catch:{ all -> 0x02e1 }
            r1.skipSilenceEnabled = r5     // Catch:{ all -> 0x02e1 }
            long r5 = r0.detachSurfaceTimeoutMs     // Catch:{ all -> 0x02e1 }
            r1.detachSurfaceTimeoutMs = r5     // Catch:{ all -> 0x02e1 }
            com.google.android.exoplayer2.ExoPlayerImpl$ComponentListener r15 = new com.google.android.exoplayer2.ExoPlayerImpl$ComponentListener     // Catch:{ all -> 0x02e1 }
            r14 = 0
            r15.<init>()     // Catch:{ all -> 0x02e1 }
            r1.componentListener = r15     // Catch:{ all -> 0x02e1 }
            com.google.android.exoplayer2.ExoPlayerImpl$FrameMetadataListener r13 = new com.google.android.exoplayer2.ExoPlayerImpl$FrameMetadataListener     // Catch:{ all -> 0x02e1 }
            r13.<init>()     // Catch:{ all -> 0x02e1 }
            r1.frameMetadataListener = r13     // Catch:{ all -> 0x02e1 }
            android.os.Handler r6 = new android.os.Handler     // Catch:{ all -> 0x02e1 }
            android.os.Looper r5 = r0.looper     // Catch:{ all -> 0x02e1 }
            r6.<init>(r5)     // Catch:{ all -> 0x02e1 }
            com.google.common.base.Supplier<com.google.android.exoplayer2.RenderersFactory> r5 = r0.renderersFactorySupplier     // Catch:{ all -> 0x02e1 }
            java.lang.Object r5 = r5.get()     // Catch:{ all -> 0x02e1 }
            r7 = r5
            com.google.android.exoplayer2.RenderersFactory r7 = (com.google.android.exoplayer2.RenderersFactory) r7     // Catch:{ all -> 0x02e1 }
            r8 = r6
            r9 = r15
            r10 = r15
            r11 = r15
            r12 = r15
            com.google.android.exoplayer2.Renderer[] r7 = r7.createRenderers(r8, r9, r10, r11, r12)     // Catch:{ all -> 0x02e1 }
            r1.renderers = r7     // Catch:{ all -> 0x02e1 }
            int r5 = r7.length     // Catch:{ all -> 0x02e1 }
            r12 = 0
        ...
        L_0x0094:
            r5 = r12
        L_0x0095:
            com.google.android.exoplayer2.util.Assertions.checkState(r5)     // Catch:{ all -> 0x02e1 }
            com.google.common.base.Supplier<com.google.android.exoplayer2.trackselection.TrackSelector> r5 = r0.trackSelectorSupplier     // Catch:{ all -> 0x02e1 }
            java.lang.Object r5 = r5.get()     // Catch:{ all -> 0x02e1 }
            r10 = r5
            com.google.android.exoplayer2.trackselection.TrackSelector r10 = (com.google.android.exoplayer2.trackselection.TrackSelector) r10     // Catch:{ all -> 0x02e1 }
            r1.trackSelector = r10     // Catch:{ all -> 0x02e1 }
            com.google.common.base.Supplier<com.google.android.exoplayer2.source.MediaSource$Factory> r5 = r0.mediaSourceFactorySupplier     // Catch:{ all -> 0x02e1 }
            java.lang.Object r5 = r5.get()     // Catch:{ all -> 0x02e1 }
            com.google.android.exoplayer2.source.MediaSource$Factory r5 = (com.google.android.exoplayer2.source.MediaSource.Factory) r5     // Catch:{ all -> 0x02e1 }
            r1.mediaSourceFactory = r5     // Catch:{ all -> 0x02e1 }
            com.google.common.base.Supplier<com.google.android.exoplayer2.upstream.BandwidthMeter> r5 = r0.bandwidthMeterSupplier     // Catch:{ all -> 0x02e1 }
            java.lang.Object r5 = r5.get()     // Catch:{ all -> 0x02e1 }
            r9 = r5
            com.google.android.exoplayer2.upstream.BandwidthMeter r9 = (com.google.android.exoplayer2.upstream.BandwidthMeter) r9     // Catch:{ all -> 0x02e1 }
            r1.bandwidthMeter = r9     // Catch:{ all -> 0x02e1 }
            boolean r5 = r0.useLazyPreparation     // Catch:{ all -> 0x02e1 }
            r1.useLazyPreparation = r5     // Catch:{ all -> 0x02e1 }
            com.google.android.exoplayer2.SeekParameters r5 = r0.seekParameters     // Catch:{ all -> 0x02e1 }
            r1.seekParameters = r5     // Catch:{ all -> 0x02e1 }
            r16 = r15
            long r14 = r0.seekBackIncrementMs     // Catch:{ all -> 0x02e1 }
            r1.seekBackIncrementMs = r14     // Catch:{ all -> 0x02e1 }
            long r14 = r0.seekForwardIncrementMs     // Catch:{ all -> 0x02e1 }
            r1.seekForwardIncrementMs = r14     // Catch:{ all -> 0x02e1 }
            boolean r5 = r0.pauseAtEndOfMediaItems     // Catch:{ all -> 0x02e1 }
            r1.pauseAtEndOfMediaItems = r5     // Catch:{ all -> 0x02e1 }
            android.os.Looper r15 = r0.looper     // Catch:{ all -> 0x02e1 }
            r1.applicationLooper = r15     // Catch:{ all -> 0x02e1 }
            com.google.android.exoplayer2.util.Clock r14 = r0.clock     // Catch:{ all -> 0x02e1 }
            r1.clock = r14     // Catch:{ all -> 0x02e1 }
        ...
        L_0x00da:
            r5 = r38
        L_0x00dc:
            r1.wrappingPlayer = r5     // Catch:{ all -> 0x02e1 }
            com.google.android.exoplayer2.util.ListenerSet r8 = new com.google.android.exoplayer2.util.ListenerSet     // Catch:{ all -> 0x02e1 }
            com.google.android.exoplayer2.ExoPlayerImpl$$ExternalSyntheticLambda11 r11 = new com.google.android.exoplayer2.ExoPlayerImpl$$ExternalSyntheticLambda11     // Catch:{ all -> 0x02e1 }
            r11.<init>(r1)     // Catch:{ all -> 0x02e1 }
            r8.<init>(r15, r14, r11)     // Catch:{ all -> 0x02e1 }
            r1.listeners = r8     // Catch:{ all -> 0x02e1 }
            java.util.concurrent.CopyOnWriteArraySet r8 = new java.util.concurrent.CopyOnWriteArraySet     // Catch:{ all -> 0x02e1 }
            r8.<init>()     // Catch:{ all -> 0x02e1 }
            r1.audioOffloadListeners = r8     // Catch:{ all -> 0x02e1 }
            java.util.ArrayList r8 = new java.util.ArrayList     // Catch:{ all -> 0x02e1 }
            r8.<init>()     // Catch:{ all -> 0x02e1 }
            r1.mediaSourceHolderSnapshots = r8     // Catch:{ all -> 0x02e1 }
            com.google.android.exoplayer2.source.ShuffleOrder$DefaultShuffleOrder r8 = new com.google.android.exoplayer2.source.ShuffleOrder$DefaultShuffleOrder     // Catch:{ all -> 0x02e1 }
            r8.<init>(r12)     // Catch:{ all -> 0x02e1 }
            r1.shuffleOrder = r8     // Catch:{ all -> 0x02e1 }
            com.google.android.exoplayer2.trackselection.TrackSelectorResult r8 = new com.google.android.exoplayer2.trackselection.TrackSelectorResult     // Catch:{ all -> 0x02e1 }
            int r11 = r7.length     // Catch:{ all -> 0x02e1 }
            com.google.android.exoplayer2.RendererConfiguration[] r11 = new com.google.android.exoplayer2.RendererConfiguration[r11]     // Catch:{ all -> 0x02e1 }
            int r12 = r7.length     // Catch:{ all -> 0x02e1 }
            com.google.android.exoplayer2.trackselection.ExoTrackSelection[] r12 = new com.google.android.exoplayer2.trackselection.ExoTrackSelection[r12]     // Catch:{ all -> 0x02e1 }
            r20 = r6
            com.google.android.exoplayer2.Tracks r6 = com.google.android.exoplayer2.Tracks.EMPTY     // Catch:{ all -> 0x02e1 }
            r21 = r9
            r9 = 0
            r8.<init>(r11, r12, r6, r9)     // Catch:{ all -> 0x02e1 }
            r1.emptyTrackSelectorResult = r8     // Catch:{ all -> 0x02e1 }
            com.google.android.exoplayer2.Timeline$Period r6 = new com.google.android.exoplayer2.Timeline$Period     // Catch:{ all -> 0x02e1 }
            r6.<init>()     // Catch:{ all -> 0x02e1 }
            r1.period = r6     // Catch:{ all -> 0x02e1 }
            com.google.android.exoplayer2.Player$Commands$Builder r6 = new com.google.android.exoplayer2.Player$Commands$Builder     // Catch:{ all -> 0x02e1 }
            r6.<init>()     // Catch:{ all -> 0x02e1 }
            r12 = 21
            int[] r9 = new int[r12]     // Catch:{ all -> 0x02e1 }
            r9 = {1, 2, 3, 13, 14, 15, 16, 17, 18, 19, 31, 20, 30, 21, 22, 23, 24, 25, 26, 27, 28} // fill-array     // Catch:{ all -> 0x02e1 }
            com.google.android.exoplayer2.Player$Commands$Builder r6 = r6.addAll((int[]) r9)     // Catch:{ all -> 0x02e1 }
            boolean r9 = r10.isSetParametersSupported()     // Catch:{ all -> 0x02e1 }
            r11 = 29
            com.google.android.exoplayer2.Player$Commands$Builder r6 = r6.addIf(r11, r9)     // Catch:{ all -> 0x02e1 }
            com.google.android.exoplayer2.Player$Commands r6 = r6.build()     // Catch:{ all -> 0x02e1 }
            r1.permanentAvailableCommands = r6     // Catch:{ all -> 0x02e1 }
            com.google.android.exoplayer2.Player$Commands$Builder r9 = new com.google.android.exoplayer2.Player$Commands$Builder     // Catch:{ all -> 0x02e1 }
            r9.<init>()     // Catch:{ all -> 0x02e1 }
            com.google.android.exoplayer2.Player$Commands$Builder r6 = r9.addAll((com.google.android.exoplayer2.Player.Commands) r6)     // Catch:{ all -> 0x02e1 }
            r11 = 4
            com.google.android.exoplayer2.Player$Commands$Builder r6 = r6.add(r11)     // Catch:{ all -> 0x02e1 }
            r9 = 10
            com.google.android.exoplayer2.Player$Commands$Builder r6 = r6.add(r9)     // Catch:{ all -> 0x02e1 }
            com.google.android.exoplayer2.Player$Commands r6 = r6.build()     // Catch:{ all -> 0x02e1 }
            r1.availableCommands = r6     // Catch:{ all -> 0x02e1 }
            r6 = 0
            com.google.android.exoplayer2.util.HandlerWrapper r9 = r14.createHandler(r15, r6)     // Catch:{ all -> 0x02e1 }
            r1.playbackInfoUpdateHandler = r9     // Catch:{ all -> 0x02e1 }
            com.google.android.exoplayer2.ExoPlayerImpl$$ExternalSyntheticLambda21 r9 = new com.google.android.exoplayer2.ExoPlayerImpl$$ExternalSyntheticLambda21     // Catch:{ all -> 0x02e1 }
            r9.<init>(r1)     // Catch:{ all -> 0x02e1 }
            r1.playbackInfoUpdateListener = r9     // Catch:{ all -> 0x02e1 }
            com.google.android.exoplayer2.PlaybackInfo r6 = com.google.android.exoplayer2.PlaybackInfo.createDummy(r8)     // Catch:{ all -> 0x02e1 }
            r1.playbackInfo = r6     // Catch:{ all -> 0x02e1 }
            r3.setPlayer(r5, r15)     // Catch:{ all -> 0x02e1 }
            int r5 = com.google.android.exoplayer2.util.Util.SDK_INT     // Catch:{ all -> 0x02e1 }
            r6 = 31
            if (r5 >= r6) goto L_0x0177
            com.google.android.exoplayer2.analytics.PlayerId r5 = new com.google.android.exoplayer2.analytics.PlayerId     // Catch:{ all -> 0x02e1 }
            r5.<init>()     // Catch:{ all -> 0x02e1 }
            goto L_0x017d
        L_0x0177:
            boolean r5 = r0.usePlatformDiagnostics     // Catch:{ all -> 0x02e1 }
            com.google.android.exoplayer2.analytics.PlayerId r5 = com.google.android.exoplayer2.ExoPlayerImpl.Api31.registerMediaMetricsListener(r2, r1, r5)     // Catch:{ all -> 0x02e1 }
        L_0x017d:
            r22 = r5
            com.google.android.exoplayer2.ExoPlayerImplInternal r6 = new com.google.android.exoplayer2.ExoPlayerImplInternal     // Catch:{ all -> 0x02e1 }
            com.google.common.base.Supplier<com.google.android.exoplayer2.LoadControl> r5 = r0.loadControlSupplier     // Catch:{ all -> 0x02e1 }
            java.lang.Object r5 = r5.get()     // Catch:{ all -> 0x02e1 }
            r23 = r5
            com.google.android.exoplayer2.LoadControl r23 = (com.google.android.exoplayer2.LoadControl) r23     // Catch:{ all -> 0x02e1 }
            int r5 = r1.repeatMode     // Catch:{ all -> 0x02e1 }
            boolean r12 = r1.shuffleModeEnabled     // Catch:{ all -> 0x02e1 }
            r25 = r14
            com.google.android.exoplayer2.SeekParameters r14 = r1.seekParameters     // Catch:{ all -> 0x02e1 }
            r26 = r15
            com.google.android.exoplayer2.LivePlaybackSpeedControl r15 = r0.livePlaybackSpeedControl     // Catch:{ all -> 0x02e1 }
            r27 = r14
            r28 = r15
            long r14 = r0.releaseTimeoutMs     // Catch:{ all -> 0x02e1 }
            r29 = r4
            boolean r4 = r1.pauseAtEndOfMediaItems     // Catch:{ all -> 0x02e1 }
            r30 = r5
            r5 = r6
            r0 = r6
            r31 = r20
            ...
            r18 = r4
            r19 = r26
            r5.<init>(r6, r7, r8, r9, r10, r11, r12, r13, r14, r15, r16, r18, r19, r20, r21, r22)     // Catch:{ all -> 0x02e1 }
            r1.internalPlayer = r0     // Catch:{ all -> 0x02e1 }
            r4 = 1065353216(0x3f800000, float:1.0)
            r1.volume = r4     // Catch:{ all -> 0x02e1 }
            r1.repeatMode = r2     // Catch:{ all -> 0x02e1 }
            com.google.android.exoplayer2.MediaMetadata r4 = com.google.android.exoplayer2.MediaMetadata.EMPTY     // Catch:{ all -> 0x02e1 }
            r1.mediaMetadata = r4     // Catch:{ all -> 0x02e1 }
            com.google.android.exoplayer2.MediaMetadata r4 = com.google.android.exoplayer2.MediaMetadata.EMPTY     // Catch:{ all -> 0x02e1 }
            r1.playlistMetadata = r4     // Catch:{ all -> 0x02e1 }
            com.google.android.exoplayer2.MediaMetadata r4 = com.google.android.exoplayer2.MediaMetadata.EMPTY     // Catch:{ all -> 0x02e1 }
            r1.staticAndDynamicMediaMetadata = r4     // Catch:{ all -> 0x02e1 }
            r4 = -1
            r1.maskingWindowIndex = r4     // Catch:{ all -> 0x02e1 }
            int r4 = com.google.android.exoplayer2.util.Util.SDK_INT     // Catch:{ all -> 0x02e1 }
            r5 = 21
            if (r4 >= r5) goto L_0x01f6
            int r4 = r1.initializeKeepSessionIdAudioTrack(r2)     // Catch:{ all -> 0x02e1 }
            r1.audioSessionId = r4     // Catch:{ all -> 0x02e1 }
            goto L_0x01fc
        L_0x01f6:
            int r4 = com.google.android.exoplayer2.util.Util.generateAudioSessionIdV21(r23)     // Catch:{ all -> 0x02e1 }
            r1.audioSessionId = r4     // Catch:{ all -> 0x02e1 }
        L_0x01fc:
            com.google.android.exoplayer2.text.CueGroup r4 = com.google.android.exoplayer2.text.CueGroup.EMPTY     // Catch:{ all -> 0x02e1 }
            r1.currentCueGroup = r4     // Catch:{ all -> 0x02e1 }
            r4 = 1
            r1.throwsWhenUsingWrongThread = r4     // Catch:{ all -> 0x02e1 }
            r1.addListener(r3)     // Catch:{ all -> 0x02e1 }
            android.os.Handler r5 = new android.os.Handler     // Catch:{ all -> 0x02e1 }
            r6 = r26
            r5.<init>(r6)     // Catch:{ all -> 0x02e1 }
            r6 = r32
            r6.addEventListener(r5, r3)     // Catch:{ all -> 0x02e1 }
            r3 = r35
            r1.addAudioOffloadListener(r3)     // Catch:{ all -> 0x02e1 }
            r5 = r0
            r0 = r37
            long r6 = r0.foregroundModeTimeoutMs     // Catch:{ all -> 0x02e1 }
            r8 = 0
            int r6 = (r6 > r8 ? 1 : (r6 == r8 ? 0 : -1))
            if (r6 <= 0) goto L_0x0227
            long r6 = r0.foregroundModeTimeoutMs     // Catch:{ all -> 0x02e1 }
            r5.experimentalSetForegroundModeTimeoutMs(r6)     // Catch:{ all -> 0x02e1 }
        L_0x0227:
            com.google.android.exoplayer2.AudioBecomingNoisyManager r5 = new com.google.android.exoplayer2.AudioBecomingNoisyManager     // Catch:{ all -> 0x02e1 }
            android.content.Context r6 = r0.context     // Catch:{ all -> 0x02e1 }
            r7 = r31
            r5.<init>(r6, r7, r3)     // Catch:{ all -> 0x02e1 }
            r1.audioBecomingNoisyManager = r5     // Catch:{ all -> 0x02e1 }
            boolean r6 = r0.handleAudioBecomingNoisy     // Catch:{ all -> 0x02e1 }
            r5.setEnabled(r6)     // Catch:{ all -> 0x02e1 }
            com.google.android.exoplayer2.AudioFocusManager r5 = new com.google.android.exoplayer2.AudioFocusManager     // Catch:{ all -> 0x02e1 }
            android.content.Context r6 = r0.context     // Catch:{ all -> 0x02e1 }
            r5.<init>(r6, r7, r3)     // Catch:{ all -> 0x02e1 }
            r1.audioFocusManager = r5     // Catch:{ all -> 0x02e1 }
            boolean r6 = r0.handleAudioFocus     // Catch:{ all -> 0x02e1 }
            if (r6 == 0) goto L_0x0247
            com.google.android.exoplayer2.audio.AudioAttributes r14 = r1.audioAttributes     // Catch:{ all -> 0x02e1 }
            goto L_0x0249
        L_0x0247:
            r14 = r24
        L_0x0249:
            r5.setAudioAttributes(r14)     // Catch:{ all -> 0x02e1 }
            com.google.android.exoplayer2.StreamVolumeManager r5 = new com.google.android.exoplayer2.StreamVolumeManager     // Catch:{ all -> 0x02e1 }
            android.content.Context r6 = r0.context     // Catch:{ all -> 0x02e1 }
            r5.<init>(r6, r7, r3)     // Catch:{ all -> 0x02e1 }
            r1.streamVolumeManager = r5     // Catch:{ all -> 0x02e1 }
            com.google.android.exoplayer2.audio.AudioAttributes r3 = r1.audioAttributes     // Catch:{ all -> 0x02e1 }
            int r3 = r3.usage     // Catch:{ all -> 0x02e1 }
            int r3 = com.google.android.exoplayer2.util.Util.getStreamTypeForAudioUsage(r3)     // Catch:{ all -> 0x02e1 }
            r5.setStreamType(r3)     // Catch:{ all -> 0x02e1 }
            com.google.android.exoplayer2.WakeLockManager r3 = new com.google.android.exoplayer2.WakeLockManager     // Catch:{ all -> 0x02e1 }
            android.content.Context r6 = r0.context     // Catch:{ all -> 0x02e1 }
            r3.<init>(r6)     // Catch:{ all -> 0x02e1 }
            r1.wakeLockManager = r3     // Catch:{ all -> 0x02e1 }
            int r6 = r0.wakeMode     // Catch:{ all -> 0x02e1 }
        ...
        L_0x026f:
            r12 = r2
        L_0x0270:
            r3.setEnabled(r12)     // Catch:{ all -> 0x02e1 }
            com.google.android.exoplayer2.WifiLockManager r3 = new com.google.android.exoplayer2.WifiLockManager     // Catch:{ all -> 0x02e1 }
            android.content.Context r6 = r0.context     // Catch:{ all -> 0x02e1 }
            r3.<init>(r6)     // Catch:{ all -> 0x02e1 }
            r1.wifiLockManager = r3     // Catch:{ all -> 0x02e1 }
            int r0 = r0.wakeMode     // Catch:{ all -> 0x02e1 }
            r6 = 2
        ...
        L_0x0284:
            r3.setEnabled(r12)     // Catch:{ all -> 0x02e1 }
            com.google.android.exoplayer2.DeviceInfo r0 = createDeviceInfo(r5)     // Catch:{ all -> 0x02e1 }
            r1.deviceInfo = r0     // Catch:{ all -> 0x02e1 }
            com.google.android.exoplayer2.video.VideoSize r0 = com.google.android.exoplayer2.video.VideoSize.UNKNOWN     // Catch:{ all -> 0x02e1 }
            r1.videoSize = r0     // Catch:{ all -> 0x02e1 }
            com.google.android.exoplayer2.audio.AudioAttributes r0 = r1.audioAttributes     // Catch:{ all -> 0x02e1 }
            r5 = r33
            r5.setAudioAttributes(r0)     // Catch:{ all -> 0x02e1 }
            int r0 = r1.audioSessionId     // Catch:{ all -> 0x02e1 }
            java.lang.Integer r0 = java.lang.Integer.valueOf(r0)     // Catch:{ all -> 0x02e1 }
            r2 = 10
            r1.sendRendererMessage(r4, r2, r0)     // Catch:{ all -> 0x02e1 }
            int r0 = r1.audioSessionId     // Catch:{ all -> 0x02e1 }
            java.lang.Integer r0 = java.lang.Integer.valueOf(r0)     // Catch:{ all -> 0x02e1 }
            r1.sendRendererMessage(r6, r2, r0)     // Catch:{ all -> 0x02e1 }
            com.google.android.exoplayer2.audio.AudioAttributes r0 = r1.audioAttributes     // Catch:{ all -> 0x02e1 }
            r2 = 3
            r1.sendRendererMessage(r4, r2, r0)     // Catch:{ all -> 0x02e1 }
            int r0 = r1.videoScalingMode     // Catch:{ all -> 0x02e1 }
            java.lang.Integer r0 = java.lang.Integer.valueOf(r0)     // Catch:{ all -> 0x02e1 }
            r2 = 4
            r1.sendRendererMessage(r6, r2, r0)     // Catch:{ all -> 0x02e1 }
            int r0 = r1.videoChangeFrameRateStrategy     // Catch:{ all -> 0x02e1 }
            java.lang.Integer r0 = java.lang.Integer.valueOf(r0)     // Catch:{ all -> 0x02e1 }
            r2 = 5
            r1.sendRendererMessage(r6, r2, r0)     // Catch:{ all -> 0x02e1 }
            boolean r0 = r1.skipSilenceEnabled     // Catch:{ all -> 0x02e1 }
            java.lang.Boolean r0 = java.lang.Boolean.valueOf(r0)     // Catch:{ all -> 0x02e1 }
            r2 = 9
            r1.sendRendererMessage(r4, r2, r0)     // Catch:{ all -> 0x02e1 }
            r0 = 7
            r2 = r34
            r1.sendRendererMessage(r6, r0, r2)     // Catch:{ all -> 0x02e1 }
            r0 = 6
            r3 = 8
            r1.sendRendererMessage(r0, r3, r2)     // Catch:{ all -> 0x02e1 }
            r29.open()
            return
        L_0x02e1:
            r0 = move-exception
    ...
    public /* synthetic */ void m757lambda$new$0$comgoogleandroidexoplayer2ExoPlayerImpl(Player.Listener listener, FlagSet flagSet) {
    ...
    public /* synthetic */ void m759lambda$new$2$comgoogleandroidexoplayer2ExoPlayerImpl(ExoPlayerImplInternal.PlaybackInfoUpdate playbackInfoUpdate) {
    ...
    public /* synthetic */ void m760lambda$setPlaylistMetadata$7$comgoogleandroidexoplayer2ExoPlayerImpl(Player.Listener listener) {
    ...
    public void m758lambda$new$1$comgoogleandroidexoplayer2ExoPlayerImpl(ExoPlayerImplInternal.PlaybackInfoUpdate playbackInfoUpdate) {
        long j;
        boolean z;
    ...
    public /* synthetic */ void m761lambda$updateAvailableCommands$26$comgoogleandroidexoplayer2ExoPlayerImpl(Player.Listener listener) {
    ...
    private PlaybackInfo maskTimelineAndPosition(PlaybackInfo playbackInfo2, Timeline timeline, Pair<Object, Long> pair) {
        ...
        if (z || longValue < msToUs2) {
            ...
            PlaybackInfo copyWithLoadingMediaPeriodId2 = copyWithTimeline.copyWithNewPosition(mediaPeriodId3, longValue, longValue, longValue, 0, trackGroupArray, trackSelectorResult2, list).copyWithLoadingMediaPeriodId(mediaPeriodId3);
    ...
    private final class ComponentListener implements VideoRendererEventListener, AudioRendererEventListener, TextOutput, MetadataOutput, SurfaceHolder.Callback, TextureView.SurfaceTextureListener, SphericalGLSurfaceView.VideoSurfaceListener, AudioFocusManager.PlayerControl, AudioBecomingNoisyManager.EventListener, StreamVolumeManager.Listener, ExoPlayer.AudioOffloadListener {
        ...
        public /* synthetic */ void m762lambda$onMetadata$4$comgoogleandroidexoplayer2ExoPlayerImpl$ComponentListener(Player.Listener listener) {
    ...
    private static final class Api31 {
        ...
        public static PlayerId registerMediaMetricsListener(Context context, ExoPlayerImpl exoPlayerImpl, boolean z) {
            ...
            if (create == null) {
                ...
                return new PlayerId(ReactTextView$$ExternalSyntheticApiModelOutline0.m());
            }
            if (z) {
