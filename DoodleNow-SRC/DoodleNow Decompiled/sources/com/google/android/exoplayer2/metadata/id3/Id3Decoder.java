...
public final class Id3Decoder extends SimpleMetadataDecoder {
    ...
    private static com.google.android.exoplayer2.metadata.id3.Id3Frame decodeFrame(int r20, com.google.android.exoplayer2.util.ParsableByteArray r21, boolean r22, int r23, com.google.android.exoplayer2.metadata.id3.Id3Decoder.FramePredicate r24) {
        ...
        L_0x0122:
            com.google.android.exoplayer2.metadata.id3.TextInformationFrame r1 = decodeTxxxFrame(r7, r13)     // Catch:{ UnsupportedEncodingException -> 0x021d }
            goto L_0x01fc
        L_0x0128:
            if (r9 != r1) goto L_0x0137
            java.lang.String r1 = getFrameId(r0, r9, r10, r11, r14)     // Catch:{ UnsupportedEncodingException -> 0x021d }
            com.google.android.exoplayer2.metadata.id3.TextInformationFrame r1 = decodeTextInformationFrame(r7, r13, r1)     // Catch:{ UnsupportedEncodingException -> 0x021d }
            goto L_0x01fc
        L_0x0134:
            r0 = move-exception
            goto L_0x0226
        ...
        L_0x0143:
            com.google.android.exoplayer2.metadata.id3.UrlLinkFrame r1 = decodeWxxxFrame(r7, r13)     // Catch:{ UnsupportedEncodingException -> 0x021d }
            goto L_0x01fc
        L_0x0149:
            if (r9 != r4) goto L_0x0155
            java.lang.String r1 = getFrameId(r0, r9, r10, r11, r14)     // Catch:{ UnsupportedEncodingException -> 0x021d }
            com.google.android.exoplayer2.metadata.id3.UrlLinkFrame r1 = decodeUrlLinkFrame(r7, r13, r1)     // Catch:{ UnsupportedEncodingException -> 0x021d }
            goto L_0x01fc
        L_0x0155:
            r3 = 73
            r4 = 80
            ...
            com.google.android.exoplayer2.metadata.id3.PrivFrame r1 = decodePrivFrame(r7, r13)     // Catch:{ UnsupportedEncodingException -> 0x021d }
            goto L_0x01fc
        L_0x016b:
            r5 = 71
            r6 = 79
        ...
        L_0x017d:
            com.google.android.exoplayer2.metadata.id3.GeobFrame r1 = decodeGeobFrame(r7, r13)     // Catch:{ UnsupportedEncodingException -> 0x021d }
            goto L_0x01fc
        L_0x0183:
            r5 = 65
            r1 = 67
        ...
        L_0x0198:
            com.google.android.exoplayer2.metadata.id3.ApicFrame r1 = decodeApicFrame(r7, r13, r0)     // Catch:{ UnsupportedEncodingException -> 0x021d }
            goto L_0x01fc
        L_0x019e:
            r3 = 77
        ...
        L_0x01aa:
            com.google.android.exoplayer2.metadata.id3.CommentFrame r1 = decodeCommentFrame(r7, r13)     // Catch:{ UnsupportedEncodingException -> 0x021d }
            goto L_0x01fc
        L_0x01af:
            ...
            r5 = r23
            r6 = r24
            com.google.android.exoplayer2.metadata.id3.ChapterFrame r1 = decodeChapterFrame(r1, r2, r3, r4, r5, r6)     // Catch:{ UnsupportedEncodingException -> 0x021d }
            goto L_0x01fc
        L_0x01c9:
            ...
            r5 = r23
            r6 = r24
            com.google.android.exoplayer2.metadata.id3.ChapterTocFrame r1 = decodeChapterTOCFrame(r1, r2, r3, r4, r5, r6)     // Catch:{ UnsupportedEncodingException -> 0x021d }
            goto L_0x01fc
        L_0x01e3:
            ...
            com.google.android.exoplayer2.metadata.id3.MlltFrame r1 = decodeMlltFrame(r7, r13)     // Catch:{ UnsupportedEncodingException -> 0x021d }
            goto L_0x01fc
        L_0x01f4:
            java.lang.String r1 = getFrameId(r0, r9, r10, r11, r14)     // Catch:{ UnsupportedEncodingException -> 0x021d }
            com.google.android.exoplayer2.metadata.id3.BinaryFrame r1 = decodeBinaryFrame(r7, r13, r1)     // Catch:{ UnsupportedEncodingException -> 0x021d }
        L_0x01fc:
            ...
            com.google.android.exoplayer2.util.Log.w(r12, r0)     // Catch:{ UnsupportedEncodingException -> 0x021d }
        L_0x0219:
            r7.setPosition(r15)
            return r1
        L_0x021d:
