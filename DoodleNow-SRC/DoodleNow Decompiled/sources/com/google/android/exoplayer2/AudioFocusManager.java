...
final class AudioFocusManager {
    ...
    private int requestAudioFocusV26() {
        ...
        if (audioFocusRequest2 == null || this.rebuildAudioFocusRequest) {
            if (audioFocusRequest2 == null) {
                ReactTextView$$ExternalSyntheticApiModelOutline0.m$1();
                builder = ReactTextView$$ExternalSyntheticApiModelOutline0.m(this.focusGainToRequest);
            } else {
                ReactTextView$$ExternalSyntheticApiModelOutline0.m$1();
                builder = ReactTextView$$ExternalSyntheticApiModelOutline0.m(this.audioFocusRequest);
            }
    ...
    private class AudioFocusListener implements AudioManager.OnAudioFocusChangeListener {
        ...
        public /* synthetic */ void m756lambda$onAudioFocusChange$0$comgoogleandroidexoplayer2AudioFocusManager$AudioFocusListener(int i) {
