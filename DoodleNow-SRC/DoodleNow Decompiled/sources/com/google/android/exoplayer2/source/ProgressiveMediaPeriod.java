...
final class ProgressiveMediaPeriod implements MediaPeriod, ExtractorOutput, Loader.Callback<ExtractingLoadable>, Loader.ReleaseCallback, SampleQueue.UpstreamFormatChangedListener {
    ...
    public /* synthetic */ void m813lambda$onLengthKnown$2$comgoogleandroidexoplayer2sourceProgressiveMediaPeriod() {
    ...
    public /* synthetic */ void m812lambda$new$0$comgoogleandroidexoplayer2sourceProgressiveMediaPeriod() {
        if (!this.released) {
    ...
    public void m814lambda$seekMap$1$comgoogleandroidexoplayer2sourceProgressiveMediaPeriod(SeekMap seekMap2) {
