...
public final class DashMediaSource extends BaseMediaSource {
    ...
    public /* synthetic */ void m822lambda$new$0$comgoogleandroidexoplayer2sourcedashDashMediaSource() {
    ...
    public void onManifestLoadCompleted(ParsingLoadable<DashManifest> parsingLoadable, long j, long j2) {
        ...
        if (dashManifest == null) {
            ...
            i = dashManifest.getPeriodCount();
        }
        long j4 = result.getPeriod(0).startMs;
        int i2 = 0;
        while (i2 < i && this.manifest.getPeriod(i2).startMs < j4) {
            i2++;
        }
        if (result.dynamic) {
            ...
            if (i3 < this.loadErrorHandlingPolicy.getMinimumLoadableRetryCount(parsingLoadable2.type)) {
