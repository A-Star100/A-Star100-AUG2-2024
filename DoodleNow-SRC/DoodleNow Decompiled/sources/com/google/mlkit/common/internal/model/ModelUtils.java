...
public class ModelUtils {
    ...
    public static com.google.mlkit.common.internal.model.ModelUtils.AutoMLManifest parseManifestFile(java.lang.String r6, boolean r7, android.content.Context r8) {
        ...
        L_0x002f:
            ...
            return r1
        L_0x0037:
            boolean r4 = r6.isEmpty()     // Catch:{ JSONException -> 0x009f, IOException -> 0x009d }
            r5 = 0
            if (r4 == 0) goto L_0x0041
            byte[] r6 = new byte[r5]     // Catch:{ JSONException -> 0x009f, IOException -> 0x009d }
            goto L_0x0066
        L_0x0041:
            if (r7 == 0) goto L_0x004c
            android.content.res.AssetManager r7 = r8.getAssets()     // Catch:{ JSONException -> 0x009f, IOException -> 0x009d }
            java.io.InputStream r6 = r7.open(r6)     // Catch:{ JSONException -> 0x009f, IOException -> 0x009d }
            goto L_0x0057
        L_0x004c:
            java.io.FileInputStream r7 = new java.io.FileInputStream     // Catch:{ JSONException -> 0x009f, IOException -> 0x009d }
            java.io.File r8 = new java.io.File     // Catch:{ JSONException -> 0x009f, IOException -> 0x009d }
            r8.<init>(r6)     // Catch:{ JSONException -> 0x009f, IOException -> 0x009d }
            r7.<init>(r8)     // Catch:{ JSONException -> 0x009f, IOException -> 0x009d }
            r6 = r7
        L_0x0057:
            ...
            r6.close()     // Catch:{ JSONException -> 0x009f, IOException -> 0x009d }
        L_0x0065:
            r6 = r8
        L_0x0066:
            java.lang.String r7 = new java.lang.String     // Catch:{ JSONException -> 0x009f, IOException -> 0x009d }
            java.lang.String r8 = "UTF-8"
            r7.<init>(r6, r8)     // Catch:{ JSONException -> 0x009f, IOException -> 0x009d }
            java.lang.String r6 = r0.concat(r7)     // Catch:{ JSONException -> 0x009f, IOException -> 0x009d }
            r2.d(r3, r6)     // Catch:{ JSONException -> 0x009f, IOException -> 0x009d }
            org.json.JSONObject r6 = new org.json.JSONObject     // Catch:{ JSONException -> 0x009f, IOException -> 0x009d }
            r6.<init>(r7)     // Catch:{ JSONException -> 0x009f, IOException -> 0x009d }
            java.lang.String r7 = "modelType"
            java.lang.String r7 = r6.getString(r7)     // Catch:{ JSONException -> 0x009f, IOException -> 0x009d }
            java.lang.String r8 = "modelFile"
            java.lang.String r8 = r6.getString(r8)     // Catch:{ JSONException -> 0x009f, IOException -> 0x009d }
            java.lang.String r0 = "labelsFile"
            java.lang.String r6 = r6.getString(r0)     // Catch:{ JSONException -> 0x009f, IOException -> 0x009d }
            com.google.mlkit.common.internal.model.AutoValue_ModelUtils_AutoMLManifest r0 = new com.google.mlkit.common.internal.model.AutoValue_ModelUtils_AutoMLManifest     // Catch:{ JSONException -> 0x009f, IOException -> 0x009d }
            r0.<init>(r7, r8, r6)     // Catch:{ JSONException -> 0x009f, IOException -> 0x009d }
            return r0
        L_0x0091:
            r7 = move-exception
        ...
        L_0x0098:
            r6 = move-exception
            com.google.mlkit.common.internal.model.zzh.zza(r7, r6)     // Catch:{ JSONException -> 0x009f, IOException -> 0x009d }
        L_0x009c:
            throw r7     // Catch:{ JSONException -> 0x009f, IOException -> 0x009d }
        L_0x009d:
            r6 = move-exception
            goto L_0x00a0
        L_0x009f:
