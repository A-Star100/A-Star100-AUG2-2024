...
public class RemoteModelDownloadManager {
    ...
    private final synchronized Long zzo(ModelInfo modelInfo, DownloadConditions downloadConditions) throws MlKitException {
        ...
        if (downloadingModelHash == null || !downloadingModelHash.equals(modelInfo.getModelHash()) || downloadingModelStatusCode == null) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                DownloadManager.Request unused = request.setRequiresCharging(downloadConditions.isChargingRequired());
            }
    ...
    public boolean isModelDownloadedAndValid() throws MlKitException {
        ...
        if (downloadingModelStatusCode == null) {
            removeOrCancelDownload();
            return false;
        } else if (!com.google.android.gms.common.internal.Objects.equal(downloadingModelStatusCode, 8) || zzi(downloadingModelHash) == null) {
            return false;
        } else {
            return true;
        }
    ...
    public synchronized void removeOrCancelDownload() throws com.google.mlkit.common.MlKitException {
        /*
            r5 = this;
            monitor-enter(r5)
            java.lang.Long r0 = r5.getDownloadingId()     // Catch:{ all -> 0x0057 }
            android.app.DownloadManager r1 = r5.zzf     // Catch:{ all -> 0x0057 }
            if (r1 == 0) goto L_0x0055
            if (r0 != 0) goto L_0x000c
            goto L_0x0055
        L_0x000c:
            com.google.android.gms.common.internal.GmsLogger r1 = zza     // Catch:{ all -> 0x0057 }
            java.lang.String r2 = "Cancel or remove existing downloading task: "
            java.util.Objects.toString(r0)     // Catch:{ all -> 0x0057 }
            java.lang.String r3 = r0.toString()     // Catch:{ all -> 0x0057 }
            java.lang.String r2 = r2.concat(r3)     // Catch:{ all -> 0x0057 }
            java.lang.String r3 = "ModelDownloadManager"
            r1.d(r3, r2)     // Catch:{ all -> 0x0057 }
            android.app.DownloadManager r1 = r5.zzf     // Catch:{ all -> 0x0057 }
            r2 = 1
            long[] r2 = new long[r2]     // Catch:{ all -> 0x0057 }
            long r3 = r0.longValue()     // Catch:{ all -> 0x0057 }
            r0 = 0
            r2[r0] = r3     // Catch:{ all -> 0x0057 }
            int r0 = r1.remove(r2)     // Catch:{ all -> 0x0057 }
            if (r0 > 0) goto L_0x003b
            java.lang.Integer r0 = r5.getDownloadingModelStatusCode()     // Catch:{ all -> 0x0057 }
        ...
        L_0x0039:
            ...
            return
        L_0x003b:
            com.google.mlkit.common.sdkinternal.model.ModelFileHelper r0 = r5.zzk     // Catch:{ all -> 0x0057 }
            com.google.mlkit.common.model.RemoteModel r1 = r5.zzg     // Catch:{ all -> 0x0057 }
            java.lang.String r1 = r1.getUniqueModelNameForPersist()     // Catch:{ all -> 0x0057 }
            com.google.mlkit.common.model.RemoteModel r2 = r5.zzg     // Catch:{ all -> 0x0057 }
            com.google.mlkit.common.sdkinternal.ModelType r2 = r2.getModelType()     // Catch:{ all -> 0x0057 }
            r0.deleteTempFilesInPrivateFolder(r1, r2)     // Catch:{ all -> 0x0057 }
            com.google.mlkit.common.sdkinternal.SharedPrefManager r0 = r5.zzj     // Catch:{ all -> 0x0057 }
            com.google.mlkit.common.model.RemoteModel r1 = r5.zzg     // Catch:{ all -> 0x0057 }
            r0.clearDownloadingModelInfo(r1)     // Catch:{ all -> 0x0057 }
            monitor-exit(r5)
            return
        L_0x0055:
            monitor-exit(r5)
