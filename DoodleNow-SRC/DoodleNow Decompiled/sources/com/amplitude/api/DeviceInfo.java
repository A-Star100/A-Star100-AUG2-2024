...
public class DeviceInfo {
    ...
    private class CachedInfo {
        ...
        private Locale getLocale() {
            ...
            if (ComponentDialog$$ExternalSyntheticApiModelOutline0.m(m)) {
        ...
        private boolean checkGPSEnabled() {
            try {
                ...
                String access$200 = DeviceInfo.TAG;
                logger.w(access$200, "Error when checking for Google Play Services: " + e);
                return false;
            }
        }
    }

    public DeviceInfo(Context context2, boolean z, boolean z2) {
