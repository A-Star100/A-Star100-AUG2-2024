...
public final class SingleRequest<R> implements Request, SizeReadyCallback, ResourceCallback {
    ...
    public void onResourceReady(com.bumptech.glide.load.engine.Resource<?> r7, com.bumptech.glide.load.DataSource r8, boolean r9) {
        /*
            ...
            r2.throwIfRecycled()
            r2 = 0
            java.lang.Object r3 = r6.requestLock     // Catch:{ all -> 0x00bd }
            monitor-enter(r3)     // Catch:{ all -> 0x00bd }
            r6.loadStatus = r2     // Catch:{ all -> 0x00ba }
            ...
            java.lang.Class<R> r9 = r6.transcodeClass     // Catch:{ all -> 0x00ba }
            ...
            r6.onLoadFailed(r7)     // Catch:{ all -> 0x00ba }
            monitor-exit(r3)     // Catch:{ all -> 0x00ba }
            return
        L_0x002e:
            java.lang.Object r1 = r7.get()     // Catch:{ all -> 0x00ba }
            if (r1 == 0) goto L_0x0062
            java.lang.Class<R> r4 = r6.transcodeClass     // Catch:{ all -> 0x00ba }
            java.lang.Class r5 = r1.getClass()     // Catch:{ all -> 0x00ba }
            boolean r4 = r4.isAssignableFrom(r5)     // Catch:{ all -> 0x00ba }
            if (r4 != 0) goto L_0x0041
            goto L_0x0062
        L_0x0041:
            boolean r0 = r6.canSetResource()     // Catch:{ all -> 0x00ba }
            if (r0 != 0) goto L_0x005d
            r6.resource = r2     // Catch:{ all -> 0x00b6 }
            com.bumptech.glide.request.SingleRequest$Status r8 = com.bumptech.glide.request.SingleRequest.Status.COMPLETE     // Catch:{ all -> 0x00b6 }
            r6.status = r8     // Catch:{ all -> 0x00b6 }
            java.lang.String r8 = "GlideRequest"
            int r9 = r6.cookie     // Catch:{ all -> 0x00b6 }
            com.bumptech.glide.util.pool.GlideTrace.endSectionAsync(r8, r9)     // Catch:{ all -> 0x00b6 }
        ...
        L_0x005c:
            return
        L_0x005d:
            r6.onResourceReady(r7, r1, r8, r9)     // Catch:{ all -> 0x00ba }
            monitor-exit(r3)     // Catch:{ all -> 0x00ba }
            return
        L_0x0062:
            r6.resource = r2     // Catch:{ all -> 0x00b6 }
            ...
            java.lang.Class<R> r0 = r6.transcodeClass     // Catch:{ all -> 0x00b6 }
            r9.append(r0)     // Catch:{ all -> 0x00b6 }
            java.lang.String r0 = " but instead got "
            r9.append(r0)     // Catch:{ all -> 0x00b6 }
            if (r1 == 0) goto L_0x007c
            java.lang.Class r0 = r1.getClass()     // Catch:{ all -> 0x00b6 }
            goto L_0x007e
        L_0x007c:
            java.lang.String r0 = ""
        L_0x007e:
        ...
        L_0x00a0:
            ...
            r6.onLoadFailed(r8)     // Catch:{ all -> 0x00b6 }
            monitor-exit(r3)     // Catch:{ all -> 0x00b6 }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:23:0x00cf A[Catch:{ all -> 0x00e6 }] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void onResourceReady(com.bumptech.glide.load.engine.Resource<R> r16, R r17, com.bumptech.glide.load.DataSource r18, boolean r19) {
        ...
        L_0x006d:
            ...
            r11 = 0
            java.util.List<com.bumptech.glide.request.RequestListener<R>> r2 = r1.requestListeners     // Catch:{ all -> 0x00e6 }
            if (r2 == 0) goto L_0x00b5
            java.util.Iterator r12 = r2.iterator()     // Catch:{ all -> 0x00e6 }
            r8 = r11
        L_0x007d:
            boolean r2 = r12.hasNext()     // Catch:{ all -> 0x00e6 }
            if (r2 == 0) goto L_0x00b6
            java.lang.Object r2 = r12.next()     // Catch:{ all -> 0x00e6 }
            r13 = r2
            com.bumptech.glide.request.RequestListener r13 = (com.bumptech.glide.request.RequestListener) r13     // Catch:{ all -> 0x00e6 }
            java.lang.Object r4 = r1.model     // Catch:{ all -> 0x00e6 }
            com.bumptech.glide.request.target.Target<R> r5 = r1.target     // Catch:{ all -> 0x00e6 }
            r2 = r13
            r3 = r17
            r6 = r18
            r7 = r9
            boolean r2 = r2.onResourceReady(r3, r4, r5, r6, r7)     // Catch:{ all -> 0x00e6 }
            r14 = r8 | r2
            boolean r2 = r13 instanceof com.bumptech.glide.request.ExperimentalRequestListener     // Catch:{ all -> 0x00e6 }
            if (r2 == 0) goto L_0x00b3
            r2 = r13
            com.bumptech.glide.request.ExperimentalRequestListener r2 = (com.bumptech.glide.request.ExperimentalRequestListener) r2     // Catch:{ all -> 0x00e6 }
            java.lang.Object r4 = r1.model     // Catch:{ all -> 0x00e6 }
            com.bumptech.glide.request.target.Target<R> r5 = r1.target     // Catch:{ all -> 0x00e6 }
            r3 = r17
            r6 = r18
            r7 = r9
            r8 = r19
            boolean r2 = r2.onResourceReady(r3, r4, r5, r6, r7, r8)     // Catch:{ all -> 0x00e6 }
            r2 = r2 | r14
            r8 = r2
            goto L_0x007d
        L_0x00b3:
        ...
        L_0x00b5:
            r8 = r11
        L_0x00b6:
            com.bumptech.glide.request.RequestListener<R> r2 = r1.targetListener     // Catch:{ all -> 0x00e6 }
        ...
        L_0x00cb:
            ...
            com.bumptech.glide.request.transition.TransitionFactory<? super R> r2 = r1.animationFactory     // Catch:{ all -> 0x00e6 }
            com.bumptech.glide.request.transition.Transition r0 = r2.build(r0, r9)     // Catch:{ all -> 0x00e6 }
            com.bumptech.glide.request.target.Target<R> r2 = r1.target     // Catch:{ all -> 0x00e6 }
            r3 = r17
            r2.onResourceReady(r3, r0)     // Catch:{ all -> 0x00e6 }
        L_0x00dc:
