...
public class VideoDecoder<T> implements ResourceDecoder<T, Bitmap> {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:26:0x005d A[Catch:{ all -> 0x0068 }] */
    /* JADX WARNING: Removed duplicated region for block: B:28:0x0064 A[DONT_GENERATE] */
    ...
    private boolean isUnsupportedFormat(T r6, android.media.MediaMetadataRetriever r7) {
        /*
            ...
            r1 = 12
            r3 = 0
            java.lang.String r7 = r7.extractMetadata(r1)     // Catch:{ all -> 0x0055 }
            java.lang.String r1 = "video/webm"
            boolean r7 = r1.equals(r7)     // Catch:{ all -> 0x0055 }
            if (r7 != 0) goto L_0x0022
            return r2
        L_0x0022:
            android.media.MediaExtractor r7 = new android.media.MediaExtractor     // Catch:{ all -> 0x0055 }
            r7.<init>()     // Catch:{ all -> 0x0055 }
            com.bumptech.glide.load.resource.bitmap.VideoDecoder$MediaInitializer<T> r1 = r5.initializer     // Catch:{ all -> 0x0052 }
            r1.initializeExtractor(r7, r6)     // Catch:{ all -> 0x0052 }
            int r6 = r7.getTrackCount()     // Catch:{ all -> 0x0052 }
            r1 = r2
        L_0x0031:
            if (r1 >= r6) goto L_0x004e
            android.media.MediaFormat r3 = r7.getTrackFormat(r1)     // Catch:{ all -> 0x0052 }
        ...
        L_0x0056:
            r7 = 3
            boolean r7 = android.util.Log.isLoggable(r0, r7)     // Catch:{ all -> 0x0068 }
            if (r7 == 0) goto L_0x0062
            java.lang.String r7 = "Exception trying to extract track info for a webm video on CrOS."
            android.util.Log.d(r0, r7, r6)     // Catch:{ all -> 0x0068 }
        L_0x0062:
