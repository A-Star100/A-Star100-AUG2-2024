...
public final class Downsampler {
    ...
    private Bitmap decodeFromWrappedStreams(ImageReader imageReader, BitmapFactory.Options options, DownsampleStrategy downsampleStrategy, DecodeFormat decodeFormat, PreferredColorSpace preferredColorSpace, boolean z, int i, int i2, boolean z2, DecodeCallbacks decodeCallbacks) throws IOException {
        ...
        if (preferredColorSpace3 != null) {
            if (Build.VERSION.SDK_INT >= 28) {
                options3.inPreferredColorSpace = ColorSpace.get((preferredColorSpace3 != PreferredColorSpace.DISPLAY_P3 || zzg$$ExternalSyntheticApiModelOutline0.m(options) == null || !zzg$$ExternalSyntheticApiModelOutline0.m(options).isWideGamut()) ? ColorKt$$ExternalSyntheticApiModelOutline0.m() : zzg$$ExternalSyntheticApiModelOutline0.m());
    ...
    private void calculateConfig(com.bumptech.glide.load.resource.bitmap.ImageReader r7, com.bumptech.glide.load.DecodeFormat r8, boolean r9, boolean r10, android.graphics.BitmapFactory.Options r11, int r12, int r13) {
        ...
        L_0x000e:
            ...
            com.bumptech.glide.load.ImageHeaderParser$ImageType r7 = r7.getImageType()     // Catch:{ IOException -> 0x001f }
            boolean r7 = r7.hasAlpha()     // Catch:{ IOException -> 0x001f }
    ...
    private static void setInBitmap(BitmapFactory.Options options, BitmapPool bitmapPool2, int i, int i2) {
        ...
        if (Build.VERSION.SDK_INT < 26) {
            config = null;
        } else if (options.inPreferredConfig != zzg$$ExternalSyntheticApiModelOutline0.m()) {
            config = zzg$$ExternalSyntheticApiModelOutline0.m(options);
        } else {
            return;
        }
        if (config == null) {
