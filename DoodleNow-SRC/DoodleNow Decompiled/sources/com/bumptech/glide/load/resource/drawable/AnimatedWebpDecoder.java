...
public final class AnimatedWebpDecoder {
    ...
    public Resource<Drawable> decode(ImageDecoder.Source source, int i, int i2, Options options) throws IOException {
        ...
        if (zzg$$ExternalSyntheticApiModelOutline0.m((Object) m)) {
            return new AnimatedImageDrawableResource(zzg$$ExternalSyntheticApiModelOutline0.m((Object) m));
        }
    ...
    private static final class AnimatedImageDrawableResource implements Resource<Drawable> {
        ...
        public int getSize() {
            return zzg$$ExternalSyntheticApiModelOutline0.m(this.imageDrawable) * this.imageDrawable.getIntrinsicHeight() * Util.getBytesPerPixel(Bitmap.Config.ARGB_8888) * 2;
        }

        public void recycle() {
            zzg$$ExternalSyntheticApiModelOutline0.m(this.imageDrawable);
