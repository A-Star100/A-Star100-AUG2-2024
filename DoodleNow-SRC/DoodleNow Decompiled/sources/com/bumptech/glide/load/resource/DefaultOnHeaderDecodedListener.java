...
public final class DefaultOnHeaderDecodedListener implements ImageDecoder$OnHeaderDecodedListener {
    ...
    public void onHeaderDecoded(ImageDecoder imageDecoder, ImageDecoder.ImageInfo imageInfo, ImageDecoder.Source source) {
        ...
        Size m = zzg$$ExternalSyntheticApiModelOutline0.m(imageInfo);
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            imageDecoder.setTargetColorSpace(ColorSpace.get((this.preferredColorSpace != PreferredColorSpace.DISPLAY_P3 || zzg$$ExternalSyntheticApiModelOutline0.m(imageInfo) == null || !zzg$$ExternalSyntheticApiModelOutline0.m(imageInfo).isWideGamut()) ? ColorKt$$ExternalSyntheticApiModelOutline0.m() : zzg$$ExternalSyntheticApiModelOutline0.m()));
