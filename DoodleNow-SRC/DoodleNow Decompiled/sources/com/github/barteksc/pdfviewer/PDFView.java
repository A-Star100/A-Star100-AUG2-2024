...
public class PDFView extends RelativeLayout {
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void performPageSnap(boolean r4) {
        /*
            r3 = this;
        ...
        L_0x0020:
            ...
            com.github.barteksc.pdfviewer.AnimationManager r4 = r3.animationManager
            float r1 = r3.currentYOffset
            float r0 = -r0
            r4.startYAnimation(r1, r0)
            goto L_0x004b
        L_0x0033:
            float r4 = r3.currentXOffset
            float r0 = -r0
            r3.moveTo(r4, r0)
            goto L_0x004b
        L_0x003a:
            ...
            com.github.barteksc.pdfviewer.AnimationManager r4 = r3.animationManager
            float r1 = r3.currentXOffset
            float r0 = -r0
            r4.startXAnimation(r1, r0)
            goto L_0x004b
        L_0x0045:
            float r4 = -r0
            float r0 = r3.currentYOffset
            r3.moveTo(r4, r0)
        L_0x004b:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.github.barteksc.pdfviewer.PDFView.performPageSnap(boolean):void");
    }
