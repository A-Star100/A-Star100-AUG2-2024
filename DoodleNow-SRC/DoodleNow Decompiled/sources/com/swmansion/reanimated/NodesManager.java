    ...
    public String obtainProp(int i, String str) {
        try {
            ...
            switch (c) {
                ...
                case 1:
                    return Float.toString(PixelUtil.toDIPFromPixel((float) resolveView.getHeight()));
                case 2:
                    return Float.toString(resolveView.getElevation());
                case 3:
                    return Float.toString(PixelUtil.toDIPFromPixel((float) resolveView.getTop()));
                case 4:
                    return Float.toString(PixelUtil.toDIPFromPixel((float) resolveView.getLeft()));
                case 5:
                    return Float.toString(PixelUtil.toDIPFromPixel((float) resolveView.getWidth()));
                case 6:
                    ...
                    String format = String.format("%08x", new Object[]{Integer.valueOf(((ReactViewBackgroundDrawable) background).getColor())});
