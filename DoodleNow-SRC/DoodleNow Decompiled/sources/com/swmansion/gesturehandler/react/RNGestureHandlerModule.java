...
public final class RNGestureHandlerModule extends NativeRNGestureHandlerModuleSpec implements GestureHandlerStateManager {
    ...
    private final com.swmansion.gesturehandler.react.RNGestureHandlerRootHelper findRootHelperForViewAncestor(int r7) {
        ...
        L_0x0018:
            ...
            monitor-enter(r0)
            java.util.List<com.swmansion.gesturehandler.react.RNGestureHandlerRootHelper> r2 = r6.roots     // Catch:{ all -> 0x0049 }
            java.lang.Iterable r2 = (java.lang.Iterable) r2     // Catch:{ all -> 0x0049 }
            java.util.Iterator r2 = r2.iterator()     // Catch:{ all -> 0x0049 }
        L_0x0023:
            boolean r3 = r2.hasNext()     // Catch:{ all -> 0x0049 }
            if (r3 == 0) goto L_0x0045
            java.lang.Object r3 = r2.next()     // Catch:{ all -> 0x0049 }
            r4 = r3
            com.swmansion.gesturehandler.react.RNGestureHandlerRootHelper r4 = (com.swmansion.gesturehandler.react.RNGestureHandlerRootHelper) r4     // Catch:{ all -> 0x0049 }
            android.view.ViewGroup r5 = r4.getRootView()     // Catch:{ all -> 0x0049 }
            boolean r5 = r5 instanceof com.facebook.react.ReactRootView     // Catch:{ all -> 0x0049 }
            if (r5 == 0) goto L_0x0023
            android.view.ViewGroup r4 = r4.getRootView()     // Catch:{ all -> 0x0049 }
            com.facebook.react.ReactRootView r4 = (com.facebook.react.ReactRootView) r4     // Catch:{ all -> 0x0049 }
            int r4 = r4.getRootViewTag()     // Catch:{ all -> 0x0049 }
            if (r4 != r7) goto L_0x0023
            r1 = r3
        L_0x0045:
            com.swmansion.gesturehandler.react.RNGestureHandlerRootHelper r1 = (com.swmansion.gesturehandler.react.RNGestureHandlerRootHelper) r1     // Catch:{ all -> 0x0049 }
            monitor-exit(r0)
            return r1
        L_0x0049:
            r7 = move-exception
