...
public class GestureHandler<ConcreteGestureHandlerT extends GestureHandler<ConcreteGestureHandlerT>> {
    ...
    public final void m1160setMouseButton(int i) {
        this.mouseButton = i;
    }
    ...
    public final boolean wantEvents() {
        /*
            ...
            r2 = 5
            if (r0 == r2) goto L_0x0014
            int r0 = r3.trackedPointersIDsCount
            if (r0 <= 0) goto L_0x0014
            goto L_0x0015
        L_0x0014:
            r1 = 0
        L_0x0015:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.swmansion.gesturehandler.core.GestureHandler.wantEvents():boolean");
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:76:0x00b6 A[EDGE_INSN: B:76:0x00b6->B:42:0x00b6 ?: BREAK  , SYNTHETIC] */
    ...
    private final android.view.MotionEvent adaptEvent(android.view.MotionEvent r26) {
        ...
        L_0x00e1:
            ...
            throw r0
        L_0x00fc:
            long r5 = r26.getDownTime()     // Catch:{ IllegalArgumentException -> 0x014d }
            long r11 = r26.getEventTime()     // Catch:{ IllegalArgumentException -> 0x014d }
            android.view.MotionEvent$PointerProperties[] r0 = pointerProps     // Catch:{ IllegalArgumentException -> 0x014d }
            if (r0 != 0) goto L_0x010d
            kotlin.jvm.internal.Intrinsics.throwUninitializedPropertyAccessException(r9)     // Catch:{ IllegalArgumentException -> 0x014d }
            r15 = r10
            goto L_0x010e
        L_0x010d:
            r15 = r0
        L_0x010e:
            android.view.MotionEvent$PointerCoords[] r0 = pointerCoords     // Catch:{ IllegalArgumentException -> 0x014d }
            if (r0 != 0) goto L_0x0118
            kotlin.jvm.internal.Intrinsics.throwUninitializedPropertyAccessException(r3)     // Catch:{ IllegalArgumentException -> 0x014d }
            r16 = r10
            goto L_0x011a
        L_0x0118:
            r16 = r0
        L_0x011a:
            int r17 = r26.getMetaState()     // Catch:{ IllegalArgumentException -> 0x014d }
            int r18 = r26.getButtonState()     // Catch:{ IllegalArgumentException -> 0x014d }
            float r19 = r26.getXPrecision()     // Catch:{ IllegalArgumentException -> 0x014d }
            float r20 = r26.getYPrecision()     // Catch:{ IllegalArgumentException -> 0x014d }
            int r21 = r26.getDeviceId()     // Catch:{ IllegalArgumentException -> 0x014d }
            int r22 = r26.getEdgeFlags()     // Catch:{ IllegalArgumentException -> 0x014d }
            int r23 = r26.getSource()     // Catch:{ IllegalArgumentException -> 0x014d }
            int r24 = r26.getFlags()     // Catch:{ IllegalArgumentException -> 0x014d }
            r9 = r5
            android.view.MotionEvent r0 = android.view.MotionEvent.obtain(r9, r11, r13, r14, r15, r16, r17, r18, r19, r20, r21, r22, r23, r24)     // Catch:{ IllegalArgumentException -> 0x014d }
            java.lang.String r3 = "obtain(...)"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r0, r3)     // Catch:{ IllegalArgumentException -> 0x014d }
            float r3 = -r4
            float r4 = -r7
    ...
    public final boolean isWithinBounds(View view2, float f, float f2) {
        ...
        if (f4 > f || f > width || f3 > f2 || f2 > height) {
            return false;
        }
        return true;
    }
    ...
    private static final class PointerData {
        ...
        public String toString() {
            ...
            float f4 = this.absoluteY;
            return "PointerData(pointerId=" + i + ", x=" + f + ", y=" + f2 + ", absoluteX=" + f3 + ", absoluteY=" + f4 + ")";
        }
