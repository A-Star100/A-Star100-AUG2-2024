...
public final class ScreenStackHeaderConfig extends ViewGroup {
    ...
    private final View.OnClickListener backClickListener = new ScreenStackHeaderConfig$$ExternalSyntheticLambda3(this);
    ...
    public void onAttachedToWindow() {
        ...
        if (this.headerTopInset == null) {
            if (Build.VERSION.SDK_INT >= 30) {
                num = Integer.valueOf(getRootWindowInsets().getInsets(Downloader$$ExternalSyntheticApiModelOutline0.m()).top);
            } else {
