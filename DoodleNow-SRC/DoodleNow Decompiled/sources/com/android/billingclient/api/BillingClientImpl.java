...
class BillingClientImpl extends BillingClient {
    ...
    public final com.android.billingclient.api.BillingResult launchBillingFlow(android.app.Activity r32, com.android.billingclient.api.BillingFlowParams r33) {
        ...
        L_0x047d:
            ...
            com.android.billingclient.api.BillingResult r1 = com.android.billingclient.api.zzbk.zzm     // Catch:{ TimeoutException -> 0x0506, CancellationException -> 0x0504, Exception -> 0x04eb }
            r2 = 25
            r3 = 2
            com.google.android.gms.internal.play_billing.zzhy r1 = com.android.billingclient.api.zzbh.zza(r2, r3, r1)     // Catch:{ TimeoutException -> 0x0506, CancellationException -> 0x0504, Exception -> 0x04eb }
            ...
            return r0
        L_0x0493:
            java.util.concurrent.TimeUnit r2 = java.util.concurrent.TimeUnit.MILLISECONDS     // Catch:{ TimeoutException -> 0x0506, CancellationException -> 0x0504, Exception -> 0x04eb }
            r3 = 5000(0x1388, double:2.4703E-320)
            java.lang.Object r0 = r0.get(r3, r2)     // Catch:{ TimeoutException -> 0x0506, CancellationException -> 0x0504, Exception -> 0x04eb }
            android.os.Bundle r0 = (android.os.Bundle) r0     // Catch:{ TimeoutException -> 0x0506, CancellationException -> 0x0504, Exception -> 0x04eb }
            int r2 = com.google.android.gms.internal.play_billing.zzb.zzb(r0, r9)     // Catch:{ TimeoutException -> 0x0506, CancellationException -> 0x0504, Exception -> 0x04eb }
            java.lang.String r3 = com.google.android.gms.internal.play_billing.zzb.zzg(r0, r9)     // Catch:{ TimeoutException -> 0x0506, CancellationException -> 0x0504, Exception -> 0x04eb }
        ...
        L_0x04c5:
            r4 = 2
            com.google.android.gms.internal.play_billing.zzhy r0 = com.android.billingclient.api.zzbh.zza(r1, r4, r2)     // Catch:{ TimeoutException -> 0x0506, CancellationException -> 0x0504, Exception -> 0x04eb }
            ...
            return r2
        L_0x04d1:
            android.content.Intent r1 = new android.content.Intent     // Catch:{ TimeoutException -> 0x0506, CancellationException -> 0x0504, Exception -> 0x04eb }
            ...
            r3 = r32
            r1.<init>(r3, r2)     // Catch:{ TimeoutException -> 0x0506, CancellationException -> 0x0504, Exception -> 0x04eb }
            r2 = r17
            android.os.Parcelable r0 = r0.getParcelable(r2)     // Catch:{ TimeoutException -> 0x0506, CancellationException -> 0x0504, Exception -> 0x04eb }
            android.app.PendingIntent r0 = (android.app.PendingIntent) r0     // Catch:{ TimeoutException -> 0x0506, CancellationException -> 0x0504, Exception -> 0x04eb }
            r1.putExtra(r2, r0)     // Catch:{ TimeoutException -> 0x0506, CancellationException -> 0x0504, Exception -> 0x04eb }
            r3.startActivity(r1)     // Catch:{ TimeoutException -> 0x0506, CancellationException -> 0x0504, Exception -> 0x04eb }
    ...
    public final /* synthetic */ Object zzn(QueryProductDetailsParams queryProductDetailsParams, ProductDetailsResponseListener productDetailsResponseListener) throws Exception {
        ...
        while (true) {
            ...
            try {
                ...
                i3 = 7;
                try {
                    Bundle zzl2 = zzm2.zzl(i7, packageName, zzb2, bundle, bundle2);
