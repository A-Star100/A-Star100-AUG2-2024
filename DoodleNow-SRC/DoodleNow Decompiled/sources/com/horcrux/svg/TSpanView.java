...
class TSpanView extends TextView {
    ...
    public void draw(Canvas canvas, Paint paint, float f) {
        ...
        } else if (this.mInlineSize == null || this.mInlineSize.value == AudioStats.AUDIO_AMPLITUDE_NONE) {
    ...
    private void drawWrappedText(Canvas canvas, Paint paint) {
        ...
        StaticLayout staticLayout = getStaticLayout(textPaint, alignment2, true, new SpannableString(this.mContent), (int) PropHelper.fromRelative(this.mInlineSize, (double) canvas.getWidth(), AudioStats.AUDIO_AMPLITUDE_NONE, (double) this.mScale, fontSize));
        int lineAscent = staticLayout.getLineAscent(0);
        popGlyphContext();
        canvas.save();
        canvas2.translate((float) textRootGlyphContext.nextX(AudioStats.AUDIO_AMPLITUDE_NONE), (float) (textRootGlyphContext.nextY() + ((double) lineAscent)));
    ...
    private void applySpacingAndFeatures(Paint paint, FontData fontData) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            boolean unused = paint.setFontVariationSettings(fontWeightTag + fontData.absoluteFontWeight + fontData.fontVariationSettings);
        }
    }
    ...
    private android.graphics.Path getLinePath(java.lang.String r70, android.graphics.Paint r71, android.graphics.Canvas r72) {
        ...
        L_0x01fe:
            ...
            int r2 = r7.hashCode()
            switch(r2) {
                case -1720785339: goto L_0x0238;
                case 114240: goto L_0x022d;
                case 109801339: goto L_0x0222;
    ...
    private double getAbsoluteStartOffset(SVGLength sVGLength, double d, double d2) {
        return PropHelper.fromRelative(sVGLength, d, AudioStats.AUDIO_AMPLITUDE_NONE, (double) this.mScale, d2);
    }
     ...
     */
    /* JADX WARNING: Failed to process nested try/catch */
    /* JADX WARNING: Missing exception handler attribute for start block: B:28:0x00bd */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void applyTextPropertiesToPaint(android.graphics.Paint r11, com.horcrux.svg.FontData r12) {
        ...
        L_0x0028:
            ...
            com.rnfs.Downloader$$ExternalSyntheticApiModelOutline0.m()
            android.content.res.AssetManager r5 = r10.assets
            android.graphics.Typeface$Builder r5 = com.rnfs.Downloader$$ExternalSyntheticApiModelOutline0.m((android.content.res.AssetManager) r5, (java.lang.String) r6)
            java.lang.StringBuilder r6 = new java.lang.StringBuilder
            ...
            com.rnfs.Downloader$$ExternalSyntheticApiModelOutline0.m()
            android.content.res.AssetManager r5 = r10.assets
            android.graphics.Typeface$Builder r5 = com.rnfs.Downloader$$ExternalSyntheticApiModelOutline0.m((android.content.res.AssetManager) r5, (java.lang.String) r7)
            java.lang.StringBuilder r6 = new java.lang.StringBuilder
            r6.<init>(r8)
            r6.append(r0)
            ...
            goto L_0x00c7
        L_0x00b2:
            android.content.res.AssetManager r8 = r10.assets     // Catch:{ Exception -> 0x00bd }
            android.graphics.Typeface r5 = android.graphics.Typeface.createFromAsset(r8, r6)     // Catch:{ Exception -> 0x00bd }
            android.graphics.Typeface r5 = android.graphics.Typeface.create(r5, r2)     // Catch:{ Exception -> 0x00bd }
            goto L_0x00c7
        L_0x00bd:
            android.content.res.AssetManager r6 = r10.assets     // Catch:{ Exception -> 0x00c7 }
            android.graphics.Typeface r5 = android.graphics.Typeface.createFromAsset(r6, r7)     // Catch:{ Exception -> 0x00c7 }
            android.graphics.Typeface r5 = android.graphics.Typeface.create(r5, r2)     // Catch:{ Exception -> 0x00c7 }
        L_0x00c7:
            if (r5 != 0) goto L_0x00d3
            com.facebook.react.views.text.ReactFontManager r6 = com.facebook.react.views.text.ReactFontManager.getInstance()     // Catch:{ Exception -> 0x00d3 }
            android.content.res.AssetManager r7 = r10.assets     // Catch:{ Exception -> 0x00d3 }
            android.graphics.Typeface r5 = r6.getTypeface(r4, r2, r7)     // Catch:{ Exception -> 0x00d3 }
        L_0x00d3:
