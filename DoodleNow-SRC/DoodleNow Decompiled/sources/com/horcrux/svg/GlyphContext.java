...
class GlyphContext {
    ...
    public double nextX(double d) {
        ...
        if (i < sVGLengthArr.length) {
            this.mDX = AudioStats.AUDIO_AMPLITUDE_NONE;
            this.mXIndex = i;
            this.mX = PropHelper.fromRelative(sVGLengthArr[i], (double) this.mWidth, AudioStats.AUDIO_AMPLITUDE_NONE, (double) this.mScale, this.mFontSize);
        }
        double d2 = this.mX + d;
        this.mX = d2;
        return d2;
    ...
    public double nextY() {
        ...
        if (i < sVGLengthArr.length) {
            this.mDY = AudioStats.AUDIO_AMPLITUDE_NONE;
            this.mYIndex = i;
            this.mY = PropHelper.fromRelative(sVGLengthArr[i], (double) this.mHeight, AudioStats.AUDIO_AMPLITUDE_NONE, (double) this.mScale, this.mFontSize);
        }
        return this.mY;
    }
    ...
    public double nextDeltaX() {
        ...
        if (i < sVGLengthArr.length) {
            this.mDXIndex = i;
            this.mDX += PropHelper.fromRelative(sVGLengthArr[i], (double) this.mWidth, AudioStats.AUDIO_AMPLITUDE_NONE, (double) this.mScale, this.mFontSize);
        }
        return this.mDX;
    }
    ...
    public double nextDeltaY() {
        ...
        if (i < sVGLengthArr.length) {
            this.mDYIndex = i;
            this.mDY += PropHelper.fromRelative(sVGLengthArr[i], (double) this.mHeight, AudioStats.AUDIO_AMPLITUDE_NONE, (double) this.mScale, this.mFontSize);
        }
        return this.mDY;
    }
