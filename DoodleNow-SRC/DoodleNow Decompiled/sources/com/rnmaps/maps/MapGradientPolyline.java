...
public class MapGradientPolyline extends MapFeature {
    ...
    public MapGradientPolyline(Context context2) {
        super(context2);
    ...
    public class AirMapGradientPolylineProvider implements TileProvider {
        ...
        public void renderTrail(Canvas canvas, Matrix matrix, Paint paint, Paint paint2, float f, int i, int i2) {
            ...
            if (this.points.size() == 1) {
                ...
                paint3.setColor(MapGradientPolyline.interpolateColor(this.colors, 1.0f));
                ...
                while (i5 < this.points.size()) {
                    ...
                    paint3.setStyle(Paint.Style.FILL);
                    paint3.setColor(MapGradientPolyline.interpolateColor(this.colors, f6));
                    canvas2.drawCircle((float) mutPoint2.x, (float) mutPoint2.y, paint2.getStrokeWidth() / 2.0f, paint3);
                    paint3.setStyle(Paint.Style.STROKE);
                    MutPoint mutPoint6 = i6 == 0 ? mutPoint : mutPoint4;
                    float f7 = f6;
                    int i10 = i5;
                    boolean z2 = z;
                    float f8 = size;
                    float f9 = f2;
                    drawLine(canvas, matrix, paint, paint2, mutPoint6, mutPoint2, f8, f7);
