...
public final class LottieAnimationViewPropertyManager {
    ...
    public LottieAnimationViewPropertyManager(final LottieAnimationView lottieAnimationView) {
        ...
        lottieAnimationView.setFontAssetDelegate(new FontAssetDelegate() {
            public Typeface fetchFont(String str) {
                ...
                Typeface typeface = ReactFontManager.getInstance().getTypeface(str, -1, -1, lottieAnimationView.getContext().getAssets());
            ...
            /* JADX WARNING: Code restructure failed: missing block: B:15:0x004d, code lost:
                if (r4.equals("Regular") == false) goto L_0x0068;
             */
            /* JADX WARNING: Code restructure failed: missing block: B:17:0x0056, code lost:
                if (r4.equals("Normal") == false) goto L_0x0068;
             */
            ...
            /* JADX WARNING: Code restructure failed: missing block: B:23:0x0069, code lost:
                r3 = com.facebook.react.views.text.ReactFontManager.getInstance().getTypeface(r5, -1, r3, r2.getContext().getAssets());
                kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r3, "getTypeface(...)");
             */
            ...
            public android.graphics.Typeface fetchFont(java.lang.String r3, java.lang.String r4, java.lang.String r5) {
                ...
                L_0x0069:
                    ...
                    android.graphics.Typeface r3 = r4.getTypeface((java.lang.String) r5, (int) r0, (int) r3, (android.content.res.AssetManager) r1)
        ...
        if (lottieAnimationView != null) {
            ...
            if (str3 != null) {
                ...
                try {
                    ...
                    obj = Result.m1230constructorimpl(Uri.parse(str3).getScheme());
                } catch (Throwable th) {
    ...
    private final void parseColorFilter(ReadableMap readableMap, LottieAnimationView lottieAnimationView) {
        ...
        String string = readableMap.getString("keypath");
