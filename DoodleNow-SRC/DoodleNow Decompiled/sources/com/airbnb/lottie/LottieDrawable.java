...
public class LottieDrawable extends Drawable implements Drawable.Callback, Animatable {
    private static final List<String> ALLOWED_REDUCED_MOTION_MARKERS = Arrays.asList(new String[]{"reduced motion", "reduced_motion", "reduced-motion", "reducedmotion"});
    ...
    public /* synthetic */ void m371lambda$new$0$comairbnblottieLottieDrawable(ValueAnimator valueAnimator) {
    ...
    public /* synthetic */ void m373lambda$new$2$comairbnblottieLottieDrawable() {
        CompositionLayer compositionLayer2 = this.compositionLayer;
        if (compositionLayer2 != null) {
            try {
                ...
                if (invalidateSelfOnMainThread && this.isDirty) {
                    if (this.mainThreadHandler == null) {
                        ...
                        this.invalidateSelfRunnable = new LottieDrawable$$ExternalSyntheticLambda3(this);
                    }
    ...
    public /* synthetic */ void m372lambda$new$1$comairbnblottieLottieDrawable() {
    ...
    public LottieDrawable() {
        ...
        LottieDrawable$$ExternalSyntheticLambda0 lottieDrawable$$ExternalSyntheticLambda0 = new LottieDrawable$$ExternalSyntheticLambda0(this);
        this.progressUpdateListener = lottieDrawable$$ExternalSyntheticLambda0;
        this.setProgressDrawLock = new Semaphore(1);
        this.updateProgressRunnable = new LottieDrawable$$ExternalSyntheticLambda9(this);
        this.lastDrawnProgress = -3.4028235E38f;
        lottieValueAnimator.addUpdateListener(lottieDrawable$$ExternalSyntheticLambda0);
    }
    ...
    public /* synthetic */ void m374lambda$playAnimation$3$comairbnblottieLottieDrawable(LottieComposition lottieComposition) {
        playAnimation();
    }

    public void playAnimation() {
        if (this.compositionLayer == null) {
            this.lazyCompositionTasks.add(new LottieDrawable$$ExternalSyntheticLambda5(this));
            return;
        }
        computeRenderMode();
    ...
    private com.airbnb.lottie.model.Marker getMarkerForAnimationsDisabled() {
        /*
            r3 = this;
            java.util.List<java.lang.String> r0 = ALLOWED_REDUCED_MOTION_MARKERS
    ...
    public /* synthetic */ void m375lambda$resumeAnimation$4$comairbnblottieLottieDrawable(LottieComposition lottieComposition) {
        resumeAnimation();
    }

    public void resumeAnimation() {
        if (this.compositionLayer == null) {
            this.lazyCompositionTasks.add(new LottieDrawable$$ExternalSyntheticLambda15(this));
            return;
        }
        computeRenderMode();
        if (animationsEnabled() || getRepeatCount() == 0) {
    ...
    public /* synthetic */ void m384lambda$setMinFrame$5$comairbnblottieLottieDrawable(int i, LottieComposition lottieComposition) {
        setMinFrame(i);
    }
    ...
    public /* synthetic */ void m386lambda$setMinProgress$6$comairbnblottieLottieDrawable(float f, LottieComposition lottieComposition) {
        setMinProgress(f);
    }
    ...
    public void setMinProgress(float f) {
        LottieComposition lottieComposition = this.composition;
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LottieDrawable$$ExternalSyntheticLambda13(this, f));
        } else {
    ...
    public /* synthetic */ void m378lambda$setMaxFrame$7$comairbnblottieLottieDrawable(int i, LottieComposition lottieComposition) {
        setMaxFrame(i);
    }

    public void setMaxFrame(int i) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new LottieDrawable$$ExternalSyntheticLambda14(this, i));
        } else {
    ...
    public /* synthetic */ void m379lambda$setMaxProgress$8$comairbnblottieLottieDrawable(float f, LottieComposition lottieComposition) {
        setMaxProgress(f);
    }
    ...
    public void setMaxProgress(float f) {
        LottieComposition lottieComposition = this.composition;
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LottieDrawable$$ExternalSyntheticLambda4(this, f));
        } else {
    ...
    public /* synthetic */ void m385lambda$setMinFrame$9$comairbnblottieLottieDrawable(String str, LottieComposition lottieComposition) {
        setMinFrame(str);
    }
    ...
    public void setMinFrame(String str) {
        LottieComposition lottieComposition = this.composition;
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LottieDrawable$$ExternalSyntheticLambda1(this, str));
            return;
        }
    ...
    public /* synthetic */ void m377lambda$setMaxFrame$10$comairbnblottieLottieDrawable(String str, LottieComposition lottieComposition) {
        setMaxFrame(str);
    }
    ...
    public void setMaxFrame(String str) {
        LottieComposition lottieComposition = this.composition;
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LottieDrawable$$ExternalSyntheticLambda16(this, str));
            return;
        }
        Marker marker = lottieComposition.getMarker(str);
        if (marker != null) {
    ...
    public /* synthetic */ void m380lambda$setMinAndMaxFrame$11$comairbnblottieLottieDrawable(String str, LottieComposition lottieComposition) {
    ...
    public /* synthetic */ void m381lambda$setMinAndMaxFrame$12$comairbnblottieLottieDrawable(String str, String str2, boolean z, LottieComposition lottieComposition) {
    ...
    public void setMinAndMaxFrame(String str, String str2, boolean z) {
        LottieComposition lottieComposition = this.composition;
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LottieDrawable$$ExternalSyntheticLambda17(this, str, str2, z));
            return;
        }
        Marker marker = lottieComposition.getMarker(str);
        if (marker != null) {
    ...
    public /* synthetic */ void m382lambda$setMinAndMaxFrame$13$comairbnblottieLottieDrawable(int i, int i2, LottieComposition lottieComposition) {
        setMinAndMaxFrame(i, i2);
    }

    public void setMinAndMaxFrame(int i, int i2) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new LottieDrawable$$ExternalSyntheticLambda7(this, i, i2));
        } else {
    ...
    public /* synthetic */ void m383lambda$setMinAndMaxProgress$14$comairbnblottieLottieDrawable(float f, float f2, LottieComposition lottieComposition) {
    ...
    public void setMinAndMaxProgress(float f, float f2) {
        LottieComposition lottieComposition = this.composition;
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LottieDrawable$$ExternalSyntheticLambda11(this, f, f2));
        } else {
    ...
    public /* synthetic */ void m376lambda$setFrame$15$comairbnblottieLottieDrawable(int i, LottieComposition lottieComposition) {
        setFrame(i);
    }

    public void setFrame(int i) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new LottieDrawable$$ExternalSyntheticLambda6(this, i));
        } else {
    ...
    public /* synthetic */ void m387lambda$setProgress$16$comairbnblottieLottieDrawable(float f, LottieComposition lottieComposition) {
        setProgress(f);
    }

    public void setProgress(float f) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new LottieDrawable$$ExternalSyntheticLambda10(this, f));
            return;
        }
    ...
    public <T> void addValueCallback(KeyPath keyPath, T t, LottieValueCallback<T> lottieValueCallback) {
        if (this.compositionLayer == null) {
            this.lazyCompositionTasks.add(new LottieDrawable$$ExternalSyntheticLambda2(this, keyPath, t, lottieValueCallback));
            return;
        }
    ...
    public /* synthetic */ void m370lambda$addValueCallback$17$comairbnblottieLottieDrawable(KeyPath keyPath, Object obj, LottieValueCallback lottieValueCallback, LottieComposition lottieComposition) {
