...
public class LottieAnimationView extends AppCompatImageView {
    ...
    public static final LottieListener<Throwable> DEFAULT_FAILURE_LISTENER = new LottieAnimationView$$ExternalSyntheticLambda1();
    ...
    public /* synthetic */ LottieResult m369lambda$fromRawRes$1$comairbnblottieLottieAnimationView(int i) throws Exception {
    ...
    private LottieTask<LottieComposition> fromAssets(String str) {
        if (isInEditMode()) {
            return new LottieTask<>(new LottieAnimationView$$ExternalSyntheticLambda2(this, str), true);
        }
    ...
    public /* synthetic */ LottieResult m368lambda$fromAssets$2$comairbnblottieLottieAnimationView(String str) throws Exception {
    ...
    public <T> void clearValueCallback(KeyPath keyPath, T t) {
        LottieValueCallback lottieValueCallback = null;
