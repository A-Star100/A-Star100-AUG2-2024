...
public class TransformKeyframeAnimation {
    ...
    public Matrix getMatrix() {
        ...
        if (!this.autoOrient) {
            ...
            this.matrix.preRotate((float) Math.toDegrees(Math.atan2((double) (value5.y - f5), (double) (value5.x - f4))));
        }
        FloatKeyframeAnimation floatKeyframeAnimation = this.skew;
        if (floatKeyframeAnimation != null) {
            FloatKeyframeAnimation floatKeyframeAnimation2 = this.skewAngle;
            if (floatKeyframeAnimation2 == null) {
                ...
                f = (float) Math.cos(Math.toRadians((double) ((-floatKeyframeAnimation2.getFloatValue()) + 90.0f)));
            }
            FloatKeyframeAnimation floatKeyframeAnimation3 = this.skewAngle;
            if (floatKeyframeAnimation3 == null) {
                f2 = 1.0f;
            } else {
                f2 = (float) Math.sin(Math.toRadians((double) ((-floatKeyframeAnimation3.getFloatValue()) + 90.0f)));
            }
