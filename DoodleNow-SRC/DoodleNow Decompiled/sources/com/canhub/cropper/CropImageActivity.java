...
public class CropImageActivity extends AppCompatActivity implements CropImageView.OnSetImageUriCompleteListener, CropImageView.OnCropImageCompleteListener {
    ...
    public static final void m415pickImageGallery$lambda0(CropImageActivity cropImageActivity, Uri uri) {
    ...
    public static final void m417takePicture$lambda1(CropImageActivity cropImageActivity, Boolean bool) {
        Intrinsics.checkNotNullParameter(cropImageActivity, "this$0");
    ...
    public static final void m416showImageSourceDialog$lambda10(Function1 function1, DialogInterface dialogInterface, int i) {
        Intrinsics.checkNotNullParameter(function1, "$openSource");
    ...
    public Intent getResultIntent(Uri uri, Exception exc, int i) {
        ...
        if (cropImageView6 != null) {
            rect = cropImageView6.getWholeImageRect();
        } else {
            rect = null;
        }
        CropImage.ActivityResult activityResult = new CropImage.ActivityResult(imageUri, uri, exc, cropPoints, cropRect, rotatedDegrees, rect, i);
