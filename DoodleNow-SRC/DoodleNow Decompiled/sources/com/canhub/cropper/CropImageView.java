...
public final class CropImageView extends FrameLayout implements CropOverlayView.CropWindowChangeListener {
    ...
    public final void rotateImage(int i) {
        ...
        if (this.originalBitmap != null) {
            if (i3 < 0) {
                i2 = (i3 % CropImageOptions.DEGREES_360) + CropImageOptions.DEGREES_360;
            } else {
                i2 = i3 % CropImageOptions.DEGREES_360;
            }
            CropOverlayView cropOverlayView = this.mCropOverlayView;
            Intrinsics.checkNotNull(cropOverlayView);
            boolean z = !cropOverlayView.isFixAspectRatio() && ((46 <= i2 && i2 < 135) || (216 <= i2 && i2 < 305));
            ...
            this.mDegreesRotated = (this.mDegreesRotated + i2) % CropImageOptions.DEGREES_360;
            applyImageMatrix((float) getWidth(), (float) getHeight(), true, false);
            this.mImageMatrix.mapPoints(BitmapUtils.INSTANCE.getPOINTS2(), BitmapUtils.INSTANCE.getPOINTS());
            float sqrt = this.mZoom / ((float) Math.sqrt(Math.pow((double) (BitmapUtils.INSTANCE.getPOINTS2()[4] - BitmapUtils.INSTANCE.getPOINTS2()[2]), 2.0d) + Math.pow((double) (BitmapUtils.INSTANCE.getPOINTS2()[5] - BitmapUtils.INSTANCE.getPOINTS2()[3]), 2.0d)));
            this.mZoom = sqrt;
            this.mZoom = Math.max(sqrt, 1.0f);
            applyImageMatrix((float) getWidth(), (float) getHeight(), true, false);
            this.mImageMatrix.mapPoints(BitmapUtils.INSTANCE.getPOINTS2(), BitmapUtils.INSTANCE.getPOINTS());
            float sqrt2 = (float) Math.sqrt(Math.pow((double) (BitmapUtils.INSTANCE.getPOINTS2()[4] - BitmapUtils.INSTANCE.getPOINTS2()[2]), 2.0d) + Math.pow((double) (BitmapUtils.INSTANCE.getPOINTS2()[5] - BitmapUtils.INSTANCE.getPOINTS2()[3]), 2.0d));
    ...
    public final void startCropWorkerTask(int i, int i2, RequestSizeOptions requestSizeOptions, Bitmap.CompressFormat compressFormat, int i3, Uri uri) {
        ...
        if (bitmap != null) {
            ...
            Uri uri3 = uri == null ? this.customOutputUri : uri;
            BitmapCroppingWorkerJob bitmapCroppingWorkerJob3 = r1;
            BitmapCroppingWorkerJob bitmapCroppingWorkerJob4 = new BitmapCroppingWorkerJob(context, weakReference2, uri2, bitmap, cropPoints, i4, intValue, intValue2, isFixAspectRatio, aspectRatioX, aspectRatioY, i5, i6, z, z2, requestSizeOptions, compressFormat, i3, uri3);
    ...
    private final void handleCropWindowChanged(boolean r12, boolean r13) {
        /*
            ...
            android.graphics.Bitmap r2 = r11.originalBitmap
            if (r2 == 0) goto L_0x010a
            if (r0 <= 0) goto L_0x010a
            if (r1 <= 0) goto L_0x010a
            com.canhub.cropper.CropOverlayView r2 = r11.mCropOverlayView
        ...
        L_0x00d9:
            ...
            com.canhub.cropper.CropImageAnimation r2 = r11.mAnimation
            ...
            com.canhub.cropper.CropOverlayView r4 = r11.mCropOverlayView
            r2.<init>(r3, r4)
            r11.mAnimation = r2
        L_0x00ea:
            com.canhub.cropper.CropImageAnimation r2 = r11.mAnimation
        ...
        L_0x00fe:
            com.canhub.cropper.CropImageView$OnSetCropWindowChangeListener r13 = r11.mOnSetCropWindowChangeListener
