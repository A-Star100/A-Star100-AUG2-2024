...
public abstract class ShareIntent {
    ...
    public void open(ReadableMap readableMap) throws ActivityNotFoundException {
        ...
        String str = "";
        String string = hasValidKey(OneSignalDbContract.NotificationTable.COLUMN_NAME_MESSAGE, readableMap) ? readableMap.getString(OneSignalDbContract.NotificationTable.COLUMN_NAME_MESSAGE) : str;
        ...
        if (hasValidKey("urls", readableMap)) {
            ...
            if (fileShares.isFile()) {
                ...
                intent2.putExtra("android.intent.extra.TEXT", string + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + readableMap.getArray("urls").getString(0));
            } else {
            ...
            if (fileShare2.isFile()) {
                ...
                intent3.putExtra("android.intent.extra.TEXT", string + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + readableMap.getString(ImagesContract.URL));
            } else {
