...
public class TargetChosenReceiver extends BroadcastReceiver {
    ...
    public static IntentSender getSharingSenderIntent(ReactContext reactContext) {
        synchronized (LOCK) {
            ...
            if (Build.VERSION.SDK_INT < 34 || applicationContext.getApplicationInfo().targetSdkVersion < 34) {
                ...
                Intent unused = applicationContext.registerReceiver(sLastRegisteredReceiver, new IntentFilter(sTargetChosenReceiveAction), 2);
            }
        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:13:0x002c, code lost:
        ...
        r4.putBoolean("success", true);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x003e, code lost:
        if (r3 == null) goto L_0x004a;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:15:0x0040, code lost:
        r4.putString(com.onesignal.core.internal.database.impl.OneSignalDbContract.NotificationTable.COLUMN_NAME_MESSAGE, r3.flattenToString());
     */
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x004a, code lost:
        r4.putString(com.onesignal.core.internal.database.impl.OneSignalDbContract.NotificationTable.COLUMN_NAME_MESSAGE, "OK");
     */
    ...
    public void onReceive(android.content.Context r3, android.content.Intent r4) {
        /*
            ...
            monitor-enter(r0)
            cl.json.social.TargetChosenReceiver r1 = sLastRegisteredReceiver     // Catch:{ all -> 0x0055 }
        ...
        L_0x0009:
            ...
            cl.json.social.TargetChosenReceiver r1 = sLastRegisteredReceiver     // Catch:{ all -> 0x0055 }
            r3.unregisterReceiver(r1)     // Catch:{ all -> 0x0055 }
            r3 = 0
            sLastRegisteredReceiver = r3     // Catch:{ all -> 0x0055 }
            monitor-exit(r0)     // Catch:{ all -> 0x0055 }
