...
public final class Challenge {
    ...
    public final Map<String, String> m2881deprecated_authParams() {
        return this.authParams;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "scheme", imports = {}))
    /* renamed from: -deprecated_scheme  reason: not valid java name */
    public final String m2884deprecated_scheme() {
        return this.scheme;
    }
    ...
    public final String m2883deprecated_realm() {
        return realm();
    }
    ...
    public final Charset m2882deprecated_charset() {
        return charset();
    }
