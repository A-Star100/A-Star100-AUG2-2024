...
public final class MediaType {
    ...
    public final String m2933deprecated_subtype() {
        return this.subtype;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "type", imports = {}))
    /* renamed from: -deprecated_type  reason: not valid java name */
    public final String m2934deprecated_type() {
        return this.type;
    }
    ...
    public static final class Companion {
        ...
        public final MediaType m2935deprecated_get(String str) {
        ...
        public final MediaType m2936deprecated_parse(String str) {
            Intrinsics.checkNotNullParameter(str, "mediaType");
            Companion companion = this;
            return parse(str);
        }
