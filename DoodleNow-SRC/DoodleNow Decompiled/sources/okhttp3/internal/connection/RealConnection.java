...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    private final void connectTls(okhttp3.internal.connection.ConnectionSpecSelector r11) throws java.io.IOException {
        /*
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNull(r3)     // Catch:{ all -> 0x0195 }
            java.net.Socket r5 = r10.rawSocket     // Catch:{ all -> 0x0195 }
            okhttp3.HttpUrl r6 = r2.url()     // Catch:{ all -> 0x0195 }
            java.lang.String r6 = r6.host()     // Catch:{ all -> 0x0195 }
            okhttp3.HttpUrl r7 = r2.url()     // Catch:{ all -> 0x0195 }
            int r7 = r7.port()     // Catch:{ all -> 0x0195 }
            r8 = 1
            java.net.Socket r3 = r3.createSocket(r5, r6, r7, r8)     // Catch:{ all -> 0x0195 }
            if (r3 == 0) goto L_0x018d
            javax.net.ssl.SSLSocket r3 = (javax.net.ssl.SSLSocket) r3     // Catch:{ all -> 0x0195 }
            okhttp3.ConnectionSpec r11 = r11.configureSecureSocket(r3)     // Catch:{ all -> 0x018a }
            boolean r5 = r11.supportsTlsExtensions()     // Catch:{ all -> 0x018a }
            if (r5 == 0) goto L_0x004f
            okhttp3.internal.platform.Platform$Companion r5 = okhttp3.internal.platform.Platform.Companion     // Catch:{ all -> 0x018a }
            okhttp3.internal.platform.Platform r5 = r5.get()     // Catch:{ all -> 0x018a }
            okhttp3.HttpUrl r6 = r2.url()     // Catch:{ all -> 0x018a }
            java.lang.String r6 = r6.host()     // Catch:{ all -> 0x018a }
            java.util.List r7 = r2.protocols()     // Catch:{ all -> 0x018a }
            r5.configureTlsExtensions(r3, r6, r7)     // Catch:{ all -> 0x018a }
        L_0x004f:
            r3.startHandshake()     // Catch:{ all -> 0x018a }
            javax.net.ssl.SSLSession r5 = r3.getSession()     // Catch:{ all -> 0x018a }
            okhttp3.Handshake$Companion r6 = okhttp3.Handshake.Companion     // Catch:{ all -> 0x018a }
            java.lang.String r7 = "sslSocketSession"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r5, r7)     // Catch:{ all -> 0x018a }
            okhttp3.Handshake r6 = r6.get(r5)     // Catch:{ all -> 0x018a }
            javax.net.ssl.HostnameVerifier r7 = r2.hostnameVerifier()     // Catch:{ all -> 0x018a }
            kotlin.jvm.internal.Intrinsics.checkNotNull(r7)     // Catch:{ all -> 0x018a }
            okhttp3.HttpUrl r9 = r2.url()     // Catch:{ all -> 0x018a }
            java.lang.String r9 = r9.host()     // Catch:{ all -> 0x018a }
            boolean r5 = r7.verify(r9, r5)     // Catch:{ all -> 0x018a }
            if (r5 != 0) goto L_0x010f
            java.util.List r11 = r6.peerCertificates()     // Catch:{ all -> 0x018a }
            r5 = r11
            java.util.Collection r5 = (java.util.Collection) r5     // Catch:{ all -> 0x018a }
            boolean r5 = r5.isEmpty()     // Catch:{ all -> 0x018a }
            r5 = r5 ^ r8
            if (r5 == 0) goto L_0x00ee
            r1 = 0
            java.lang.Object r11 = r11.get(r1)     // Catch:{ all -> 0x018a }
        ...
        L_0x0093:
            java.security.cert.X509Certificate r11 = (java.security.cert.X509Certificate) r11     // Catch:{ all -> 0x018a }
            javax.net.ssl.SSLPeerUnverifiedException r1 = new javax.net.ssl.SSLPeerUnverifiedException     // Catch:{ all -> 0x018a }
            java.lang.StringBuilder r5 = new java.lang.StringBuilder     // Catch:{ all -> 0x018a }
            r5.<init>(r0)     // Catch:{ all -> 0x018a }
            okhttp3.HttpUrl r0 = r2.url()     // Catch:{ all -> 0x018a }
            java.lang.String r0 = r0.host()     // Catch:{ all -> 0x018a }
            r5.append(r0)     // Catch:{ all -> 0x018a }
            java.lang.String r0 = " not verified:\n              |    certificate: "
            r5.append(r0)     // Catch:{ all -> 0x018a }
            okhttp3.CertificatePinner$Companion r0 = okhttp3.CertificatePinner.Companion     // Catch:{ all -> 0x018a }
            r2 = r11
            java.security.cert.Certificate r2 = (java.security.cert.Certificate) r2     // Catch:{ all -> 0x018a }
            java.lang.String r0 = r0.pin(r2)     // Catch:{ all -> 0x018a }
            r5.append(r0)     // Catch:{ all -> 0x018a }
            java.lang.String r0 = "\n              |    DN: "
            r5.append(r0)     // Catch:{ all -> 0x018a }
            java.security.Principal r0 = r11.getSubjectDN()     // Catch:{ all -> 0x018a }
            java.lang.String r2 = "cert.subjectDN"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r0, r2)     // Catch:{ all -> 0x018a }
            java.lang.String r0 = r0.getName()     // Catch:{ all -> 0x018a }
            r5.append(r0)     // Catch:{ all -> 0x018a }
            java.lang.String r0 = "\n              |    subjectAltNames: "
            r5.append(r0)     // Catch:{ all -> 0x018a }
            okhttp3.internal.tls.OkHostnameVerifier r0 = okhttp3.internal.tls.OkHostnameVerifier.INSTANCE     // Catch:{ all -> 0x018a }
            java.util.List r11 = r0.allSubjectAltNames(r11)     // Catch:{ all -> 0x018a }
            r5.append(r11)     // Catch:{ all -> 0x018a }
            java.lang.String r11 = "\n              "
            r5.append(r11)     // Catch:{ all -> 0x018a }
            java.lang.String r11 = r5.toString()     // Catch:{ all -> 0x018a }
            java.lang.String r11 = kotlin.text.StringsKt.trimMargin$default(r11, r4, r8, r4)     // Catch:{ all -> 0x018a }
            r1.<init>(r11)     // Catch:{ all -> 0x018a }
            java.lang.Throwable r1 = (java.lang.Throwable) r1     // Catch:{ all -> 0x018a }
            throw r1     // Catch:{ all -> 0x018a }
        L_0x00ee:
            javax.net.ssl.SSLPeerUnverifiedException r11 = new javax.net.ssl.SSLPeerUnverifiedException     // Catch:{ all -> 0x018a }
            java.lang.StringBuilder r0 = new java.lang.StringBuilder     // Catch:{ all -> 0x018a }
            r0.<init>(r1)     // Catch:{ all -> 0x018a }
            okhttp3.HttpUrl r1 = r2.url()     // Catch:{ all -> 0x018a }
            java.lang.String r1 = r1.host()     // Catch:{ all -> 0x018a }
            ...
            r11.<init>(r0)     // Catch:{ all -> 0x018a }
            java.lang.Throwable r11 = (java.lang.Throwable) r11     // Catch:{ all -> 0x018a }
            throw r11     // Catch:{ all -> 0x018a }
        L_0x010f:
            okhttp3.CertificatePinner r0 = r2.certificatePinner()     // Catch:{ all -> 0x018a }
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)     // Catch:{ all -> 0x018a }
            okhttp3.Handshake r1 = new okhttp3.Handshake     // Catch:{ all -> 0x018a }
            okhttp3.TlsVersion r5 = r6.tlsVersion()     // Catch:{ all -> 0x018a }
            okhttp3.CipherSuite r7 = r6.cipherSuite()     // Catch:{ all -> 0x018a }
            java.util.List r8 = r6.localCertificates()     // Catch:{ all -> 0x018a }
            okhttp3.internal.connection.RealConnection$connectTls$1 r9 = new okhttp3.internal.connection.RealConnection$connectTls$1     // Catch:{ all -> 0x018a }
            r9.<init>(r0, r6, r2)     // Catch:{ all -> 0x018a }
            kotlin.jvm.functions.Function0 r9 = (kotlin.jvm.functions.Function0) r9     // Catch:{ all -> 0x018a }
            r1.<init>(r5, r7, r8, r9)     // Catch:{ all -> 0x018a }
            r10.handshake = r1     // Catch:{ all -> 0x018a }
            okhttp3.HttpUrl r1 = r2.url()     // Catch:{ all -> 0x018a }
            java.lang.String r1 = r1.host()     // Catch:{ all -> 0x018a }
            okhttp3.internal.connection.RealConnection$connectTls$2 r2 = new okhttp3.internal.connection.RealConnection$connectTls$2     // Catch:{ all -> 0x018a }
            r2.<init>(r10)     // Catch:{ all -> 0x018a }
            kotlin.jvm.functions.Function0 r2 = (kotlin.jvm.functions.Function0) r2     // Catch:{ all -> 0x018a }
            r0.check$okhttp(r1, r2)     // Catch:{ all -> 0x018a }
            boolean r11 = r11.supportsTlsExtensions()     // Catch:{ all -> 0x018a }
            if (r11 == 0) goto L_0x0152
            okhttp3.internal.platform.Platform$Companion r11 = okhttp3.internal.platform.Platform.Companion     // Catch:{ all -> 0x018a }
            okhttp3.internal.platform.Platform r11 = r11.get()     // Catch:{ all -> 0x018a }
            java.lang.String r4 = r11.getSelectedProtocol(r3)     // Catch:{ all -> 0x018a }
        L_0x0152:
            r11 = r3
            java.net.Socket r11 = (java.net.Socket) r11     // Catch:{ all -> 0x018a }
            r10.socket = r11     // Catch:{ all -> 0x018a }
            r11 = r3
            java.net.Socket r11 = (java.net.Socket) r11     // Catch:{ all -> 0x018a }
            okio.Source r11 = okio.Okio.source((java.net.Socket) r11)     // Catch:{ all -> 0x018a }
            okio.BufferedSource r11 = okio.Okio.buffer((okio.Source) r11)     // Catch:{ all -> 0x018a }
            r10.source = r11     // Catch:{ all -> 0x018a }
            r11 = r3
            java.net.Socket r11 = (java.net.Socket) r11     // Catch:{ all -> 0x018a }
            okio.Sink r11 = okio.Okio.sink((java.net.Socket) r11)     // Catch:{ all -> 0x018a }
            okio.BufferedSink r11 = okio.Okio.buffer((okio.Sink) r11)     // Catch:{ all -> 0x018a }
            r10.sink = r11     // Catch:{ all -> 0x018a }
            if (r4 == 0) goto L_0x017a
            okhttp3.Protocol$Companion r11 = okhttp3.Protocol.Companion     // Catch:{ all -> 0x018a }
            okhttp3.Protocol r11 = r11.get(r4)     // Catch:{ all -> 0x018a }
            goto L_0x017c
        L_0x017a:
            okhttp3.Protocol r11 = okhttp3.Protocol.HTTP_1_1     // Catch:{ all -> 0x018a }
        L_0x017c:
            r10.protocol = r11     // Catch:{ all -> 0x018a }
        ...
        L_0x018a:
            ...
            goto L_0x0196
        L_0x018d:
            java.lang.NullPointerException r11 = new java.lang.NullPointerException     // Catch:{ all -> 0x0195 }
            java.lang.String r0 = "null cannot be cast to non-null type javax.net.ssl.SSLSocket"
            r11.<init>(r0)     // Catch:{ all -> 0x0195 }
            throw r11     // Catch:{ all -> 0x0195 }
        L_0x0195:
            r11 = move-exception
        L_0x0196:
