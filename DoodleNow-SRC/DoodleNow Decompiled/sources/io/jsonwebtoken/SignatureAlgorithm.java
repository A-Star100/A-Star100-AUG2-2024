...
public enum SignatureAlgorithm {
    NONE("none", "No digital signature or MAC performed", Constants.BluetoothLogLevel.NONE, (String) null, false),
    ...
    private SignatureAlgorithm(String str, String str2, String str3, String str4, boolean z) {
        this.value = str;
