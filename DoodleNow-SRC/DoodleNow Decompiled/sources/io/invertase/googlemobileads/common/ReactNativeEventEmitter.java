...
public class ReactNativeEventEmitter {
    ...
    public void attachReactContext(ReactContext reactContext2) {
        this.handler.post(new ReactNativeEventEmitter$$ExternalSyntheticLambda2(this, reactContext2));
    }
    ...
    public void notifyJsReady(Boolean bool) {
        this.handler.post(new ReactNativeEventEmitter$$ExternalSyntheticLambda3(this, bool));
    }
    ...
    public void sendEvent(NativeEvent nativeEvent) {
        this.handler.post(new ReactNativeEventEmitter$$ExternalSyntheticLambda1(this, nativeEvent));
    }
    ...
    public void addListener(String str) {
        ...
        this.handler.post(new ReactNativeEventEmitter$$ExternalSyntheticLambda0(this));
    }
