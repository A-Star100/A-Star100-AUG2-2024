    ...
    static final class LatestCoordinator<T, R> extends AtomicInteger implements Disposable {
        ...
        public void innerError(int r3, java.lang.Throwable r4) {
            /*
                ...
                monitor-enter(r2)
                java.lang.Object[] r4 = r2.latest     // Catch:{ all -> 0x002b }
                if (r4 != 0) goto L_0x0013
                monitor-exit(r2)     // Catch:{ all -> 0x002b }
                return
            L_0x0013:
                r3 = r4[r3]     // Catch:{ all -> 0x002b }
                r0 = 1
            ...
            L_0x001b:
                ...
                int r1 = r2.complete     // Catch:{ all -> 0x002b }
                int r1 = r1 + r0
                r2.complete = r1     // Catch:{ all -> 0x002b }
                int r4 = r4.length     // Catch:{ all -> 0x002b }
                if (r1 != r4) goto L_0x0027
            L_0x0025:
                r2.done = r0     // Catch:{ all -> 0x002b }
            L_0x0027:
                monitor-exit(r2)     // Catch:{ all -> 0x002b }
