...
public class LocationGooglePlayServicesProvider implements ServiceLocationProvider, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener, ResultCallback<Status> {
    ...
    public void init(Context context2, Logger logger2) {
        ...
        logger2.d("already started", new Object[0]);
    }
    ...
    static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: io.nlopez.smartlocation.location.providers.LocationGooglePlayServicesProvider.AnonymousClass2.<clinit>():void");
        }
    }
    ...
    public void startUpdating(LocationRequest locationRequest2) {
        ...
        } else if (ActivityCompat.checkSelfPermission(this.context, LocationConstants.ANDROID_FINE_LOCATION_PERMISSION_STRING) == 0 || ActivityCompat.checkSelfPermission(this.context, LocationConstants.ANDROID_COARSE_LOCATION_PERMISSION_STRING) == 0) {
    ...
    public void onConnectionSuspended(int i) {
        ...
        logger2.d("onConnectionSuspended " + i, new Object[0]);
        GooglePlayServicesListener googlePlayServicesListener2 = this.googlePlayServicesListener;
        if (googlePlayServicesListener2 != null) {
    ...
    public void onConnectionFailed(ConnectionResult connectionResult) {
        Logger logger2 = this.logger;
        logger2.d("onConnectionFailed " + connectionResult.toString(), new Object[0]);
        GooglePlayServicesListener googlePlayServicesListener2 = this.googlePlayServicesListener;
        if (googlePlayServicesListener2 != null) {
    ...
    public void onResult(Status status) {
        if (status.isSuccess()) {
            ...
            Logger logger2 = this.logger;
            logger2.e("Registering failed: " + status.getStatusMessage(), new Object[0]);
        } else {
