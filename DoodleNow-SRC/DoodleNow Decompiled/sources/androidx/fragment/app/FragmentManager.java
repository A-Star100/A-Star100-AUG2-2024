...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    public /* synthetic */ void m332lambda$new$0$androidxfragmentappFragmentManager(Configuration configuration) {
        if (isParentAdded()) {
    ...
    public /* synthetic */ void m333lambda$new$1$androidxfragmentappFragmentManager(Integer num) {
    ...
    public /* synthetic */ void m334lambda$new$2$androidxfragmentappFragmentManager(MultiWindowModeChangedInfo multiWindowModeChangedInfo) {
        if (isParentAdded()) {
    ...
    public /* synthetic */ void m335lambda$new$3$androidxfragmentappFragmentManager(PictureInPictureModeChangedInfo pictureInPictureModeChangedInfo) {
        if (isParentAdded()) {
    ...
    private void clearBackStackStateViewModels() {
        ...
        L_0x0045:
            ...
            r3.clearNonConfigState((java.lang.String) r2)
            goto L_0x0045
        L_0x005b:
            return
        */
    ...
    public boolean saveBackStackState(ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, String str) {
        ...
        for (int i2 = findBackStackIndex; i2 < this.mBackStack.size(); i2++) {
            ...
            if (!hashSet2.isEmpty()) {
                ...
                if (hashSet2.size() == 1) {
                    str2 = MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + hashSet2.iterator().next();
                } else {
                    str2 = "s " + hashSet2;
                }
                sb.append(str2);
    ...
    public Parcelable saveAllState() {
        ...
        Bundle saveAllStateInternal = m331lambda$attachController$4$androidxfragmentappFragmentManager();
    ...
    public Bundle m331lambda$attachController$4$androidxfragmentappFragmentManager() {
