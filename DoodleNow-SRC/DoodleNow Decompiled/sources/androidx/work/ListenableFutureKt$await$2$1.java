...
public final class ListenableFutureKt$await$2$1 implements Runnable {
    ...
    public final void run() {
        try {
            ...
            this.$cancellableContinuation.resumeWith(Result.m1230constructorimpl(this.$this_await.get()));
        } catch (Throwable th) {
            ...
            this.$cancellableContinuation.resumeWith(Result.m1230constructorimpl(ResultKt.createFailure(cause)));
        }
    }
}
