            ...
            if (Build.VERSION.SDK_INT >= 30) {
                ...
                if (m != null && !m.isEmpty()) {
                    ...
                    for (int i = 0; i < m.size(); i++) {
                        ApplicationExitInfo m2 = zzg$$ExternalSyntheticApiModelOutline0.m(m.get(i));
                        if (zzg$$ExternalSyntheticApiModelOutline0.m(m2) == 10 && zzg$$ExternalSyntheticApiModelOutline0.m(m2) >= lastForceStopEventMillis) {
                            return true;
                        }
                    }
                }
