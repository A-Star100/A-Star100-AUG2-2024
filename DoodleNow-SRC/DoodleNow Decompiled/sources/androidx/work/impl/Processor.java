...
public class Processor implements ExecutionListener, ForegroundProcessor {
    ...
    public /* synthetic */ WorkSpec m355lambda$startWork$0$androidxworkimplProcessor(ArrayList arrayList, String str) throws Exception {
    ...
    public void m354lambda$runOnExecuted$1$androidxworkimplProcessor(WorkGenerationalId workGenerationalId, boolean z) {
        synchronized (this.mLock) {
            ...
            Logger logger = Logger.get();
            String str = TAG;
            logger.debug(str, getClass().getSimpleName() + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + workGenerationalId.getWorkSpecId() + " executed; reschedule = " + z);
