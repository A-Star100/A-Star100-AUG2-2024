...
public final class SystemIdInfoDao_Impl implements SystemIdInfoDao {
    ...
    public androidx.work.impl.model.SystemIdInfo getSystemIdInfo(java.lang.String r6, int r7) {
        ...
        L_0x0011:
            ...
            int r7 = androidx.room.util.CursorUtil.getColumnIndexOrThrow(r6, r7)     // Catch:{ all -> 0x005b }
            java.lang.String r2 = "generation"
            int r2 = androidx.room.util.CursorUtil.getColumnIndexOrThrow(r6, r2)     // Catch:{ all -> 0x005b }
            java.lang.String r3 = "system_id"
            int r3 = androidx.room.util.CursorUtil.getColumnIndexOrThrow(r6, r3)     // Catch:{ all -> 0x005b }
            boolean r4 = r6.moveToFirst()     // Catch:{ all -> 0x005b }
            if (r4 == 0) goto L_0x0054
            boolean r4 = r6.isNull(r7)     // Catch:{ all -> 0x005b }
            if (r4 == 0) goto L_0x0042
            goto L_0x0046
        L_0x0042:
            java.lang.String r1 = r6.getString(r7)     // Catch:{ all -> 0x005b }
        L_0x0046:
            int r7 = r6.getInt(r2)     // Catch:{ all -> 0x005b }
            int r2 = r6.getInt(r3)     // Catch:{ all -> 0x005b }
            androidx.work.impl.model.SystemIdInfo r3 = new androidx.work.impl.model.SystemIdInfo     // Catch:{ all -> 0x005b }
            r3.<init>(r1, r7, r2)     // Catch:{ all -> 0x005b }
            r1 = r3
        L_0x0054:
            r6.close()
            r0.release()
