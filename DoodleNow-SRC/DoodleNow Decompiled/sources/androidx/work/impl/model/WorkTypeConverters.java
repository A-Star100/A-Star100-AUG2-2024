...
public final class WorkTypeConverters {
    ...
    public static final byte[] setOfTriggersToByteArray(java.util.Set<androidx.work.Constraints.ContentUriTrigger> r6) {
        ...
        L_0x0010:
            ...
            r2 = r1
            java.io.ByteArrayOutputStream r2 = (java.io.ByteArrayOutputStream) r2     // Catch:{ all -> 0x006e }
            java.io.ObjectOutputStream r2 = new java.io.ObjectOutputStream     // Catch:{ all -> 0x006e }
            r3 = r0
            java.io.OutputStream r3 = (java.io.OutputStream) r3     // Catch:{ all -> 0x006e }
            r2.<init>(r3)     // Catch:{ all -> 0x006e }
            java.io.Closeable r2 = (java.io.Closeable) r2     // Catch:{ all -> 0x006e }
            r3 = r2
            java.io.ObjectOutputStream r3 = (java.io.ObjectOutputStream) r3     // Catch:{ all -> 0x0067 }
            int r4 = r6.size()     // Catch:{ all -> 0x0067 }
            r3.writeInt(r4)     // Catch:{ all -> 0x0067 }
            java.util.Iterator r6 = r6.iterator()     // Catch:{ all -> 0x0067 }
        L_0x0033:
            boolean r4 = r6.hasNext()     // Catch:{ all -> 0x0067 }
            if (r4 == 0) goto L_0x0052
            java.lang.Object r4 = r6.next()     // Catch:{ all -> 0x0067 }
            androidx.work.Constraints$ContentUriTrigger r4 = (androidx.work.Constraints.ContentUriTrigger) r4     // Catch:{ all -> 0x0067 }
            android.net.Uri r5 = r4.getUri()     // Catch:{ all -> 0x0067 }
            java.lang.String r5 = r5.toString()     // Catch:{ all -> 0x0067 }
            r3.writeUTF(r5)     // Catch:{ all -> 0x0067 }
            boolean r4 = r4.isTriggeredForDescendants()     // Catch:{ all -> 0x0067 }
            r3.writeBoolean(r4)     // Catch:{ all -> 0x0067 }
            goto L_0x0033
        L_0x0052:
            kotlin.Unit r6 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0067 }
            r6 = 0
            kotlin.io.CloseableKt.closeFinally(r2, r6)     // Catch:{ all -> 0x006e }
    ...
    public static final java.util.Set<androidx.work.Constraints.ContentUriTrigger> byteArrayToSetOfTriggers(byte[] r10) {
        ...
        L_0x0010:
            ...
            r2 = r10
            java.io.ByteArrayInputStream r2 = (java.io.ByteArrayInputStream) r2     // Catch:{ all -> 0x0063 }
            r2 = 0
            java.io.ObjectInputStream r3 = new java.io.ObjectInputStream     // Catch:{ IOException -> 0x0059 }
            java.io.InputStream r1 = (java.io.InputStream) r1     // Catch:{ IOException -> 0x0059 }
            r3.<init>(r1)     // Catch:{ IOException -> 0x0059 }
            java.io.Closeable r3 = (java.io.Closeable) r3     // Catch:{ IOException -> 0x0059 }
            r1 = r3
            java.io.ObjectInputStream r1 = (java.io.ObjectInputStream) r1     // Catch:{ all -> 0x0052 }
            int r4 = r1.readInt()     // Catch:{ all -> 0x0052 }
            r5 = 0
        L_0x002d:
            if (r5 >= r4) goto L_0x004c
            java.lang.String r6 = r1.readUTF()     // Catch:{ all -> 0x0052 }
            android.net.Uri r6 = android.net.Uri.parse(r6)     // Catch:{ all -> 0x0052 }
            boolean r7 = r1.readBoolean()     // Catch:{ all -> 0x0052 }
            androidx.work.Constraints$ContentUriTrigger r8 = new androidx.work.Constraints$ContentUriTrigger     // Catch:{ all -> 0x0052 }
            java.lang.String r9 = "uri"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r6, r9)     // Catch:{ all -> 0x0052 }
            r8.<init>(r6, r7)     // Catch:{ all -> 0x0052 }
            r0.add(r8)     // Catch:{ all -> 0x0052 }
            int r5 = r5 + 1
            goto L_0x002d
        L_0x004c:
            kotlin.Unit r1 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0052 }
            kotlin.io.CloseableKt.closeFinally(r3, r2)     // Catch:{ IOException -> 0x0059 }
            goto L_0x005d
        L_0x0052:
            r1 = move-exception
        ...
        L_0x0054:
            r4 = move-exception
            kotlin.io.CloseableKt.closeFinally(r3, r1)     // Catch:{ IOException -> 0x0059 }
