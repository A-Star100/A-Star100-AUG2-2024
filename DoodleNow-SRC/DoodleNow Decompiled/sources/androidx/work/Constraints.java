...
public final class Constraints {
    ...
    public static final class Builder {
        ...
        public final Constraints build() {
            ...
            return new Constraints(this.requiredNetworkType, this.requiresCharging, this.requiresDeviceIdle, this.requiresBatteryNotLow, this.requiresStorageNotLow, j2, j, set);
        }
    }
