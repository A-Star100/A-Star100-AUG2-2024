...
public final class PreviewView extends FrameLayout {
    ...
    public /* synthetic */ void m291lambda$new$0$androidxcameraviewPreviewView(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
    ...
    public PreviewView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mSurfaceProvider = new Preview.SurfaceProvider() {
            ...
            public /* synthetic */ void m292lambda$onSurfaceRequested$0$androidxcameraviewPreviewView$1(SurfaceRequest surfaceRequest) {
            ...
            public /* synthetic */ void m293lambda$onSurfaceRequested$1$androidxcameraviewPreviewView$1(androidx.camera.core.impl.CameraInternal r4, androidx.camera.core.SurfaceRequest r5, androidx.camera.core.SurfaceRequest.TransformationInfo r6) {
                /*
                    r3 = this;
                ...
                L_0x005c:
                    ...
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: androidx.camera.view.PreviewView.AnonymousClass1.m293lambda$onSurfaceRequested$1$androidxcameraviewPreviewView$1(androidx.camera.core.impl.CameraInternal, androidx.camera.core.SurfaceRequest, androidx.camera.core.SurfaceRequest$TransformationInfo):void");
            }

            /* access modifiers changed from: package-private */
            /* renamed from: lambda$onSurfaceRequested$2$androidx-camera-view-PreviewView$1  reason: not valid java name */
            public /* synthetic */ void m294lambda$onSurfaceRequested$2$androidxcameraviewPreviewView$1(PreviewStreamStateObserver previewStreamStateObserver, CameraInternal cameraInternal) {
