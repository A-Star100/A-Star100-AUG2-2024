...
public final class Preview extends UseCase {
    ...
    private SessionConfig.Builder createPipeline(String str, PreviewConfig previewConfig, StreamSpec streamSpec) {
        ...
        if (effect != null) {
            ...
            this.mCameraEdge.addOnInvalidatedListener(new Preview$$ExternalSyntheticLambda1(this));
            ...
            surfaceEdge.addOnInvalidatedListener(new Preview$$ExternalSyntheticLambda2(this, surfaceEdge, cameraInternal));
    ...
    public void m145lambda$createPipeline$0$androidxcameracorePreview(SurfaceEdge surfaceEdge, CameraInternal cameraInternal) {
        Threads.checkMainThread();
    ...
    private void addCameraSurfaceAndErrorListener(SessionConfig.Builder builder, String str, PreviewConfig previewConfig, StreamSpec streamSpec) {
        ...
        builder.addErrorListener(new Preview$$ExternalSyntheticLambda3(this, str, previewConfig, streamSpec));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$addCameraSurfaceAndErrorListener$1$androidx-camera-core-Preview  reason: not valid java name */
    public /* synthetic */ void m144lambda$addCameraSurfaceAndErrorListener$1$androidxcameracorePreview(String str, PreviewConfig previewConfig, StreamSpec streamSpec, SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
