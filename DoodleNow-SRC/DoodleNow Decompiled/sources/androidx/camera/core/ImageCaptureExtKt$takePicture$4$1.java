...
public final class ImageCaptureExtKt$takePicture$4$1 implements ImageCapture.OnImageSavedCallback {
    ...
    public void onImageSaved(ImageCapture.OutputFileResults outputFileResults) {
        ...
        this.$continuation.resumeWith(Result.m1230constructorimpl(outputFileResults));
    }
    ...
    public void onError(ImageCaptureException imageCaptureException) {
        ...
        delegatingImageSavedCallback.dispose();
        Result.Companion companion = Result.Companion;
        this.$continuation.resumeWith(Result.m1230constructorimpl(ResultKt.createFailure(imageCaptureException)));
    }
}
