...
public final /* synthetic */ class SurfaceRequest$$ExternalSyntheticLambda4 implements CallbackToFutureAdapter.Resolver {
    ...
    public /* synthetic */ SurfaceRequest$$ExternalSyntheticLambda4(SurfaceRequest surfaceRequest, AtomicReference atomicReference) {
        this.f$0 = surfaceRequest;
        this.f$1 = atomicReference;
    }

    public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
        return this.f$0.m148lambda$initialSurfaceRecreationCompleter$6$androidxcameracoreSurfaceRequest(this.f$1, completer);
    }
}
