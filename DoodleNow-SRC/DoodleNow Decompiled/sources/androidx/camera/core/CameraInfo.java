...
public interface CameraInfo {
    ...
    public final /* synthetic */ class CC {
        ...
        public static Set $default$getSupportedFrameRateRanges(CameraInfo _this) {
            return Collections.emptySet();
        }

        public static Set $default$querySupportedDynamicRanges(CameraInfo _this, Set set) {
            return DynamicRanges.findAllPossibleMatches(set, Collections.singleton(DynamicRange.SDR));
        }

        public static Set $default$getPhysicalCameraInfos(CameraInfo _this) {
            return Collections.emptySet();
        }
    }
}
