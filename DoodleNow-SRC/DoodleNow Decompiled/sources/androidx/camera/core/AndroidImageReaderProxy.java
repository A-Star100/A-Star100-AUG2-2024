...
class AndroidImageReaderProxy implements ImageReaderProxy {
    ...
    public /* synthetic */ void m129lambda$setOnImageAvailableListener$1$androidxcameracoreAndroidImageReaderProxy(Executor executor, ImageReaderProxy.OnImageAvailableListener onImageAvailableListener, ImageReader imageReader) {
        synchronized (this.mLock) {
    ...
    public /* synthetic */ void m128lambda$setOnImageAvailableListener$0$androidxcameracoreAndroidImageReaderProxy(ImageReaderProxy.OnImageAvailableListener onImageAvailableListener) {
