...
public class MetadataImageReader implements ImageReaderProxy, ForwardingImageProxy.OnImageCloseListener {
    ...
    public /* synthetic */ void m143lambda$new$0$androidxcameracoreMetadataImageReader(ImageReaderProxy imageReaderProxy) {
    ...
    public /* synthetic */ void m142lambda$enqueueImageProxy$1$androidxcameracoreMetadataImageReader(ImageReaderProxy.OnImageAvailableListener onImageAvailableListener) {
        onImageAvailableListener.onImageAvailable(this);
    }
    ...
    private void removeStaleData() {
        /*
            ...
            monitor-enter(r0)
            android.util.LongSparseArray<androidx.camera.core.ImageProxy> r1 = r7.mPendingImages     // Catch:{ all -> 0x008e }
            int r1 = r1.size()     // Catch:{ all -> 0x008e }
            if (r1 == 0) goto L_0x008c
            android.util.LongSparseArray<androidx.camera.core.ImageInfo> r1 = r7.mPendingImageInfos     // Catch:{ all -> 0x008e }
            int r1 = r1.size()     // Catch:{ all -> 0x008e }
        ...
        L_0x0015:
            ...
            android.util.LongSparseArray<androidx.camera.core.ImageInfo> r3 = r7.mPendingImageInfos     // Catch:{ all -> 0x008e }
            long r2 = r3.keyAt(r2)     // Catch:{ all -> 0x008e }
            java.lang.Long r2 = java.lang.Long.valueOf(r2)     // Catch:{ all -> 0x008e }
            boolean r3 = r2.equals(r1)     // Catch:{ all -> 0x008e }
            r3 = r3 ^ 1
            androidx.core.util.Preconditions.checkArgument(r3)     // Catch:{ all -> 0x008e }
            long r3 = r2.longValue()     // Catch:{ all -> 0x008e }
        ...
        L_0x0047:
            ...
            android.util.LongSparseArray<androidx.camera.core.ImageProxy> r3 = r7.mPendingImages     // Catch:{ all -> 0x008e }
            long r3 = r3.keyAt(r1)     // Catch:{ all -> 0x008e }
            long r5 = r2.longValue()     // Catch:{ all -> 0x008e }
            int r3 = (r3 > r5 ? 1 : (r3 == r5 ? 0 : -1))
            if (r3 >= 0) goto L_0x0067
            android.util.LongSparseArray<androidx.camera.core.ImageProxy> r3 = r7.mPendingImages     // Catch:{ all -> 0x008e }
            java.lang.Object r3 = r3.valueAt(r1)     // Catch:{ all -> 0x008e }
            androidx.camera.core.ImageProxy r3 = (androidx.camera.core.ImageProxy) r3     // Catch:{ all -> 0x008e }
            r3.close()     // Catch:{ all -> 0x008e }
            android.util.LongSparseArray<androidx.camera.core.ImageProxy> r3 = r7.mPendingImages     // Catch:{ all -> 0x008e }
            r3.removeAt(r1)     // Catch:{ all -> 0x008e }
        L_0x0067:
            int r1 = r1 + -1
            goto L_0x0047
        L_0x006a:
            android.util.LongSparseArray<androidx.camera.core.ImageInfo> r2 = r7.mPendingImageInfos     // Catch:{ all -> 0x008e }
