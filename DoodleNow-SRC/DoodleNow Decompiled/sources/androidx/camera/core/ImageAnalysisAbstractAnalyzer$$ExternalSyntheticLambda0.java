...
public final /* synthetic */ class ImageAnalysisAbstractAnalyzer$$ExternalSyntheticLambda0 implements CallbackToFutureAdapter.Resolver {
    ...
    public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
        return this.f$0.m137lambda$analyzeImage$1$androidxcameracoreImageAnalysisAbstractAnalyzer(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6, completer);
    }
}
