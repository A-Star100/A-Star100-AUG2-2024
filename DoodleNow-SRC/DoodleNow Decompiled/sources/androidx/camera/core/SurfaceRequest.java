...
public final class SurfaceRequest {
    ...
    public /* synthetic */ void m149lambda$new$3$androidxcameracoreSurfaceRequest() {
    ...
    private CallbackToFutureAdapter.Completer<Void> initialSurfaceRecreationCompleter(Executor executor, final Runnable runnable) {
        AtomicReference atomicReference = new AtomicReference((Object) null);
        Futures.addCallback(CallbackToFutureAdapter.getFuture(new SurfaceRequest$$ExternalSyntheticLambda4(this, atomicReference)), new FutureCallback<Void>() {
            public void onFailure(Throwable th) {
            }
    ...
    public /* synthetic */ Object m148lambda$initialSurfaceRecreationCompleter$6$androidxcameracoreSurfaceRequest(AtomicReference atomicReference, CallbackToFutureAdapter.Completer completer) throws Exception {
