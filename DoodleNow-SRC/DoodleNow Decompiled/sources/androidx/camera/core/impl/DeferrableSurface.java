...
public abstract class DeferrableSurface {
    ...
    public /* synthetic */ Object m173lambda$new$1$androidxcameracoreimplDeferrableSurface(CallbackToFutureAdapter.Completer completer) throws Exception {
        synchronized (this.mLock) {
    ...
    public /* synthetic */ void m174lambda$new$2$androidxcameracoreimplDeferrableSurface(String str) {
        try {
    ...
    public void incrementUseCount() throws SurfaceClosedException {
        synchronized (this.mLock) {
            ...
            if (Logger.isDebugEnabled(TAG)) {
                ...
                Logger.d(TAG, "use count+1, useCount=" + this.mUseCount + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + this);
            }
        }
    }
    ...
    public void decrementUseCount() {
        ...
        synchronized (this.mLock) {
            ...
            if (i != 0) {
                ...
                if (Logger.isDebugEnabled(TAG)) {
                    Logger.d(TAG, "use count-1,  useCount=" + this.mUseCount + " closed=" + this.mClosed + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + this);
                    if (this.mUseCount == 0) {
