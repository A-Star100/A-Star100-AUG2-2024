...
public interface CameraConfig extends ReadableConfig {
    ...
    public final /* synthetic */ class CC {
        ...
        public static int $default$getUseCaseCombinationRequiredRule(CameraConfig _this) {
            return ((Integer) _this.retrieveOption(CameraConfig.OPTION_USE_CASE_COMBINATION_REQUIRED_RULE, 0)).intValue();
        }
        ...
        public static boolean $default$isPostviewSupported(CameraConfig _this) {
            return ((Boolean) _this.retrieveOption(CameraConfig.OPTION_POSTVIEW_SUPPORTED, false)).booleanValue();
        }

        public static boolean $default$isCaptureProcessProgressSupported(CameraConfig _this) {
            return ((Boolean) _this.retrieveOption(CameraConfig.OPTION_CAPTURE_PROCESS_PROGRESS_SUPPORTED, false)).booleanValue();
        }
