...
public final class LiveDataObservable<T> implements Observable<T> {
    ...
    public /* synthetic */ Object m177lambda$fetchData$1$androidxcameracoreimplLiveDataObservable(CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    public /* synthetic */ void m176lambda$fetchData$0$androidxcameracoreimplLiveDataObservable(CallbackToFutureAdapter.Completer completer) {
    ...
    public /* synthetic */ void m175lambda$addObserver$2$androidxcameracoreimplLiveDataObservable(LiveDataObserverAdapter liveDataObserverAdapter, LiveDataObserverAdapter liveDataObserverAdapter2) {
        if (liveDataObserverAdapter != null) {
    ...
    public /* synthetic */ void m178lambda$removeObserver$3$androidxcameracoreimplLiveDataObservable(LiveDataObserverAdapter liveDataObserverAdapter) {
        this.mLiveData.removeObserver(liveDataObserverAdapter);
    }
    ...
    private static final class LiveDataObserverAdapter<T> implements Observer<Result<T>> {
        ...
        public /* synthetic */ void m179lambda$onChanged$0$androidxcameracoreimplLiveDataObservable$LiveDataObserverAdapter(Result result) {
            if (this.mActive.get()) {
