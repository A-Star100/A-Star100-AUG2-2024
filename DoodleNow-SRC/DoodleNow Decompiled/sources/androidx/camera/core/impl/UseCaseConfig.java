...
public interface UseCaseConfig<T extends UseCase> extends TargetConfig<T>, ImageInputConfig {
    ...
    public final /* synthetic */ class CC {
        ...
        public static boolean $default$isZslDisabled(UseCaseConfig _this, boolean z) {
            return ((Boolean) _this.retrieveOption(UseCaseConfig.OPTION_ZSL_DISABLED, Boolean.valueOf(z))).booleanValue();
        }

        public static boolean $default$isHigResolutionDisabled(UseCaseConfig _this, boolean z) {
            return ((Boolean) _this.retrieveOption(UseCaseConfig.OPTION_HIGH_RESOLUTION_DISABLED, Boolean.valueOf(z))).booleanValue();
        }
        ...
        public static int $default$getPreviewStabilizationMode(UseCaseConfig _this) {
            return ((Integer) _this.retrieveOption(UseCaseConfig.OPTION_PREVIEW_STABILIZATION_MODE, 0)).intValue();
        }

        public static int $default$getVideoStabilizationMode(UseCaseConfig _this) {
            return ((Integer) _this.retrieveOption(UseCaseConfig.OPTION_VIDEO_STABILIZATION_MODE, 0)).intValue();
        }
    }
}
