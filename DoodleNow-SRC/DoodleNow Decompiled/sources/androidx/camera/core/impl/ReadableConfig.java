...
public interface ReadableConfig extends Config {
    ...
    public final /* synthetic */ class CC {
        ...
        public static Object $default$retrieveOption(ReadableConfig _this, Config.Option option) {
            return _this.getConfig().retrieveOption(option);
        }

        public static Object $default$retrieveOption(ReadableConfig _this, Config.Option option, Object obj) {
        ...
        public static Object $default$retrieveOptionWithPriority(ReadableConfig _this, Config.Option option, Config.OptionPriority optionPriority) {
