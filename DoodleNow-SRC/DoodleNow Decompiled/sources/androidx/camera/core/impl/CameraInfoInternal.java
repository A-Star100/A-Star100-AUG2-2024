...
public interface CameraInfoInternal extends CameraInfo {
    ...
    public final /* synthetic */ class CC {
        ...
        public static CameraSelector $default$getCameraSelector(CameraInfoInternal _this) {
            return new CameraSelector.Builder().addCameraFilter(new CameraInfoInternal$$ExternalSyntheticLambda0(_this)).addCameraFilter(new LensFacingCameraFilter(_this.getLensFacing())).build();
        }
