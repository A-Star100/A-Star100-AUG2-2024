...
public class AdvancedVendorExtender implements VendorExtender {
    ...
    public boolean isExtensionStrengthAvailable() {
        ...
        return getSupportedParameterKeys().contains(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2());
    }
    ...
    public boolean isCurrentExtensionModeAvailable() {
        ...
        return getSupportedResultKeys().contains(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$1());
    }
