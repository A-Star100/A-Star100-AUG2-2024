...
class PreviewProcessor {
    ...
    public /* synthetic */ void m211lambda$start$0$androidxcameraextensionsinternalsessionprocessorPreviewProcessor(final OnCaptureResultCallback onCaptureResultCallback, ImageReference imageReference, TotalCaptureResult totalCaptureResult, int i) {
        synchronized (this.mLock) {
