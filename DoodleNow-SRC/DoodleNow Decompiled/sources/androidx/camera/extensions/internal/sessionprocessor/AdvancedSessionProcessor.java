...
public class AdvancedSessionProcessor extends SessionProcessorBase {
    ...
    public void setExtensionStrength(int i) {
        ...
        if (isExtensionStrengthAvailable() && Build.VERSION.SDK_INT >= 34) {
            synchronized (this.mLock) {
                ...
                this.mWorkingCaptureConfigMap.put(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2(), Integer.valueOf(this.mExtensionStrength));
    ...
    public void setParameters(Config config) {
        ...
        synchronized (this.mLock) {
            ...
            if (this.mExtensionStrength != -1 && Build.VERSION.SDK_INT >= 34) {
                convertConfigToMap.put(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2(), Integer.valueOf(this.mExtensionStrength));
            }
    ...
    private static class SessionProcessorImplCaptureCallbackAdapter implements SessionProcessorImpl.CaptureCallback {
        ...
        SessionProcessorImplCaptureCallbackAdapter(SessionProcessor.CaptureCallback captureCallback) {
            this(captureCallback, (ExtensionMetadataMonitor) null);
        }
    ...
    private static class ExtensionMetadataMonitor {
        ...
        public void checkExtensionMetadata(Map<CaptureResult.Key, Object> map) {
            ...
            if (Build.VERSION.SDK_INT >= 34) {
                if (!(this.mCurrentExtensionTypeLiveData == null || (obj2 = map.get(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$1())) == null)) {
                ...
                if (this.mExtensionStrengthLiveData != null && (obj = map.get(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2())) != null && !Objects.equals(this.mExtensionStrengthLiveData.getValue(), obj)) {
