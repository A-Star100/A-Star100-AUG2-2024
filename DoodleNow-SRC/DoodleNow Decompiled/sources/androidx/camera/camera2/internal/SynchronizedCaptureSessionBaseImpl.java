...
class SynchronizedCaptureSessionBaseImpl extends SynchronizedCaptureSession.StateCallback implements SynchronizedCaptureSession, SynchronizedCaptureSession.Opener {
    ...
    public /* synthetic */ Object m84lambda$openCaptureSession$0$androidxcameracamera2internalSynchronizedCaptureSessionBaseImpl(List list, CameraDeviceCompat cameraDeviceCompat, SessionConfigurationCompat sessionConfigurationCompat, CallbackToFutureAdapter.Completer completer) throws Exception {
        String str;
        synchronized (this.mLock) {
    ...
    public /* synthetic */ ListenableFuture m85lambda$startWithDeferrableSurface$1$androidxcameracamera2internalSynchronizedCaptureSessionBaseImpl(List list, List list2) throws Exception {
    ...
    public /* synthetic */ void m81lambda$close$2$androidxcameracamera2internalSynchronizedCaptureSessionBaseImpl() {
    ...
    public /* synthetic */ void m82lambda$onClosed$3$androidxcameracamera2internalSynchronizedCaptureSessionBaseImpl(SynchronizedCaptureSession synchronizedCaptureSession) {
    ...
    public /* synthetic */ void m83lambda$onSessionFinished$4$androidxcameracamera2internalSynchronizedCaptureSessionBaseImpl(SynchronizedCaptureSession synchronizedCaptureSession) {
        Objects.requireNonNull(this.mCaptureSessionStateCallback);
