...
public class Camera2CameraControlImpl implements CameraControlInternal {
    ...
    public void addInteropConfig(Config config) {
        this.mCamera2CameraControl.addCaptureRequestOptions(CaptureRequestOptions.Builder.from(config).build()).addListener(new Camera2CameraControlImpl$$ExternalSyntheticLambda9(), CameraXExecutors.directExecutor());
    }
    ...
    public /* synthetic */ Object m16lambda$waitForSessionUpdateId$3$androidxcameracamera2internalCamera2CameraControlImpl(long j, CallbackToFutureAdapter.Completer completer) throws Exception {
        addCaptureResultListener(new Camera2CameraControlImpl$$ExternalSyntheticLambda3(j, completer));
    ...
    public ListenableFuture<List<Void>> submitStillCaptureRequests(List<CaptureConfig> list, int i, int i2) {
        ...
        return FutureChain.from(Futures.nonCancellationPropagating(this.mFlashModeChangeSessionUpdateFuture)).transformAsync(new Camera2CameraControlImpl$$ExternalSyntheticLambda7(this, list, i, getFlashMode(), i2), this.mExecutor);
    }
    ...
    public /* synthetic */ ListenableFuture m13lambda$submitStillCaptureRequests$4$androidxcameracamera2internalCamera2CameraControlImpl(List list, int i, int i2, int i3, Void voidR) throws Exception {
    ...
    public ListenableFuture<Void> updateSessionConfigAsync() {
        return Futures.nonCancellationPropagating(CallbackToFutureAdapter.getFuture(new Camera2CameraControlImpl$$ExternalSyntheticLambda2(this)));
    }
    ...
    public /* synthetic */ Object m15lambda$updateSessionConfigAsync$6$androidxcameracamera2internalCamera2CameraControlImpl(CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    public /* synthetic */ void m14lambda$updateSessionConfigAsync$5$androidxcameracamera2internalCamera2CameraControlImpl(CallbackToFutureAdapter.Completer completer) {
    ...
    public /* synthetic */ void m11lambda$addSessionCameraCaptureCallback$7$androidxcameracamera2internalCamera2CameraControlImpl(Executor executor, CameraCaptureCallback cameraCaptureCallback) {
    ...
    public /* synthetic */ void m12lambda$removeSessionCameraCaptureCallback$8$androidxcameracamera2internalCamera2CameraControlImpl(CameraCaptureCallback cameraCaptureCallback) {
    ...
    static final class CameraControlSessionCallback extends CameraCaptureSession.CaptureCallback {
        ...
        public /* synthetic */ void m17lambda$onCaptureCompleted$0$androidxcameracamera2internalCamera2CameraControlImpl$CameraControlSessionCallback(TotalCaptureResult totalCaptureResult) {
