...
public class ExposureControl {
    ...
    public /* synthetic */ Object m60lambda$setExposureCompensationIndex$2$androidxcameracamera2internalExposureControl(int i, CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    public /* synthetic */ void m59lambda$setExposureCompensationIndex$1$androidxcameracamera2internalExposureControl(CallbackToFutureAdapter.Completer completer, int i) {
        boolean z = false;
        if (!this.mIsActive) {
            this.mExposureStateImpl.setExposureCompensationIndex(0);
