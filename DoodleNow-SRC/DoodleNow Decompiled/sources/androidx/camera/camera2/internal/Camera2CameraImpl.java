...
final class Camera2CameraImpl implements CameraInternal {
    ...
    public /* synthetic */ void m21lambda$configAndCloseIfNeeded$0$androidxcameracamera2internalCamera2CameraImpl() {
        this.mIsConfiguringForClose = false;
        this.mIsConfigAndCloseRequired = false;
    ...
    public /* synthetic */ Object m31lambda$openCameraConfigAndClose$1$androidxcameracamera2internalCamera2CameraImpl(final CallbackToFutureAdapter.Completer completer) throws Exception {
        try {
            ...
            arrayList.add(new CameraDevice.StateCallback() {
                ...
                public void onError(CameraDevice cameraDevice, int i) {
                    ...
                    camera2CameraImpl.debugLog("openCameraConfigAndClose camera error " + i);
                    completer.set(null);
                }
    ...
    public /* synthetic */ Object m33lambda$release$5$androidxcameracamera2internalCamera2CameraImpl(CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    public /* synthetic */ void m32lambda$release$4$androidxcameracamera2internalCamera2CameraImpl(CallbackToFutureAdapter.Completer completer) {
    ...
    public /* synthetic */ Object m23lambda$getOrCreateUserReleaseFuture$6$androidxcameracamera2internalCamera2CameraImpl(CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    public void onUseCaseActive(UseCase useCase) {
        ...
        this.mExecutor.execute(new Camera2CameraImpl$$ExternalSyntheticLambda1(this, getUseCaseId(useCase), useCase.getSessionConfig(), useCase.getCurrentConfig(), useCase.getAttachedStreamSpec(), getCaptureTypes(useCase)));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$onUseCaseActive$7$androidx-camera-camera2-internal-Camera2CameraImpl  reason: not valid java name */
    public /* synthetic */ void m28lambda$onUseCaseActive$7$androidxcameracamera2internalCamera2CameraImpl(String str, SessionConfig sessionConfig, UseCaseConfig useCaseConfig, StreamSpec streamSpec, List list) {
    ...
    public /* synthetic */ void m29lambda$onUseCaseInactive$8$androidxcameracamera2internalCamera2CameraImpl(String str) {
    ...
    public void onUseCaseUpdated(UseCase useCase) {
        Preconditions.checkNotNull(useCase);
        this.mExecutor.execute(new Camera2CameraImpl$$ExternalSyntheticLambda4(this, getUseCaseId(useCase), useCase.getSessionConfig(), useCase.getCurrentConfig(), useCase.getAttachedStreamSpec(), getCaptureTypes(useCase)));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$onUseCaseUpdated$9$androidx-camera-camera2-internal-Camera2CameraImpl  reason: not valid java name */
    public /* synthetic */ void m30lambda$onUseCaseUpdated$9$androidxcameracamera2internalCamera2CameraImpl(String str, SessionConfig sessionConfig, UseCaseConfig useCaseConfig, StreamSpec streamSpec, List list) {
    ...
    public /* synthetic */ void m34lambda$resetUseCase$10$androidxcameracamera2internalCamera2CameraImpl(String str, SessionConfig sessionConfig, UseCaseConfig useCaseConfig, StreamSpec streamSpec, List list) {
    ...
    public /* synthetic */ Object m27lambda$isUseCaseAttached$12$androidxcameracamera2internalCamera2CameraImpl(String str, CallbackToFutureAdapter.Completer completer) throws Exception {
        try {
    ...
    public /* synthetic */ void m26lambda$isUseCaseAttached$11$androidxcameracamera2internalCamera2CameraImpl(CallbackToFutureAdapter.Completer completer, String str) {
    ...
    public /* synthetic */ Object m25lambda$isMeteringRepeatingAttached$14$androidxcameracamera2internalCamera2CameraImpl(CallbackToFutureAdapter.Completer completer) throws Exception {
        try {
    ...
    public /* synthetic */ void m24lambda$isMeteringRepeatingAttached$13$androidxcameracamera2internalCamera2CameraImpl(CallbackToFutureAdapter.Completer completer) {
    ...
    public /* synthetic */ void m20lambda$attachUseCases$15$androidxcameracamera2internalCamera2CameraImpl(List list) {
        try {
    ...
    public void m22lambda$detachUseCases$16$androidxcameracamera2internalCamera2CameraImpl(Collection<UseCaseInfo> collection) {
        ArrayList arrayList = new ArrayList();
        boolean z = false;
        for (UseCaseInfo next : collection) {
            if (this.mUseCaseAttachState.isUseCaseAttached(next.getUseCaseId())) {
    ...
    public /* synthetic */ void m19lambda$addOrRemoveMeteringRepeatingUseCase$17$androidxcameracamera2internalCamera2CameraImpl() {
    ...
    public /* synthetic */ void m35lambda$setActiveResumingMode$18$androidxcameracamera2internalCamera2CameraImpl(boolean z) {
    ...
    public void postSurfaceClosedError(SessionConfig sessionConfig) {
        ...
        if (!errorListeners.isEmpty()) {
            ...
            mainThreadExecutor.execute(new Camera2CameraImpl$$ExternalSyntheticLambda2(errorListeners.get(0), sessionConfig));
        }
    }
    ...
    final class StateCallback extends CameraDevice.StateCallback {
        ...
        class ScheduledReopen implements Runnable {
            ...
            public /* synthetic */ void m38lambda$run$0$androidxcameracamera2internalCamera2CameraImpl$StateCallback$ScheduledReopen() {
                if (!this.mCancelled) {
