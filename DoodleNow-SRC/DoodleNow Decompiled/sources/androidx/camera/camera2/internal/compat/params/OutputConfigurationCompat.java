...
public final class OutputConfigurationCompat {
    ...
    public static OutputConfigurationCompat wrap(Object obj) {
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            outputConfigurationCompatImpl = OutputConfigurationCompatApi33Impl.wrap(ComponentDialog$$ExternalSyntheticApiModelOutline0.m(obj));
        } else if (Build.VERSION.SDK_INT >= 28) {
            outputConfigurationCompatImpl = OutputConfigurationCompatApi28Impl.wrap(ComponentDialog$$ExternalSyntheticApiModelOutline0.m(obj));
        } else if (Build.VERSION.SDK_INT >= 26) {
            outputConfigurationCompatImpl = OutputConfigurationCompatApi26Impl.wrap(ComponentDialog$$ExternalSyntheticApiModelOutline0.m(obj));
        } else {
            outputConfigurationCompatImpl = Build.VERSION.SDK_INT >= 24 ? OutputConfigurationCompatApi24Impl.wrap(ComponentDialog$$ExternalSyntheticApiModelOutline0.m(obj)) : null;
        }
