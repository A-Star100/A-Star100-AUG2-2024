...
public final class SessionConfigurationCompat {
    ...
    static List<OutputConfigurationCompat> transformToCompat(List<OutputConfiguration> list) {
        ...
        for (OutputConfiguration m : list) {
            arrayList.add(OutputConfigurationCompat.wrap(ComponentDialog$$ExternalSyntheticApiModelOutline0.m((Object) m)));
        }
        return arrayList;
    }
    ...
    public static List<OutputConfiguration> transformFromCompat(List<OutputConfigurationCompat> list) {
        ...
        for (OutputConfigurationCompat unwrap : list) {
            arrayList.add(ComponentDialog$$ExternalSyntheticApiModelOutline0.m(unwrap.unwrap()));
        }
        return arrayList;
    }
