...
final class AndroidRZoomImpl implements ZoomControl.ZoomImpl {
    ...
    AndroidRZoomImpl(CameraCharacteristicsCompat cameraCharacteristicsCompat) {
        ...
        this.mZoomRatioRange = (Range) cameraCharacteristicsCompat.get(ComponentDialog$$ExternalSyntheticApiModelOutline0.m());
    }
    ...
    public void addRequestOption(Camera2ImplConfig.Builder builder) {
        builder.setCaptureRequestOptionWithPriority(ComponentDialog$$ExternalSyntheticApiModelOutline0.m(), Float.valueOf(this.mCurrentZoomRatio), Config.OptionPriority.REQUIRED);
    }
    ...
    public void onCaptureResult(TotalCaptureResult totalCaptureResult) {
        ...
        if (this.mPendingZoomRatioCompleter != null) {
            ...
            if (request == null) {
                ...
                f = (Float) request.get(ComponentDialog$$ExternalSyntheticApiModelOutline0.m());
            }
            if (f != null) {
