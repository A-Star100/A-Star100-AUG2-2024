...
final class ProcessingCaptureSession implements CaptureSessionInterface {
    ...
    public /* synthetic */ ListenableFuture m78lambda$open$2$androidxcameracamera2internalProcessingCaptureSession(SessionConfig sessionConfig, CameraDevice cameraDevice, SynchronizedCaptureSession.Opener opener, List list) throws Exception {
    ...
    public /* synthetic */ void m77lambda$open$0$androidxcameracamera2internalProcessingCaptureSession(DeferrableSurface deferrableSurface) {
        DeferrableSurfaces.decrementAll(this.mOutputSurfaces);
        if (deferrableSurface != null) {
            deferrableSurface.decrementUseCount();
        }
    ...
    public /* synthetic */ Void m79lambda$open$3$androidxcameracamera2internalProcessingCaptureSession(Void voidR) {
    ...
    public void issueTriggerRequest(androidx.camera.core.impl.CaptureConfig r6) {
        /*
            r5 = this;
            java.lang.String r0 = "ProcessingCaptureSession"
            java.lang.String r1 = "issueTriggerRequest"
            androidx.camera.core.Logger.d(r0, r1)
            androidx.camera.core.impl.Config r0 = r6.getImplementationOptions()
        ...
        L_0x003d:
            androidx.camera.core.impl.SessionProcessor r1 = r5.mSessionProcessor
            androidx.camera.camera2.internal.ProcessingCaptureSession$CaptureCallbackAdapter r2 = new androidx.camera.camera2.internal.ProcessingCaptureSession$CaptureCallbackAdapter
            int r3 = r6.getId()
            java.util.List r6 = r6.getCameraCaptureCallbacks()
            r4 = 0
            r2.<init>(r3, r6)
    ...
    private static class CaptureCallbackAdapter implements SessionProcessor.CaptureCallback {
        ...
        public void onCaptureSequenceCompleted(int i) {
            for (CameraCaptureCallback onCaptureCompleted : this.mCameraCaptureCallbacks) {
                onCaptureCompleted.onCaptureCompleted(this.mCaptureConfigId, new CameraCaptureResult.EmptyCameraCaptureResult());
            }
        }
    ...
    public /* synthetic */ void m80lambda$release$4$androidxcameracamera2internalProcessingCaptureSession() {
