...
class FocusMeteringControl {
    ...
    public /* synthetic */ Object m73lambda$startFocusAndMetering$1$androidxcameracamera2internalFocusMeteringControl(FocusMeteringAction focusMeteringAction, long j, CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    public void m72lambda$startFocusAndMetering$0$androidxcameracamera2internalFocusMeteringControl(CallbackToFutureAdapter.Completer<FocusMeteringResult> completer, FocusMeteringAction focusMeteringAction, long j) {
        if (!this.mIsActive) {
    ...
    public /* synthetic */ Object m75lambda$triggerAePrecapture$3$androidxcameracamera2internalFocusMeteringControl(CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    public void m74lambda$triggerAePrecapture$2$androidxcameracamera2internalFocusMeteringControl(final CallbackToFutureAdapter.Completer<Void> completer) {
        if (this.mIsActive) {
            CaptureConfig.Builder builder = new CaptureConfig.Builder();
            builder.setTemplateType(this.mTemplate);
            builder.setUseRepeatingSurface(true);
    ...
    public /* synthetic */ Object m65lambda$enableExternalFlashAeMode$5$androidxcameracamera2internalFocusMeteringControl(boolean z, CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    public /* synthetic */ void m64lambda$enableExternalFlashAeMode$4$androidxcameracamera2internalFocusMeteringControl(boolean z, CallbackToFutureAdapter.Completer completer) {
    ...
    public /* synthetic */ boolean m66lambda$enableExternalFlashAeMode$6$androidxcameracamera2internalFocusMeteringControl(long j, CallbackToFutureAdapter.Completer completer, TotalCaptureResult totalCaptureResult) {
    ...
    public /* synthetic */ boolean m69lambda$executeMeteringAction$7$androidxcameracamera2internalFocusMeteringControl(boolean z, long j, TotalCaptureResult totalCaptureResult) {
    ...
    public /* synthetic */ void m71lambda$executeMeteringAction$9$androidxcameracamera2internalFocusMeteringControl(long j) {
    ...
    public /* synthetic */ void m70lambda$executeMeteringAction$8$androidxcameracamera2internalFocusMeteringControl(long j) {
    ...
    public /* synthetic */ void m68lambda$executeMeteringAction$11$androidxcameracamera2internalFocusMeteringControl(long j) {
    ...
    public /* synthetic */ void m67lambda$executeMeteringAction$10$androidxcameracamera2internalFocusMeteringControl(long j) {
        if (j == this.mFocusTimeoutCounter) {
            cancelFocusAndMeteringWithoutAsyncResult();
        }
    }
    ...
    public /* synthetic */ Object m62lambda$cancelFocusAndMetering$13$androidxcameracamera2internalFocusMeteringControl(CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    public void cancelFocusAndMeteringWithoutAsyncResult() {
        m61lambda$cancelFocusAndMetering$12$androidxcameracamera2internalFocusMeteringControl((CallbackToFutureAdapter.Completer<Void>) null);
    }

    /* access modifiers changed from: package-private */
    /* renamed from: cancelFocusAndMeteringInternal */
    public void m61lambda$cancelFocusAndMetering$12$androidxcameracamera2internalFocusMeteringControl(CallbackToFutureAdapter.Completer<Void> completer) {
    ...
    public /* synthetic */ boolean m63lambda$cancelFocusAndMeteringInternal$14$androidxcameracamera2internalFocusMeteringControl(int i, long j, TotalCaptureResult totalCaptureResult) {
