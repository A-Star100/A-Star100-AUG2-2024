...
final class TorchControl {
    ...
    public /* synthetic */ boolean m91lambda$new$0$androidxcameracamera2internalTorchControl(TotalCaptureResult totalCaptureResult) {
    ...
    public /* synthetic */ Object m90lambda$enableTorch$2$androidxcameracamera2internalTorchControl(boolean z, CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    public void m89lambda$enableTorch$1$androidxcameracamera2internalTorchControl(CallbackToFutureAdapter.Completer<Void> completer, boolean z) {
        if (!this.mHasFlashUnit) {
            if (completer != null) {
