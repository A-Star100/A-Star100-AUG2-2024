...
final class SupportedSurfaceCombination {
    ...
    /* access modifiers changed from: package-private */
    public Pair<Map<UseCaseConfig<?>, StreamSpec>, Map<AttachedSurfaceInfo, StreamSpec>> getSuggestedStreamSpecifications(int i, List<AttachedSurfaceInfo> list, Map<UseCaseConfig<?>, List<Size>> map, boolean z) {
        List<Integer> list2;
        int i2;
        Range<Integer> range;
        HashMap hashMap;
        ...
        if (isUseCasesCombinationSupported) {
            ...
            while (true) {
                ...
                int i13 = i2;
                boolean z4 = range == null || i13 <= i8 || i8 >= range.getLower().intValue();
            ...
            if (list4 != null) {
                ...
                while (it3.hasNext()) {
                    ...
                    Iterator it4 = it3;
                    StreamSpec.Builder implementationOptions = StreamSpec.builder((Size) list4.get(list11.indexOf(Integer.valueOf(arrayList.indexOf(useCaseConfig2))))).setDynamicRange((DynamicRange) Preconditions.checkNotNull(map4.get(useCaseConfig2))).setImplementationOptions(StreamUseCaseUtil.getStreamSpecImplementationOptions(useCaseConfig2));
                    if (range3 != null) {
    ...
    private void updateUltraMaximumSizeByFormat(Map<Integer, Size> map, int i) {
        ...
        if (Build.VERSION.SDK_INT >= 31 && this.mIsUltraHighResolutionSensorSupported && (streamConfigurationMap = (StreamConfigurationMap) this.mCharacteristics.get(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2())) != null) {
