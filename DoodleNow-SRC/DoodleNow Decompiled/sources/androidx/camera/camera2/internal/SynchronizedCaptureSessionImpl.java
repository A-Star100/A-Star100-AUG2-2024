...
class SynchronizedCaptureSessionImpl extends SynchronizedCaptureSessionBaseImpl {
    ...
    public /* synthetic */ ListenableFuture m88lambda$openCaptureSession$0$androidxcameracamera2internalSynchronizedCaptureSessionImpl(CameraDevice cameraDevice, SessionConfigurationCompat sessionConfigurationCompat, List list, List list2) throws Exception {
    ...
    public /* synthetic */ void m87lambda$onConfigured$1$androidxcameracamera2internalSynchronizedCaptureSessionImpl(SynchronizedCaptureSession synchronizedCaptureSession) {
    ...
    public /* synthetic */ void m86lambda$close$2$androidxcameracamera2internalSynchronizedCaptureSessionImpl() {
