...
public final class Camera2CameraControl {
    ...
    public /* synthetic */ Object m127lambda$setCaptureRequestOptions$1$androidxcameracamera2interopCamera2CameraControl(CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    public /* synthetic */ Object m122lambda$addCaptureRequestOptions$3$androidxcameracamera2interopCamera2CameraControl(CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    public /* synthetic */ Object m124lambda$clearCaptureRequestOptions$5$androidxcameracamera2interopCamera2CameraControl(CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    public void m126lambda$setCaptureRequestOptions$0$androidxcameracamera2interopCamera2CameraControl(CallbackToFutureAdapter.Completer<Void> completer) {
    ...
    public void m125lambda$setActive$6$androidxcameracamera2interopCamera2CameraControl(boolean z) {
        if (this.mIsActive != z) {
            this.mIsActive = z;
            if (!z) {
