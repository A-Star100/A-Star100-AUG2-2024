...
final class VideoEncoderSession {
    ...
    public /* synthetic */ Object m236lambda$configure$0$androidxcameravideoVideoEncoderSession(CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    public /* synthetic */ Object m237lambda$configure$1$androidxcameravideoVideoEncoderSession(CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    public /* synthetic */ Object m238lambda$configure$2$androidxcameravideoVideoEncoderSession(SurfaceRequest surfaceRequest, Timebase timebase, VideoValidatedEncoderProfilesProxy videoValidatedEncoderProfilesProxy, MediaSpec mediaSpec, CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    public /* synthetic */ void m241lambda$terminateNow$3$androidxcameravideoVideoEncoderSession() {
        this.mReleasedCompleter.set(null);
    }
    ...
    public /* synthetic */ void m240lambda$configureVideoEncoderInternal$5$androidxcameravideoVideoEncoderSession(CallbackToFutureAdapter.Completer completer, SurfaceRequest surfaceRequest, Surface surface) {
        Executor executor;
        int ordinal = this.mVideoEncoderState.ordinal();
        if (ordinal != 0) {
            if (ordinal != 1) {
                ...
                Logger.d(TAG, "Not provide surface, " + Objects.toString(surfaceRequest, g.a) + " is already serviced.");
                completer.set(null);
                closeInternal();
                return;
            } else {
    ...
    public /* synthetic */ void m239lambda$configureVideoEncoderInternal$4$androidxcameravideoVideoEncoderSession(Surface surface) {
