...
public class BufferedAudioStream implements AudioStream {
    ...
    public /* synthetic */ void m254lambda$start$0$androidxcameravideointernalaudioBufferedAudioStream() {
        try {
    ...
    public /* synthetic */ void m255lambda$stop$1$androidxcameravideointernalaudioBufferedAudioStream() {
    ...
    public /* synthetic */ void m252lambda$release$2$androidxcameravideointernalaudioBufferedAudioStream() {
        this.mIsCollectingAudioData.set(false);
    ...
    public /* synthetic */ void m253lambda$setCallback$3$androidxcameravideointernalaudioBufferedAudioStream(AudioStream.AudioStreamCallback audioStreamCallback, Executor executor) {
    ...
    public void m256lambda$updateCollectionBufferSizeAsync$4$androidxcameravideointernalaudioBufferedAudioStream(int i) {
