...
public final class AudioSource {
    ...
    public /* synthetic */ void m247lambda$setBufferProvider$0$androidxcameravideointernalaudioAudioSource(BufferProvider bufferProvider) {
    ...
    public /* synthetic */ void m248lambda$start$1$androidxcameravideointernalaudioAudioSource() {
        start(this.mMuted);
    }
    ...
    public /* synthetic */ void m249lambda$start$2$androidxcameravideointernalaudioAudioSource(boolean z) {
        int ordinal = this.mState.ordinal();
        if (ordinal == 0) {
    ...
    public /* synthetic */ void m250lambda$stop$3$androidxcameravideointernalaudioAudioSource() {
        int ordinal = this.mState.ordinal();
        if (ordinal == 1) {
    ...
    public /* synthetic */ Object m245lambda$release$5$androidxcameravideointernalaudioAudioSource(CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    public /* synthetic */ void m244lambda$release$4$androidxcameravideointernalaudioAudioSource(CallbackToFutureAdapter.Completer completer) {
        try {
            int ordinal = this.mState.ordinal();
            if (ordinal == 0 || ordinal == 1) {
    ...
    public /* synthetic */ void m246lambda$setAudioSourceCallback$6$androidxcameravideointernalaudioAudioSource(Executor executor, AudioSourceCallback audioSourceCallback) {
        int ordinal = this.mState.ordinal();
        if (ordinal == 0) {
    ...
    public /* synthetic */ void m242lambda$mute$7$androidxcameravideointernalaudioAudioSource(boolean z) {
        int ordinal = this.mState.ordinal();
        if (ordinal == 0 || ordinal == 1) {
            if (this.mMuted != z) {
                this.mMuted = z;
    ...
    public /* synthetic */ void m243lambda$postMaxAmplitude$11$androidxcameravideointernalaudioAudioSource(AudioSourceCallback audioSourceCallback) {
