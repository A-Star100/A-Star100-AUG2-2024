...
public final /* synthetic */ class VideoCapture$$ExternalSyntheticLambda4 implements Runnable {
    ...
    public /* synthetic */ VideoCapture$$ExternalSyntheticLambda4(VideoCapture videoCapture, SurfaceEdge surfaceEdge, CameraInternal cameraInternal, VideoCaptureConfig videoCaptureConfig, Timebase timebase) {
    ...
    public final void run() {
        this.f$0.m231lambda$createPipeline$1$androidxcameravideoVideoCapture(this.f$1, this.f$2, this.f$3, this.f$4);
    }
}
