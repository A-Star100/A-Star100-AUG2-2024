...
public final /* synthetic */ class Recorder$$ExternalSyntheticLambda11 implements Runnable {
    ...
    public /* synthetic */ Recorder$$ExternalSyntheticLambda11(Recorder recorder, Recorder.RecordingRecord recordingRecord) {
        this.f$0 = recorder;
        this.f$1 = recordingRecord;
    }

    public final void run() {
        this.f$0.m220lambda$pause$3$androidxcameravideoRecorder(this.f$1);
    }
}
