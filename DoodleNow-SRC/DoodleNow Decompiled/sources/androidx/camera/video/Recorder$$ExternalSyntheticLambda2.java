...
public final /* synthetic */ class Recorder$$ExternalSyntheticLambda2 implements Runnable {
    ...
    public /* synthetic */ Recorder$$ExternalSyntheticLambda2(Recorder recorder, Recorder.RecordingRecord recordingRecord, long j, int i, Throwable th) {
        this.f$0 = recorder;
    ...
    public final void run() {
        this.f$0.m224lambda$stop$5$androidxcameravideoRecorder(this.f$1, this.f$2, this.f$3, this.f$4);
    }
}
