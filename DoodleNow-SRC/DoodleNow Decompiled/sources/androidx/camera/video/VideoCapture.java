...
public final class VideoCapture<T extends VideoOutput> extends UseCase {
    ...
    public StreamSpec onSuggestedStreamSpecUpdated(StreamSpec streamSpec) {
        ...
        List customOrderedResolutions = ((VideoCaptureConfig) getCurrentConfig()).getCustomOrderedResolutions((List) null);
    ...
    private SessionConfig.Builder createPipeline(String str, VideoCaptureConfig<T> videoCaptureConfig, StreamSpec streamSpec) {
        ...
        VideoCapture$$ExternalSyntheticLambda3 videoCapture$$ExternalSyntheticLambda3 = new VideoCapture$$ExternalSyntheticLambda3(this);
        ...
        surfaceEdge.addOnInvalidatedListener(videoCapture$$ExternalSyntheticLambda3);
        if (this.mNode != null) {
            ...
            surfaceEdge2.addOnInvalidatedListener(new VideoCapture$$ExternalSyntheticLambda4(this, surfaceEdge2, cameraInternal, videoCaptureConfig, resolveTimebase));
            ...
            deferrableSurface.getTerminationFuture().addListener(new VideoCapture$$ExternalSyntheticLambda5(this, deferrableSurface), CameraXExecutors.mainThreadExecutor());
        } else {
        ...
        createFrom.addErrorListener(new VideoCapture$$ExternalSyntheticLambda6(this, str, videoCaptureConfig2, streamSpec));
    ...
    public /* synthetic */ void m232lambda$createPipeline$2$androidxcameravideoVideoCapture(DeferrableSurface deferrableSurface) {
    ...
    public /* synthetic */ void m233lambda$createPipeline$3$androidxcameravideoVideoCapture(String str, VideoCaptureConfig videoCaptureConfig, StreamSpec streamSpec, SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
        resetPipeline(str, videoCaptureConfig, streamSpec);
    }

    /* access modifiers changed from: private */
    /* renamed from: onAppEdgeInvalidated */
    public void m231lambda$createPipeline$1$androidxcameravideoVideoCapture(SurfaceEdge surfaceEdge, CameraInternal cameraInternal, VideoCaptureConfig<T> videoCaptureConfig, Timebase timebase) {
    ...
    /* access modifiers changed from: package-private */
    public void resetPipeline(String str, VideoCaptureConfig<T> videoCaptureConfig, StreamSpec streamSpec) {
        clearPipeline();
    ...
    private static Rect adjustCropRectToValidSize(Rect rect, Size size, VideoEncoderInfo videoEncoderInfo) {
        ...
        Collections.sort(arrayList, new VideoCapture$$ExternalSyntheticLambda0(rect));
    ...
    public /* synthetic */ Object m234lambda$setupSurfaceUpdateNotifier$6$androidxcameravideoVideoCapture(final SessionConfig.Builder builder, final CallbackToFutureAdapter.Completer completer) throws Exception {
        ...
        AnonymousClass2 r3 = new CameraCaptureCallback() {
            ...
            public /* synthetic */ void m235lambda$onCaptureCompleted$0$androidxcameravideoVideoCapture$2(SessionConfig.Builder builder) {
    ...
    private static boolean hasVideoQualityQuirkAndWorkaroundBySurfaceProcessing() {
        for (VideoQualityQuirk workaroundBySurfaceProcessing : DeviceQuirks.getAll(VideoQualityQuirk.class)) {
