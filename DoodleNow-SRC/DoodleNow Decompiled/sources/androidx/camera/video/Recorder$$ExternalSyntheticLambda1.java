...
public final /* synthetic */ class Recorder$$ExternalSyntheticLambda1 implements Runnable {
    ...
    public /* synthetic */ Recorder$$ExternalSyntheticLambda1(Recorder recorder, Recorder.RecordingRecord recordingRecord, boolean z) {
        this.f$0 = recorder;
    ...
    public final void run() {
        this.f$0.m217lambda$mute$6$androidxcameravideoRecorder(this.f$1, this.f$2);
    }
}
