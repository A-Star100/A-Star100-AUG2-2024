...
public final /* synthetic */ class Recorder$$ExternalSyntheticLambda9 implements Runnable {
    ...
    public /* synthetic */ Recorder$$ExternalSyntheticLambda9(Recorder recorder, Recorder.RecordingRecord recordingRecord) {
        this.f$0 = recorder;
        this.f$1 = recordingRecord;
    }

    public final void run() {
        this.f$0.m221lambda$resume$4$androidxcameravideoRecorder(this.f$1);
    }
}
