...
final class ProcessCameraProvider$Companion$getInstance$1 extends Lambda implements Function1<CameraX, ProcessCameraProvider> {
    final /* synthetic */ Context $context;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ProcessCameraProvider$Companion$getInstance$1(Context context) {
        super(1);
