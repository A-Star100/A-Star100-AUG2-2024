...
final class ProcessCameraProvider$getOrCreateCameraXInstance$1$1$1$future$1 extends Lambda implements Function1<Void, ListenableFuture<Void>> {
    final /* synthetic */ CameraX $cameraX;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ProcessCameraProvider$getOrCreateCameraXInstance$1$1$1$future$1(CameraX cameraX) {
        super(1);
