    ...
    private static final class TypeImpl30 {
        ...
        static int toPlatformType(int i) {
            ...
            for (int i4 = 1; i4 <= 256; i4 <<= 1) {
                if ((i & i4) != 0) {
                    if (i4 == 1) {
                        i2 = AudioFocusRequestCompat$$ExternalSyntheticApiModelOutline0.m();
                    } else if (i4 == 2) {
                        i2 = AudioFocusRequestCompat$$ExternalSyntheticApiModelOutline0.m$1();
                    } else if (i4 == 4) {
                        i2 = AudioFocusRequestCompat$$ExternalSyntheticApiModelOutline0.m$2();
                    } else if (i4 == 8) {
                        i2 = HalfKt$$ExternalSyntheticApiModelOutline0.m();
                    } else if (i4 == 16) {
                        i2 = AudioFocusRequestCompat$$ExternalSyntheticApiModelOutline0.m$3();
                    } else if (i4 == 32) {
                        i2 = AudioFocusRequestCompat$$ExternalSyntheticApiModelOutline0.m$4();
                    } else if (i4 == 64) {
                        i2 = AudioFocusRequestCompat$$ExternalSyntheticApiModelOutline0.m$5();
                    } else if (i4 == 128) {
                        i2 = AudioFocusRequestCompat$$ExternalSyntheticApiModelOutline0.m$6();
                    }
                    i3 |= i2;
                }
            }
