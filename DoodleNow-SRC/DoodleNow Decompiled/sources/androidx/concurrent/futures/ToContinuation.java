...
final class ToContinuation<T> implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            cancellableContinuation.resumeWith(Result.m1230constructorimpl(AbstractResolvableFuture.getUninterruptibly(this.futureToObserve)));
        } catch (ExecutionException e) {
            Throwable access$nonNullCause = ListenableFutureKt.nonNullCause(e);
            Result.Companion companion2 = Result.Companion;
            this.continuation.resumeWith(Result.m1230constructorimpl(ResultKt.createFailure(access$nonNullCause)));
        }
    }
}
