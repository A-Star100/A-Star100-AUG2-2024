...
public class ExifInterface {
    ...
    public void setAltitude(double d) {
        String str = d >= AudioStats.AUDIO_AMPLITUDE_NONE ? SessionDescription.SUPPORTED_SDP_VERSION : "1";
    ...
    private void getHeifAttributes(final androidx.exifinterface.media.ExifInterface.SeekableByteOrderedDataInputStream r14) throws java.io.IOException {
        /*
            ...
            r2.<init>()
            androidx.exifinterface.media.ExifInterface$1 r3 = new androidx.exifinterface.media.ExifInterface$1     // Catch:{ RuntimeException -> 0x0139 }
            r3.<init>(r14)     // Catch:{ RuntimeException -> 0x0139 }
            androidx.exifinterface.media.ExifInterfaceUtils.Api23Impl.setDataSource(r2, r3)     // Catch:{ RuntimeException -> 0x0139 }
            r3 = 33
            java.lang.String r3 = r2.extractMetadata(r3)     // Catch:{ RuntimeException -> 0x0139 }
            r4 = 34
            java.lang.String r4 = r2.extractMetadata(r4)     // Catch:{ RuntimeException -> 0x0139 }
            r5 = 26
            java.lang.String r5 = r2.extractMetadata(r5)     // Catch:{ RuntimeException -> 0x0139 }
            r6 = 17
            java.lang.String r6 = r2.extractMetadata(r6)     // Catch:{ RuntimeException -> 0x0139 }
            boolean r5 = r0.equals(r5)     // Catch:{ RuntimeException -> 0x0139 }
            if (r5 == 0) goto L_0x0049
            r0 = 29
            java.lang.String r0 = r2.extractMetadata(r0)     // Catch:{ RuntimeException -> 0x0139 }
            r5 = 30
            java.lang.String r5 = r2.extractMetadata(r5)     // Catch:{ RuntimeException -> 0x0139 }
            r6 = 31
            java.lang.String r6 = r2.extractMetadata(r6)     // Catch:{ RuntimeException -> 0x0139 }
            goto L_0x0065
        L_0x0049:
            boolean r0 = r0.equals(r6)     // Catch:{ RuntimeException -> 0x0139 }
        ...
        L_0x0065:
            ...
            java.util.HashMap<java.lang.String, androidx.exifinterface.media.ExifInterface$ExifAttribute>[] r8 = r13.mAttributes     // Catch:{ RuntimeException -> 0x0139 }
            r8 = r8[r7]     // Catch:{ RuntimeException -> 0x0139 }
            java.lang.String r9 = "ImageWidth"
            int r10 = java.lang.Integer.parseInt(r0)     // Catch:{ RuntimeException -> 0x0139 }
            java.nio.ByteOrder r11 = r13.mExifByteOrder     // Catch:{ RuntimeException -> 0x0139 }
            androidx.exifinterface.media.ExifInterface$ExifAttribute r10 = androidx.exifinterface.media.ExifInterface.ExifAttribute.createUShort((int) r10, (java.nio.ByteOrder) r11)     // Catch:{ RuntimeException -> 0x0139 }
            r8.put(r9, r10)     // Catch:{ RuntimeException -> 0x0139 }
        L_0x007b:
            if (r5 == 0) goto L_0x0090
            java.util.HashMap<java.lang.String, androidx.exifinterface.media.ExifInterface$ExifAttribute>[] r8 = r13.mAttributes     // Catch:{ RuntimeException -> 0x0139 }
            r8 = r8[r7]     // Catch:{ RuntimeException -> 0x0139 }
            java.lang.String r9 = "ImageLength"
            int r10 = java.lang.Integer.parseInt(r5)     // Catch:{ RuntimeException -> 0x0139 }
            java.nio.ByteOrder r11 = r13.mExifByteOrder     // Catch:{ RuntimeException -> 0x0139 }
            androidx.exifinterface.media.ExifInterface$ExifAttribute r10 = androidx.exifinterface.media.ExifInterface.ExifAttribute.createUShort((int) r10, (java.nio.ByteOrder) r11)     // Catch:{ RuntimeException -> 0x0139 }
            r8.put(r9, r10)     // Catch:{ RuntimeException -> 0x0139 }
        L_0x0090:
            ...
            int r9 = java.lang.Integer.parseInt(r6)     // Catch:{ RuntimeException -> 0x0139 }
            r10 = 90
        ...
        L_0x00aa:
            r9 = r8
        L_0x00ab:
            java.util.HashMap<java.lang.String, androidx.exifinterface.media.ExifInterface$ExifAttribute>[] r10 = r13.mAttributes     // Catch:{ RuntimeException -> 0x0139 }
            r10 = r10[r7]     // Catch:{ RuntimeException -> 0x0139 }
            java.lang.String r11 = "Orientation"
            java.nio.ByteOrder r12 = r13.mExifByteOrder     // Catch:{ RuntimeException -> 0x0139 }
            androidx.exifinterface.media.ExifInterface$ExifAttribute r9 = androidx.exifinterface.media.ExifInterface.ExifAttribute.createUShort((int) r9, (java.nio.ByteOrder) r12)     // Catch:{ RuntimeException -> 0x0139 }
            r10.put(r11, r9)     // Catch:{ RuntimeException -> 0x0139 }
        L_0x00ba:
            if (r3 == 0) goto L_0x010d
            if (r4 == 0) goto L_0x010d
            int r3 = java.lang.Integer.parseInt(r3)     // Catch:{ RuntimeException -> 0x0139 }
            int r4 = java.lang.Integer.parseInt(r4)     // Catch:{ RuntimeException -> 0x0139 }
            if (r4 <= r8) goto L_0x0105
            long r9 = (long) r3     // Catch:{ RuntimeException -> 0x0139 }
            r14.seek(r9)     // Catch:{ RuntimeException -> 0x0139 }
            byte[] r9 = new byte[r8]     // Catch:{ RuntimeException -> 0x0139 }
            int r10 = r14.read(r9)     // Catch:{ RuntimeException -> 0x0139 }
            if (r10 != r8) goto L_0x00fd
            int r3 = r3 + r8
            int r4 = r4 + -6
            byte[] r8 = IDENTIFIER_EXIF_APP1     // Catch:{ RuntimeException -> 0x0139 }
            boolean r8 = java.util.Arrays.equals(r9, r8)     // Catch:{ RuntimeException -> 0x0139 }
            if (r8 == 0) goto L_0x00f5
            byte[] r8 = new byte[r4]     // Catch:{ RuntimeException -> 0x0139 }
            int r14 = r14.read(r8)     // Catch:{ RuntimeException -> 0x0139 }
            if (r14 != r4) goto L_0x00ed
            r13.mOffsetToExifData = r3     // Catch:{ RuntimeException -> 0x0139 }
            r13.readExifSegment(r8, r7)     // Catch:{ RuntimeException -> 0x0139 }
            goto L_0x010d
        L_0x00ed:
            java.io.IOException r14 = new java.io.IOException     // Catch:{ RuntimeException -> 0x0139 }
            java.lang.String r0 = "Can't read exif"
            r14.<init>(r0)     // Catch:{ RuntimeException -> 0x0139 }
            throw r14     // Catch:{ RuntimeException -> 0x0139 }
        L_0x00f5:
            java.io.IOException r14 = new java.io.IOException     // Catch:{ RuntimeException -> 0x0139 }
        ...
        L_0x0105:
            ...
            throw r14     // Catch:{ RuntimeException -> 0x0139 }
        L_0x010d:
            boolean r14 = DEBUG     // Catch:{ RuntimeException -> 0x0139 }
            if (r14 == 0) goto L_0x0133
            java.lang.String r14 = "ExifInterface"
            java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch:{ RuntimeException -> 0x0139 }
            r3.<init>(r1)     // Catch:{ RuntimeException -> 0x0139 }
            r3.append(r0)     // Catch:{ RuntimeException -> 0x0139 }
            java.lang.String r0 = "x"
            r3.append(r0)     // Catch:{ RuntimeException -> 0x0139 }
            r3.append(r5)     // Catch:{ RuntimeException -> 0x0139 }
            java.lang.String r0 = ", rotation "
            r3.append(r0)     // Catch:{ RuntimeException -> 0x0139 }
            r3.append(r6)     // Catch:{ RuntimeException -> 0x0139 }
            java.lang.String r0 = r3.toString()     // Catch:{ RuntimeException -> 0x0139 }
            android.util.Log.d(r14, r0)     // Catch:{ RuntimeException -> 0x0139 }
        L_0x0133:
            r2.release()
            return
        L_0x0137:
            ...
            goto L_0x0141
        L_0x0139:
            java.lang.UnsupportedOperationException r14 = new java.lang.UnsupportedOperationException     // Catch:{ all -> 0x0137 }
            java.lang.String r0 = "Failed to read EXIF from HEIF file. Given stream is either malformed or unsupported."
            r14.<init>(r0)     // Catch:{ all -> 0x0137 }
            throw r14     // Catch:{ all -> 0x0137 }
        L_0x0141:
            r2.release()
            throw r14
        L_0x0145:
    ...
    /* JADX WARNING: Removed duplicated region for block: B:84:0x0213  */
    ...
    private void readImageFileDirectory(androidx.exifinterface.media.ExifInterface.SeekableByteOrderedDataInputStream r30, int r31) throws java.io.IOException {
        ...
        L_0x01e6:
            ...
            r4 = 4
            if (r13 == r4) goto L_0x0207
            if (r13 == r6) goto L_0x0202
            r4 = 9
