...
public final class InlineSuggestionUi {
    ...
    public static final class Content extends SlicedContent {
        ...
        Content(Slice slice) {
            super(slice);
            for (Object m : ComponentDialog$$ExternalSyntheticApiModelOutline0.m(slice)) {
                SliceItem m2 = ComponentDialog$$ExternalSyntheticApiModelOutline0.m(m);
                String itemType = itemType(m2);
                if (itemType != null) {
                    itemType.hashCode();
                    char c = 65535;
                    ...
                    switch (c) {
                        case 0:
                            this.mSubtitle = ComponentDialog$$ExternalSyntheticApiModelOutline0.m(m2).toString();
                            break;
                        case 1:
                            this.mContentDescription = ComponentDialog$$ExternalSyntheticApiModelOutline0.m(m2);
                            break;
                        case 2:
                            this.mStartIcon = ComponentDialog$$ExternalSyntheticApiModelOutline0.m(m2);
                            break;
                        case 3:
                            this.mTitle = ComponentDialog$$ExternalSyntheticApiModelOutline0.m(m2).toString();
                            break;
                        case 4:
                            this.mAttributionIntent = ComponentDialog$$ExternalSyntheticApiModelOutline0.m(m2);
                            break;
                        case 5:
                            this.mEndIcon = ComponentDialog$$ExternalSyntheticApiModelOutline0.m(m2);
                            break;
                    }
                }
            }
        ...
        private static String itemType(SliceItem sliceItem) {
            String m = ComponentDialog$$ExternalSyntheticApiModelOutline0.m(sliceItem);
            m.hashCode();
            char c = 65535;
            switch (m.hashCode()) {
                case -1422950858:
            ...
            switch (c) {
                case 0:
                    if (ComponentDialog$$ExternalSyntheticApiModelOutline0.m(sliceItem) == null || !ComponentDialog$$ExternalSyntheticApiModelOutline0.m(sliceItem).contains(HINT_INLINE_ATTRIBUTION_INTENT)) {
                        return null;
                    }
                    return HINT_INLINE_ATTRIBUTION_INTENT;
                case 1:
                    if (TextUtils.isEmpty(ComponentDialog$$ExternalSyntheticApiModelOutline0.m(sliceItem))) {
                        return null;
                    }
                    if (ComponentDialog$$ExternalSyntheticApiModelOutline0.m(sliceItem).contains(HINT_INLINE_TITLE)) {
                        return HINT_INLINE_TITLE;
                    }
                    if (ComponentDialog$$ExternalSyntheticApiModelOutline0.m(sliceItem).contains(HINT_INLINE_SUBTITLE)) {
                        return HINT_INLINE_SUBTITLE;
                    }
                    if (ComponentDialog$$ExternalSyntheticApiModelOutline0.m(sliceItem).contains(HINT_INLINE_CONTENT_DESCRIPTION)) {
                        return HINT_INLINE_CONTENT_DESCRIPTION;
                    }
                    break;
                case 2:
                    if (ComponentDialog$$ExternalSyntheticApiModelOutline0.m(sliceItem) == null) {
                        return null;
                    }
                    if (ComponentDialog$$ExternalSyntheticApiModelOutline0.m(sliceItem).contains(HINT_INLINE_START_ICON)) {
                        return HINT_INLINE_START_ICON;
                    }
                    if (ComponentDialog$$ExternalSyntheticApiModelOutline0.m(sliceItem).contains(HINT_INLINE_END_ICON)) {
            ...
            public Content build() {
                ...
                if (charSequence == null && this.mStartIcon == null && this.mEndIcon == null && this.mSubtitle == null) {
                    ...
                    if (this.mStartIcon != null) {
                        Slice.Builder unused = this.mSliceBuilder.addIcon(this.mStartIcon, (String) null, Collections.singletonList(Content.HINT_INLINE_START_ICON));
                    }
                    if (this.mTitle != null) {
                        Slice.Builder unused2 = this.mSliceBuilder.addText(this.mTitle, (String) null, Collections.singletonList(Content.HINT_INLINE_TITLE));
                    }
                    if (this.mSubtitle != null) {
                        Slice.Builder unused3 = this.mSliceBuilder.addText(this.mSubtitle, (String) null, Collections.singletonList(Content.HINT_INLINE_SUBTITLE));
                    }
                    if (this.mEndIcon != null) {
                        Slice.Builder unused4 = this.mSliceBuilder.addIcon(this.mEndIcon, (String) null, Collections.singletonList(Content.HINT_INLINE_END_ICON));
                    }
                    if (this.mAttributionIntent != null) {
                        ...
                        Slice.Builder unused5 = builder.addAction(pendingIntent, ComponentDialog$$ExternalSyntheticApiModelOutline0.m(ComponentDialog$$ExternalSyntheticApiModelOutline0.m(this.mSliceBuilder).addHints(Collections.singletonList(Content.HINT_INLINE_ATTRIBUTION_INTENT))), (String) null);
                    }
                    if (this.mContentDescription != null) {
                        Slice.Builder unused6 = this.mSliceBuilder.addText(this.mContentDescription, (String) null, Collections.singletonList(Content.HINT_INLINE_CONTENT_DESCRIPTION));
                    }
                    if (this.mHints != null) {
                        Slice.Builder unused7 = this.mSliceBuilder.addHints(this.mHints);
                    }
                    return new Content(ComponentDialog$$ExternalSyntheticApiModelOutline0.m(this.mSliceBuilder));
                } else {
