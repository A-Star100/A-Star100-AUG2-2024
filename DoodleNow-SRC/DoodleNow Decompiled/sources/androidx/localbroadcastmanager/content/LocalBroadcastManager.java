...
public final class LocalBroadcastManager {
    ...
    public boolean sendBroadcast(android.content.Intent r23) {
        /*
            ...
            monitor-enter(r4)
            java.lang.String r12 = r23.getAction()     // Catch:{ all -> 0x016c }
            android.content.Context r5 = r1.mAppContext     // Catch:{ all -> 0x016c }
            android.content.ContentResolver r5 = r5.getContentResolver()     // Catch:{ all -> 0x016c }
            java.lang.String r13 = r0.resolveTypeIfNeeded(r5)     // Catch:{ all -> 0x016c }
            android.net.Uri r14 = r23.getData()     // Catch:{ all -> 0x016c }
            java.lang.String r15 = r23.getScheme()     // Catch:{ all -> 0x016c }
            java.util.Set r16 = r23.getCategories()     // Catch:{ all -> 0x016c }
            int r5 = r23.getFlags()     // Catch:{ all -> 0x016c }
            r5 = r5 & 8
            r11 = 0
            r10 = 1
        ...
        L_0x0034:
            ...
            r6.<init>(r3)     // Catch:{ all -> 0x016c }
            r6.append(r13)     // Catch:{ all -> 0x016c }
            java.lang.String r3 = " scheme "
            r6.append(r3)     // Catch:{ all -> 0x016c }
            r6.append(r15)     // Catch:{ all -> 0x016c }
            java.lang.String r3 = " of intent "
            r6.append(r3)     // Catch:{ all -> 0x016c }
            r6.append(r0)     // Catch:{ all -> 0x016c }
            java.lang.String r3 = r6.toString()     // Catch:{ all -> 0x016c }
            android.util.Log.v(r5, r3)     // Catch:{ all -> 0x016c }
        L_0x0057:
            ...
            java.lang.String r5 = r23.getAction()     // Catch:{ all -> 0x016c }
            java.lang.Object r3 = r3.get(r5)     // Catch:{ all -> 0x016c }
            java.util.ArrayList r3 = (java.util.ArrayList) r3     // Catch:{ all -> 0x016c }
            if (r3 == 0) goto L_0x0169
            if (r17 == 0) goto L_0x0078
            java.lang.String r5 = "LocalBroadcastManager"
            java.lang.StringBuilder r6 = new java.lang.StringBuilder     // Catch:{ all -> 0x016c }
            r6.<init>(r2)     // Catch:{ all -> 0x016c }
            r6.append(r3)     // Catch:{ all -> 0x016c }
            java.lang.String r2 = r6.toString()     // Catch:{ all -> 0x016c }
            android.util.Log.v(r5, r2)     // Catch:{ all -> 0x016c }
        L_0x0078:
            r2 = 0
            r9 = r11
        L_0x007a:
            int r5 = r3.size()     // Catch:{ all -> 0x016c }
            if (r9 >= r5) goto L_0x0138
            java.lang.Object r5 = r3.get(r9)     // Catch:{ all -> 0x016c }
            r8 = r5
            androidx.localbroadcastmanager.content.LocalBroadcastManager$ReceiverRecord r8 = (androidx.localbroadcastmanager.content.LocalBroadcastManager.ReceiverRecord) r8     // Catch:{ all -> 0x016c }
            ...
            android.content.IntentFilter r7 = r8.filter     // Catch:{ all -> 0x016c }
            r6.append(r7)     // Catch:{ all -> 0x016c }
            java.lang.String r6 = r6.toString()     // Catch:{ all -> 0x016c }
            android.util.Log.v(r5, r6)     // Catch:{ all -> 0x016c }
        L_0x00a1:
            boolean r5 = r8.broadcasting     // Catch:{ all -> 0x016c }
        ...
        L_0x00ae:
            ...
            goto L_0x012e
        L_0x00b7:
            android.content.IntentFilter r5 = r8.filter     // Catch:{ all -> 0x016c }
            ...
            r10 = r16
            r11 = r18
            int r5 = r5.match(r6, r7, r8, r9, r10, r11)     // Catch:{ all -> 0x016c }
            if (r5 < 0) goto L_0x00fa
            if (r17 == 0) goto L_0x00ed
            java.lang.String r6 = "LocalBroadcastManager"
            java.lang.StringBuilder r7 = new java.lang.StringBuilder     // Catch:{ all -> 0x016c }
            r7.<init>()     // Catch:{ all -> 0x016c }
            java.lang.String r8 = "  Filter matched!  match=0x"
            r7.append(r8)     // Catch:{ all -> 0x016c }
            java.lang.String r5 = java.lang.Integer.toHexString(r5)     // Catch:{ all -> 0x016c }
            r7.append(r5)     // Catch:{ all -> 0x016c }
            java.lang.String r5 = r7.toString()     // Catch:{ all -> 0x016c }
            android.util.Log.v(r6, r5)     // Catch:{ all -> 0x016c }
        L_0x00ed:
            if (r2 != 0) goto L_0x00f4
            java.util.ArrayList r2 = new java.util.ArrayList     // Catch:{ all -> 0x016c }
            r2.<init>()     // Catch:{ all -> 0x016c }
        L_0x00f4:
            r2.add(r3)     // Catch:{ all -> 0x016c }
            r3.broadcasting = r12     // Catch:{ all -> 0x016c }
            goto L_0x012e
        L_0x00fa:
        ...
        L_0x0138:
            ...
            r11 = 0
        L_0x013c:
            int r3 = r2.size()     // Catch:{ all -> 0x016c }
            if (r11 >= r3) goto L_0x014e
            java.lang.Object r3 = r2.get(r11)     // Catch:{ all -> 0x016c }
            androidx.localbroadcastmanager.content.LocalBroadcastManager$ReceiverRecord r3 = (androidx.localbroadcastmanager.content.LocalBroadcastManager.ReceiverRecord) r3     // Catch:{ all -> 0x016c }
            r5 = 0
            r3.broadcasting = r5     // Catch:{ all -> 0x016c }
            int r11 = r11 + 1
            goto L_0x013c
        L_0x014e:
            ...
            androidx.localbroadcastmanager.content.LocalBroadcastManager$BroadcastRecord r5 = new androidx.localbroadcastmanager.content.LocalBroadcastManager$BroadcastRecord     // Catch:{ all -> 0x016c }
            r5.<init>(r0, r2)     // Catch:{ all -> 0x016c }
            r3.add(r5)     // Catch:{ all -> 0x016c }
            android.os.Handler r0 = r1.mHandler     // Catch:{ all -> 0x016c }
            boolean r0 = r0.hasMessages(r12)     // Catch:{ all -> 0x016c }
            if (r0 != 0) goto L_0x0165
            android.os.Handler r0 = r1.mHandler     // Catch:{ all -> 0x016c }
            r0.sendEmptyMessage(r12)     // Catch:{ all -> 0x016c }
        L_0x0165:
