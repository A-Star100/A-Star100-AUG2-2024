...
public class ConstraintSet {
        ...
        while (i < childCount) {
            ...
            if (!this.mForceId || id != -1) {
                ...
                if (!constraint.transform.mApply) {
                    ...
                    if (!(((double) pivotX) == AudioStats.AUDIO_AMPLITUDE_NONE && ((double) pivotY) == AudioStats.AUDIO_AMPLITUDE_NONE)) {
    ...
    public void load(android.content.Context r9, org.xmlpull.v1.XmlPullParser r10) {
        /*
            r8 = this;
            int r0 = r10.getEventType()     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            r1 = 0
            r2 = r1
        L_0x0006:
            r3 = 1
            ...
            goto L_0x017a
        L_0x0015:
            java.lang.String r0 = r10.getName()     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            java.lang.String r3 = "ConstraintSet"
            boolean r3 = r3.equals(r0)     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            if (r3 == 0) goto L_0x0022
            return
        L_0x0022:
            boolean r0 = r0.equalsIgnoreCase(r4)     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            if (r0 == 0) goto L_0x017a
            java.util.HashMap<java.lang.Integer, androidx.constraintlayout.widget.ConstraintSet$Constraint> r0 = r8.mConstraints     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            int r3 = r2.mViewId     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            java.lang.Integer r3 = java.lang.Integer.valueOf(r3)     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            r0.put(r3, r2)     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            r2 = r1
            goto L_0x017a
        L_0x0036:
            java.lang.String r0 = r10.getName()     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            int r7 = r0.hashCode()     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            switch(r7) {
        ...
        L_0x0041:
            goto L_0x008f
        L_0x0042:
            boolean r0 = r0.equals(r4)     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
        ...
        L_0x0097:
            ...
            java.util.HashMap<java.lang.String, androidx.constraintlayout.widget.ConstraintAttribute> r0 = r2.mCustomConstraints     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            androidx.constraintlayout.widget.ConstraintAttribute.parse(r9, r10, r0)     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            goto L_0x017a
        L_0x00a0:
            java.lang.RuntimeException r9 = new java.lang.RuntimeException     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            java.lang.StringBuilder r1 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            r1.<init>()     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            r1.append(r0)     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            int r10 = r10.getLineNumber()     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            r1.append(r10)     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            java.lang.String r10 = r1.toString()     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            r9.<init>(r10)     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            throw r9     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
        L_0x00b9:
            if (r2 == 0) goto L_0x00c6
            androidx.constraintlayout.widget.ConstraintSet$Motion r0 = r2.motion     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            android.util.AttributeSet r3 = android.util.Xml.asAttributeSet(r10)     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            r0.fillFromAttributeList(r9, r3)     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            goto L_0x017a
        L_0x00c6:
            java.lang.RuntimeException r9 = new java.lang.RuntimeException     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            java.lang.StringBuilder r1 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
        ...
        L_0x00df:
            ...
            androidx.constraintlayout.widget.ConstraintSet$Layout r0 = r2.layout     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            android.util.AttributeSet r3 = android.util.Xml.asAttributeSet(r10)     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            r0.fillFromAttributeList(r9, r3)     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            goto L_0x017a
        L_0x00ec:
        ...
        L_0x0105:
            ...
            androidx.constraintlayout.widget.ConstraintSet$Transform r0 = r2.transform     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            android.util.AttributeSet r3 = android.util.Xml.asAttributeSet(r10)     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            r0.fillFromAttributeList(r9, r3)     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            goto L_0x017a
        L_0x0111:
        ...
        L_0x012a:
            ...
            androidx.constraintlayout.widget.ConstraintSet$PropertySet r0 = r2.propertySet     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            android.util.AttributeSet r3 = android.util.Xml.asAttributeSet(r10)     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            r0.fillFromAttributeList(r9, r3)     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            goto L_0x017a
        L_0x0136:
            ...
            throw r9     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
        L_0x014f:
            android.util.AttributeSet r0 = android.util.Xml.asAttributeSet(r10)     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            androidx.constraintlayout.widget.ConstraintSet$Constraint r0 = r8.fillFromAttributeList(r9, r0)     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            androidx.constraintlayout.widget.ConstraintSet$Layout r2 = r0.layout     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            r2.mHelperType = r3     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            goto L_0x0175
        L_0x015c:
            android.util.AttributeSet r0 = android.util.Xml.asAttributeSet(r10)     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            androidx.constraintlayout.widget.ConstraintSet$Constraint r0 = r8.fillFromAttributeList(r9, r0)     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            androidx.constraintlayout.widget.ConstraintSet$Layout r2 = r0.layout     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            r2.mIsGuideline = r3     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            androidx.constraintlayout.widget.ConstraintSet$Layout r2 = r0.layout     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            r2.mApply = r3     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            goto L_0x0175
        L_0x016d:
            android.util.AttributeSet r0 = android.util.Xml.asAttributeSet(r10)     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            androidx.constraintlayout.widget.ConstraintSet$Constraint r0 = r8.fillFromAttributeList(r9, r0)     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
        L_0x0175:
            ...
            goto L_0x017a
        L_0x0177:
            r10.getName()     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
        L_0x017a:
            int r0 = r10.next()     // Catch:{ XmlPullParserException -> 0x0185, IOException -> 0x0180 }
            goto L_0x0006
        L_0x0180:
            r9 = move-exception
            r9.printStackTrace()
