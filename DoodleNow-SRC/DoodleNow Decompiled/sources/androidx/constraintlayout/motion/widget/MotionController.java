...
public class MotionController {
    ...
    public void buildPath(float[] fArr, int i) {
        ...
        while (i3 < i2) {
            ...
            if (keyCycleOscillator != null) {
                fArr2[i4] = fArr2[i4] + keyCycleOscillator.get(f3);
            } else if (splineSet2 != null) {
                fArr2[i4] = fArr2[i4] + splineSet2.get(f3);
            }
    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        double[][] dArr = (double[][]) Array.newInstance(Double.TYPE, new int[]{i3, this.mInterpolateVariables.length});
        ...
        while (true) {
            ...
            for (int i17 = 0; i17 < i3; i17++) {
                if (motionPathsArr[i17].hasCustomData(str7)) {
                    if (dArr5 == null) {
                        dArr4 = new double[i3];
                        dArr5 = (double[][]) Array.newInstance(Double.TYPE, new int[]{i3, motionPathsArr[i17].getCustomDataCount(str7)});
                    }
                    dArr4[i16] = (double) motionPathsArr[i17].time;
                    motionPathsArr[i17].getCustomData(str7, dArr5[i16], 0);
                    i16++;
                }
            }
            i15++;
            this.mSpline[i15] = CurveFit.get(this.mCurveFitType, Arrays.copyOf(dArr4, i16), (double[][]) Arrays.copyOf(dArr5, i16));
        }
        this.mSpline[0] = CurveFit.get(this.mCurveFitType, dArr2, dArr);
        if (motionPathsArr[0].mPathMotionArc != Key.UNSET) {
            int[] iArr4 = new int[i3];
            double[] dArr6 = new double[i3];
            double[][] dArr7 = (double[][]) Array.newInstance(Double.TYPE, new int[]{i3, 2});
            for (int i18 = 0; i18 < i3; i18++) {
                iArr4[i18] = motionPathsArr[i18].mPathMotionArc;
                dArr6[i18] = (double) motionPathsArr[i18].time;
                dArr7[i18][0] = (double) motionPathsArr[i18].x;
                dArr7[i18][1] = (double) motionPathsArr[i18].y;
            }
    ...
    public void getPostLayoutDvDp(float f, int i, int i2, float f2, float f3, float[] fArr) {
        ...
        if (hashMap3 == null) {
            ...
            splineSet3 = hashMap3.get(ViewProps.ROTATION);
        }
        HashMap<String, SplineSet> hashMap4 = this.mAttributesMap;
        if (hashMap4 == null) {
            splineSet4 = null;
        } else {
            splineSet4 = hashMap4.get(ViewProps.SCALE_X);
        }
        HashMap<String, SplineSet> hashMap5 = this.mAttributesMap;
        if (hashMap5 == null) {
            splineSet5 = null;
        } else {
            splineSet5 = hashMap5.get(ViewProps.SCALE_Y);
        }
        ...
        if (hashMap8 == null) {
            ...
            keyCycleOscillator3 = hashMap8.get(ViewProps.ROTATION);
        }
        HashMap<String, KeyCycleOscillator> hashMap9 = this.mCycleMap;
        if (hashMap9 == null) {
            keyCycleOscillator4 = null;
        } else {
            keyCycleOscillator4 = hashMap9.get(ViewProps.SCALE_X);
        }
        HashMap<String, KeyCycleOscillator> hashMap10 = this.mCycleMap;
        if (hashMap10 != null) {
            keyCycleOscillator5 = hashMap10.get(ViewProps.SCALE_Y);
        }
