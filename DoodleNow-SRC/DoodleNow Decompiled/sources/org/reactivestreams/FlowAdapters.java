...
public final class FlowAdapters {
    ...
    public static <T> Flow.Publisher<T> toFlowPublisher(Publisher<? extends T> publisher) {
        ...
        if (FlowAdapters$$ExternalSyntheticApiModelOutline0.m$2(publisher)) {
            return FlowAdapters$$ExternalSyntheticApiModelOutline0.m((Object) publisher);
        }
    ...
    public static <T, U> Flow.Processor<T, U> toFlowProcessor(Processor<? super T, ? extends U> processor) {
        ...
        if (FlowAdapters$$ExternalSyntheticApiModelOutline0.m((Object) processor)) {
            return FlowAdapters$$ExternalSyntheticApiModelOutline0.m((Object) processor);
        }
    ...
    public static <T> Flow.Subscriber<T> toFlowSubscriber(Subscriber<T> subscriber) {
        ...
        if (FlowAdapters$$ExternalSyntheticApiModelOutline0.m$1(subscriber)) {
            return FlowAdapters$$ExternalSyntheticApiModelOutline0.m((Object) subscriber);
        }
