...
class ArraysKt__ArraysKt extends ArraysKt__ArraysJVMKt {
                                                    ...
                                                    if (!(t instanceof UByteArray) || !(t2 instanceof UByteArray)) {
                                                        if (!(t instanceof UShortArray) || !(t2 instanceof UShortArray)) {
                                                            if (!(t instanceof UIntArray) || !(t2 instanceof UIntArray)) {
                                                                ...
                                                                } else if (!UArraysKt.m1797contentEqualslec5QzE(((ULongArray) t).m1473unboximpl(), ((ULongArray) t2).m1473unboximpl())) {
                                                                    return false;
                                                                }
                                                            } else if (!UArraysKt.m1795contentEqualsKJPZfPQ(((UIntArray) t).m1394unboximpl(), ((UIntArray) t2).m1394unboximpl())) {
                                                                return false;
                                                            }
                                                        } else if (!UArraysKt.m1794contentEqualsFGO6Aew(((UShortArray) t).m1578unboximpl(), ((UShortArray) t2).m1578unboximpl())) {
                                                            return false;
                                                        }
                                                    } else if (!UArraysKt.m1796contentEqualskV0jMPg(((UByteArray) t).m1315unboximpl(), ((UByteArray) t2).m1315unboximpl())) {
                                                        return false;
                                                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] r5, java.lang.StringBuilder r6, java.util.List<java.lang.Object[]> r7) {
        ...
        L_0x00c5:
            ...
            byte[] r4 = r2.m1315unboximpl()
        L_0x00d2:
            java.lang.String r2 = kotlin.collections.unsigned.UArraysKt.m1802contentToString2csIQuQ(r4)
            r6.append(r2)
            goto L_0x011d
        L_0x00da:
            ...
            short[] r4 = r2.m1578unboximpl()
        L_0x00e6:
            java.lang.String r2 = kotlin.collections.unsigned.UArraysKt.m1804contentToStringd6D3K8(r4)
            r6.append(r2)
            goto L_0x011d
        L_0x00ee:
            ...
            int[] r4 = r2.m1394unboximpl()
        L_0x00fa:
            java.lang.String r2 = kotlin.collections.unsigned.UArraysKt.m1803contentToStringXUkPCBk(r4)
            r6.append(r2)
            goto L_0x011d
        L_0x0102:
            ...
            long[] r4 = r2.m1473unboximpl()
        L_0x010e:
            java.lang.String r2 = kotlin.collections.unsigned.UArraysKt.m1805contentToStringuLth9ew(r4)
            r6.append(r2)
            goto L_0x011d
        L_0x0116:
