...
class UCollectionsKt___UCollectionsKt {
    public static final byte[] toUByteArray(Collection<UByte> collection) {
        ...
        byte[] r0 = UByteArray.m1300constructorimpl(collection.size());
        int i = 0;
        for (UByte r2 : collection) {
            UByteArray.m1311setVurrAj0(r0, i, r2.m1298unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final int[] toUIntArray(Collection<UInt> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        int[] r0 = UIntArray.m1379constructorimpl(collection.size());
        int i = 0;
        for (UInt r2 : collection) {
            UIntArray.m1390setVXSXFK8(r0, i, r2.m1377unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final long[] toULongArray(Collection<ULong> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        long[] r0 = ULongArray.m1458constructorimpl(collection.size());
        int i = 0;
        for (ULong r2 : collection) {
            ULongArray.m1469setk8EXiF4(r0, i, r2.m1456unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final short[] toUShortArray(Collection<UShort> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        short[] r0 = UShortArray.m1563constructorimpl(collection.size());
        int i = 0;
        for (UShort r2 : collection) {
            UShortArray.m1574set01HTLdE(r0, i, r2.m1561unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final int sumOfUInt(Iterable<UInt> iterable) {
        ...
        for (UInt r1 : iterable) {
            i = UInt.m1325constructorimpl(i + r1.m1377unboximpl());
        }
        return i;
    }
    ...
    public static final long sumOfULong(Iterable<ULong> iterable) {
        ...
        for (ULong r2 : iterable) {
            j = ULong.m1404constructorimpl(j + r2.m1456unboximpl());
        }
        return j;
    }
    ...
    public static final int sumOfUByte(Iterable<UByte> iterable) {
        ...
        for (UByte r1 : iterable) {
            i = UInt.m1325constructorimpl(i + UInt.m1325constructorimpl(r1.m1298unboximpl() & 255));
        }
        return i;
    }
    ...
    public static final int sumOfUShort(Iterable<UShort> iterable) {
        ...
        for (UShort r1 : iterable) {
            i = UInt.m1325constructorimpl(i + UInt.m1325constructorimpl(r1.m1561unboximpl() & UShort.MAX_VALUE));
        }
        return i;
    }
}
