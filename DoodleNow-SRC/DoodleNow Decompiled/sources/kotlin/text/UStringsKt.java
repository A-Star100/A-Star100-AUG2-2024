...
public final class UStringsKt {
    ...
    public static final String m2536toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m2538toStringolVBNx4(short s, int i) {
    ...
    public static final String m2537toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m2535toStringJSWoG40(long j, int i) {
    ...
    public static final byte toUByte(String str) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m1298unboximpl();
        }
    ...
    public static final short toUShort(String str) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m1561unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final int toUInt(String str) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m1377unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final long toULong(String str) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m1456unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m1377unboximpl();
        if (Integer.compare(r1 ^ Integer.MIN_VALUE, UInt.m1325constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m1242boximpl(UByte.m1248constructorimpl((byte) r1));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m1377unboximpl();
        if (Integer.compare(r1 ^ Integer.MIN_VALUE, UInt.m1325constructorimpl(65535) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m1505boximpl(UShort.m1511constructorimpl((short) r1));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int r3 = UInt.m1325constructorimpl(i);
        int i4 = 119304647;
        while (i2 < length) {
            ...
            int r2 = UInt.m1325constructorimpl(i3 * r3);
            int r7 = UInt.m1325constructorimpl(UInt.m1325constructorimpl(digitOf) + r2);
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long r5 = ULong.m1404constructorimpl((long) i2);
        long j = 0;
        ...
        while (i3 < length) {
            ...
            long r9 = ULong.m1404constructorimpl(j * r5);
            long r13 = ULong.m1404constructorimpl(ULong.m1404constructorimpl(((long) UInt.m1325constructorimpl(digitOf)) & 4294967295L) + r9);
