...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public final long m2459getFirstsVKNKU() {
        return this.first;
    }

    /* renamed from: getLast-s-VKNKU  reason: not valid java name */
    public final long m2460getLastsVKNKU() {
        return this.last;
    }
    ...
    private ULongProgression(long j, long j2, long j3) {
        if (j3 == 0) {
            ...
            this.first = j;
            this.last = UProgressionUtilKt.m2435getProgressionLastElement7ftBX0g(j, j2, j3);
            this.step = j3;
        } else {
    ...
    public int hashCode() {
        ...
        long j2 = this.last;
        long j3 = this.step;
        return (((((int) ULong.m1404constructorimpl(j ^ ULong.m1404constructorimpl(j >>> 32))) * 31) + ((int) ULong.m1404constructorimpl(j2 ^ ULong.m1404constructorimpl(j2 >>> 32)))) * 31) + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append(ULong.m1450toStringimpl(this.first));
            sb.append("..");
            sb.append(ULong.m1450toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
    ...
    public static final class Companion {
        ...
        public final ULongProgression m2461fromClosedRange7ftBX0g(long j, long j2, long j3) {
