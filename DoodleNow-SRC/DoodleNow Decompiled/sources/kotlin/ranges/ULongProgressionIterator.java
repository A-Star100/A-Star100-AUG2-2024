...
final class ULongProgressionIterator implements Iterator<ULong>, KMappedMarker {
    ...
    private ULongProgressionIterator(long j, long j2, long j3) {
        ...
        this.hasNext = z;
        this.step = ULong.m1404constructorimpl(j3);
        this.next = !this.hasNext ? j2 : j;
    }

    public /* bridge */ /* synthetic */ Object next() {
        return ULong.m1398boximpl(m2462nextsVKNKU());
    }

    /* renamed from: next-s-VKNKU  reason: not valid java name */
    public long m2462nextsVKNKU() {
        long j = this.next;
        if (j != this.finalElement) {
            this.next = ULong.m1404constructorimpl(this.step + j);
