...
public final class UIntArrayKt {
    ...
    private static final int[] m1396uintArrayOfajY9A(int... iArr) {
    ...
    private static final int[] UIntArray(int i, Function1<? super Integer, UInt> function1) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            iArr[i2] = function1.invoke(Integer.valueOf(i2)).m1377unboximpl();
        }
        return UIntArray.m1380constructorimpl(iArr);
    }
}
