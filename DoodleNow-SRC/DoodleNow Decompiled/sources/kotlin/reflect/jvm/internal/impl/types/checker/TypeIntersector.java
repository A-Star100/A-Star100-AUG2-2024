            ...
            if (!(iterable instanceof Collection) || !((Collection) iterable).isEmpty()) {
                ...
                while (true) {
                    ...
                    if (simpleType2 != simpleType) {
                        Intrinsics.checkNotNullExpressionValue(simpleType2, Constants.CASEFIRST_LOWER);
                        Intrinsics.checkNotNullExpressionValue(simpleType, Constants.CASEFIRST_UPPER);
