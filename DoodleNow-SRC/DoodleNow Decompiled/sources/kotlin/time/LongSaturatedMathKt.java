...
public final class LongSaturatedMathKt {
    ...
    public static final long m2692saturatingAddNuflL3o(long j, DurationUnit durationUnit, long j2) {
        Intrinsics.checkNotNullParameter(durationUnit, "unit");
        long r5 = Duration.m2609toLongimpl(j2, durationUnit);
        if (((j - 1) | 1) == Long.MAX_VALUE) {
            return m2691checkInfiniteSumDefinedPjuGub4(j, j2, r5);
        }
        if ((1 | (r5 - 1)) == Long.MAX_VALUE) {
            return m2693saturatingAddInHalvesNuflL3o(j, durationUnit, j2);
        }
        long j3 = j + r5;
        if (((j ^ j3) & (r5 ^ j3)) >= 0) {
            return j3;
    ...
    private static final long m2691checkInfiniteSumDefinedPjuGub4(long j, long j2, long j3) {
        if (!Duration.m2595isInfiniteimpl(j2) || (j ^ j3) >= 0) {
            return j;
        }
    ...
    private static final long m2693saturatingAddInHalvesNuflL3o(long j, DurationUnit durationUnit, long j2) {
        long r0 = Duration.m2566divUwyO8pc(j2, 2);
        long r2 = Duration.m2609toLongimpl(r0, durationUnit);
        if ((1 | (r2 - 1)) == Long.MAX_VALUE) {
            return r2;
        }
        return m2692saturatingAddNuflL3o(m2692saturatingAddNuflL3o(j, durationUnit, r0), durationUnit, Duration.m2598minusLRDsOJo(j2, r0));
    }

    private static final long infinityOfSign(long j) {
        return j < 0 ? Duration.Companion.m2665getNEG_INFINITEUwyO8pc$kotlin_stdlib() : Duration.Companion.m2664getINFINITEUwyO8pc();
    }

    public static final long saturatingDiff(long j, long j2, DurationUnit durationUnit) {
        Intrinsics.checkNotNullParameter(durationUnit, "unit");
        if ((1 | (j2 - 1)) == Long.MAX_VALUE) {
            return Duration.m2616unaryMinusUwyO8pc(infinityOfSign(j2));
        }
    ...
    private static final long saturatingFiniteDiff(long j, long j2, DurationUnit durationUnit) {
        ...
        if (durationUnit.compareTo(DurationUnit.MILLISECONDS) >= 0) {
            return Duration.m2616unaryMinusUwyO8pc(infinityOfSign(j3));
        }
        ...
        return Duration.m2599plusLRDsOJo(DurationKt.toDuration((j / convertDurationUnit) - (j2 / convertDurationUnit), DurationUnit.MILLISECONDS), DurationKt.toDuration(j4, durationUnit));
    }
}
