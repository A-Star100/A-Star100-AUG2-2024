...
final class AdjustedTimeMark implements TimeMark {
    ...
    public final long m2552getAdjustmentUwyO8pc() {
    ...
    public TimeMark m2553minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m2703minusLRDsOJo(this, j);
    }

    /* renamed from: elapsedNow-UwyO8pc  reason: not valid java name */
    public long m2551elapsedNowUwyO8pc() {
        return Duration.m2598minusLRDsOJo(this.mark.m2700elapsedNowUwyO8pc(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m2554plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m2599plusLRDsOJo(this.adjustment, j), (DefaultConstructorMarker) null);
    }
}
