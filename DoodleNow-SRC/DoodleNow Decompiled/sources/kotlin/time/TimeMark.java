...
public interface TimeMark {
    ...
    TimeMark m2701minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    TimeMark m2702plusLRDsOJo(long j);

    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    /* compiled from: TimeSource.kt */
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo  reason: not valid java name */
        public static TimeMark m2704plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, (DefaultConstructorMarker) null);
        }

        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static TimeMark m2703minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.m2702plusLRDsOJo(Duration.m2616unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m2596isNegativeimpl(timeMark.m2700elapsedNowUwyO8pc());
        }
