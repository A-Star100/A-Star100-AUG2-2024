...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public ComparableTimeMark m2541minusLRDsOJo(long j) {
            return ComparableTimeMark.DefaultImpls.m2558minusLRDsOJo(this, j);
        }

        /* renamed from: elapsedNow-UwyO8pc  reason: not valid java name */
        public long m2539elapsedNowUwyO8pc() {
            return Duration.m2598minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        /* renamed from: plus-LRDsOJo  reason: not valid java name */
        public ComparableTimeMark m2544plusLRDsOJo(long j) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m2599plusLRDsOJo(this.offset, j), (DefaultConstructorMarker) null);
        }

        /* renamed from: minus-UwyO8pc  reason: not valid java name */
        public long m2542minusUwyO8pc(ComparableTimeMark comparableTimeMark) {
            ...
            if (comparableTimeMark instanceof DoubleTimeMark) {
                ...
                if (Intrinsics.areEqual((Object) this.timeSource, (Object) doubleTimeMark.timeSource)) {
                    if (Duration.m2568equalsimpl0(this.offset, doubleTimeMark.offset) && Duration.m2595isInfiniteimpl(this.offset)) {
                        return Duration.Companion.m2666getZEROUwyO8pc();
                    }
                    long r2 = Duration.m2598minusLRDsOJo(this.offset, doubleTimeMark.offset);
                    long duration = DurationKt.toDuration(this.startedAt - doubleTimeMark.startedAt, this.timeSource.getUnit());
                    return Duration.m2568equalsimpl0(duration, Duration.m2616unaryMinusUwyO8pc(r2)) ? Duration.Companion.m2666getZEROUwyO8pc() : Duration.m2599plusLRDsOJo(duration, r2);
                }
            }
        ...
        public boolean equals(Object obj) {
            return (obj instanceof DoubleTimeMark) && Intrinsics.areEqual((Object) this.timeSource, (Object) ((DoubleTimeMark) obj).timeSource) && Duration.m2568equalsimpl0(m2542minusUwyO8pc((ComparableTimeMark) obj), Duration.Companion.m2666getZEROUwyO8pc());
        }

        public int hashCode() {
            return Duration.m2591hashCodeimpl(Duration.m2599plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + Duration.m2612toStringimpl(this.offset) + ", " + this.timeSource + ')';
        }
    }

    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.Companion.m2666getZEROUwyO8pc(), (DefaultConstructorMarker) null);
    }
}
