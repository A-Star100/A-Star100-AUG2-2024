...
public final class DurationKt {
    ...
    private static final long m2690timesmvk6XK0(int i, long j) {
        return Duration.m2601timesUwyO8pc(j, i);
    }

    /* renamed from: times-kIfJnKk  reason: not valid java name */
    private static final long m2689timeskIfJnKk(double d, long j) {
        return Duration.m2600timesUwyO8pc(j, d);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        if (length != 0) {
            long r82 = Duration.Companion.m2666getZEROUwyO8pc();
            ...
            if (length > i) {
                ...
                if (str2.charAt(i) == 'P') {
                                ...
                                if (charSequence.length() != 0) {
                                    ...
                                    if (durationUnit2 == null || durationUnit2.compareTo(durationUnitByIsoChar) > 0) {
                                        ...
                                        if (durationUnitByIsoChar != DurationUnit.SECONDS || indexOf$default <= 0) {
                                            z4 = z8;
                                            r82 = Duration.m2599plusLRDsOJo(r82, toDuration(parseOverLongIsoComponent(substring), durationUnitByIsoChar));
                                        } else {
                                            Intrinsics.checkNotNull(substring, "null cannot be cast to non-null type java.lang.String");
                                            String substring2 = substring.substring(0, indexOf$default);
                                            Intrinsics.checkNotNullExpressionValue(substring2, "substring(...)");
                                            z4 = z8;
                                            long r0 = Duration.m2599plusLRDsOJo(r82, toDuration(parseOverLongIsoComponent(substring2), durationUnitByIsoChar));
                                            Intrinsics.checkNotNull(substring, "null cannot be cast to non-null type java.lang.String");
                                            String substring3 = substring.substring(indexOf$default);
                                            Intrinsics.checkNotNullExpressionValue(substring3, "substring(...)");
                                            r82 = Duration.m2599plusLRDsOJo(r0, toDuration(Double.parseDouble(substring3), durationUnitByIsoChar));
                                        }
                                        z8 = z4;
                    ...
                    if (!z) {
                        ...
                        if (StringsKt.regionMatches(str, i, "Infinity", 0, Math.max(length - i, 8), true)) {
                            r82 = Duration.Companion.m2664getINFINITEUwyO8pc();
                        } else {
                            boolean z9 = !z6;
                                ...
                                if (charSequence3.length() != 0) {
                                    ...
                                    if (durationUnit == null || durationUnit.compareTo(durationUnitByShortName) > 0) {
                                        ...
                                        if (indexOf$default2 > 0) {
                                            ...
                                            long r5 = Duration.m2599plusLRDsOJo(r82, toDuration(Long.parseLong(substring6), durationUnitByShortName));
                                            Intrinsics.checkNotNull(substring4, "null cannot be cast to non-null type java.lang.String");
                                            String substring7 = substring4.substring(indexOf$default2);
                                            Intrinsics.checkNotNullExpressionValue(substring7, "substring(...)");
                                            r8 = Duration.m2599plusLRDsOJo(r5, toDuration(Double.parseDouble(substring7), durationUnitByShortName));
                                            if (i < length) {
                                                throw new IllegalArgumentException("Fractional component must be last");
                                            }
                                        } else {
                                            r8 = Duration.m2599plusLRDsOJo(r82, toDuration(Long.parseLong(substring4), durationUnitByShortName));
                                        }
                                        str2 = str;
                                        str4 = str6;
                ...
                if (z2) {
                    return Duration.m2616unaryMinusUwyO8pc(r82);
                }
                return r82;
            }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m2563constructorimpl(j << 1);
    }

    /* access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m2563constructorimpl((j << 1) + 1);
    }

    /* access modifiers changed from: private */
    public static final long durationOf(long j, int i) {
        return Duration.m2563constructorimpl((j << 1) + ((long) i));
    }
