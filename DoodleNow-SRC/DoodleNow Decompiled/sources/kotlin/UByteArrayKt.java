...
public final class UByteArrayKt {
    ...
    private static final byte[] m1317ubyteArrayOfGBYM_sE(byte... bArr) {
    ...
    private static final byte[] UByteArray(int i, Function1<? super Integer, UByte> function1) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            bArr[i2] = function1.invoke(Integer.valueOf(i2)).m1298unboximpl();
        }
        return UByteArray.m1301constructorimpl(bArr);
    }
}
