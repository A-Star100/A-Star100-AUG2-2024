...
public final class OptionalsKt {
    ...
    public static final <T> T getOrDefault(Optional<? extends T> optional, T t) {
        Intrinsics.checkNotNullParameter(optional, "<this>");
        return Chip$$ExternalSyntheticApiModelOutline0.m((Optional) optional) ? Chip$$ExternalSyntheticApiModelOutline0.m((Optional) optional) : t;
    }

    public static final <T> T getOrElse(Optional<? extends T> optional, Function0<? extends T> function0) {
        Intrinsics.checkNotNullParameter(optional, "<this>");
        Intrinsics.checkNotNullParameter(function0, "defaultValue");
        return Chip$$ExternalSyntheticApiModelOutline0.m((Optional) optional) ? Chip$$ExternalSyntheticApiModelOutline0.m((Optional) optional) : function0.invoke();
    }
    ...
    public static final <T, C extends Collection<? super T>> C toCollection(Optional<T> optional, C c) {
        ...
        if (Chip$$ExternalSyntheticApiModelOutline0.m((Optional) optional)) {
            Object m = Chip$$ExternalSyntheticApiModelOutline0.m((Optional) optional);
    ...
    public static final <T> List<T> toList(Optional<? extends T> optional) {
        Intrinsics.checkNotNullParameter(optional, "<this>");
        return Chip$$ExternalSyntheticApiModelOutline0.m((Optional) optional) ? CollectionsKt.listOf(Chip$$ExternalSyntheticApiModelOutline0.m((Optional) optional)) : CollectionsKt.emptyList();
    }

    public static final <T> Set<T> toSet(Optional<? extends T> optional) {
        Intrinsics.checkNotNullParameter(optional, "<this>");
        return Chip$$ExternalSyntheticApiModelOutline0.m((Optional) optional) ? SetsKt.setOf(Chip$$ExternalSyntheticApiModelOutline0.m((Optional) optional)) : SetsKt.emptySet();
    }
    ...
    public static final <T> Sequence<T> asSequence(Optional<? extends T> optional) {
        ...
        return SequencesKt.sequenceOf(Chip$$ExternalSyntheticApiModelOutline0.m((Optional) optional));
    }
}
