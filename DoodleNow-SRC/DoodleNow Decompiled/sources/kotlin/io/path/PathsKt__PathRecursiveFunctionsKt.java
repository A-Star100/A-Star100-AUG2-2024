...
class PathsKt__PathRecursiveFunctionsKt extends PathsKt__PathReadWriteKt {
    ...
    public static final Path copyToRecursively(Path path, Path path2, Function3<? super Path, ? super Path, ? super Exception, ? extends OnErrorResult> function3, boolean z, Function3<? super CopyActionContext, ? super Path, ? super Path, ? extends CopyActionResult> function32) {
        ...
        if (Files.exists(path, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length))) {
            if (Files.exists(path, (LinkOption[]) Arrays.copyOf(new LinkOption[0], 0)) && (z || !Headers$Builder$$ExternalSyntheticApiModelOutline0.m(path))) {
                boolean z2 = Files.exists(path2, (LinkOption[]) Arrays.copyOf(new LinkOption[0], 0)) && !Headers$Builder$$ExternalSyntheticApiModelOutline0.m(path2);
                if ((!z2 || !PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path, path2)) && Intrinsics.areEqual((Object) PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path), (Object) PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path2)) && (!z2 ? !((m$1 = path2.getParent()) == null || !Files.exists(m$1, (LinkOption[]) Arrays.copyOf(new LinkOption[0], 0)) || !Headers$Builder$$ExternalSyntheticApiModelOutline0.m(Headers$Builder$$ExternalSyntheticApiModelOutline0.m(m$1, new LinkOption[0]), Headers$Builder$$ExternalSyntheticApiModelOutline0.m(path, new LinkOption[0]))) : Headers$Builder$$ExternalSyntheticApiModelOutline0.m(Headers$Builder$$ExternalSyntheticApiModelOutline0.m(path2, new LinkOption[0]), Headers$Builder$$ExternalSyntheticApiModelOutline0.m(path, new LinkOption[0])))) {
                    PathTreeWalk$$ExternalSyntheticApiModelOutline0.m();
                    throw Headers$Builder$$ExternalSyntheticApiModelOutline0.m(path.toString(), path2.toString(), "Recursively copying a directory into its subdirectory is prohibited.");
                }
            }
        ...
        Headers$Builder$$ExternalSyntheticApiModelOutline0.m();
        throw Headers$Builder$$ExternalSyntheticApiModelOutline0.m(path.toString(), path2.toString(), "The source file doesn't exist.");
    }
    ...
    private static final Path copyToRecursively$destination$PathsKt__PathRecursiveFunctionsKt(Path path, Path path2, Path path3) {
        Path m = Headers$Builder$$ExternalSyntheticApiModelOutline0.m(path2, PathsKt.relativeTo(path3, path).toString());
    ...
    private static final FileVisitResult toFileVisitResult$PathsKt__PathRecursiveFunctionsKt(CopyActionResult copyActionResult) {
        ...
        if (i == 1) {
            return Headers$Builder$$ExternalSyntheticApiModelOutline0.m$1();
        }
        if (i == 2) {
            return Headers$Builder$$ExternalSyntheticApiModelOutline0.m();
        }
        if (i == 3) {
    ...
    private static final java.util.List<java.lang.Exception> deleteRecursivelyImpl$PathsKt__PathRecursiveFunctionsKt(java.nio.file.Path r8) {
        /*
            ...
            java.nio.file.DirectoryStream r5 = okhttp3.Headers$Builder$$ExternalSyntheticApiModelOutline0.m((java.nio.file.Path) r4)     // Catch:{ all -> 0x0013 }
            goto L_0x0014
        L_0x0013:
            r5 = r3
        L_0x0014:
            ...
            java.nio.file.DirectoryStream r6 = okhttp3.Headers$Builder$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r5)     // Catch:{ all -> 0x003f }
            boolean r7 = okhttp3.Headers$Builder$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r6)     // Catch:{ all -> 0x003f }
            if (r7 == 0) goto L_0x0036
            r0.setPath(r4)     // Catch:{ all -> 0x003f }
            java.nio.file.SecureDirectoryStream r2 = okhttp3.Headers$Builder$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r6)     // Catch:{ all -> 0x003f }
            java.nio.file.Path r4 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((java.nio.file.Path) r8)     // Catch:{ all -> 0x003f }
    ...
    private static final void enterDirectory$PathsKt__PathRecursiveFunctionsKt(java.nio.file.SecureDirectoryStream<java.nio.file.Path> r4, java.nio.file.Path r5, kotlin.io.path.ExceptionsCollector r6) {
        ...
        L_0x0013:
            ...
            java.nio.file.SecureDirectoryStream r5 = okhttp3.Headers$Builder$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r4)     // Catch:{ all -> 0x0040 }
        ...
        L_0x001f:
            ...
            java.nio.file.Path r2 = com.facebook.react.views.text.ReactTextView$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r2)     // Catch:{ all -> 0x0040 }
    ...
    private static final boolean isDirectory$PathsKt__PathRecursiveFunctionsKt(SecureDirectoryStream<Path> secureDirectoryStream, Path path, LinkOption... linkOptionArr) {
        Boolean bool;
        try {
            bool = Boolean.valueOf(Headers$Builder$$ExternalSyntheticApiModelOutline0.m((Object) secureDirectoryStream.getFileAttributeView(path, Headers$Builder$$ExternalSyntheticApiModelOutline0.m(), (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length))).readAttributes().isDirectory());
        } catch (NoSuchFileException unused) {
            bool = null;
        }
        if (bool != null) {
    ...
    private static final void insecureHandleEntry$PathsKt__PathRecursiveFunctionsKt(Path path, ExceptionsCollector exceptionsCollector) {
        try {
            if (Files.isDirectory(path, (LinkOption[]) Arrays.copyOf(new LinkOption[]{PathTreeWalk$$ExternalSyntheticApiModelOutline0.m()}, 1))) {
                ...
                if (totalExceptions == exceptionsCollector.getTotalExceptions()) {
                    Headers$Builder$$ExternalSyntheticApiModelOutline0.m$1(path);
                    return;
                }
                return;
            }
    ...
    private static final void insecureEnterDirectory$PathsKt__PathRecursiveFunctionsKt(java.nio.file.Path r3, kotlin.io.path.ExceptionsCollector r4) {
        /*
            r0 = 0
            java.nio.file.DirectoryStream r3 = okhttp3.Headers$Builder$$ExternalSyntheticApiModelOutline0.m((java.nio.file.Path) r3)     // Catch:{ NoSuchFileException -> 0x0008 }
            goto L_0x0009
        L_0x0006:
            r3 = move-exception
            goto L_0x0037
        ...
        L_0x0009:
            ...
            java.nio.file.DirectoryStream r1 = okhttp3.Headers$Builder$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r3)     // Catch:{ all -> 0x0030 }
        ...
        L_0x0015:
            ...
            java.nio.file.Path r2 = com.facebook.react.views.text.ReactTextView$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r2)     // Catch:{ all -> 0x0030 }
            kotlin.jvm.internal.Intrinsics.checkNotNull(r2)     // Catch:{ all -> 0x0030 }
            insecureHandleEntry$PathsKt__PathRecursiveFunctionsKt(r2, r4)     // Catch:{ all -> 0x0030 }
            goto L_0x0015
        L_0x002a:
