...
class PathsKt__PathUtilsKt extends PathsKt__PathRecursiveFunctionsKt {
    ...
    private static final Path absolute(Path path) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Path m = Headers$Builder$$ExternalSyntheticApiModelOutline0.m(path);
        Intrinsics.checkNotNullExpressionValue(m, "toAbsolutePath(...)");
        return m;
    }

    private static final String absolutePathString(Path path) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        return Headers$Builder$$ExternalSyntheticApiModelOutline0.m(path).toString();
    }
    ...
    static /* synthetic */ Path copyTo$default(Path path, Path path2, boolean z, int i, Object obj) throws IOException {
        ...
        CopyOption[] copyOptionArr = z ? new CopyOption[]{Headers$Builder$$ExternalSyntheticApiModelOutline0.m()} : new CopyOption[0];
    ...
    private static final boolean isRegularFile(Path path, LinkOption... linkOptionArr) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(linkOptionArr, "options");
        return Headers$Builder$$ExternalSyntheticApiModelOutline0.m(path, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length));
    }
    ...
    private static final boolean isSymbolicLink(Path path) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        return Headers$Builder$$ExternalSyntheticApiModelOutline0.m(path);
    }
    ...
    public static final java.util.List<java.nio.file.Path> listDirectoryEntries(java.nio.file.Path r1, java.lang.String r2) throws java.io.IOException {
        /*
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r2, r0)
            java.nio.file.DirectoryStream r1 = okhttp3.Headers$Builder$$ExternalSyntheticApiModelOutline0.m((java.nio.file.Path) r1, (java.lang.String) r2)
            java.io.Closeable r1 = (java.io.Closeable) r1
            java.nio.file.DirectoryStream r2 = okhttp3.Headers$Builder$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r1)     // Catch:{ all -> 0x0022 }
    ...
    static /* synthetic */ java.lang.Object useDirectoryEntries$default(java.nio.file.Path r0, java.lang.String r1, kotlin.jvm.functions.Function1 r2, int r3, java.lang.Object r4) throws java.io.IOException {
        ...
        L_0x0006:
            ...
            java.nio.file.DirectoryStream r0 = okhttp3.Headers$Builder$$ExternalSyntheticApiModelOutline0.m((java.nio.file.Path) r0, (java.lang.String) r1)
            java.io.Closeable r0 = (java.io.Closeable) r0
            r1 = 0
            java.nio.file.DirectoryStream r3 = okhttp3.Headers$Builder$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r0)     // Catch:{ all -> 0x0044 }
    ...
    private static final <T> T useDirectoryEntries(java.nio.file.Path r2, java.lang.String r3, kotlin.jvm.functions.Function1<? super kotlin.sequences.Sequence<? extends java.nio.file.Path>, ? extends T> r4) throws java.io.IOException {
        /*
            ...
            java.nio.file.DirectoryStream r2 = okhttp3.Headers$Builder$$ExternalSyntheticApiModelOutline0.m((java.nio.file.Path) r2, (java.lang.String) r3)
            java.io.Closeable r2 = (java.io.Closeable) r2
            r3 = 0
            r0 = 1
            java.nio.file.DirectoryStream r1 = okhttp3.Headers$Builder$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r2)     // Catch:{ all -> 0x003f }
    ...
    static /* synthetic */ void forEachDirectoryEntry$default(java.nio.file.Path r1, java.lang.String r2, kotlin.jvm.functions.Function1 r3, int r4, java.lang.Object r5) throws java.io.IOException {
        ...
        L_0x0006:
            ...
            java.io.Closeable r1 = (java.io.Closeable) r1
            r2 = 0
            java.nio.file.DirectoryStream r4 = okhttp3.Headers$Builder$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r1)     // Catch:{ all -> 0x0050 }
    ...
    private static final void forEachDirectoryEntry(java.nio.file.Path r3, java.lang.String r4, kotlin.jvm.functions.Function1<? super java.nio.file.Path, kotlin.Unit> r5) throws java.io.IOException {
        /*
            ...
            java.nio.file.DirectoryStream r3 = okhttp3.Headers$Builder$$ExternalSyntheticApiModelOutline0.m((java.nio.file.Path) r3, (java.lang.String) r4)
            java.io.Closeable r3 = (java.io.Closeable) r3
            r4 = 0
            r0 = 1
            java.nio.file.DirectoryStream r1 = okhttp3.Headers$Builder$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r3)     // Catch:{ all -> 0x004b }
    ...
    private static final void deleteExisting(Path path) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Headers$Builder$$ExternalSyntheticApiModelOutline0.m(path);
    }

    private static final boolean deleteIfExists(Path path) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        return Headers$Builder$$ExternalSyntheticApiModelOutline0.m$1(path);
    }
    ...
    private static final FileStore fileStore(Path path) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        FileStore m = Headers$Builder$$ExternalSyntheticApiModelOutline0.m(path);
    ...
    private static final Object getAttribute(Path path, String str, LinkOption... linkOptionArr) throws IOException {
        ...
        Intrinsics.checkNotNullParameter(linkOptionArr, "options");
        return Headers$Builder$$ExternalSyntheticApiModelOutline0.m(path, str, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length));
    }
    ...
    private static final /* synthetic */ <V extends FileAttributeView> V fileAttributesViewOrNull(Path path, LinkOption... linkOptionArr) {
        ...
        Class m$1 = Headers$Builder$$ExternalSyntheticApiModelOutline0.m$1();
        Class cls = m$1;
    ...
    private static final /* synthetic */ <V extends FileAttributeView> V fileAttributesView(Path path, LinkOption... linkOptionArr) {
        ...
        if (m != null) {
            return Headers$Builder$$ExternalSyntheticApiModelOutline0.m((Object) m);
        }
        Intrinsics.reifiedOperationMarker(4, ExifInterface.GPS_MEASUREMENT_INTERRUPTED);
        Class m$12 = Headers$Builder$$ExternalSyntheticApiModelOutline0.m$1();
        Class cls2 = m$12;
    ...
    private static final /* synthetic */ <A extends BasicFileAttributes> A readAttributes(Path path, LinkOption... linkOptionArr) throws IOException {
        ...
        return Headers$Builder$$ExternalSyntheticApiModelOutline0.m((Object) m2);
    }
    ...
    private static final Map<String, Object> readAttributes(Path path, String str, LinkOption... linkOptionArr) throws IOException {
        ...
        Intrinsics.checkNotNullParameter(linkOptionArr, "options");
        Map<String, Object> m = Headers$Builder$$ExternalSyntheticApiModelOutline0.m(path, str, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length));
    ...
    private static final FileTime getLastModifiedTime(Path path, LinkOption... linkOptionArr) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(linkOptionArr, "options");
        FileTime m = Headers$Builder$$ExternalSyntheticApiModelOutline0.m(path, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length));
    ...
    private static final Set<PosixFilePermission> getPosixFilePermissions(Path path, LinkOption... linkOptionArr) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(linkOptionArr, "options");
        Set<PosixFilePermission> m = Headers$Builder$$ExternalSyntheticApiModelOutline0.m(path, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length));
    ...
    private static final Path createLinkPointingTo(Path path, Path path2) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(path2, TouchesHelper.TARGET_KEY);
        Path m = Headers$Builder$$ExternalSyntheticApiModelOutline0.m(path, path2);
    ...
    private static final Path readSymbolicLink(Path path) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Path m$1 = Headers$Builder$$ExternalSyntheticApiModelOutline0.m$1(path);
    ...
    private static final Path createFile(Path path, FileAttribute<?>... fileAttributeArr) throws IOException {
        ...
        Intrinsics.checkNotNullExpressionValue(m, "createFile(...)");
        return m;
    }
    ...
    private static final Path div(Path path, String str) {
        ...
        Path m = Headers$Builder$$ExternalSyntheticApiModelOutline0.m(path, str);
        Intrinsics.checkNotNullExpressionValue(m, "resolve(...)");
        return m;
    }
