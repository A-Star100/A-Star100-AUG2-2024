...
public final class DelayKt {
    ...
    public static final Object m2736delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m2737toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2737toDelayMillisLRDsOJo(long j) {
        boolean r0 = Duration.m2597isPositiveimpl(j);
        if (r0) {
            Duration.Companion companion = Duration.Companion;
            return Duration.m2581getInWholeMillisecondsimpl(Duration.m2599plusLRDsOJo(j, DurationKt.toDuration(999999, DurationUnit.NANOSECONDS)));
        } else if (!r0) {
            return 0;
        } else {
