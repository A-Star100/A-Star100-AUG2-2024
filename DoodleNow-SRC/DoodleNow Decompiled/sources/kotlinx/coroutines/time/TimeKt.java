...
public final class TimeKt {
    ...
    private static final long coerceToMillis(Duration duration) {
        if (duration.compareTo(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m()) <= 0) {
            return 0;
        }
        if (duration.compareTo(Headers$Builder$$ExternalSyntheticApiModelOutline0.m().getDuration()) <= 0) {
            return 1;
        }
        if (Headers$Builder$$ExternalSyntheticApiModelOutline0.m(duration) < 9223372036854775L || (Headers$Builder$$ExternalSyntheticApiModelOutline0.m(duration) == 9223372036854775L && Headers$Builder$$ExternalSyntheticApiModelOutline0.m(duration) < 807000000)) {
