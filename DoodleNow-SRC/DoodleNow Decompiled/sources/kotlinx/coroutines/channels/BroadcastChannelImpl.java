...
public final class BroadcastChannelImpl<E> extends BufferedChannel<E> implements BroadcastChannel<E> {
    ...
    public ReceiveChannel<E> openSubscription() {
        ...
        try {
            ...
            if (!isClosedForSend() || this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT) {
                if (this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT) {
                    subscriberConflated.m2749trySendJP2dKIU(getValue());
                }
    ...
    public Object m2742trySendJP2dKIU(E e) {
        Lock lock2 = this.lock;
        lock2.lock();
        try {
            if (isClosedForSend()) {
                return super.m2749trySendJP2dKIU(e);
            }
            ...
            if (!(iterable instanceof Collection) || !((Collection) iterable).isEmpty()) {
                for (BufferedChannel shouldSendSuspend$kotlinx_coroutines_core : iterable) {
                    if (shouldSendSuspend$kotlinx_coroutines_core.shouldSendSuspend$kotlinx_coroutines_core()) {
                        Object r4 = ChannelResult.Companion.m2772failurePtdJZtk();
                        lock2.unlock();
                        return r4;
                    }
                }
            ...
            for (BufferedChannel r2 : this.subscribers) {
                r2.m2749trySendJP2dKIU(e);
            }
            Object r42 = ChannelResult.Companion.m2773successJP2dKIU(Unit.INSTANCE);
            lock2.unlock();
            return r42;
        } finally {
            lock2.unlock();
