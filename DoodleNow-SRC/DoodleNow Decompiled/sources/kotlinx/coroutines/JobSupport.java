...
public class JobSupport implements Job, ChildJob, ParentJob {
    ...
    public final DisposableHandle invokeOnCompletionInternal$kotlinx_coroutines_core(boolean z, boolean z2, InternalCompletionHandler internalCompletionHandler) {
        ...
        while (true) {
            ...
            if (state$kotlinx_coroutines_core instanceof Empty) {
                ...
                } else if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_state$volatile$FU, this, state$kotlinx_coroutines_core, makeNode)) {
                    return makeNode;
                }
            } else {
                Throwable th = null;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:53:0x0095, code lost:
        if (tryWaitForChild(r1, r8, r9) == false) goto L_0x009a;
     */
    ...
    private final java.lang.Object tryMakeCompletingSlowPath(kotlinx.coroutines.Incomplete r8, java.lang.Object r9) {
        ...
        L_0x001d:
            ...
            r3.<init>()
            monitor-enter(r1)
            boolean r4 = r1.isCompleting()     // Catch:{ all -> 0x009f }
        ...
        L_0x002f:
            r4 = 1
            r1.setCompleting(r4)     // Catch:{ all -> 0x009f }
            if (r1 == r8) goto L_0x0045
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r5 = _state$volatile$FU     // Catch:{ all -> 0x009f }
            boolean r5 = androidx.concurrent.futures.AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(r5, r7, r8, r1)     // Catch:{ all -> 0x009f }
            if (r5 != 0) goto L_0x0045
            kotlinx.coroutines.internal.Symbol r8 = kotlinx.coroutines.JobSupportKt.COMPLETING_RETRY     // Catch:{ all -> 0x009f }
            monitor-exit(r1)
            return r8
        L_0x0045:
            boolean r5 = kotlinx.coroutines.DebugKt.getASSERTIONS_ENABLED()     // Catch:{ all -> 0x009f }
            if (r5 == 0) goto L_0x0059
            boolean r5 = r1.isSealed()     // Catch:{ all -> 0x009f }
            r5 = r5 ^ r4
        ...
        L_0x0059:
            boolean r5 = r1.isCancelling()     // Catch:{ all -> 0x009f }
            boolean r6 = r9 instanceof kotlinx.coroutines.CompletedExceptionally     // Catch:{ all -> 0x009f }
            if (r6 == 0) goto L_0x0065
            r6 = r9
            kotlinx.coroutines.CompletedExceptionally r6 = (kotlinx.coroutines.CompletedExceptionally) r6     // Catch:{ all -> 0x009f }
            goto L_0x0066
        L_0x0065:
            r6 = r2
        L_0x0066:
            if (r6 == 0) goto L_0x006d
            java.lang.Throwable r6 = r6.cause     // Catch:{ all -> 0x009f }
            r1.addExceptionLocked(r6)     // Catch:{ all -> 0x009f }
        L_0x006d:
            java.lang.Throwable r6 = r1.getRootCause()     // Catch:{ all -> 0x009f }
            r4 = r4 ^ r5
            java.lang.Boolean r4 = java.lang.Boolean.valueOf(r4)     // Catch:{ all -> 0x009f }
            boolean r4 = r4.booleanValue()     // Catch:{ all -> 0x009f }
            if (r4 == 0) goto L_0x007d
            r2 = r6
        L_0x007d:
            r3.element = r2     // Catch:{ all -> 0x009f }
