...
public final class FutureKt {
    ...
    public static final <T> CompletableFuture<T> future(CoroutineScope coroutineScope, CoroutineContext coroutineContext, CoroutineStart coroutineStart, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2) {
        if (!coroutineStart.isLazy()) {
            ...
            CompletableFuture<T> m = Headers$Builder$$ExternalSyntheticApiModelOutline0.m();
            CompletableFutureCoroutine completableFutureCoroutine = new CompletableFutureCoroutine(newCoroutineContext, m);
            CompletableFuture unused = m.handle(Headers$Builder$$ExternalSyntheticApiModelOutline0.m((Object) completableFutureCoroutine));
    ...
    public static final CompletableFuture<Unit> asCompletableFuture(Job job) {
        CompletableFuture<Unit> m = Headers$Builder$$ExternalSyntheticApiModelOutline0.m();
    ...
    public static final <T> Deferred<T> asDeferred(CompletionStage<T> completionStage) {
        ...
        if (Headers$Builder$$ExternalSyntheticApiModelOutline0.m(m)) {
            try {
                return CompletableDeferredKt.CompletableDeferred(Headers$Builder$$ExternalSyntheticApiModelOutline0.m(m));
            } catch (Throwable th) {
                th = th;
    ...
    public static final <T> Object await(CompletionStage<T> completionStage, Continuation<? super T> continuation) {
        ...
        if (Headers$Builder$$ExternalSyntheticApiModelOutline0.m(m)) {
            try {
                return Headers$Builder$$ExternalSyntheticApiModelOutline0.m(m);
            ...
            CompletionStage unused = completionStage.handle(Headers$Builder$$ExternalSyntheticApiModelOutline0.m((Object) continuationHandler));
