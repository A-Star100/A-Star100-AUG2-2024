...
public final class UIntArraySerializer extends PrimitiveArraySerializer<UInt, UIntArray, UIntArrayBuilder> implements KSerializer<UIntArray> {
    ...
    public /* bridge */ /* synthetic */ int collectionSize(Object obj) {
        return m2836collectionSizeajY9A(((UIntArray) obj).m1394unboximpl());
    }

    public /* bridge */ /* synthetic */ Object empty() {
        return UIntArray.m1378boximpl(m2837emptyhP7Qyg());
    }

    public /* bridge */ /* synthetic */ Object toBuilder(Object obj) {
        return m2838toBuilderajY9A(((UIntArray) obj).m1394unboximpl());
    }

    public /* bridge */ /* synthetic */ void writeContent(CompositeEncoder compositeEncoder, Object obj, int i) {
        m2839writeContentCPlH8fI(compositeEncoder, ((UIntArray) obj).m1394unboximpl(), i);
    }
    ...
    public int m2836collectionSizeajY9A(int[] iArr) {
        Intrinsics.checkNotNullParameter(iArr, "$this$collectionSize");
        return UIntArray.m1386getSizeimpl(iArr);
    }

    /* access modifiers changed from: protected */
    /* renamed from: toBuilder--ajY-9A  reason: not valid java name */
    public UIntArrayBuilder m2838toBuilderajY9A(int[] iArr) {
    ...
    public int[] m2837emptyhP7Qyg() {
        return UIntArray.m1379constructorimpl(0);
    }
    ...
    public void readElement(CompositeDecoder compositeDecoder, int i, UIntArrayBuilder uIntArrayBuilder, boolean z) {
        ...
        uIntArrayBuilder.m2834appendWZ4Q5Ns$kotlinx_serialization_core(UInt.m1325constructorimpl(compositeDecoder.decodeInlineElement(getDescriptor(), i).decodeInt()));
    }

    /* access modifiers changed from: protected */
    /* renamed from: writeContent-CPlH8fI  reason: not valid java name */
    public void m2839writeContentCPlH8fI(CompositeEncoder compositeEncoder, int[] iArr, int i) {
        Intrinsics.checkNotNullParameter(compositeEncoder, "encoder");
        Intrinsics.checkNotNullParameter(iArr, UriUtil.LOCAL_CONTENT_SCHEME);
        for (int i2 = 0; i2 < i; i2++) {
            compositeEncoder.encodeInlineElement(getDescriptor(), i2).encodeInt(UIntArray.m1385getpVg5ArA(iArr, i2));
        }
    }
}
