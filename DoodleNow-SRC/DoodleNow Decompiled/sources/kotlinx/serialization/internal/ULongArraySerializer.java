...
public final class ULongArraySerializer extends PrimitiveArraySerializer<ULong, ULongArray, ULongArrayBuilder> implements KSerializer<ULongArray> {
    ...
    public /* bridge */ /* synthetic */ int collectionSize(Object obj) {
        return m2844collectionSizeQwZRm1k(((ULongArray) obj).m1473unboximpl());
    }

    public /* bridge */ /* synthetic */ Object empty() {
        return ULongArray.m1457boximpl(m2845emptyY2RjT0g());
    }

    public /* bridge */ /* synthetic */ Object toBuilder(Object obj) {
        return m2846toBuilderQwZRm1k(((ULongArray) obj).m1473unboximpl());
    }

    public /* bridge */ /* synthetic */ void writeContent(CompositeEncoder compositeEncoder, Object obj, int i) {
        m2847writeContent0q3Fkuo(compositeEncoder, ((ULongArray) obj).m1473unboximpl(), i);
    }
    ...
    public int m2844collectionSizeQwZRm1k(long[] jArr) {
        Intrinsics.checkNotNullParameter(jArr, "$this$collectionSize");
        return ULongArray.m1465getSizeimpl(jArr);
    }

    /* access modifiers changed from: protected */
    /* renamed from: toBuilder-QwZRm1k  reason: not valid java name */
    public ULongArrayBuilder m2846toBuilderQwZRm1k(long[] jArr) {
    ...
    public long[] m2845emptyY2RjT0g() {
        return ULongArray.m1458constructorimpl(0);
    }
    ...
    public void readElement(CompositeDecoder compositeDecoder, int i, ULongArrayBuilder uLongArrayBuilder, boolean z) {
        ...
        uLongArrayBuilder.m2842appendVKZWuLQ$kotlinx_serialization_core(ULong.m1404constructorimpl(compositeDecoder.decodeInlineElement(getDescriptor(), i).decodeLong()));
    }

    /* access modifiers changed from: protected */
    /* renamed from: writeContent-0q3Fkuo  reason: not valid java name */
    public void m2847writeContent0q3Fkuo(CompositeEncoder compositeEncoder, long[] jArr, int i) {
        Intrinsics.checkNotNullParameter(compositeEncoder, "encoder");
        Intrinsics.checkNotNullParameter(jArr, UriUtil.LOCAL_CONTENT_SCHEME);
        for (int i2 = 0; i2 < i; i2++) {
            compositeEncoder.encodeInlineElement(getDescriptor(), i2).encodeLong(ULongArray.m1464getsVKNKU(jArr, i2));
        }
    }
}
