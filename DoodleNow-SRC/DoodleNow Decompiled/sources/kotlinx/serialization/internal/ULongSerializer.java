...
public final class ULongSerializer implements KSerializer<ULong> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return ULong.m1398boximpl(m2848deserializeI7RO_PI(decoder));
    }

    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object obj) {
        m2849serialize2TYgG_w(encoder, ((ULong) obj).m1456unboximpl());
    }

    /* renamed from: serialize-2TYgG_w  reason: not valid java name */
    public void m2849serialize2TYgG_w(Encoder encoder, long j) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        encoder.encodeInline(getDescriptor()).encodeLong(j);
    }

    /* renamed from: deserialize-I7RO_PI  reason: not valid java name */
    public long m2848deserializeI7RO_PI(Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return ULong.m1404constructorimpl(decoder.decodeInline(getDescriptor()).decodeLong());
    }
}
