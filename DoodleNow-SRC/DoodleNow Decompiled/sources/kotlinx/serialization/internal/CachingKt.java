...
public final class CachingKt {
    ...
    static {
        ...
        try {
            ...
            z = Result.m1230constructorimpl(Class.forName("java.lang.ClassValue"));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            z = Result.m1230constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m1237isSuccessimpl(z)) {
            Result.Companion companion3 = Result.Companion;
            Class cls = (Class) z;
            z = true;
        }
        Object r0 = Result.m1230constructorimpl(z);
        if (Result.m1236isFailureimpl(r0)) {
            r0 = false;
        }
