...
public final class DurationSerializer implements KSerializer<Duration> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return Duration.m2561boximpl(m2821deserialize5sfh64U(decoder));
    }

    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object obj) {
        m2822serializeHG0u8IE(encoder, ((Duration) obj).m2618unboximpl());
    }

    /* renamed from: serialize-HG0u8IE  reason: not valid java name */
    public void m2822serializeHG0u8IE(Encoder encoder, long j) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        encoder.encodeString(Duration.m2608toIsoStringimpl(j));
    }

    /* renamed from: deserialize-5sfh64U  reason: not valid java name */
    public long m2821deserialize5sfh64U(Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return Duration.Companion.m2683parseIsoStringUwyO8pc(decoder.decodeString());
    }
}
