...
public final class UByteArraySerializer extends PrimitiveArraySerializer<UByte, UByteArray, UByteArrayBuilder> implements KSerializer<UByteArray> {
    ...
    public /* bridge */ /* synthetic */ int collectionSize(Object obj) {
        return m2828collectionSizeGBYM_sE(((UByteArray) obj).m1315unboximpl());
    }

    public /* bridge */ /* synthetic */ Object empty() {
        return UByteArray.m1299boximpl(m2829emptyTcUX1vc());
    }

    public /* bridge */ /* synthetic */ Object toBuilder(Object obj) {
        return m2830toBuilderGBYM_sE(((UByteArray) obj).m1315unboximpl());
    }

    public /* bridge */ /* synthetic */ void writeContent(CompositeEncoder compositeEncoder, Object obj, int i) {
        m2831writeContentCoi6ktg(compositeEncoder, ((UByteArray) obj).m1315unboximpl(), i);
    }
    ...
    public int m2828collectionSizeGBYM_sE(byte[] bArr) {
        Intrinsics.checkNotNullParameter(bArr, "$this$collectionSize");
        return UByteArray.m1307getSizeimpl(bArr);
    }

    /* access modifiers changed from: protected */
    /* renamed from: toBuilder-GBYM_sE  reason: not valid java name */
    public UByteArrayBuilder m2830toBuilderGBYM_sE(byte[] bArr) {
    ...
    public byte[] m2829emptyTcUX1vc() {
        return UByteArray.m1300constructorimpl(0);
    }
    ...
    public void readElement(CompositeDecoder compositeDecoder, int i, UByteArrayBuilder uByteArrayBuilder, boolean z) {
        ...
        uByteArrayBuilder.m2826append7apg3OU$kotlinx_serialization_core(UByte.m1248constructorimpl(compositeDecoder.decodeInlineElement(getDescriptor(), i).decodeByte()));
    }

    /* access modifiers changed from: protected */
    /* renamed from: writeContent-Coi6ktg  reason: not valid java name */
    public void m2831writeContentCoi6ktg(CompositeEncoder compositeEncoder, byte[] bArr, int i) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            compositeEncoder.encodeInlineElement(getDescriptor(), i2).encodeByte(UByteArray.m1306getw2LRezQ(bArr, i2));
        }
    }
}
