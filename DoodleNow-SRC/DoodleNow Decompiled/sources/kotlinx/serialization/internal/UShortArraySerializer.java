...
public final class UShortArraySerializer extends PrimitiveArraySerializer<UShort, UShortArray, UShortArrayBuilder> implements KSerializer<UShortArray> {
    ...
    public /* bridge */ /* synthetic */ int collectionSize(Object obj) {
        return m2852collectionSizerL5Bavg(((UShortArray) obj).m1578unboximpl());
    }

    public /* bridge */ /* synthetic */ Object empty() {
        return UShortArray.m1562boximpl(m2853emptyamswpOA());
    }

    public /* bridge */ /* synthetic */ Object toBuilder(Object obj) {
        return m2854toBuilderrL5Bavg(((UShortArray) obj).m1578unboximpl());
    }

    public /* bridge */ /* synthetic */ void writeContent(CompositeEncoder compositeEncoder, Object obj, int i) {
        m2855writeContenteny0XGE(compositeEncoder, ((UShortArray) obj).m1578unboximpl(), i);
    }
    ...
    public int m2852collectionSizerL5Bavg(short[] sArr) {
        Intrinsics.checkNotNullParameter(sArr, "$this$collectionSize");
        return UShortArray.m1570getSizeimpl(sArr);
    }

    /* access modifiers changed from: protected */
    /* renamed from: toBuilder-rL5Bavg  reason: not valid java name */
    public UShortArrayBuilder m2854toBuilderrL5Bavg(short[] sArr) {
    ...
    public short[] m2853emptyamswpOA() {
        return UShortArray.m1563constructorimpl(0);
    }
    ...
    public void readElement(CompositeDecoder compositeDecoder, int i, UShortArrayBuilder uShortArrayBuilder, boolean z) {
        ...
        uShortArrayBuilder.m2850appendxj2QHRw$kotlinx_serialization_core(UShort.m1511constructorimpl(compositeDecoder.decodeInlineElement(getDescriptor(), i).decodeShort()));
    }

    /* access modifiers changed from: protected */
    /* renamed from: writeContent-eny0XGE  reason: not valid java name */
    public void m2855writeContenteny0XGE(CompositeEncoder compositeEncoder, short[] sArr, int i) {
        Intrinsics.checkNotNullParameter(compositeEncoder, "encoder");
        Intrinsics.checkNotNullParameter(sArr, UriUtil.LOCAL_CONTENT_SCHEME);
        for (int i2 = 0; i2 < i; i2++) {
            compositeEncoder.encodeInlineElement(getDescriptor(), i2).encodeShort(UShortArray.m1569getMh2AYeg(sArr, i2));
        }
    }
}
