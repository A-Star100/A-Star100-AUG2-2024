...
public final class JsonArray extends JsonElement implements List<JsonElement>, KMappedMarker {
    ...
    public JsonArray(List<? extends JsonElement> list) {
        ...
        Intrinsics.checkNotNullParameter(list, UriUtil.LOCAL_CONTENT_SCHEME);
        this.content = list;
    }
    ...
    public String toString() {
        return CollectionsKt.joinToString$default(this.content, f.a, "[", "]", 0, (CharSequence) null, (Function1) null, 56, (Object) null);
    }
}
