...
public final class AbstractJsonTreeEncoder$encodeTaggedInline$1 extends AbstractEncoder {
    ...
    public void encodeInt(int i) {
        putUnquotedString(UByte$$ExternalSyntheticBackport0.m(UInt.m1325constructorimpl(i), 10));
    }

    public void encodeLong(long j) {
        putUnquotedString(UByte$$ExternalSyntheticBackport0.m(ULong.m1404constructorimpl(j)));
    }

    public void encodeByte(byte b) {
        putUnquotedString(UByte.m1292toStringimpl(UByte.m1248constructorimpl(b)));
    }

    public void encodeShort(short s) {
        putUnquotedString(UShort.m1555toStringimpl(UShort.m1511constructorimpl(s)));
    }
}
