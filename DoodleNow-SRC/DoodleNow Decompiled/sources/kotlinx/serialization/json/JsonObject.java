...
public final class JsonObject extends JsonElement implements Map<String, JsonElement>, KMappedMarker {
    ...
    public JsonObject(Map<String, ? extends JsonElement> map) {
        ...
        Intrinsics.checkNotNullParameter(map, UriUtil.LOCAL_CONTENT_SCHEME);
        this.content = map;
    }
    ...
    public String toString() {
        return CollectionsKt.joinToString$default(this.content.entrySet(), f.a, "{", "}", 0, (CharSequence) null, JsonObject$toString$1.INSTANCE, 24, (Object) null);
    }
}
